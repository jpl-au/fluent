...
// Text Creates a new strong element with text content
// Example: strong.Text("Important notice")
// Renders: <strong>Important notice</strong>
...
// Static Creates a new strong element with static text content.
// Example: strong.Static("Hello World")
// Renders: <strong>Hello World</strong>
...
// RawText Creates a new strong element with raw text content as unescaped HTML.
// Example: strong.RawText("Important <em>nested</em> text")
// Renders: <strong>Important <em>nested</em> text</strong>
...
// Textf Creates a new strong element with formatted text content using text.Textf.
// Example: strong.Textf("%s notice", "Important")
// Renders: <strong>Important notice</strong>
...
// RawTextf Creates a new strong element with formatted raw text content as unescaped HTML using text.RawTextf.
// Example: strong.RawTextf("%s <em>%s</em> text", "Important", "nested")
// Renders: <strong>Important <em>nested</em> text</strong>
