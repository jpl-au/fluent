...
//
// The <strong>: The Strong Importance element indicates that its contents have strong importance, seriousness, or
...
// element represents the <strong> HTML element
type element struct {
...
func (e *element) RenderBuilder(buf *bytes.Buffer) {
	...
	buf.Write(html5.TagStrongClose)
}
