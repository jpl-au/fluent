...
//
// The <fieldset> element groups related form controls. Its first legend child
// provides the group's caption. Disabled makes descendant controls unavailable,
// except for controls inside that first legend.
package fieldset
...
// Disabled creates a fieldset whose descendant form controls are disabled,
// except those inside its first legend child. Disabled controls are excluded
...
//
// Disables descendant form controls, excluding those inside the first legend
// child. Disabled controls cannot receive focus or contribute submitted values.
//
...
//
// The id of the form that owns this fieldset. This associates the group with
// a form even when it is outside that form. It does not automatically associate
// the fieldset's descendant controls with the same form.
