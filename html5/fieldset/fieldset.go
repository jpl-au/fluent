...
// greyed out, and cannot be interacted with. The legend element and its contents are exempt from this
// disabling. Useful for temporarily preventing input to entire sections of a form.
