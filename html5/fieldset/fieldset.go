...
//
// The <fieldset> HTML element groups related form controls and labels, providing semantic structure and visual
// organisation to forms. Often paired with a <legend> element to provide a caption. Useful for organising
// complex forms into logical sections, supporting accessibility by grouping related inputs, and enabling
// bulk enable/disable of controls via the disabled attribute.
package fieldset
...
// element represents the <fieldset> HTML element
type element struct {
...
// Disabled creates a disabled fieldset where all descendant form controls are
// inactive. The legend element and its contents are exempt from
...
//
// Disables all form controls that are descendants of the fieldset. Controls become greyed out and cannot
// be interacted with. The legend element and its contents are exempt from this disabling.
//
...
//
// Associates the fieldset with a specific form element by referencing the form's ID attribute. This allows
// the fieldset to be part of a form even when not physically nested inside it, providing flexibility in
...
//
// The name associated with the group of form controls within the fieldset. This name can be used for
// scripting and accessibility purposes, providing a programmatic identifier for the grouped controls.
...
func (e *element) RenderBuilder(buf *bytes.Buffer) {
	...
	buf.Write(html5.TagFieldsetClose)
}
