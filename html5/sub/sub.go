...
// Text Creates a new sub element with text content (HTML-encoded).
// Example: sub.Text("<em>2</em>")
// Renders: <sub>&lt;em&gt;2&lt;/em&gt;</sub>
...
// Static Creates a new sub element with static text content.
// Example: sub.Static("Hello World")
// Renders: <sub>Hello World</sub>
...
// RawText Creates a new sub element with raw text content as unescaped HTML.
// Example: sub.RawText("<em>2</em>")
// Renders: <sub><em>2</em></sub>
...
// Textf Creates a new sub element with formatted text content using text.Textf.
// Example: sub.Textf("%d", 2)
// Renders: <sub>2</sub>
...
// RawTextf Creates a new sub element with formatted raw text content as unescaped HTML using text.RawTextf.
// Example: sub.RawTextf("<em>%d</em>", 2)
// Renders: <sub><em>2</em></sub>
