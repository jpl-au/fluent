...
//
// The <sub> HTML element specifies inline text displayed as subscript for solely typographical
// reasons. Subscripts are typically rendered with a lowered baseline using smaller text.
package sub
...
// Text creates a new sub element with text content. Uses text.Text which HTML-escapes the output.
// Example: sub.Text("2")
// Renders: <sub>2</sub>
