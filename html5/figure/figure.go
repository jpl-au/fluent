...
// specified using the <figcaption> element. The figure, its caption, and its contents are referenced as a
// single unit.
package figure
...
// element represents the <figure> HTML element
type element struct {
...
func (e *element) RenderBuilder(buf *bytes.Buffer) {
	...
	buf.Write(html5.TagFigureClose)
}
