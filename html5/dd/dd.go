...
//
// The <dd> element supplies a description or value for one or more dt terms in
// a dl description list. A group can contain several terms and several
// descriptions, as in a glossary entry with synonyms and multiple definitions.
package dd
