...
//
// The <bdi> HTML element isolates text from its surrounding bidirectional text context, preventing it from
// affecting the directionality of adjacent text. Essential when embedding dynamic content of unknown
// directionality (like usernames or user-generated content) within text that might be right-to-left (RTL) or
// left-to-right (LTR). Prevents layout issues in multilingual applications.
package bdi
