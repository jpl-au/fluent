...
//
// The <bdi> element isolates a run of text from the surrounding bidirectional
// text. Use it for content such as usernames whose direction is not known in
// advance, so it does not reorder adjacent punctuation or text.
package bdi
