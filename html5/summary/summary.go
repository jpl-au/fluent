...
// Text Creates a new summary element with text content.
...
// Static Creates a new summary element with static text content.
// Example: summary.Static("Hello World")
// Renders: <summary>Hello World</summary>
...
// RawText Creates a new summary element with raw text content as unescaped HTML.
...
// Textf Creates a new summary element with formatted text content using text.Textf.
// Example: summary.Textf("%s to %s", "Click", "expand")
// Renders: <summary>Click to expand</summary>
...
// RawTextf Creates a new summary element with formatted raw text content as unescaped HTML using text.RawTextf.
// Example: summary.RawTextf("<strong>%s</strong> to %s", "Click", "expand")
// Renders: <summary><strong>Click</strong> to expand</summary>
