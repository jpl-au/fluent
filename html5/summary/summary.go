...
//
// The <summary> element labels a details disclosure widget. Place it as the
// first child of details. Activating it toggles the visibility of the remaining
// content. The label stays visible when the widget is closed.
package summary
...
// Element represents the <summary> HTML element.
type Element struct {
...
func (e *Element) RenderBuilder(buf *bytes.Buffer) {
	...
	buf.Write(html5.TagSummaryClose)
}
