...
// Text Creates a new ruby element with text content
...
// Static Creates a new ruby element with static text content
...
// RawText Creates a new ruby element with raw text content
...
// Textf Creates a new ruby element with formatted text content (HTML-encoded)
// Example: ruby.Textf("Chapter %d", 1)
// Renders: <ruby>Chapter 1</ruby>
...
// RawTextf Creates a new ruby element with formatted raw text content as unescaped HTML
// Example: ruby.RawTextf("%s<rt>%s</rt>", "漢", "かん")
// Renders: <ruby>漢<rt>かん</rt></ruby>
