...
// Text Creates a new list item element with text content
// Example: li.Text("List item text")
// Renders: <li>List item text</li>
...
// Static Creates a new li element with static text content.
// Example: li.Static("Hello World")
// Renders: <li>Hello World</li>
...
// RawText Creates a new list item element with raw text content
// Example: li.RawText("Item with <strong>bold</strong> text")
// Renders: <li>Item with <strong>bold</strong> text</li>
...
// Textf Creates a new li element with formatted text content using text.Textf.
// Example: li.Textf("Hello %s", "World")
// Renders: <li>Hello World</li>
...
// RawTextf Creates a new li element with formatted raw text content as unescaped HTML using text.RawTextf.
// Example: li.RawTextf("Hello <em>%s</em>", "World")
// Renders: <li>Hello <em>World</em></li>
...
// Type This character attribute indicates the numbering type. Values: "a", "A", "i", "I", "1"
