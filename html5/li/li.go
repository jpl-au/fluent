...
//
// The <li>: The List Item element is used to represent an item in a list. It must be contained in a parent
...
// element represents the <li> HTML element
type element struct {
...
//
// Indicates the numbering type for this list item. Values: "a", "A", "i", "I", "1"
//
