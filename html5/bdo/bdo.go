...
//
// The <bdo> HTML element forcibly overrides the bidirectional text algorithm, rendering text in a specific
// direction regardless of its natural directionality. Used when you need to explicitly control text direction
// for special formatting, displaying code examples, or showing text in an intentionally reversed manner.
// Requires the dir attribute to specify the override direction.
package bdo
...
// Element represents the <bdo> HTML element.
type Element struct {
...
//
// The direction in which text should be rendered in this element's contents. This attribute is required for
// the bdo element to function correctly. Use dir.LeftToRight for left-to-right or dir.RightToLeft for
// right-to-left. The specified direction overrides the Unicode bidirectional algorithm, forcing all text
// within to render in the specified direction.
