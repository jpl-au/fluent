...
// element represents the <head> HTML element
type element struct {
...
// Profile sets the profile attribute.
//
// A space-separated list of URIs for one or more metadata profiles.
//
// Deprecated: This attribute has been removed from the HTML specification.
func (e *element) Profile(urls string) *element {
	e.SetAttribute("profile", urls)
	return e
}
