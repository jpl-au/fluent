...
//
// The <s> HTML element renders text with a strikethrough, or a line through it. Use the <s> element to
...
// Element represents the <s> HTML element.
type Element struct {
...
// Example: s.New(text.Text("Old price: $100"))
