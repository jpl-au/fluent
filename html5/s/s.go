...
// Text Creates a new s element with text content.
...
// Static Creates a new s element with static text content.
// Example: s.Static("Hello World")
// Renders: <s>Hello World</s>
...
// RawText Creates a new s element with raw text content.
// Example: s.RawText("Old price: $100")
// Renders: <s>Old price: $100</s>
