...
//
// The <rp> element supplies fallback punctuation around ruby annotations.
// Browsers that render ruby hide it. Other renderers show the punctuation
// around the rt text so the annotation remains distinguishable from the base text.
package rp
