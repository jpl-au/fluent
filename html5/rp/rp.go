...
// Text Creates a new rp element with text content (HTML-encoded).
// Example: rp.Text("(")
// Renders: <rp>(</rp>
...
// Static Creates a new rp element with static text content.
// Example: rp.Static(")")
// Renders: <rp>)</rp>
...
// RawText Creates a new rp element with raw text content as unescaped HTML.
...
// Textf Creates a new rp element with formatted text content (HTML-encoded).
// Example: rp.Textf("%s", "(")
// Renders: <rp>(</rp>
...
// RawTextf Creates a new rp element with formatted raw text content as unescaped HTML.
// Example: rp.RawTextf("<%s>", "span")
// Renders: <rp><span></rp>
