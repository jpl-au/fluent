...
//
// The <col> HTML element defines one or more columns in a column group represented by its parent <colgroup>
// element. The <col> element is only valid as a child of a <colgroup> element that has no span attribute
// defined.
package col
...
// Element represents the <col> HTML element.
type Element struct {
...
//
// Specifies the number of consecutive columns the <col> element spans. The value must be a positive integer
// greater than zero. If not present, its default value is 1. This attribute allows a single <col> element
// to apply styling or behaviour to multiple consecutive columns in a table.
