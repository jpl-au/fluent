...
// New Creates a new select element with optional child nodes
...
// Text Creates a new select element with text content
// Example: dropdown.Text("Select an option")
// Renders: <select>Select an option</select>
...
// Static Creates a new select element with static text content.
// Example: dropdown.Static("Hello World")
// Renders: <select>Hello World</select>
...
// RawText Creates a new select element with raw content as unescaped HTML.
// Example: dropdown.RawText("<option>Option</option>")
// Renders: <select><option>Option</option></select>
...
// Textf Creates a new select element with formatted text content using text.Textf.
// Example: dropdown.Textf("Select %s option", "an")
// Renders: <select>Select an option</select>
...
// RawTextf Creates a new select element with formatted raw text content as unescaped HTML using text.RawTextf.
// Example: dropdown.RawTextf("<option>%s</option>", "Option")
// Renders: <select><option>Option</option></select>
...
// AutoFocus A boolean attribute that automatically focuses this select element when the page loads or when a dialog
...
// navigation expectations. Most effective for primary selection controls in forms.
func (e *element) AutoFocus() *element {
	e.autoFocus = true
	return e
}

// Disabled A boolean attribute that disables the select element, preventing user interaction and form submission. When
...
// Form Associates the select element with a form element in the document by referencing the form's ID attribute.
...
// Multiple A boolean attribute that allows users to select multiple options simultaneously using Ctrl+click (or
...
// Required A boolean attribute that makes this select element mandatory for form submission. Browsers will prevent form
...
// Size Specifies the number of options that should be visible in the select element without scrolling. When size
