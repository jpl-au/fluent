...
//
// The <datalist> element supplies suggested values for an input whose list
// attribute references its id. Its option children offer choices without limiting
// the input to those choices. Validation constraints are specified on the input.
package datalist
...
// Element represents the <datalist> HTML element.
type Element struct {
...
func (e *Element) RenderBuilder(buf *bytes.Buffer) {
	...
	buf.Write(html5.TagDatalistClose)
}
