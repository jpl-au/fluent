...
// Text Creates a new dfn element with text content (HTML-encoded).
// Example: dfn.Text("<b>validator</b>")
...
// Static Creates a new dfn element with static text content.
// Example: dfn.Static("Hello World")
// Renders: <dfn>Hello World</dfn>
...
// RawText Creates a new dfn element with raw text content as unescaped HTML.
...
// Textf Creates a new dfn element with formatted text content using text.Textf.
// Example: dfn.Textf("Hello %s", "World")
// Renders: <dfn>Hello World</dfn>
...
// RawTextf Creates a new dfn element with formatted raw text content as unescaped HTML using text.RawTextf.
// Example: dfn.RawTextf("Hello <em>%s</em>", "World")
// Renders: <dfn>Hello <em>World</em></dfn>
