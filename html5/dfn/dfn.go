...
//
// The <dfn> element marks the term being defined. The containing paragraph,
// description-list group or section provides the definition. If title is present,
// its value identifies the term. Otherwise the term is taken from the content.
package dfn
...
// Element represents the <dfn> HTML element.
type Element struct {
...
// Renders: <dfn title="Specification">spec</dfn>
...
//
// Provides an alternative form or expanded version of the term being defined. On dfn, the title
// attribute has special semantics - it represents the term being defined when the element content
// is an abbreviation or alternative form. Screen readers and other tools use this to identify
// the canonical term.
