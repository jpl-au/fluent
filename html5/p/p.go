...
// Text Creates a new paragraph element with text content
...
// Static Creates a new p element with static text content
// Example: p.Static("Static text")
// Renders: <p>Static text</p>
...
// RawText Creates a new paragraph element with raw text content as unescaped HTML
...
// Textf Creates a new paragraph element with formatted text content using text.Textf
// Example: p.Textf("Hello %s", "World")
...
// RawTextf Creates a new paragraph element with formatted raw text content as unescaped HTML using text.RawTextf
// Example: p.RawTextf("Hello <em>%s</em>", "World")
// Renders: <p>Hello <em>World</em></p>
