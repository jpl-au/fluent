...
// Text Creates a complete HTML5 document with DOCTYPE declaration and text content
...
// Static Creates a complete HTML5 document with DOCTYPE declaration and static text content
// Example: html.Static("Hello World")
...
// RawText Creates a complete HTML5 document with DOCTYPE declaration and raw text content
...
// Textf Creates a complete HTML5 document with DOCTYPE declaration and formatted text content using text.Textf
// Example: html.Textf("Hello %s", "World")
// Renders: <!DOCTYPE html><html>Hello World</html>
...
// RawTextf Creates a complete HTML5 document with DOCTYPE declaration and formatted raw text content as unescaped HTML using text.RawTextf
// Example: html.RawTextf("Hello <em>%s</em>", "World")
...
// FragmentText Creates an html fragment without DOCTYPE declaration with text content
...
// FragmentStatic Creates an html fragment without DOCTYPE declaration with static text content
// Example: html.FragmentStatic("Hello World")
// Renders: <html>Hello World</html>
...
// FragmentRawText Creates an html fragment without DOCTYPE declaration with raw text content
...
// FragmentTextf Creates an html fragment without DOCTYPE declaration with formatted text content using text.Textf
// Example: html.FragmentTextf("Hello %s", "World")
// Renders: <html>Hello World</html>
...
// FragmentRawTextf Creates an html fragment without DOCTYPE declaration with formatted raw text content as unescaped HTML using text.RawTextf
// Example: html.FragmentRawTextf("Hello <em>%s</em>", "World")
// Renders: <html>Hello <em>World</em></html>
...
// Xmlns Defines the XML namespace for the document. Typically "http://www.w3.org/1999/xhtml" for XHTML documents
func (e *element) Xmlns(namespace string) *element {
	e.SetAttribute("xmlns", namespace)
	return e
}

// Manifest Specifies the URI of a resource manifest for the application. Deprecated in HTML5
