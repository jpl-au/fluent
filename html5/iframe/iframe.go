...
// Text Creates a new iframe element with fallback text content (HTML-encoded).
...
// Static Creates a new iframe element with static text content.
// Example: iframe.Static("Hello World")
// Renders: <iframe>Hello World</iframe>
...
// RawText Creates a new iframe element with raw fallback content as unescaped HTML.
...
// Textf Creates a new iframe element with formatted text content using text.Textf.
// Example: iframe.Textf("Hello %s", "World")
// Renders: <iframe>Hello World</iframe>
...
// RawTextf Creates a new iframe element with formatted raw text content as unescaped HTML using text.RawTextf.
// Example: iframe.RawTextf("Hello <em>%s</em>", "World")
// Renders: <iframe>Hello <em>World</em></iframe>
...
func (e *element) AllowFullscreen() *element {
