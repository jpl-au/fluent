...
// filter represents the <filter> SVG element.
type filter struct {
	bufferhint     atomic.Int64
	filterUnits    units.Units
	nodes          []node.Node
	primitiveUnits units.Units
	dynamic        string
	height         string
	href           string
	memoise        any
...
func (e *filter) event() *html5.EventAttributes {
	if e.ea == nil {
...
// Filter defines a sequence of image-processing primitives applied to an SVG
// element. Reference its id through filter="url(#id)". Primitives can use the
// source graphic, source alpha or earlier named results. The filter region
// bounds the area available to the effect.
func Filter(children ...FilterPrimitive) *filter {
...
//
// The x of the filter region, the area the filter may paint into. It defaults to -10% so effects such as
// a blur or a shadow have room to spread beyond the element.
func (e *filter) X(value string) *filter {
...
//
// The y of the filter region. It defaults to -10%, for the same reason as x.
func (e *filter) Y(value string) *filter {
...
//
// The width of the filter region. It defaults to 120%, so an effect is not clipped at the element's edge.
func (e *filter) Width(value string) *filter {
...
//
// The height of the filter region. It defaults to 120%, for the same reason as width.
func (e *filter) Height(value string) *filter {
	e.height = node.EscapeAttribute(value)
	return e
}

// FilterUnits sets the filterUnits attribute.
//
// The coordinate system of x, y, width and height: the user space in place where the filter is
// referenced, or fractions of the bounding box of the filtered element, which is the default.
func (e *filter) FilterUnits(value units.Units) *filter {
	e.filterUnits = value
	return e
}

// PrimitiveUnits sets the primitiveUnits attribute.
//
// The coordinate system of the length attributes on the child primitives, such as a blur's standard
// deviation, which is separate from the system the filter region is measured in. It defaults to the user
// space in place where the filter is referenced.
func (e *filter) PrimitiveUnits(value units.Units) *filter {
	e.primitiveUnits = value
	return e
}

// Href sets the href attribute.
//
// A reference to another filter, as "#id", whose attributes and primitives this filter inherits unless
// it sets its own.
func (e *filter) Href(value string) *filter {
	e.href = node.EscapeAttribute(value)
	return e
}

// ID sets the id attribute.
func (e *filter) ID(id string) *filter {
	e.svg().ID = node.EscapeAttribute(id)
	return e
}

// Class appends to the space-separated class attribute.
func (e *filter) Class(class string) *filter {
...
func (e *filter) Style(css string) *filter {
	e.svg().Style = node.EscapeAttribute(css)
	return e
}

// Transform sets the transform attribute.
func (e *filter) Transform(transform string) *filter {
...
func (e *filter) TransformOrigin(origin string) *filter {
	e.svg().TransformOrigin = node.EscapeAttribute(origin)
	return e
}

// TabIndex sets the tabindex attribute.
func (e *filter) TabIndex(index string) *filter {
	e.svg().TabIndex = node.EscapeAttribute(index)
	return e
}

// Role sets the role attribute.
func (e *filter) Role(role string) *filter {
...
func (e *filter) Lang(lang string) *filter {
...
func (e *filter) AutoFocus(conds ...bool) *filter {
	if len(conds) > 0 {
...
func (e *filter) SetAria(key string, value string) *filter {
...
func (e *filter) StrokeDashOffset(offset string) *filter {
...
func (e *filter) StrokeMiterLimit(limit string) *filter {
...
func (e *filter) FillRule(rule fillrule.FillRule) *filter {
	e.svg().FillRule = rule
	return e
}
...
// a clipPath.
func (e *filter) ClipRule(rule cliprule.ClipRule) *filter {
	e.svg().ClipRule = rule
	return e
}
...
func (e *filter) ClipPath(clip string) *filter {
...
// per pixel.
func (e *filter) Mask(mask string) *filter {
...
func (e *filter) Filter(filter string) *filter {
...
func (e *filter) Color(color string) *filter {
...
func (e *filter) Cursor(cursor string) *filter {
...
func (e *filter) Display(display string) *filter {
...
// drawn again.
func (e *filter) Visibility(value visibility.Visibility) *filter {
...
func (e *filter) PointerEvents(events pointerevents.PointerEvents) *filter {
...
func (e *filter) VectorEffect(effect vectoreffect.VectorEffect) *filter {
...
func (e *filter) ShapeRendering(rendering shaperendering.ShapeRendering) *filter {
...
func (e *filter) FontFamily(family string) *filter {
...
// is in user units.
func (e *filter) FontSize(size string) *filter {
...
// from 100 to 900.
func (e *filter) FontWeight(weight string) *filter {
...
func (e *filter) FontStyle(style string) *filter {
...
func (e *filter) OnClick(handler string) *filter {
...
func (e *filter) OnChange(handler string) *filter {
...
func (e *filter) OnInput(handler string) *filter {
...
func (e *filter) OnFocus(handler string) *filter {
...
func (e *filter) OnBlur(handler string) *filter {
...
func (e *filter) OnSubmit(handler string) *filter {
...
func (e *filter) OnLoad(handler string) *filter {
...
func (e *filter) OnError(handler string) *filter {
...
// developer-controlled key. Never build the key from user input - a key containing a space, quote,
// "=", "/" or ">" changes the markup structure. The value is escaped. The key is not escaped.
func (e *filter) SetEvent(key string, value string) *filter {
...
func (e *filter) OnAbort(handler string) *filter {
...
func (e *filter) OnAutoComplete(handler string) *filter {
...
//
// Deprecated: Removed from the WHATWG living standard. Was in an older HTML5 draft.
func (e *filter) OnAutoCompleteError(handler string) *filter {
...
func (e *filter) OnCancel(handler string) *filter {
...
func (e *filter) OnCanPlay(handler string) *filter {
...
func (e *filter) OnCanPlayThrough(handler string) *filter {
...
// results.
func (e *filter) OnClose(handler string) *filter {
...
func (e *filter) OnContextMenu(handler string) *filter {
...
// timestamps.
func (e *filter) OnCueChange(handler string) *filter {
...
func (e *filter) OnDblClick(handler string) *filter {
...
func (e *filter) OnDrag(handler string) *filter {
...
func (e *filter) OnDragEnd(handler string) *filter {
...
func (e *filter) OnDragEnter(handler string) *filter {
...
func (e *filter) OnDragLeave(handler string) *filter {
...
func (e *filter) OnDragOver(handler string) *filter {
...
func (e *filter) OnDragStart(handler string) *filter {
...
// enable dropping.
func (e *filter) OnDrop(handler string) *filter {
...
func (e *filter) OnDurationChange(handler string) *filter {
...
// media content.
func (e *filter) OnEmptied(handler string) *filter {
...
func (e *filter) OnEnded(handler string) *filter {
...
func (e *filter) OnInvalid(handler string) *filter {
...
func (e *filter) OnKeyDown(handler string) *filter {
...
func (e *filter) OnKeyPress(handler string) *filter {
...
func (e *filter) OnKeyUp(handler string) *filter {
...
func (e *filter) OnLoadedData(handler string) *filter {
...
func (e *filter) OnLoadedMetadata(handler string) *filter {
...
func (e *filter) OnLoadStart(handler string) *filter {
...
func (e *filter) OnMouseDown(handler string) *filter {
...
func (e *filter) OnMouseEnter(handler string) *filter {
...
func (e *filter) OnMouseLeave(handler string) *filter {
...
func (e *filter) OnMouseMove(handler string) *filter {
...
func (e *filter) OnMouseOut(handler string) *filter {
...
func (e *filter) OnMouseOver(handler string) *filter {
...
func (e *filter) OnMouseUp(handler string) *filter {
...
func (e *filter) OnMouseWheel(handler string) *filter {
...
func (e *filter) OnPause(handler string) *filter {
...
func (e *filter) OnPlay(handler string) *filter {
...
func (e *filter) OnPlaying(handler string) *filter {
...
func (e *filter) OnProgress(handler string) *filter {
...
func (e *filter) OnRateChange(handler string) *filter {
...
func (e *filter) OnReset(handler string) *filter {
...
// ResizeObserver.
func (e *filter) OnResize(handler string) *filter {
...
func (e *filter) OnScroll(handler string) *filter {
...
func (e *filter) OnSeeked(handler string) *filter {
...
func (e *filter) OnSeeking(handler string) *filter {
...
func (e *filter) OnSelect(handler string) *filter {
...
func (e *filter) OnShow(handler string) *filter {
...
func (e *filter) OnSort(handler string) *filter {
...
func (e *filter) OnStalled(handler string) *filter {
...
func (e *filter) OnSuspend(handler string) *filter {
...
func (e *filter) OnTimeUpdate(handler string) *filter {
...
func (e *filter) OnToggle(handler string) *filter {
...
func (e *filter) OnVolumeChange(handler string) *filter {
...
func (e *filter) OnWaiting(handler string) *filter {
...
func (e *filter) OnAuxClick(handler string) *filter {
...
func (e *filter) OnWheel(handler string) *filter {
...
func (e *filter) OnCopy(handler string) *filter {
...
// content itself.
func (e *filter) OnCut(handler string) *filter {
...
func (e *filter) OnPaste(handler string) *filter {
...
func (e *filter) OnScrollEnd(handler string) *filter {
...
func (e *filter) OnFormData(handler string) *filter {
...
func (e *filter) OnAnimationCancel(handler string) *filter {
...
func (e *filter) OnAnimationEnd(handler string) *filter {
...
func (e *filter) OnAnimationIteration(handler string) *filter {
...
func (e *filter) OnAnimationStart(handler string) *filter {
...
func (e *filter) OnTransitionCancel(handler string) *filter {
...
func (e *filter) OnTransitionEnd(handler string) *filter {
...
func (e *filter) OnTransitionRun(handler string) *filter {
...
func (e *filter) OnTransitionStart(handler string) *filter {
...
func (e *filter) OnBeforeToggle(handler string) *filter {
...
func (e *filter) OnBeforeInput(handler string) *filter {
...
func (e *filter) OnBeforeMatch(handler string) *filter {
...
func (e *filter) OnCommand(handler string) *filter {
...
func (e *filter) OnContextLost(handler string) *filter {
...
func (e *filter) OnContextRestored(handler string) *filter {
...
func (e *filter) OnSecurityPolicyViolation(handler string) *filter {
...
func (e *filter) OnSlotChange(handler string) *filter {
...
func (e *filter) OnPointerDown(handler string) *filter {
...
func (e *filter) OnPointerUp(handler string) *filter {
...
func (e *filter) OnPointerMove(handler string) *filter {
...
func (e *filter) OnPointerEnter(handler string) *filter {
...
func (e *filter) OnPointerLeave(handler string) *filter {
...
func (e *filter) OnPointerOver(handler string) *filter {
...
// element for any of its descendants.
func (e *filter) OnPointerOut(handler string) *filter {
...
func (e *filter) OnPointerCancel(handler string) *filter {
...
func (e *filter) OnGotPointerCapture(handler string) *filter {
...
func (e *filter) OnLostPointerCapture(handler string) *filter {
...
func (e *filter) OnTouchStart(handler string) *filter {
...
func (e *filter) OnTouchEnd(handler string) *filter {
...
func (e *filter) OnTouchMove(handler string) *filter {
...
func (e *filter) OnTouchCancel(handler string) *filter {
...
func (e *filter) OnSelectStart(handler string) *filter {
...
func (e *filter) OnSelectionChange(handler string) *filter {
...
func (e *filter) SetAttribute(key string, value string) {
...
func (e *filter) SetAttributeRaw(key string, value string) {
	if e.attr == nil {
		e.attr = &[]node.Attribute{}
	}
	for i, attr := range *e.attr {
...
func (e *filter) Add(children ...FilterPrimitive) *filter {
...
func (e *filter) Replace(children ...FilterPrimitive) *filter {
...
func (e *filter) DynamicKey() string {
	return e.dynamic
}
...
func (e *filter) Memoise(version any) *filter {
	e.memoise = version
	return e
}
...
func (e *filter) BufferHint(hint int) *filter {
	if hint > 0 {
...
func (e *filter) RenderedSize() int {
...
func (e *filter) Render(w io.Writer) {
	_, _ = e.WriteTo(w)
}
...
func (e *filter) WriteTo(w io.Writer) (int64, error) {
...
func (e *filter) RenderBytes() []byte {
...
func (e *filter) AttributeBuilder(buf *bytes.Buffer) {
	if e.x != "" {
		buf.Write(AttrX)
		buf.WriteString(e.x)
	...
	if len(e.filterUnits) > 0 {
		buf.Write(AttrFilterUnits)
		buf.Write(e.filterUnits)
		buf.Write(MarkupQuote)
	}
	if len(e.primitiveUnits) > 0 {
		buf.Write(AttrPrimitiveUnits)
		buf.Write(e.primitiveUnits)
		buf.Write(MarkupQuote)
	}
	if e.href != "" {
		buf.Write(AttrHref)
...
func (e *filter) RenderBuilder(buf *bytes.Buffer) {
	buf.Write(TagFilter)
	...
	buf.Write(TagFilterClose)
}

// RenderOpen writes the opening tag and attributes to the buffer.
func (e *filter) RenderOpen(buf *bytes.Buffer) {
	buf.Write(TagFilter)
	e.AttributeBuilder(buf)
	buf.Write(MarkupCloseTag)
}
...
// isSVGShape seals filter as a Shape.
func (*filter) isSVGShape() {}
