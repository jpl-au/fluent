...
// animateMotion represents the <animateMotion> SVG element.
...
func (e *animateMotion) svg() *svgAttrs {
	if e.sa == nil {
		e.sa = &svgAttrs{}
	}
	return e.sa
...
func (e *animateMotion) event() *html5.EventAttributes {
	if e.ea == nil {
...
// AnimateMotion moves its parent element along a path over time. Give the path
// in the path attribute, or reference an existing one with a child MPath.
func AnimateMotion(children ...*mpath) *animateMotion {
...
//
// The path to move along, in the same syntax as a path element's d attribute.
func (e *animateMotion) Path(value string) *animateMotion {
	e.path = node.EscapeAttribute(value)
	return e
}

// KeyPoints sets the keyPoints attribute.
//
// How far along the path each keyTime falls, as fractions from 0 to 1, which lets the motion pause or
// change pace without changing the path.
func (e *animateMotion) KeyPoints(value string) *animateMotion {
	e.keyPoints = node.EscapeAttribute(value)
	return e
}

// Rotate sets the rotate attribute.
//
// How the element is turned as it moves: "auto" to face along the path, "auto-reverse" to face backwards
// along it, or a fixed angle in degrees.
func (e *animateMotion) Rotate(value string) *animateMotion {
...
//
// Reserved by the specification and ignored by browsers.
func (e *animateMotion) Origin(value string) *animateMotion {
	e.origin = node.EscapeAttribute(value)
	return e
}

// Values sets the values attribute.
//
// The sequence of offsets to animate through, separated by semicolons, when no path is given.
func (e *animateMotion) Values(value string) *animateMotion {
...
//
// The starting offset.
func (e *animateMotion) From(value string) *animateMotion {
...
//
// The ending offset.
func (e *animateMotion) To(value string) *animateMotion {
...
func (e *animateMotion) By(value string) *animateMotion {
...
func (e *animateMotion) Begin(value string) *animateMotion {
...
func (e *animateMotion) Dur(value string) *animateMotion {
...
//
// When to stop.
func (e *animateMotion) End(value string) *animateMotion {
...
func (e *animateMotion) RepeatCount(value string) *animateMotion {
...
func (e *animateMotion) RepeatDur(value string) *animateMotion {
...
func (e *animateMotion) Restart(value restart.Restart) *animateMotion {
	e.restart = value
	return e
}
...
//
// Whether the final position is kept when the animation ends.
func (e *animateMotion) Fill(value animationfill.AnimationFill) *animateMotion {
	e.fill = value
	return e
}
...
//
// How offsets are interpolated between. Motion defaults to paced, which keeps the speed even along the path.
func (e *animateMotion) CalcMode(value calcmode.CalcMode) *animateMotion {
	e.calcMode = value
	return e
}
...
//
// When each value or key point is reached, as fractions of the duration.
func (e *animateMotion) KeyTimes(value string) *animateMotion {
...
func (e *animateMotion) KeySplines(value string) *animateMotion {
...
//
// Whether the motion replaces the underlying position or adds to it.
func (e *animateMotion) Additive(value additive.Additive) *animateMotion {
	e.additive = value
	return e
}
...
func (e *animateMotion) Accumulate(value accumulate.Accumulate) *animateMotion {
	e.accumulate = value
	return e
}
...
//
// The element to move, as "#id", when the animation is not placed inside it.
func (e *animateMotion) Href(value string) *animateMotion {
	e.href = node.EscapeAttribute(value)
	return e
}

// ID sets the id attribute.
func (e *animateMotion) ID(id string) *animateMotion {
	e.svg().ID = node.EscapeAttribute(id)
	return e
}

// Class appends to the space-separated class attribute.
func (e *animateMotion) Class(class string) *animateMotion {
...
func (e *animateMotion) Style(css string) *animateMotion {
	e.svg().Style = node.EscapeAttribute(css)
	return e
}

// Transform sets the transform attribute.
func (e *animateMotion) Transform(transform string) *animateMotion {
...
func (e *animateMotion) TransformOrigin(origin string) *animateMotion {
	e.svg().TransformOrigin = node.EscapeAttribute(origin)
	return e
}

// TabIndex sets the tabindex attribute.
func (e *animateMotion) TabIndex(index string) *animateMotion {
	e.svg().TabIndex = node.EscapeAttribute(index)
	return e
}

// Role sets the role attribute.
func (e *animateMotion) Role(role string) *animateMotion {
...
func (e *animateMotion) Lang(lang string) *animateMotion {
...
func (e *animateMotion) AutoFocus(conds ...bool) *animateMotion {
	if len(conds) > 0 {
...
func (e *animateMotion) SetAria(key string, value string) *animateMotion {
...
func (e *animateMotion) StrokeDashOffset(offset string) *animateMotion {
...
func (e *animateMotion) StrokeMiterLimit(limit string) *animateMotion {
...
func (e *animateMotion) FillRule(rule fillrule.FillRule) *animateMotion {
	e.svg().FillRule = rule
	return e
}
...
// a clipPath.
func (e *animateMotion) ClipRule(rule cliprule.ClipRule) *animateMotion {
	e.svg().ClipRule = rule
	return e
}
...
func (e *animateMotion) ClipPath(clip string) *animateMotion {
...
// per pixel.
func (e *animateMotion) Mask(mask string) *animateMotion {
...
func (e *animateMotion) Filter(filter string) *animateMotion {
...
func (e *animateMotion) Color(color string) *animateMotion {
...
func (e *animateMotion) Cursor(cursor string) *animateMotion {
...
func (e *animateMotion) Display(display string) *animateMotion {
...
// drawn again.
func (e *animateMotion) Visibility(value visibility.Visibility) *animateMotion {
...
func (e *animateMotion) PointerEvents(events pointerevents.PointerEvents) *animateMotion {
...
func (e *animateMotion) VectorEffect(effect vectoreffect.VectorEffect) *animateMotion {
...
func (e *animateMotion) ShapeRendering(rendering shaperendering.ShapeRendering) *animateMotion {
...
func (e *animateMotion) FontFamily(family string) *animateMotion {
...
// is in user units.
func (e *animateMotion) FontSize(size string) *animateMotion {
...
// from 100 to 900.
func (e *animateMotion) FontWeight(weight string) *animateMotion {
...
func (e *animateMotion) FontStyle(style string) *animateMotion {
...
func (e *animateMotion) OnClick(handler string) *animateMotion {
...
func (e *animateMotion) OnChange(handler string) *animateMotion {
...
func (e *animateMotion) OnInput(handler string) *animateMotion {
...
func (e *animateMotion) OnFocus(handler string) *animateMotion {
...
func (e *animateMotion) OnBlur(handler string) *animateMotion {
...
func (e *animateMotion) OnSubmit(handler string) *animateMotion {
...
func (e *animateMotion) OnLoad(handler string) *animateMotion {
...
func (e *animateMotion) OnError(handler string) *animateMotion {
...
// developer-controlled key. Never build the key from user input - a key containing a space, quote,
// "=", "/" or ">" changes the markup structure. The value is escaped. The key is not escaped.
func (e *animateMotion) SetEvent(key string, value string) *animateMotion {
...
func (e *animateMotion) OnAbort(handler string) *animateMotion {
...
func (e *animateMotion) OnAutoComplete(handler string) *animateMotion {
...
//
// Deprecated: Removed from the WHATWG living standard. Was in an older HTML5 draft.
func (e *animateMotion) OnAutoCompleteError(handler string) *animateMotion {
...
func (e *animateMotion) OnCancel(handler string) *animateMotion {
...
func (e *animateMotion) OnCanPlay(handler string) *animateMotion {
...
func (e *animateMotion) OnCanPlayThrough(handler string) *animateMotion {
...
// results.
func (e *animateMotion) OnClose(handler string) *animateMotion {
...
func (e *animateMotion) OnContextMenu(handler string) *animateMotion {
...
// timestamps.
func (e *animateMotion) OnCueChange(handler string) *animateMotion {
...
func (e *animateMotion) OnDblClick(handler string) *animateMotion {
...
func (e *animateMotion) OnDrag(handler string) *animateMotion {
...
func (e *animateMotion) OnDragEnd(handler string) *animateMotion {
...
func (e *animateMotion) OnDragEnter(handler string) *animateMotion {
...
func (e *animateMotion) OnDragLeave(handler string) *animateMotion {
...
func (e *animateMotion) OnDragOver(handler string) *animateMotion {
...
func (e *animateMotion) OnDragStart(handler string) *animateMotion {
...
// enable dropping.
func (e *animateMotion) OnDrop(handler string) *animateMotion {
...
func (e *animateMotion) OnDurationChange(handler string) *animateMotion {
...
// media content.
func (e *animateMotion) OnEmptied(handler string) *animateMotion {
...
func (e *animateMotion) OnEnded(handler string) *animateMotion {
...
func (e *animateMotion) OnInvalid(handler string) *animateMotion {
...
func (e *animateMotion) OnKeyDown(handler string) *animateMotion {
...
func (e *animateMotion) OnKeyPress(handler string) *animateMotion {
...
func (e *animateMotion) OnKeyUp(handler string) *animateMotion {
...
func (e *animateMotion) OnLoadedData(handler string) *animateMotion {
...
func (e *animateMotion) OnLoadedMetadata(handler string) *animateMotion {
...
func (e *animateMotion) OnLoadStart(handler string) *animateMotion {
...
func (e *animateMotion) OnMouseDown(handler string) *animateMotion {
...
func (e *animateMotion) OnMouseEnter(handler string) *animateMotion {
...
func (e *animateMotion) OnMouseLeave(handler string) *animateMotion {
...
func (e *animateMotion) OnMouseMove(handler string) *animateMotion {
...
func (e *animateMotion) OnMouseOut(handler string) *animateMotion {
...
func (e *animateMotion) OnMouseOver(handler string) *animateMotion {
...
func (e *animateMotion) OnMouseUp(handler string) *animateMotion {
...
func (e *animateMotion) OnMouseWheel(handler string) *animateMotion {
...
func (e *animateMotion) OnPause(handler string) *animateMotion {
...
func (e *animateMotion) OnPlay(handler string) *animateMotion {
...
func (e *animateMotion) OnPlaying(handler string) *animateMotion {
...
func (e *animateMotion) OnProgress(handler string) *animateMotion {
...
func (e *animateMotion) OnRateChange(handler string) *animateMotion {
...
func (e *animateMotion) OnReset(handler string) *animateMotion {
...
// ResizeObserver.
func (e *animateMotion) OnResize(handler string) *animateMotion {
...
func (e *animateMotion) OnScroll(handler string) *animateMotion {
...
func (e *animateMotion) OnSeeked(handler string) *animateMotion {
...
func (e *animateMotion) OnSeeking(handler string) *animateMotion {
...
func (e *animateMotion) OnSelect(handler string) *animateMotion {
...
func (e *animateMotion) OnShow(handler string) *animateMotion {
...
func (e *animateMotion) OnSort(handler string) *animateMotion {
...
func (e *animateMotion) OnStalled(handler string) *animateMotion {
...
func (e *animateMotion) OnSuspend(handler string) *animateMotion {
...
func (e *animateMotion) OnTimeUpdate(handler string) *animateMotion {
...
func (e *animateMotion) OnToggle(handler string) *animateMotion {
...
func (e *animateMotion) OnVolumeChange(handler string) *animateMotion {
...
func (e *animateMotion) OnWaiting(handler string) *animateMotion {
...
func (e *animateMotion) OnAuxClick(handler string) *animateMotion {
...
func (e *animateMotion) OnWheel(handler string) *animateMotion {
...
func (e *animateMotion) OnCopy(handler string) *animateMotion {
...
// content itself.
func (e *animateMotion) OnCut(handler string) *animateMotion {
...
func (e *animateMotion) OnPaste(handler string) *animateMotion {
...
func (e *animateMotion) OnScrollEnd(handler string) *animateMotion {
...
func (e *animateMotion) OnFormData(handler string) *animateMotion {
...
func (e *animateMotion) OnAnimationCancel(handler string) *animateMotion {
...
func (e *animateMotion) OnAnimationEnd(handler string) *animateMotion {
...
func (e *animateMotion) OnAnimationIteration(handler string) *animateMotion {
...
func (e *animateMotion) OnAnimationStart(handler string) *animateMotion {
...
func (e *animateMotion) OnTransitionCancel(handler string) *animateMotion {
...
func (e *animateMotion) OnTransitionEnd(handler string) *animateMotion {
...
func (e *animateMotion) OnTransitionRun(handler string) *animateMotion {
...
func (e *animateMotion) OnTransitionStart(handler string) *animateMotion {
...
func (e *animateMotion) OnBeforeToggle(handler string) *animateMotion {
...
func (e *animateMotion) OnBeforeInput(handler string) *animateMotion {
...
func (e *animateMotion) OnBeforeMatch(handler string) *animateMotion {
...
func (e *animateMotion) OnCommand(handler string) *animateMotion {
...
func (e *animateMotion) OnContextLost(handler string) *animateMotion {
...
func (e *animateMotion) OnContextRestored(handler string) *animateMotion {
...
func (e *animateMotion) OnSecurityPolicyViolation(handler string) *animateMotion {
...
func (e *animateMotion) OnSlotChange(handler string) *animateMotion {
...
func (e *animateMotion) OnPointerDown(handler string) *animateMotion {
...
func (e *animateMotion) OnPointerUp(handler string) *animateMotion {
...
func (e *animateMotion) OnPointerMove(handler string) *animateMotion {
...
func (e *animateMotion) OnPointerEnter(handler string) *animateMotion {
...
func (e *animateMotion) OnPointerLeave(handler string) *animateMotion {
...
func (e *animateMotion) OnPointerOver(handler string) *animateMotion {
...
// element for any of its descendants.
func (e *animateMotion) OnPointerOut(handler string) *animateMotion {
...
func (e *animateMotion) OnPointerCancel(handler string) *animateMotion {
...
func (e *animateMotion) OnGotPointerCapture(handler string) *animateMotion {
...
func (e *animateMotion) OnLostPointerCapture(handler string) *animateMotion {
...
func (e *animateMotion) OnTouchStart(handler string) *animateMotion {
...
func (e *animateMotion) OnTouchEnd(handler string) *animateMotion {
...
func (e *animateMotion) OnTouchMove(handler string) *animateMotion {
...
func (e *animateMotion) OnTouchCancel(handler string) *animateMotion {
...
func (e *animateMotion) OnSelectStart(handler string) *animateMotion {
...
func (e *animateMotion) OnSelectionChange(handler string) *animateMotion {
...
func (e *animateMotion) SetAttribute(key string, value string) {
...
func (e *animateMotion) SetAttributeRaw(key string, value string) {
	if e.attr == nil {
		e.attr = &[]node.Attribute{}
	}
	for i, attr := range *e.attr {
...
func (e *animateMotion) Add(children ...*mpath) *animateMotion {
...
func (e *animateMotion) Replace(children ...*mpath) *animateMotion {
...
func (e *animateMotion) Dynamic(key string) *animateMotion {
	e.dynamic = key
	return e
}

// IsDynamic reports whether this element has been marked for reactive tracking.
func (e *animateMotion) IsDynamic() bool {
	return e.dynamic != ""
}
...
func (e *animateMotion) DynamicKey() string {
	return e.dynamic
}
...
func (e *animateMotion) Memoise(version any) *animateMotion {
	e.memoise = version
	return e
}
...
// by fluent-jit.
func (e *animateMotion) MemoiseKey() any {
	return e.memoise
}
...
func (e *animateMotion) BufferHint(hint int) *animateMotion {
	if hint > 0 {
...
func (e *animateMotion) RenderedSize() int {
...
func (e *animateMotion) Render(w io.Writer) {
	_, _ = e.WriteTo(w)
}
...
func (e *animateMotion) WriteTo(w io.Writer) (int64, error) {
...
func (e *animateMotion) RenderBytes() []byte {
...
func (e *animateMotion) AttributeBuilder(buf *bytes.Buffer) {
	if e.path != "" {
		buf.Write(AttrPath)
	...
	if e.keyPoints != "" {
		buf.Write(AttrKeyPoints)
		buf.WriteString(e.keyPoints)
		buf.Write(MarkupQuote)
	}
	if e.rotate != "" {
	...
	if e.origin != "" {
		buf.Write(AttrOrigin)
		buf.WriteString(e.origin)
		buf.Write(MarkupQuote)
	}
	if e.values != "" {
...
func (e *animateMotion) RenderBuilder(buf *bytes.Buffer) {
	buf.Write(TagAnimateMotion)
	...
	buf.Write(TagAnimateMotionClose)
}

// RenderOpen writes the opening tag and attributes to the buffer.
func (e *animateMotion) RenderOpen(buf *bytes.Buffer) {
	buf.Write(TagAnimateMotion)
	e.AttributeBuilder(buf)
	buf.Write(MarkupCloseTag)
}
...
// isSVGShape seals animateMotion as a Shape.
func (*animateMotion) isSVGShape() {}

// isSVGShapeContent seals animateMotion as a ShapeContent.
func (*animateMotion) isSVGShapeContent() {}
