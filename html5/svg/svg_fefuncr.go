...
// feFuncR represents the <feFuncR> SVG element.
type feFuncR struct {
...
func (e *feFuncR) event() *html5.EventAttributes {
	if e.ea == nil {
...
// FeFuncR is the transfer function for the red channel of an
// FeComponentTransfer.
func FeFuncR(children ...PrimitiveContent) *feFuncR {
...
func (e *feFuncR) Type(value transfertype.TransferType) *feFuncR {
	e.typeAttr = value
	return e
}
...
// to 1.
func (e *feFuncR) TableValues(value string) *feFuncR {
...
func (e *feFuncR) Slope(value string) *feFuncR {
...
func (e *feFuncR) Intercept(value string) *feFuncR {
...
func (e *feFuncR) Amplitude(value string) *feFuncR {
...
func (e *feFuncR) Exponent(value string) *feFuncR {
...
func (e *feFuncR) Style(css string) *feFuncR {
	e.svg().Style = node.EscapeAttribute(css)
	return e
}

// Transform sets the transform attribute.
func (e *feFuncR) Transform(transform string) *feFuncR {
...
func (e *feFuncR) TransformOrigin(origin string) *feFuncR {
	e.svg().TransformOrigin = node.EscapeAttribute(origin)
	return e
}

// TabIndex sets the tabindex attribute.
func (e *feFuncR) TabIndex(index string) *feFuncR {
	e.svg().TabIndex = node.EscapeAttribute(index)
	return e
}

// Role sets the role attribute.
func (e *feFuncR) Role(role string) *feFuncR {
...
func (e *feFuncR) Lang(lang string) *feFuncR {
...
func (e *feFuncR) AutoFocus(conds ...bool) *feFuncR {
	if len(conds) > 0 {
...
func (e *feFuncR) SetAria(key string, value string) *feFuncR {
...
func (e *feFuncR) StrokeDashOffset(offset string) *feFuncR {
...
func (e *feFuncR) StrokeMiterLimit(limit string) *feFuncR {
...
func (e *feFuncR) FillRule(rule fillrule.FillRule) *feFuncR {
	e.svg().FillRule = rule
	return e
}
...
// a clipPath.
func (e *feFuncR) ClipRule(rule cliprule.ClipRule) *feFuncR {
	e.svg().ClipRule = rule
	return e
}
...
func (e *feFuncR) ClipPath(clip string) *feFuncR {
...
// per pixel.
func (e *feFuncR) Mask(mask string) *feFuncR {
...
func (e *feFuncR) Filter(filter string) *feFuncR {
...
func (e *feFuncR) Color(color string) *feFuncR {
...
func (e *feFuncR) Cursor(cursor string) *feFuncR {
...
func (e *feFuncR) Display(display string) *feFuncR {
...
// drawn again.
func (e *feFuncR) Visibility(value visibility.Visibility) *feFuncR {
...
func (e *feFuncR) PointerEvents(events pointerevents.PointerEvents) *feFuncR {
...
func (e *feFuncR) VectorEffect(effect vectoreffect.VectorEffect) *feFuncR {
...
func (e *feFuncR) ShapeRendering(rendering shaperendering.ShapeRendering) *feFuncR {
...
func (e *feFuncR) FontFamily(family string) *feFuncR {
...
// is in user units.
func (e *feFuncR) FontSize(size string) *feFuncR {
...
// from 100 to 900.
func (e *feFuncR) FontWeight(weight string) *feFuncR {
...
func (e *feFuncR) FontStyle(style string) *feFuncR {
...
func (e *feFuncR) OnClick(handler string) *feFuncR {
...
func (e *feFuncR) OnChange(handler string) *feFuncR {
...
func (e *feFuncR) OnInput(handler string) *feFuncR {
...
func (e *feFuncR) OnFocus(handler string) *feFuncR {
...
func (e *feFuncR) OnBlur(handler string) *feFuncR {
...
func (e *feFuncR) OnSubmit(handler string) *feFuncR {
...
func (e *feFuncR) OnLoad(handler string) *feFuncR {
...
func (e *feFuncR) OnError(handler string) *feFuncR {
...
// developer-controlled key. Never build the key from user input - a key containing a space, quote,
// "=", "/" or ">" changes the markup structure. The value is escaped. The key is not escaped.
func (e *feFuncR) SetEvent(key string, value string) *feFuncR {
...
func (e *feFuncR) OnAbort(handler string) *feFuncR {
...
func (e *feFuncR) OnAutoComplete(handler string) *feFuncR {
...
//
// Deprecated: Removed from the WHATWG living standard. Was in an older HTML5 draft.
func (e *feFuncR) OnAutoCompleteError(handler string) *feFuncR {
...
func (e *feFuncR) OnCancel(handler string) *feFuncR {
...
func (e *feFuncR) OnCanPlay(handler string) *feFuncR {
...
func (e *feFuncR) OnCanPlayThrough(handler string) *feFuncR {
...
// results.
func (e *feFuncR) OnClose(handler string) *feFuncR {
...
func (e *feFuncR) OnContextMenu(handler string) *feFuncR {
...
// timestamps.
func (e *feFuncR) OnCueChange(handler string) *feFuncR {
...
func (e *feFuncR) OnDblClick(handler string) *feFuncR {
...
func (e *feFuncR) OnDrag(handler string) *feFuncR {
...
func (e *feFuncR) OnDragEnd(handler string) *feFuncR {
...
func (e *feFuncR) OnDragEnter(handler string) *feFuncR {
...
func (e *feFuncR) OnDragLeave(handler string) *feFuncR {
...
func (e *feFuncR) OnDragOver(handler string) *feFuncR {
...
func (e *feFuncR) OnDragStart(handler string) *feFuncR {
...
// enable dropping.
func (e *feFuncR) OnDrop(handler string) *feFuncR {
...
func (e *feFuncR) OnDurationChange(handler string) *feFuncR {
...
// media content.
func (e *feFuncR) OnEmptied(handler string) *feFuncR {
...
func (e *feFuncR) OnEnded(handler string) *feFuncR {
...
func (e *feFuncR) OnInvalid(handler string) *feFuncR {
...
func (e *feFuncR) OnKeyDown(handler string) *feFuncR {
...
func (e *feFuncR) OnKeyPress(handler string) *feFuncR {
...
func (e *feFuncR) OnKeyUp(handler string) *feFuncR {
...
func (e *feFuncR) OnLoadedData(handler string) *feFuncR {
...
func (e *feFuncR) OnLoadedMetadata(handler string) *feFuncR {
...
func (e *feFuncR) OnLoadStart(handler string) *feFuncR {
...
func (e *feFuncR) OnMouseDown(handler string) *feFuncR {
...
func (e *feFuncR) OnMouseEnter(handler string) *feFuncR {
...
func (e *feFuncR) OnMouseLeave(handler string) *feFuncR {
...
func (e *feFuncR) OnMouseMove(handler string) *feFuncR {
...
func (e *feFuncR) OnMouseOut(handler string) *feFuncR {
...
func (e *feFuncR) OnMouseOver(handler string) *feFuncR {
...
func (e *feFuncR) OnMouseUp(handler string) *feFuncR {
...
func (e *feFuncR) OnMouseWheel(handler string) *feFuncR {
...
func (e *feFuncR) OnPause(handler string) *feFuncR {
...
func (e *feFuncR) OnPlay(handler string) *feFuncR {
...
func (e *feFuncR) OnPlaying(handler string) *feFuncR {
...
func (e *feFuncR) OnProgress(handler string) *feFuncR {
...
func (e *feFuncR) OnRateChange(handler string) *feFuncR {
...
func (e *feFuncR) OnReset(handler string) *feFuncR {
...
// ResizeObserver.
func (e *feFuncR) OnResize(handler string) *feFuncR {
...
func (e *feFuncR) OnScroll(handler string) *feFuncR {
...
func (e *feFuncR) OnSeeked(handler string) *feFuncR {
...
func (e *feFuncR) OnSeeking(handler string) *feFuncR {
...
func (e *feFuncR) OnSelect(handler string) *feFuncR {
...
func (e *feFuncR) OnShow(handler string) *feFuncR {
...
func (e *feFuncR) OnSort(handler string) *feFuncR {
...
func (e *feFuncR) OnStalled(handler string) *feFuncR {
...
func (e *feFuncR) OnSuspend(handler string) *feFuncR {
...
func (e *feFuncR) OnTimeUpdate(handler string) *feFuncR {
...
func (e *feFuncR) OnToggle(handler string) *feFuncR {
...
func (e *feFuncR) OnVolumeChange(handler string) *feFuncR {
...
func (e *feFuncR) OnWaiting(handler string) *feFuncR {
...
func (e *feFuncR) OnAuxClick(handler string) *feFuncR {
...
func (e *feFuncR) OnWheel(handler string) *feFuncR {
...
func (e *feFuncR) OnCopy(handler string) *feFuncR {
...
// content itself.
func (e *feFuncR) OnCut(handler string) *feFuncR {
...
func (e *feFuncR) OnPaste(handler string) *feFuncR {
...
func (e *feFuncR) OnScrollEnd(handler string) *feFuncR {
...
func (e *feFuncR) OnFormData(handler string) *feFuncR {
...
func (e *feFuncR) OnAnimationCancel(handler string) *feFuncR {
...
func (e *feFuncR) OnAnimationEnd(handler string) *feFuncR {
...
func (e *feFuncR) OnAnimationIteration(handler string) *feFuncR {
...
func (e *feFuncR) OnAnimationStart(handler string) *feFuncR {
...
func (e *feFuncR) OnTransitionCancel(handler string) *feFuncR {
...
func (e *feFuncR) OnTransitionEnd(handler string) *feFuncR {
...
func (e *feFuncR) OnTransitionRun(handler string) *feFuncR {
...
func (e *feFuncR) OnTransitionStart(handler string) *feFuncR {
...
func (e *feFuncR) OnBeforeToggle(handler string) *feFuncR {
...
func (e *feFuncR) OnBeforeInput(handler string) *feFuncR {
...
func (e *feFuncR) OnBeforeMatch(handler string) *feFuncR {
...
func (e *feFuncR) OnCommand(handler string) *feFuncR {
...
func (e *feFuncR) OnContextLost(handler string) *feFuncR {
...
func (e *feFuncR) OnContextRestored(handler string) *feFuncR {
...
func (e *feFuncR) OnSecurityPolicyViolation(handler string) *feFuncR {
...
func (e *feFuncR) OnSlotChange(handler string) *feFuncR {
...
func (e *feFuncR) OnPointerDown(handler string) *feFuncR {
...
func (e *feFuncR) OnPointerUp(handler string) *feFuncR {
...
func (e *feFuncR) OnPointerMove(handler string) *feFuncR {
...
func (e *feFuncR) OnPointerEnter(handler string) *feFuncR {
...
func (e *feFuncR) OnPointerLeave(handler string) *feFuncR {
...
func (e *feFuncR) OnPointerOver(handler string) *feFuncR {
...
// element for any of its descendants.
func (e *feFuncR) OnPointerOut(handler string) *feFuncR {
...
func (e *feFuncR) OnPointerCancel(handler string) *feFuncR {
...
func (e *feFuncR) OnGotPointerCapture(handler string) *feFuncR {
...
func (e *feFuncR) OnLostPointerCapture(handler string) *feFuncR {
...
func (e *feFuncR) OnTouchStart(handler string) *feFuncR {
...
func (e *feFuncR) OnTouchEnd(handler string) *feFuncR {
...
func (e *feFuncR) OnTouchMove(handler string) *feFuncR {
...
func (e *feFuncR) OnTouchCancel(handler string) *feFuncR {
...
func (e *feFuncR) OnSelectStart(handler string) *feFuncR {
...
func (e *feFuncR) OnSelectionChange(handler string) *feFuncR {
...
func (e *feFuncR) SetAttribute(key string, value string) {
...
func (e *feFuncR) SetAttributeRaw(key string, value string) {
	if e.attr == nil {
		e.attr = &[]node.Attribute{}
	}
	for i, attr := range *e.attr {
...
func (e *feFuncR) Add(children ...PrimitiveContent) *feFuncR {
...
func (e *feFuncR) Replace(children ...PrimitiveContent) *feFuncR {
...
func (e *feFuncR) DynamicKey() string {
	return e.dynamic
}
...
func (e *feFuncR) Memoise(version any) *feFuncR {
	e.memoise = version
	return e
}
...
func (e *feFuncR) BufferHint(hint int) *feFuncR {
	if hint > 0 {
...
func (e *feFuncR) RenderedSize() int {
...
func (e *feFuncR) Render(w io.Writer) {
	_, _ = e.WriteTo(w)
}
...
func (e *feFuncR) WriteTo(w io.Writer) (int64, error) {
...
func (e *feFuncR) RenderBytes() []byte {
...
func (e *feFuncR) AttributeBuilder(buf *bytes.Buffer) {
	if len(e.typeAttr) > 0 {
		buf.Write(AttrType)
...
func (e *feFuncR) RenderBuilder(buf *bytes.Buffer) {
	buf.Write(TagFeFuncR)
	...
	buf.Write(TagFeFuncRClose)
}

// RenderOpen writes the opening tag and attributes to the buffer.
func (e *feFuncR) RenderOpen(buf *bytes.Buffer) {
	buf.Write(TagFeFuncR)
	e.AttributeBuilder(buf)
	buf.Write(MarkupCloseTag)
}
...
// isSVGTransferFunction seals feFuncR as a TransferFunction.
func (*feFuncR) isSVGTransferFunction() {}
