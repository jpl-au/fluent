...
func (e *polyline) event() *html5.EventAttributes {
	if e.ea == nil {
...
// Polyline draws connected straight segments through the coordinate pairs in
// points. Unlike Polygon, it does not stroke a closing segment from the last
// point to the first. Set fill="none" when only the connected line is wanted.
func Polyline(children ...ShapeContent) *polyline {
...
func (e *polyline) TransformOrigin(origin string) *polyline {
...
func (e *polyline) Lang(lang string) *polyline {
...
func (e *polyline) AutoFocus(conds ...bool) *polyline {
	if len(conds) > 0 {
...
// developer-controlled key. Never build the key from user input - a key containing a space, quote,
// "=", "/" or ">" changes the markup structure. The value is escaped. The key is not escaped.
func (e *polyline) SetData(key string, value string) *polyline {
...
func (e *polyline) StrokeDashOffset(offset string) *polyline {
...
func (e *polyline) StrokeMiterLimit(limit string) *polyline {
...
func (e *polyline) FillRule(rule fillrule.FillRule) *polyline {
	e.svg().FillRule = rule
	return e
}
...
// a clipPath.
func (e *polyline) ClipRule(rule cliprule.ClipRule) *polyline {
	e.svg().ClipRule = rule
	return e
}
...
func (e *polyline) ClipPath(clip string) *polyline {
...
// per pixel.
func (e *polyline) Mask(mask string) *polyline {
...
func (e *polyline) Filter(filter string) *polyline {
...
func (e *polyline) Color(color string) *polyline {
...
func (e *polyline) Cursor(cursor string) *polyline {
...
func (e *polyline) Display(display string) *polyline {
...
// drawn again.
func (e *polyline) Visibility(value visibility.Visibility) *polyline {
...
func (e *polyline) PointerEvents(events pointerevents.PointerEvents) *polyline {
...
func (e *polyline) VectorEffect(effect vectoreffect.VectorEffect) *polyline {
...
func (e *polyline) ShapeRendering(rendering shaperendering.ShapeRendering) *polyline {
...
func (e *polyline) FontFamily(family string) *polyline {
...
// is in user units.
func (e *polyline) FontSize(size string) *polyline {
...
// from 100 to 900.
func (e *polyline) FontWeight(weight string) *polyline {
...
func (e *polyline) FontStyle(style string) *polyline {
...
func (e *polyline) OnChange(handler string) *polyline {
...
func (e *polyline) OnInput(handler string) *polyline {
...
func (e *polyline) OnSubmit(handler string) *polyline {
...
func (e *polyline) OnLoad(handler string) *polyline {
...
func (e *polyline) OnError(handler string) *polyline {
...
// developer-controlled key. Never build the key from user input - a key containing a space, quote,
// "=", "/" or ">" changes the markup structure. The value is escaped. The key is not escaped.
func (e *polyline) SetEvent(key string, value string) *polyline {
...
func (e *polyline) OnAbort(handler string) *polyline {
...
func (e *polyline) OnAutoComplete(handler string) *polyline {
...
//
// Deprecated: Removed from the WHATWG living standard. Was in an older HTML5 draft.
func (e *polyline) OnAutoCompleteError(handler string) *polyline {
...
func (e *polyline) OnCancel(handler string) *polyline {
...
func (e *polyline) OnCanPlay(handler string) *polyline {
...
func (e *polyline) OnCanPlayThrough(handler string) *polyline {
...
// results.
func (e *polyline) OnClose(handler string) *polyline {
...
func (e *polyline) OnContextMenu(handler string) *polyline {
...
// timestamps.
func (e *polyline) OnCueChange(handler string) *polyline {
...
func (e *polyline) OnDblClick(handler string) *polyline {
...
func (e *polyline) OnDrag(handler string) *polyline {
...
func (e *polyline) OnDragEnd(handler string) *polyline {
...
func (e *polyline) OnDragEnter(handler string) *polyline {
...
func (e *polyline) OnDragLeave(handler string) *polyline {
...
func (e *polyline) OnDragOver(handler string) *polyline {
...
func (e *polyline) OnDragStart(handler string) *polyline {
...
// enable dropping.
func (e *polyline) OnDrop(handler string) *polyline {
...
func (e *polyline) OnDurationChange(handler string) *polyline {
...
// media content.
func (e *polyline) OnEmptied(handler string) *polyline {
...
func (e *polyline) OnEnded(handler string) *polyline {
...
func (e *polyline) OnInvalid(handler string) *polyline {
...
func (e *polyline) OnKeyDown(handler string) *polyline {
...
func (e *polyline) OnKeyPress(handler string) *polyline {
...
func (e *polyline) OnKeyUp(handler string) *polyline {
...
func (e *polyline) OnLoadedData(handler string) *polyline {
...
func (e *polyline) OnLoadedMetadata(handler string) *polyline {
...
func (e *polyline) OnLoadStart(handler string) *polyline {
...
func (e *polyline) OnMouseEnter(handler string) *polyline {
...
func (e *polyline) OnMouseLeave(handler string) *polyline {
...
func (e *polyline) OnMouseWheel(handler string) *polyline {
...
func (e *polyline) OnPause(handler string) *polyline {
...
func (e *polyline) OnPlay(handler string) *polyline {
...
func (e *polyline) OnPlaying(handler string) *polyline {
...
func (e *polyline) OnProgress(handler string) *polyline {
...
func (e *polyline) OnRateChange(handler string) *polyline {
...
func (e *polyline) OnReset(handler string) *polyline {
...
// ResizeObserver.
func (e *polyline) OnResize(handler string) *polyline {
...
func (e *polyline) OnScroll(handler string) *polyline {
...
func (e *polyline) OnSeeked(handler string) *polyline {
...
func (e *polyline) OnSeeking(handler string) *polyline {
...
func (e *polyline) OnSelect(handler string) *polyline {
...
func (e *polyline) OnShow(handler string) *polyline {
...
func (e *polyline) OnSort(handler string) *polyline {
...
func (e *polyline) OnStalled(handler string) *polyline {
...
func (e *polyline) OnSuspend(handler string) *polyline {
...
func (e *polyline) OnTimeUpdate(handler string) *polyline {
...
func (e *polyline) OnToggle(handler string) *polyline {
...
func (e *polyline) OnVolumeChange(handler string) *polyline {
...
func (e *polyline) OnWaiting(handler string) *polyline {
...
func (e *polyline) OnAuxClick(handler string) *polyline {
...
func (e *polyline) OnWheel(handler string) *polyline {
...
func (e *polyline) OnCopy(handler string) *polyline {
...
// content itself.
func (e *polyline) OnCut(handler string) *polyline {
...
func (e *polyline) OnPaste(handler string) *polyline {
...
func (e *polyline) OnScrollEnd(handler string) *polyline {
...
func (e *polyline) OnFormData(handler string) *polyline {
...
func (e *polyline) OnAnimationCancel(handler string) *polyline {
...
func (e *polyline) OnAnimationEnd(handler string) *polyline {
...
func (e *polyline) OnAnimationIteration(handler string) *polyline {
...
func (e *polyline) OnAnimationStart(handler string) *polyline {
...
func (e *polyline) OnTransitionCancel(handler string) *polyline {
...
func (e *polyline) OnTransitionEnd(handler string) *polyline {
...
func (e *polyline) OnTransitionRun(handler string) *polyline {
...
func (e *polyline) OnTransitionStart(handler string) *polyline {
...
func (e *polyline) OnBeforeToggle(handler string) *polyline {
...
func (e *polyline) OnBeforeInput(handler string) *polyline {
...
func (e *polyline) OnBeforeMatch(handler string) *polyline {
...
func (e *polyline) OnCommand(handler string) *polyline {
...
func (e *polyline) OnContextLost(handler string) *polyline {
...
func (e *polyline) OnContextRestored(handler string) *polyline {
...
func (e *polyline) OnSecurityPolicyViolation(handler string) *polyline {
...
func (e *polyline) OnSlotChange(handler string) *polyline {
...
func (e *polyline) OnPointerDown(handler string) *polyline {
...
func (e *polyline) OnPointerUp(handler string) *polyline {
...
func (e *polyline) OnPointerMove(handler string) *polyline {
...
func (e *polyline) OnPointerEnter(handler string) *polyline {
...
func (e *polyline) OnPointerLeave(handler string) *polyline {
...
func (e *polyline) OnPointerOver(handler string) *polyline {
...
// element for any of its descendants.
func (e *polyline) OnPointerOut(handler string) *polyline {
...
func (e *polyline) OnPointerCancel(handler string) *polyline {
...
func (e *polyline) OnGotPointerCapture(handler string) *polyline {
...
func (e *polyline) OnLostPointerCapture(handler string) *polyline {
...
func (e *polyline) OnTouchStart(handler string) *polyline {
...
func (e *polyline) OnTouchEnd(handler string) *polyline {
...
func (e *polyline) OnTouchMove(handler string) *polyline {
...
func (e *polyline) OnTouchCancel(handler string) *polyline {
...
func (e *polyline) OnSelectStart(handler string) *polyline {
...
func (e *polyline) OnSelectionChange(handler string) *polyline {
...
func (e *polyline) Add(children ...ShapeContent) *polyline {
...
func (e *polyline) Replace(children ...ShapeContent) *polyline {
...
// isSVGShape seals polyline as a Shape.
