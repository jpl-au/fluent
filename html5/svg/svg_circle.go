...
func (e *circle) event() *html5.EventAttributes {
	if e.ea == nil {
...
// Circle draws a circle centred at (cx, cy), with its size set by r. Fill and
// stroke control its appearance. Descriptive and animation children can name,
// describe or animate the circle.
func Circle(children ...ShapeContent) *circle {
...
func (e *circle) TransformOrigin(origin string) *circle {
...
func (e *circle) Lang(lang string) *circle {
...
func (e *circle) AutoFocus(conds ...bool) *circle {
	if len(conds) > 0 {
...
// developer-controlled key. Never build the key from user input - a key containing a space, quote,
// "=", "/" or ">" changes the markup structure. The value is escaped. The key is not escaped.
func (e *circle) SetData(key string, value string) *circle {
...
func (e *circle) StrokeDashOffset(offset string) *circle {
...
func (e *circle) StrokeMiterLimit(limit string) *circle {
...
func (e *circle) FillRule(rule fillrule.FillRule) *circle {
	e.svg().FillRule = rule
	return e
}
...
// a clipPath.
func (e *circle) ClipRule(rule cliprule.ClipRule) *circle {
	e.svg().ClipRule = rule
	return e
}
...
func (e *circle) ClipPath(clip string) *circle {
...
// per pixel.
func (e *circle) Mask(mask string) *circle {
...
func (e *circle) Filter(filter string) *circle {
...
func (e *circle) Color(color string) *circle {
...
func (e *circle) Cursor(cursor string) *circle {
...
func (e *circle) Display(display string) *circle {
...
// drawn again.
func (e *circle) Visibility(value visibility.Visibility) *circle {
...
func (e *circle) PointerEvents(events pointerevents.PointerEvents) *circle {
...
func (e *circle) VectorEffect(effect vectoreffect.VectorEffect) *circle {
...
func (e *circle) ShapeRendering(rendering shaperendering.ShapeRendering) *circle {
...
func (e *circle) FontFamily(family string) *circle {
...
// is in user units.
func (e *circle) FontSize(size string) *circle {
...
// from 100 to 900.
func (e *circle) FontWeight(weight string) *circle {
...
func (e *circle) FontStyle(style string) *circle {
...
func (e *circle) OnChange(handler string) *circle {
...
func (e *circle) OnInput(handler string) *circle {
...
func (e *circle) OnSubmit(handler string) *circle {
...
func (e *circle) OnLoad(handler string) *circle {
...
func (e *circle) OnError(handler string) *circle {
...
// developer-controlled key. Never build the key from user input - a key containing a space, quote,
// "=", "/" or ">" changes the markup structure. The value is escaped. The key is not escaped.
func (e *circle) SetEvent(key string, value string) *circle {
...
func (e *circle) OnAbort(handler string) *circle {
...
func (e *circle) OnAutoComplete(handler string) *circle {
...
//
// Deprecated: Removed from the WHATWG living standard. Was in an older HTML5 draft.
func (e *circle) OnAutoCompleteError(handler string) *circle {
...
func (e *circle) OnCancel(handler string) *circle {
...
func (e *circle) OnCanPlay(handler string) *circle {
...
func (e *circle) OnCanPlayThrough(handler string) *circle {
...
// results.
func (e *circle) OnClose(handler string) *circle {
...
func (e *circle) OnContextMenu(handler string) *circle {
...
// timestamps.
func (e *circle) OnCueChange(handler string) *circle {
...
func (e *circle) OnDblClick(handler string) *circle {
...
func (e *circle) OnDrag(handler string) *circle {
...
func (e *circle) OnDragEnd(handler string) *circle {
...
func (e *circle) OnDragEnter(handler string) *circle {
...
func (e *circle) OnDragLeave(handler string) *circle {
...
func (e *circle) OnDragOver(handler string) *circle {
...
func (e *circle) OnDragStart(handler string) *circle {
...
// enable dropping.
func (e *circle) OnDrop(handler string) *circle {
...
func (e *circle) OnDurationChange(handler string) *circle {
...
// media content.
func (e *circle) OnEmptied(handler string) *circle {
...
func (e *circle) OnEnded(handler string) *circle {
...
func (e *circle) OnInvalid(handler string) *circle {
...
func (e *circle) OnKeyDown(handler string) *circle {
...
func (e *circle) OnKeyPress(handler string) *circle {
...
func (e *circle) OnKeyUp(handler string) *circle {
...
func (e *circle) OnLoadedData(handler string) *circle {
...
func (e *circle) OnLoadedMetadata(handler string) *circle {
...
func (e *circle) OnLoadStart(handler string) *circle {
...
func (e *circle) OnMouseEnter(handler string) *circle {
...
func (e *circle) OnMouseLeave(handler string) *circle {
...
func (e *circle) OnMouseWheel(handler string) *circle {
...
func (e *circle) OnPause(handler string) *circle {
...
func (e *circle) OnPlay(handler string) *circle {
...
func (e *circle) OnPlaying(handler string) *circle {
...
func (e *circle) OnProgress(handler string) *circle {
...
func (e *circle) OnRateChange(handler string) *circle {
...
func (e *circle) OnReset(handler string) *circle {
...
// ResizeObserver.
func (e *circle) OnResize(handler string) *circle {
...
func (e *circle) OnScroll(handler string) *circle {
...
func (e *circle) OnSeeked(handler string) *circle {
...
func (e *circle) OnSeeking(handler string) *circle {
...
func (e *circle) OnSelect(handler string) *circle {
...
func (e *circle) OnShow(handler string) *circle {
...
func (e *circle) OnSort(handler string) *circle {
...
func (e *circle) OnStalled(handler string) *circle {
...
func (e *circle) OnSuspend(handler string) *circle {
...
func (e *circle) OnTimeUpdate(handler string) *circle {
...
func (e *circle) OnToggle(handler string) *circle {
...
func (e *circle) OnVolumeChange(handler string) *circle {
...
func (e *circle) OnWaiting(handler string) *circle {
...
func (e *circle) OnAuxClick(handler string) *circle {
...
func (e *circle) OnWheel(handler string) *circle {
...
func (e *circle) OnCopy(handler string) *circle {
...
// content itself.
func (e *circle) OnCut(handler string) *circle {
...
func (e *circle) OnPaste(handler string) *circle {
...
func (e *circle) OnScrollEnd(handler string) *circle {
...
func (e *circle) OnFormData(handler string) *circle {
...
func (e *circle) OnAnimationCancel(handler string) *circle {
...
func (e *circle) OnAnimationEnd(handler string) *circle {
...
func (e *circle) OnAnimationIteration(handler string) *circle {
...
func (e *circle) OnAnimationStart(handler string) *circle {
...
func (e *circle) OnTransitionCancel(handler string) *circle {
...
func (e *circle) OnTransitionEnd(handler string) *circle {
...
func (e *circle) OnTransitionRun(handler string) *circle {
...
func (e *circle) OnTransitionStart(handler string) *circle {
...
func (e *circle) OnBeforeToggle(handler string) *circle {
...
func (e *circle) OnBeforeInput(handler string) *circle {
...
func (e *circle) OnBeforeMatch(handler string) *circle {
...
func (e *circle) OnCommand(handler string) *circle {
...
func (e *circle) OnContextLost(handler string) *circle {
...
func (e *circle) OnContextRestored(handler string) *circle {
...
func (e *circle) OnSecurityPolicyViolation(handler string) *circle {
...
func (e *circle) OnSlotChange(handler string) *circle {
...
func (e *circle) OnPointerDown(handler string) *circle {
...
func (e *circle) OnPointerUp(handler string) *circle {
...
func (e *circle) OnPointerMove(handler string) *circle {
...
func (e *circle) OnPointerEnter(handler string) *circle {
...
func (e *circle) OnPointerLeave(handler string) *circle {
...
func (e *circle) OnPointerOver(handler string) *circle {
...
// element for any of its descendants.
func (e *circle) OnPointerOut(handler string) *circle {
...
func (e *circle) OnPointerCancel(handler string) *circle {
...
func (e *circle) OnGotPointerCapture(handler string) *circle {
...
func (e *circle) OnLostPointerCapture(handler string) *circle {
...
func (e *circle) OnTouchStart(handler string) *circle {
...
func (e *circle) OnTouchEnd(handler string) *circle {
...
func (e *circle) OnTouchMove(handler string) *circle {
...
func (e *circle) OnTouchCancel(handler string) *circle {
...
func (e *circle) OnSelectStart(handler string) *circle {
...
func (e *circle) OnSelectionChange(handler string) *circle {
...
func (e *circle) Add(children ...ShapeContent) *circle {
...
func (e *circle) Replace(children ...ShapeContent) *circle {
...
// isSVGShape seals circle as a Shape.
