...
// feFuncG represents the <feFuncG> SVG element.
type feFuncG struct {
...
func (e *feFuncG) event() *html5.EventAttributes {
	if e.ea == nil {
...
// FeFuncG is the transfer function for the green channel of an
// FeComponentTransfer.
func FeFuncG(children ...PrimitiveContent) *feFuncG {
...
func (e *feFuncG) Type(value transfertype.TransferType) *feFuncG {
	e.typeAttr = value
	return e
}
...
// to 1.
func (e *feFuncG) TableValues(value string) *feFuncG {
...
func (e *feFuncG) Slope(value string) *feFuncG {
...
func (e *feFuncG) Intercept(value string) *feFuncG {
...
func (e *feFuncG) Amplitude(value string) *feFuncG {
...
func (e *feFuncG) Exponent(value string) *feFuncG {
...
func (e *feFuncG) Style(css string) *feFuncG {
	e.svg().Style = node.EscapeAttribute(css)
	return e
}

// Transform sets the transform attribute.
func (e *feFuncG) Transform(transform string) *feFuncG {
...
func (e *feFuncG) TransformOrigin(origin string) *feFuncG {
	e.svg().TransformOrigin = node.EscapeAttribute(origin)
	return e
}

// TabIndex sets the tabindex attribute.
func (e *feFuncG) TabIndex(index string) *feFuncG {
	e.svg().TabIndex = node.EscapeAttribute(index)
	return e
}

// Role sets the role attribute.
func (e *feFuncG) Role(role string) *feFuncG {
...
func (e *feFuncG) Lang(lang string) *feFuncG {
...
func (e *feFuncG) AutoFocus(conds ...bool) *feFuncG {
	if len(conds) > 0 {
...
func (e *feFuncG) SetAria(key string, value string) *feFuncG {
...
func (e *feFuncG) StrokeDashOffset(offset string) *feFuncG {
...
func (e *feFuncG) StrokeMiterLimit(limit string) *feFuncG {
...
func (e *feFuncG) FillRule(rule fillrule.FillRule) *feFuncG {
	e.svg().FillRule = rule
	return e
}
...
// a clipPath.
func (e *feFuncG) ClipRule(rule cliprule.ClipRule) *feFuncG {
	e.svg().ClipRule = rule
	return e
}
...
func (e *feFuncG) ClipPath(clip string) *feFuncG {
...
// per pixel.
func (e *feFuncG) Mask(mask string) *feFuncG {
...
func (e *feFuncG) Filter(filter string) *feFuncG {
...
func (e *feFuncG) Color(color string) *feFuncG {
...
func (e *feFuncG) Cursor(cursor string) *feFuncG {
...
func (e *feFuncG) Display(display string) *feFuncG {
...
// drawn again.
func (e *feFuncG) Visibility(value visibility.Visibility) *feFuncG {
...
func (e *feFuncG) PointerEvents(events pointerevents.PointerEvents) *feFuncG {
...
func (e *feFuncG) VectorEffect(effect vectoreffect.VectorEffect) *feFuncG {
...
func (e *feFuncG) ShapeRendering(rendering shaperendering.ShapeRendering) *feFuncG {
...
func (e *feFuncG) FontFamily(family string) *feFuncG {
...
// is in user units.
func (e *feFuncG) FontSize(size string) *feFuncG {
...
// from 100 to 900.
func (e *feFuncG) FontWeight(weight string) *feFuncG {
...
func (e *feFuncG) FontStyle(style string) *feFuncG {
...
func (e *feFuncG) OnClick(handler string) *feFuncG {
...
func (e *feFuncG) OnChange(handler string) *feFuncG {
...
func (e *feFuncG) OnInput(handler string) *feFuncG {
...
func (e *feFuncG) OnFocus(handler string) *feFuncG {
...
func (e *feFuncG) OnBlur(handler string) *feFuncG {
...
func (e *feFuncG) OnSubmit(handler string) *feFuncG {
...
func (e *feFuncG) OnLoad(handler string) *feFuncG {
...
func (e *feFuncG) OnError(handler string) *feFuncG {
...
// developer-controlled key. Never build the key from user input - a key containing a space, quote,
// "=", "/" or ">" changes the markup structure. The value is escaped. The key is not escaped.
func (e *feFuncG) SetEvent(key string, value string) *feFuncG {
...
func (e *feFuncG) OnAbort(handler string) *feFuncG {
...
func (e *feFuncG) OnAutoComplete(handler string) *feFuncG {
...
//
// Deprecated: Removed from the WHATWG living standard. Was in an older HTML5 draft.
func (e *feFuncG) OnAutoCompleteError(handler string) *feFuncG {
...
func (e *feFuncG) OnCancel(handler string) *feFuncG {
...
func (e *feFuncG) OnCanPlay(handler string) *feFuncG {
...
func (e *feFuncG) OnCanPlayThrough(handler string) *feFuncG {
...
// results.
func (e *feFuncG) OnClose(handler string) *feFuncG {
...
func (e *feFuncG) OnContextMenu(handler string) *feFuncG {
...
// timestamps.
func (e *feFuncG) OnCueChange(handler string) *feFuncG {
...
func (e *feFuncG) OnDblClick(handler string) *feFuncG {
...
func (e *feFuncG) OnDrag(handler string) *feFuncG {
...
func (e *feFuncG) OnDragEnd(handler string) *feFuncG {
...
func (e *feFuncG) OnDragEnter(handler string) *feFuncG {
...
func (e *feFuncG) OnDragLeave(handler string) *feFuncG {
...
func (e *feFuncG) OnDragOver(handler string) *feFuncG {
...
func (e *feFuncG) OnDragStart(handler string) *feFuncG {
...
// enable dropping.
func (e *feFuncG) OnDrop(handler string) *feFuncG {
...
func (e *feFuncG) OnDurationChange(handler string) *feFuncG {
...
// media content.
func (e *feFuncG) OnEmptied(handler string) *feFuncG {
...
func (e *feFuncG) OnEnded(handler string) *feFuncG {
...
func (e *feFuncG) OnInvalid(handler string) *feFuncG {
...
func (e *feFuncG) OnKeyDown(handler string) *feFuncG {
...
func (e *feFuncG) OnKeyPress(handler string) *feFuncG {
...
func (e *feFuncG) OnKeyUp(handler string) *feFuncG {
...
func (e *feFuncG) OnLoadedData(handler string) *feFuncG {
...
func (e *feFuncG) OnLoadedMetadata(handler string) *feFuncG {
...
func (e *feFuncG) OnLoadStart(handler string) *feFuncG {
...
func (e *feFuncG) OnMouseDown(handler string) *feFuncG {
...
func (e *feFuncG) OnMouseEnter(handler string) *feFuncG {
...
func (e *feFuncG) OnMouseLeave(handler string) *feFuncG {
...
func (e *feFuncG) OnMouseMove(handler string) *feFuncG {
...
func (e *feFuncG) OnMouseOut(handler string) *feFuncG {
...
func (e *feFuncG) OnMouseOver(handler string) *feFuncG {
...
func (e *feFuncG) OnMouseUp(handler string) *feFuncG {
...
func (e *feFuncG) OnMouseWheel(handler string) *feFuncG {
...
func (e *feFuncG) OnPause(handler string) *feFuncG {
...
func (e *feFuncG) OnPlay(handler string) *feFuncG {
...
func (e *feFuncG) OnPlaying(handler string) *feFuncG {
...
func (e *feFuncG) OnProgress(handler string) *feFuncG {
...
func (e *feFuncG) OnRateChange(handler string) *feFuncG {
...
func (e *feFuncG) OnReset(handler string) *feFuncG {
...
// ResizeObserver.
func (e *feFuncG) OnResize(handler string) *feFuncG {
...
func (e *feFuncG) OnScroll(handler string) *feFuncG {
...
func (e *feFuncG) OnSeeked(handler string) *feFuncG {
...
func (e *feFuncG) OnSeeking(handler string) *feFuncG {
...
func (e *feFuncG) OnSelect(handler string) *feFuncG {
...
func (e *feFuncG) OnShow(handler string) *feFuncG {
...
func (e *feFuncG) OnSort(handler string) *feFuncG {
...
func (e *feFuncG) OnStalled(handler string) *feFuncG {
...
func (e *feFuncG) OnSuspend(handler string) *feFuncG {
...
func (e *feFuncG) OnTimeUpdate(handler string) *feFuncG {
...
func (e *feFuncG) OnToggle(handler string) *feFuncG {
...
func (e *feFuncG) OnVolumeChange(handler string) *feFuncG {
...
func (e *feFuncG) OnWaiting(handler string) *feFuncG {
...
func (e *feFuncG) OnAuxClick(handler string) *feFuncG {
...
func (e *feFuncG) OnWheel(handler string) *feFuncG {
...
func (e *feFuncG) OnCopy(handler string) *feFuncG {
...
// content itself.
func (e *feFuncG) OnCut(handler string) *feFuncG {
...
func (e *feFuncG) OnPaste(handler string) *feFuncG {
...
func (e *feFuncG) OnScrollEnd(handler string) *feFuncG {
...
func (e *feFuncG) OnFormData(handler string) *feFuncG {
...
func (e *feFuncG) OnAnimationCancel(handler string) *feFuncG {
...
func (e *feFuncG) OnAnimationEnd(handler string) *feFuncG {
...
func (e *feFuncG) OnAnimationIteration(handler string) *feFuncG {
...
func (e *feFuncG) OnAnimationStart(handler string) *feFuncG {
...
func (e *feFuncG) OnTransitionCancel(handler string) *feFuncG {
...
func (e *feFuncG) OnTransitionEnd(handler string) *feFuncG {
...
func (e *feFuncG) OnTransitionRun(handler string) *feFuncG {
...
func (e *feFuncG) OnTransitionStart(handler string) *feFuncG {
...
func (e *feFuncG) OnBeforeToggle(handler string) *feFuncG {
...
func (e *feFuncG) OnBeforeInput(handler string) *feFuncG {
...
func (e *feFuncG) OnBeforeMatch(handler string) *feFuncG {
...
func (e *feFuncG) OnCommand(handler string) *feFuncG {
...
func (e *feFuncG) OnContextLost(handler string) *feFuncG {
...
func (e *feFuncG) OnContextRestored(handler string) *feFuncG {
...
func (e *feFuncG) OnSecurityPolicyViolation(handler string) *feFuncG {
...
func (e *feFuncG) OnSlotChange(handler string) *feFuncG {
...
func (e *feFuncG) OnPointerDown(handler string) *feFuncG {
...
func (e *feFuncG) OnPointerUp(handler string) *feFuncG {
...
func (e *feFuncG) OnPointerMove(handler string) *feFuncG {
...
func (e *feFuncG) OnPointerEnter(handler string) *feFuncG {
...
func (e *feFuncG) OnPointerLeave(handler string) *feFuncG {
...
func (e *feFuncG) OnPointerOver(handler string) *feFuncG {
...
// element for any of its descendants.
func (e *feFuncG) OnPointerOut(handler string) *feFuncG {
...
func (e *feFuncG) OnPointerCancel(handler string) *feFuncG {
...
func (e *feFuncG) OnGotPointerCapture(handler string) *feFuncG {
...
func (e *feFuncG) OnLostPointerCapture(handler string) *feFuncG {
...
func (e *feFuncG) OnTouchStart(handler string) *feFuncG {
...
func (e *feFuncG) OnTouchEnd(handler string) *feFuncG {
...
func (e *feFuncG) OnTouchMove(handler string) *feFuncG {
...
func (e *feFuncG) OnTouchCancel(handler string) *feFuncG {
...
func (e *feFuncG) OnSelectStart(handler string) *feFuncG {
...
func (e *feFuncG) OnSelectionChange(handler string) *feFuncG {
...
func (e *feFuncG) SetAttribute(key string, value string) {
...
func (e *feFuncG) SetAttributeRaw(key string, value string) {
	if e.attr == nil {
		e.attr = &[]node.Attribute{}
	}
	for i, attr := range *e.attr {
...
func (e *feFuncG) Add(children ...PrimitiveContent) *feFuncG {
...
func (e *feFuncG) Replace(children ...PrimitiveContent) *feFuncG {
...
func (e *feFuncG) DynamicKey() string {
	return e.dynamic
}
...
func (e *feFuncG) Memoise(version any) *feFuncG {
	e.memoise = version
	return e
}
...
func (e *feFuncG) BufferHint(hint int) *feFuncG {
	if hint > 0 {
...
func (e *feFuncG) RenderedSize() int {
...
func (e *feFuncG) Render(w io.Writer) {
	_, _ = e.WriteTo(w)
}
...
func (e *feFuncG) WriteTo(w io.Writer) (int64, error) {
...
func (e *feFuncG) RenderBytes() []byte {
...
func (e *feFuncG) AttributeBuilder(buf *bytes.Buffer) {
	if len(e.typeAttr) > 0 {
		buf.Write(AttrType)
...
func (e *feFuncG) RenderBuilder(buf *bytes.Buffer) {
	buf.Write(TagFeFuncG)
	...
	buf.Write(TagFeFuncGClose)
}

// RenderOpen writes the opening tag and attributes to the buffer.
func (e *feFuncG) RenderOpen(buf *bytes.Buffer) {
	buf.Write(TagFeFuncG)
	e.AttributeBuilder(buf)
	buf.Write(MarkupCloseTag)
}
...
// isSVGTransferFunction seals feFuncG as a TransferFunction.
func (*feFuncG) isSVGTransferFunction() {}
