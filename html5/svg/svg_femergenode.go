...
// feMergeNode represents the <feMergeNode> SVG element.
...
func (e *feMergeNode) svg() *svgAttrs {
	if e.sa == nil {
		e.sa = &svgAttrs{}
	}
	return e.sa
...
func (e *feMergeNode) event() *html5.EventAttributes {
	if e.ea == nil {
...
// FeMergeNode selects one input to be layered by its parent FeMerge. The in
// attribute can name a previous filter result or a standard input such as
// SourceGraphic. Its position among the children determines the stacking order.
func FeMergeNode(children ...PrimitiveContent) *feMergeNode {
...
//
// The input to stack at this position: a result name from an earlier primitive, or a standard input such
// as SourceGraphic.
func (e *feMergeNode) In(value string) *feMergeNode {
	e.in = node.EscapeAttribute(value)
	return e
}

// ID sets the id attribute.
func (e *feMergeNode) ID(id string) *feMergeNode {
	e.svg().ID = node.EscapeAttribute(id)
	return e
}

// Class appends to the space-separated class attribute.
func (e *feMergeNode) Class(class string) *feMergeNode {
...
func (e *feMergeNode) Style(css string) *feMergeNode {
	e.svg().Style = node.EscapeAttribute(css)
	return e
}

// Transform sets the transform attribute.
func (e *feMergeNode) Transform(transform string) *feMergeNode {
...
func (e *feMergeNode) TransformOrigin(origin string) *feMergeNode {
	e.svg().TransformOrigin = node.EscapeAttribute(origin)
	return e
}

// TabIndex sets the tabindex attribute.
func (e *feMergeNode) TabIndex(index string) *feMergeNode {
	e.svg().TabIndex = node.EscapeAttribute(index)
	return e
}

// Role sets the role attribute.
func (e *feMergeNode) Role(role string) *feMergeNode {
...
func (e *feMergeNode) Lang(lang string) *feMergeNode {
...
func (e *feMergeNode) AutoFocus(conds ...bool) *feMergeNode {
	if len(conds) > 0 {
...
func (e *feMergeNode) SetAria(key string, value string) *feMergeNode {
...
func (e *feMergeNode) StrokeDashOffset(offset string) *feMergeNode {
...
func (e *feMergeNode) StrokeMiterLimit(limit string) *feMergeNode {
...
func (e *feMergeNode) FillRule(rule fillrule.FillRule) *feMergeNode {
	e.svg().FillRule = rule
	return e
}
...
// a clipPath.
func (e *feMergeNode) ClipRule(rule cliprule.ClipRule) *feMergeNode {
	e.svg().ClipRule = rule
	return e
}
...
func (e *feMergeNode) ClipPath(clip string) *feMergeNode {
...
// per pixel.
func (e *feMergeNode) Mask(mask string) *feMergeNode {
...
func (e *feMergeNode) Filter(filter string) *feMergeNode {
...
func (e *feMergeNode) Color(color string) *feMergeNode {
...
func (e *feMergeNode) Cursor(cursor string) *feMergeNode {
...
func (e *feMergeNode) Display(display string) *feMergeNode {
...
// drawn again.
func (e *feMergeNode) Visibility(value visibility.Visibility) *feMergeNode {
...
func (e *feMergeNode) PointerEvents(events pointerevents.PointerEvents) *feMergeNode {
...
func (e *feMergeNode) VectorEffect(effect vectoreffect.VectorEffect) *feMergeNode {
...
func (e *feMergeNode) ShapeRendering(rendering shaperendering.ShapeRendering) *feMergeNode {
...
func (e *feMergeNode) FontFamily(family string) *feMergeNode {
...
// is in user units.
func (e *feMergeNode) FontSize(size string) *feMergeNode {
...
// from 100 to 900.
func (e *feMergeNode) FontWeight(weight string) *feMergeNode {
...
func (e *feMergeNode) FontStyle(style string) *feMergeNode {
...
func (e *feMergeNode) OnClick(handler string) *feMergeNode {
...
func (e *feMergeNode) OnChange(handler string) *feMergeNode {
...
func (e *feMergeNode) OnInput(handler string) *feMergeNode {
...
func (e *feMergeNode) OnFocus(handler string) *feMergeNode {
...
func (e *feMergeNode) OnBlur(handler string) *feMergeNode {
...
func (e *feMergeNode) OnSubmit(handler string) *feMergeNode {
...
func (e *feMergeNode) OnLoad(handler string) *feMergeNode {
...
func (e *feMergeNode) OnError(handler string) *feMergeNode {
...
// developer-controlled key. Never build the key from user input - a key containing a space, quote,
// "=", "/" or ">" changes the markup structure. The value is escaped. The key is not escaped.
func (e *feMergeNode) SetEvent(key string, value string) *feMergeNode {
...
func (e *feMergeNode) OnAbort(handler string) *feMergeNode {
...
func (e *feMergeNode) OnAutoComplete(handler string) *feMergeNode {
...
//
// Deprecated: Removed from the WHATWG living standard. Was in an older HTML5 draft.
func (e *feMergeNode) OnAutoCompleteError(handler string) *feMergeNode {
...
func (e *feMergeNode) OnCancel(handler string) *feMergeNode {
...
func (e *feMergeNode) OnCanPlay(handler string) *feMergeNode {
...
func (e *feMergeNode) OnCanPlayThrough(handler string) *feMergeNode {
...
// results.
func (e *feMergeNode) OnClose(handler string) *feMergeNode {
...
func (e *feMergeNode) OnContextMenu(handler string) *feMergeNode {
...
// timestamps.
func (e *feMergeNode) OnCueChange(handler string) *feMergeNode {
...
func (e *feMergeNode) OnDblClick(handler string) *feMergeNode {
...
func (e *feMergeNode) OnDrag(handler string) *feMergeNode {
...
func (e *feMergeNode) OnDragEnd(handler string) *feMergeNode {
...
func (e *feMergeNode) OnDragEnter(handler string) *feMergeNode {
...
func (e *feMergeNode) OnDragLeave(handler string) *feMergeNode {
...
func (e *feMergeNode) OnDragOver(handler string) *feMergeNode {
...
func (e *feMergeNode) OnDragStart(handler string) *feMergeNode {
...
// enable dropping.
func (e *feMergeNode) OnDrop(handler string) *feMergeNode {
...
func (e *feMergeNode) OnDurationChange(handler string) *feMergeNode {
...
// media content.
func (e *feMergeNode) OnEmptied(handler string) *feMergeNode {
...
func (e *feMergeNode) OnEnded(handler string) *feMergeNode {
...
func (e *feMergeNode) OnInvalid(handler string) *feMergeNode {
...
func (e *feMergeNode) OnKeyDown(handler string) *feMergeNode {
...
func (e *feMergeNode) OnKeyPress(handler string) *feMergeNode {
...
func (e *feMergeNode) OnKeyUp(handler string) *feMergeNode {
...
func (e *feMergeNode) OnLoadedData(handler string) *feMergeNode {
...
func (e *feMergeNode) OnLoadedMetadata(handler string) *feMergeNode {
...
func (e *feMergeNode) OnLoadStart(handler string) *feMergeNode {
...
func (e *feMergeNode) OnMouseDown(handler string) *feMergeNode {
...
func (e *feMergeNode) OnMouseEnter(handler string) *feMergeNode {
...
func (e *feMergeNode) OnMouseLeave(handler string) *feMergeNode {
...
func (e *feMergeNode) OnMouseMove(handler string) *feMergeNode {
...
func (e *feMergeNode) OnMouseOut(handler string) *feMergeNode {
...
func (e *feMergeNode) OnMouseOver(handler string) *feMergeNode {
...
func (e *feMergeNode) OnMouseUp(handler string) *feMergeNode {
...
func (e *feMergeNode) OnMouseWheel(handler string) *feMergeNode {
...
func (e *feMergeNode) OnPause(handler string) *feMergeNode {
...
func (e *feMergeNode) OnPlay(handler string) *feMergeNode {
...
func (e *feMergeNode) OnPlaying(handler string) *feMergeNode {
...
func (e *feMergeNode) OnProgress(handler string) *feMergeNode {
...
func (e *feMergeNode) OnRateChange(handler string) *feMergeNode {
...
func (e *feMergeNode) OnReset(handler string) *feMergeNode {
...
// ResizeObserver.
func (e *feMergeNode) OnResize(handler string) *feMergeNode {
...
func (e *feMergeNode) OnScroll(handler string) *feMergeNode {
...
func (e *feMergeNode) OnSeeked(handler string) *feMergeNode {
...
func (e *feMergeNode) OnSeeking(handler string) *feMergeNode {
...
func (e *feMergeNode) OnSelect(handler string) *feMergeNode {
...
func (e *feMergeNode) OnShow(handler string) *feMergeNode {
...
func (e *feMergeNode) OnSort(handler string) *feMergeNode {
...
func (e *feMergeNode) OnStalled(handler string) *feMergeNode {
...
func (e *feMergeNode) OnSuspend(handler string) *feMergeNode {
...
func (e *feMergeNode) OnTimeUpdate(handler string) *feMergeNode {
...
func (e *feMergeNode) OnToggle(handler string) *feMergeNode {
...
func (e *feMergeNode) OnVolumeChange(handler string) *feMergeNode {
...
func (e *feMergeNode) OnWaiting(handler string) *feMergeNode {
...
func (e *feMergeNode) OnAuxClick(handler string) *feMergeNode {
...
func (e *feMergeNode) OnWheel(handler string) *feMergeNode {
...
func (e *feMergeNode) OnCopy(handler string) *feMergeNode {
...
// content itself.
func (e *feMergeNode) OnCut(handler string) *feMergeNode {
...
func (e *feMergeNode) OnPaste(handler string) *feMergeNode {
...
func (e *feMergeNode) OnScrollEnd(handler string) *feMergeNode {
...
func (e *feMergeNode) OnFormData(handler string) *feMergeNode {
...
func (e *feMergeNode) OnAnimationCancel(handler string) *feMergeNode {
...
func (e *feMergeNode) OnAnimationEnd(handler string) *feMergeNode {
...
func (e *feMergeNode) OnAnimationIteration(handler string) *feMergeNode {
...
func (e *feMergeNode) OnAnimationStart(handler string) *feMergeNode {
...
func (e *feMergeNode) OnTransitionCancel(handler string) *feMergeNode {
...
func (e *feMergeNode) OnTransitionEnd(handler string) *feMergeNode {
...
func (e *feMergeNode) OnTransitionRun(handler string) *feMergeNode {
...
func (e *feMergeNode) OnTransitionStart(handler string) *feMergeNode {
...
func (e *feMergeNode) OnBeforeToggle(handler string) *feMergeNode {
...
func (e *feMergeNode) OnBeforeInput(handler string) *feMergeNode {
...
func (e *feMergeNode) OnBeforeMatch(handler string) *feMergeNode {
...
func (e *feMergeNode) OnCommand(handler string) *feMergeNode {
...
func (e *feMergeNode) OnContextLost(handler string) *feMergeNode {
...
func (e *feMergeNode) OnContextRestored(handler string) *feMergeNode {
...
func (e *feMergeNode) OnSecurityPolicyViolation(handler string) *feMergeNode {
...
func (e *feMergeNode) OnSlotChange(handler string) *feMergeNode {
...
func (e *feMergeNode) OnPointerDown(handler string) *feMergeNode {
...
func (e *feMergeNode) OnPointerUp(handler string) *feMergeNode {
...
func (e *feMergeNode) OnPointerMove(handler string) *feMergeNode {
...
func (e *feMergeNode) OnPointerEnter(handler string) *feMergeNode {
...
func (e *feMergeNode) OnPointerLeave(handler string) *feMergeNode {
...
func (e *feMergeNode) OnPointerOver(handler string) *feMergeNode {
...
// element for any of its descendants.
func (e *feMergeNode) OnPointerOut(handler string) *feMergeNode {
...
func (e *feMergeNode) OnPointerCancel(handler string) *feMergeNode {
...
func (e *feMergeNode) OnGotPointerCapture(handler string) *feMergeNode {
...
func (e *feMergeNode) OnLostPointerCapture(handler string) *feMergeNode {
...
func (e *feMergeNode) OnTouchStart(handler string) *feMergeNode {
...
func (e *feMergeNode) OnTouchEnd(handler string) *feMergeNode {
...
func (e *feMergeNode) OnTouchMove(handler string) *feMergeNode {
...
func (e *feMergeNode) OnTouchCancel(handler string) *feMergeNode {
...
func (e *feMergeNode) OnSelectStart(handler string) *feMergeNode {
...
func (e *feMergeNode) OnSelectionChange(handler string) *feMergeNode {
...
func (e *feMergeNode) SetAttribute(key string, value string) {
...
func (e *feMergeNode) SetAttributeRaw(key string, value string) {
	if e.attr == nil {
		e.attr = &[]node.Attribute{}
	}
	for i, attr := range *e.attr {
...
func (e *feMergeNode) Add(children ...PrimitiveContent) *feMergeNode {
...
func (e *feMergeNode) Replace(children ...PrimitiveContent) *feMergeNode {
...
func (e *feMergeNode) Dynamic(key string) *feMergeNode {
	e.dynamic = key
	return e
}

// IsDynamic reports whether this element has been marked for reactive tracking.
func (e *feMergeNode) IsDynamic() bool {
	return e.dynamic != ""
}
...
func (e *feMergeNode) DynamicKey() string {
	return e.dynamic
}
...
func (e *feMergeNode) Memoise(version any) *feMergeNode {
	e.memoise = version
	return e
}
...
// by fluent-jit.
func (e *feMergeNode) MemoiseKey() any {
	return e.memoise
}
...
func (e *feMergeNode) BufferHint(hint int) *feMergeNode {
	if hint > 0 {
...
func (e *feMergeNode) RenderedSize() int {
...
func (e *feMergeNode) Render(w io.Writer) {
	_, _ = e.WriteTo(w)
}
...
func (e *feMergeNode) WriteTo(w io.Writer) (int64, error) {
...
func (e *feMergeNode) RenderBytes() []byte {
...
func (e *feMergeNode) AttributeBuilder(buf *bytes.Buffer) {
	if e.in != "" {
		buf.Write(AttrIn)
...
func (e *feMergeNode) RenderBuilder(buf *bytes.Buffer) {
	buf.Write(TagFeMergeNode)
	...
	buf.Write(TagFeMergeNodeClose)
}

// RenderOpen writes the opening tag and attributes to the buffer.
func (e *feMergeNode) RenderOpen(buf *bytes.Buffer) {
	buf.Write(TagFeMergeNode)
	e.AttributeBuilder(buf)
	buf.Write(MarkupCloseTag)
}
