...
// feTile represents the <feTile> SVG element.
type feTile struct {
...
func (e *feTile) event() *html5.EventAttributes {
	if e.ea == nil {
...
// FeTile repeats its input's subregion across its own, which turns a small
// patch into a repeating texture inside a filter.
func FeTile(children ...PrimitiveContent) *feTile {
...
func (e *feTile) Style(css string) *feTile {
	e.svg().Style = node.EscapeAttribute(css)
	return e
}

// Transform sets the transform attribute.
func (e *feTile) Transform(transform string) *feTile {
...
func (e *feTile) TransformOrigin(origin string) *feTile {
	e.svg().TransformOrigin = node.EscapeAttribute(origin)
	return e
}

// TabIndex sets the tabindex attribute.
func (e *feTile) TabIndex(index string) *feTile {
	e.svg().TabIndex = node.EscapeAttribute(index)
	return e
}

// Role sets the role attribute.
func (e *feTile) Role(role string) *feTile {
...
func (e *feTile) Lang(lang string) *feTile {
...
func (e *feTile) AutoFocus(conds ...bool) *feTile {
	if len(conds) > 0 {
...
func (e *feTile) SetAria(key string, value string) *feTile {
...
func (e *feTile) StrokeDashOffset(offset string) *feTile {
...
func (e *feTile) StrokeMiterLimit(limit string) *feTile {
...
func (e *feTile) FillRule(rule fillrule.FillRule) *feTile {
	e.svg().FillRule = rule
	return e
}
...
// a clipPath.
func (e *feTile) ClipRule(rule cliprule.ClipRule) *feTile {
	e.svg().ClipRule = rule
	return e
}
...
func (e *feTile) ClipPath(clip string) *feTile {
...
// per pixel.
func (e *feTile) Mask(mask string) *feTile {
...
func (e *feTile) Filter(filter string) *feTile {
...
func (e *feTile) Color(color string) *feTile {
...
func (e *feTile) Cursor(cursor string) *feTile {
...
func (e *feTile) Display(display string) *feTile {
...
// drawn again.
func (e *feTile) Visibility(value visibility.Visibility) *feTile {
...
func (e *feTile) PointerEvents(events pointerevents.PointerEvents) *feTile {
...
func (e *feTile) VectorEffect(effect vectoreffect.VectorEffect) *feTile {
...
func (e *feTile) ShapeRendering(rendering shaperendering.ShapeRendering) *feTile {
...
func (e *feTile) FontFamily(family string) *feTile {
...
// is in user units.
func (e *feTile) FontSize(size string) *feTile {
...
// from 100 to 900.
func (e *feTile) FontWeight(weight string) *feTile {
...
func (e *feTile) FontStyle(style string) *feTile {
...
func (e *feTile) OnClick(handler string) *feTile {
...
func (e *feTile) OnChange(handler string) *feTile {
...
func (e *feTile) OnInput(handler string) *feTile {
...
func (e *feTile) OnFocus(handler string) *feTile {
...
func (e *feTile) OnBlur(handler string) *feTile {
...
func (e *feTile) OnSubmit(handler string) *feTile {
...
func (e *feTile) OnLoad(handler string) *feTile {
...
func (e *feTile) OnError(handler string) *feTile {
...
// developer-controlled key. Never build the key from user input - a key containing a space, quote,
// "=", "/" or ">" changes the markup structure. The value is escaped. The key is not escaped.
func (e *feTile) SetEvent(key string, value string) *feTile {
...
func (e *feTile) OnAbort(handler string) *feTile {
...
func (e *feTile) OnAutoComplete(handler string) *feTile {
...
//
// Deprecated: Removed from the WHATWG living standard. Was in an older HTML5 draft.
func (e *feTile) OnAutoCompleteError(handler string) *feTile {
...
func (e *feTile) OnCancel(handler string) *feTile {
...
func (e *feTile) OnCanPlay(handler string) *feTile {
...
func (e *feTile) OnCanPlayThrough(handler string) *feTile {
...
// results.
func (e *feTile) OnClose(handler string) *feTile {
...
func (e *feTile) OnContextMenu(handler string) *feTile {
...
// timestamps.
func (e *feTile) OnCueChange(handler string) *feTile {
...
func (e *feTile) OnDblClick(handler string) *feTile {
...
func (e *feTile) OnDrag(handler string) *feTile {
...
func (e *feTile) OnDragEnd(handler string) *feTile {
...
func (e *feTile) OnDragEnter(handler string) *feTile {
...
func (e *feTile) OnDragLeave(handler string) *feTile {
...
func (e *feTile) OnDragOver(handler string) *feTile {
...
func (e *feTile) OnDragStart(handler string) *feTile {
...
// enable dropping.
func (e *feTile) OnDrop(handler string) *feTile {
...
func (e *feTile) OnDurationChange(handler string) *feTile {
...
// media content.
func (e *feTile) OnEmptied(handler string) *feTile {
...
func (e *feTile) OnEnded(handler string) *feTile {
...
func (e *feTile) OnInvalid(handler string) *feTile {
...
func (e *feTile) OnKeyDown(handler string) *feTile {
...
func (e *feTile) OnKeyPress(handler string) *feTile {
...
func (e *feTile) OnKeyUp(handler string) *feTile {
...
func (e *feTile) OnLoadedData(handler string) *feTile {
...
func (e *feTile) OnLoadedMetadata(handler string) *feTile {
...
func (e *feTile) OnLoadStart(handler string) *feTile {
...
func (e *feTile) OnMouseDown(handler string) *feTile {
...
func (e *feTile) OnMouseEnter(handler string) *feTile {
...
func (e *feTile) OnMouseLeave(handler string) *feTile {
...
func (e *feTile) OnMouseMove(handler string) *feTile {
...
func (e *feTile) OnMouseOut(handler string) *feTile {
...
func (e *feTile) OnMouseOver(handler string) *feTile {
...
func (e *feTile) OnMouseUp(handler string) *feTile {
...
func (e *feTile) OnMouseWheel(handler string) *feTile {
...
func (e *feTile) OnPause(handler string) *feTile {
...
func (e *feTile) OnPlay(handler string) *feTile {
...
func (e *feTile) OnPlaying(handler string) *feTile {
...
func (e *feTile) OnProgress(handler string) *feTile {
...
func (e *feTile) OnRateChange(handler string) *feTile {
...
func (e *feTile) OnReset(handler string) *feTile {
...
// ResizeObserver.
func (e *feTile) OnResize(handler string) *feTile {
...
func (e *feTile) OnScroll(handler string) *feTile {
...
func (e *feTile) OnSeeked(handler string) *feTile {
...
func (e *feTile) OnSeeking(handler string) *feTile {
...
func (e *feTile) OnSelect(handler string) *feTile {
...
func (e *feTile) OnShow(handler string) *feTile {
...
func (e *feTile) OnSort(handler string) *feTile {
...
func (e *feTile) OnStalled(handler string) *feTile {
...
func (e *feTile) OnSuspend(handler string) *feTile {
...
func (e *feTile) OnTimeUpdate(handler string) *feTile {
...
func (e *feTile) OnToggle(handler string) *feTile {
...
func (e *feTile) OnVolumeChange(handler string) *feTile {
...
func (e *feTile) OnWaiting(handler string) *feTile {
...
func (e *feTile) OnAuxClick(handler string) *feTile {
...
func (e *feTile) OnWheel(handler string) *feTile {
...
func (e *feTile) OnCopy(handler string) *feTile {
...
// content itself.
func (e *feTile) OnCut(handler string) *feTile {
...
func (e *feTile) OnPaste(handler string) *feTile {
...
func (e *feTile) OnScrollEnd(handler string) *feTile {
...
func (e *feTile) OnFormData(handler string) *feTile {
...
func (e *feTile) OnAnimationCancel(handler string) *feTile {
...
func (e *feTile) OnAnimationEnd(handler string) *feTile {
...
func (e *feTile) OnAnimationIteration(handler string) *feTile {
...
func (e *feTile) OnAnimationStart(handler string) *feTile {
...
func (e *feTile) OnTransitionCancel(handler string) *feTile {
...
func (e *feTile) OnTransitionEnd(handler string) *feTile {
...
func (e *feTile) OnTransitionRun(handler string) *feTile {
...
func (e *feTile) OnTransitionStart(handler string) *feTile {
...
func (e *feTile) OnBeforeToggle(handler string) *feTile {
...
func (e *feTile) OnBeforeInput(handler string) *feTile {
...
func (e *feTile) OnBeforeMatch(handler string) *feTile {
...
func (e *feTile) OnCommand(handler string) *feTile {
...
func (e *feTile) OnContextLost(handler string) *feTile {
...
func (e *feTile) OnContextRestored(handler string) *feTile {
...
func (e *feTile) OnSecurityPolicyViolation(handler string) *feTile {
...
func (e *feTile) OnSlotChange(handler string) *feTile {
...
func (e *feTile) OnPointerDown(handler string) *feTile {
...
func (e *feTile) OnPointerUp(handler string) *feTile {
...
func (e *feTile) OnPointerMove(handler string) *feTile {
...
func (e *feTile) OnPointerEnter(handler string) *feTile {
...
func (e *feTile) OnPointerLeave(handler string) *feTile {
...
func (e *feTile) OnPointerOver(handler string) *feTile {
...
// element for any of its descendants.
func (e *feTile) OnPointerOut(handler string) *feTile {
...
func (e *feTile) OnPointerCancel(handler string) *feTile {
...
func (e *feTile) OnGotPointerCapture(handler string) *feTile {
...
func (e *feTile) OnLostPointerCapture(handler string) *feTile {
...
func (e *feTile) OnTouchStart(handler string) *feTile {
...
func (e *feTile) OnTouchEnd(handler string) *feTile {
...
func (e *feTile) OnTouchMove(handler string) *feTile {
...
func (e *feTile) OnTouchCancel(handler string) *feTile {
...
func (e *feTile) OnSelectStart(handler string) *feTile {
...
func (e *feTile) OnSelectionChange(handler string) *feTile {
...
func (e *feTile) SetAttribute(key string, value string) {
...
func (e *feTile) SetAttributeRaw(key string, value string) {
	if e.attr == nil {
		e.attr = &[]node.Attribute{}
	}
	for i, attr := range *e.attr {
...
func (e *feTile) Add(children ...PrimitiveContent) *feTile {
...
func (e *feTile) Replace(children ...PrimitiveContent) *feTile {
...
func (e *feTile) DynamicKey() string {
	return e.dynamic
}
...
func (e *feTile) Memoise(version any) *feTile {
	e.memoise = version
	return e
}
...
func (e *feTile) BufferHint(hint int) *feTile {
	if hint > 0 {
...
func (e *feTile) RenderedSize() int {
...
func (e *feTile) Render(w io.Writer) {
	_, _ = e.WriteTo(w)
}
...
func (e *feTile) WriteTo(w io.Writer) (int64, error) {
...
func (e *feTile) RenderBytes() []byte {
...
func (e *feTile) AttributeBuilder(buf *bytes.Buffer) {
	if e.in != "" {
		buf.Write(AttrIn)
...
func (e *feTile) RenderBuilder(buf *bytes.Buffer) {
	buf.Write(TagFeTile)
	...
	buf.Write(TagFeTileClose)
}

// RenderOpen writes the opening tag and attributes to the buffer.
func (e *feTile) RenderOpen(buf *bytes.Buffer) {
	buf.Write(TagFeTile)
	e.AttributeBuilder(buf)
	buf.Write(MarkupCloseTag)
}
...
// isSVGFilterPrimitive seals feTile as a FilterPrimitive.
func (*feTile) isSVGFilterPrimitive() {}
