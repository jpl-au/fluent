...
// desc represents the <desc> SVG element.
type desc struct {
...
func (e *desc) event() *html5.EventAttributes {
	if e.ea == nil {
...
// Desc supplies a longer text description of its parent SVG element for
// assistive technology. It complements the short name supplied by Title and
// is not painted as part of the drawing. The string content is HTML-escaped.
func Desc(s string) *desc {
	return &desc{
...
func (e *desc) Style(css string) *desc {
	e.svg().Style = node.EscapeAttribute(css)
	return e
}

// Transform sets the transform attribute.
func (e *desc) Transform(transform string) *desc {
...
func (e *desc) Lang(lang string) *desc {
...
func (e *desc) AutoFocus(conds ...bool) *desc {
	if len(conds) > 0 {
...
func (e *desc) SetAria(key string, value string) *desc {
...
func (e *desc) StrokeDashOffset(offset string) *desc {
...
func (e *desc) StrokeMiterLimit(limit string) *desc {
...
func (e *desc) FillRule(rule fillrule.FillRule) *desc {
	e.svg().FillRule = rule
	return e
}
...
// a clipPath.
func (e *desc) ClipRule(rule cliprule.ClipRule) *desc {
	e.svg().ClipRule = rule
	return e
}
...
func (e *desc) ClipPath(clip string) *desc {
...
// per pixel.
func (e *desc) Mask(mask string) *desc {
...
func (e *desc) Filter(filter string) *desc {
...
func (e *desc) Color(color string) *desc {
...
func (e *desc) Cursor(cursor string) *desc {
...
func (e *desc) Display(display string) *desc {
...
// drawn again.
func (e *desc) Visibility(value visibility.Visibility) *desc {
...
func (e *desc) PointerEvents(events pointerevents.PointerEvents) *desc {
...
func (e *desc) VectorEffect(effect vectoreffect.VectorEffect) *desc {
...
func (e *desc) ShapeRendering(rendering shaperendering.ShapeRendering) *desc {
...
func (e *desc) FontFamily(family string) *desc {
...
// is in user units.
func (e *desc) FontSize(size string) *desc {
...
// from 100 to 900.
func (e *desc) FontWeight(weight string) *desc {
...
func (e *desc) FontStyle(style string) *desc {
...
func (e *desc) OnClick(handler string) *desc {
...
func (e *desc) OnChange(handler string) *desc {
...
func (e *desc) OnInput(handler string) *desc {
...
func (e *desc) OnFocus(handler string) *desc {
...
func (e *desc) OnBlur(handler string) *desc {
...
func (e *desc) OnSubmit(handler string) *desc {
...
func (e *desc) OnLoad(handler string) *desc {
...
func (e *desc) OnError(handler string) *desc {
...
// developer-controlled key. Never build the key from user input - a key containing a space, quote,
// "=", "/" or ">" changes the markup structure. The value is escaped. The key is not escaped.
func (e *desc) SetEvent(key string, value string) *desc {
...
func (e *desc) OnAbort(handler string) *desc {
...
func (e *desc) OnAutoComplete(handler string) *desc {
...
//
// Deprecated: Removed from the WHATWG living standard. Was in an older HTML5 draft.
func (e *desc) OnAutoCompleteError(handler string) *desc {
...
func (e *desc) OnCancel(handler string) *desc {
...
func (e *desc) OnCanPlay(handler string) *desc {
...
func (e *desc) OnCanPlayThrough(handler string) *desc {
...
// results.
func (e *desc) OnClose(handler string) *desc {
...
func (e *desc) OnContextMenu(handler string) *desc {
...
// timestamps.
func (e *desc) OnCueChange(handler string) *desc {
...
func (e *desc) OnDblClick(handler string) *desc {
...
func (e *desc) OnDrag(handler string) *desc {
...
func (e *desc) OnDragEnd(handler string) *desc {
...
func (e *desc) OnDragEnter(handler string) *desc {
...
func (e *desc) OnDragLeave(handler string) *desc {
...
func (e *desc) OnDragOver(handler string) *desc {
...
func (e *desc) OnDragStart(handler string) *desc {
...
// enable dropping.
func (e *desc) OnDrop(handler string) *desc {
...
func (e *desc) OnDurationChange(handler string) *desc {
...
// media content.
func (e *desc) OnEmptied(handler string) *desc {
...
func (e *desc) OnEnded(handler string) *desc {
...
func (e *desc) OnInvalid(handler string) *desc {
...
func (e *desc) OnKeyDown(handler string) *desc {
...
func (e *desc) OnKeyPress(handler string) *desc {
...
func (e *desc) OnKeyUp(handler string) *desc {
...
func (e *desc) OnLoadedData(handler string) *desc {
...
func (e *desc) OnLoadedMetadata(handler string) *desc {
...
func (e *desc) OnLoadStart(handler string) *desc {
...
func (e *desc) OnMouseDown(handler string) *desc {
...
func (e *desc) OnMouseEnter(handler string) *desc {
...
func (e *desc) OnMouseLeave(handler string) *desc {
...
func (e *desc) OnMouseMove(handler string) *desc {
...
func (e *desc) OnMouseOut(handler string) *desc {
...
func (e *desc) OnMouseOver(handler string) *desc {
...
func (e *desc) OnMouseUp(handler string) *desc {
...
func (e *desc) OnMouseWheel(handler string) *desc {
...
func (e *desc) OnPause(handler string) *desc {
...
func (e *desc) OnPlay(handler string) *desc {
...
func (e *desc) OnPlaying(handler string) *desc {
...
func (e *desc) OnProgress(handler string) *desc {
...
func (e *desc) OnRateChange(handler string) *desc {
...
func (e *desc) OnReset(handler string) *desc {
...
// ResizeObserver.
func (e *desc) OnResize(handler string) *desc {
...
func (e *desc) OnScroll(handler string) *desc {
...
func (e *desc) OnSeeked(handler string) *desc {
...
func (e *desc) OnSeeking(handler string) *desc {
...
func (e *desc) OnSelect(handler string) *desc {
...
func (e *desc) OnShow(handler string) *desc {
...
func (e *desc) OnSort(handler string) *desc {
...
func (e *desc) OnStalled(handler string) *desc {
...
func (e *desc) OnSuspend(handler string) *desc {
...
func (e *desc) OnTimeUpdate(handler string) *desc {
...
func (e *desc) OnToggle(handler string) *desc {
...
func (e *desc) OnVolumeChange(handler string) *desc {
...
func (e *desc) OnWaiting(handler string) *desc {
...
func (e *desc) OnAuxClick(handler string) *desc {
...
func (e *desc) OnWheel(handler string) *desc {
...
func (e *desc) OnCopy(handler string) *desc {
...
// content itself.
func (e *desc) OnCut(handler string) *desc {
...
func (e *desc) OnPaste(handler string) *desc {
...
func (e *desc) OnScrollEnd(handler string) *desc {
...
func (e *desc) OnFormData(handler string) *desc {
...
func (e *desc) OnAnimationCancel(handler string) *desc {
...
func (e *desc) OnAnimationEnd(handler string) *desc {
...
func (e *desc) OnAnimationIteration(handler string) *desc {
...
func (e *desc) OnAnimationStart(handler string) *desc {
...
func (e *desc) OnTransitionCancel(handler string) *desc {
...
func (e *desc) OnTransitionEnd(handler string) *desc {
...
func (e *desc) OnTransitionRun(handler string) *desc {
...
func (e *desc) OnTransitionStart(handler string) *desc {
...
func (e *desc) OnBeforeToggle(handler string) *desc {
...
func (e *desc) OnBeforeInput(handler string) *desc {
...
func (e *desc) OnBeforeMatch(handler string) *desc {
...
func (e *desc) OnCommand(handler string) *desc {
...
func (e *desc) OnContextLost(handler string) *desc {
...
func (e *desc) OnContextRestored(handler string) *desc {
...
func (e *desc) OnSecurityPolicyViolation(handler string) *desc {
...
func (e *desc) OnSlotChange(handler string) *desc {
...
func (e *desc) OnPointerDown(handler string) *desc {
...
func (e *desc) OnPointerUp(handler string) *desc {
...
func (e *desc) OnPointerMove(handler string) *desc {
...
func (e *desc) OnPointerEnter(handler string) *desc {
...
func (e *desc) OnPointerLeave(handler string) *desc {
...
func (e *desc) OnPointerOver(handler string) *desc {
...
// element for any of its descendants.
func (e *desc) OnPointerOut(handler string) *desc {
...
func (e *desc) OnPointerCancel(handler string) *desc {
...
func (e *desc) OnGotPointerCapture(handler string) *desc {
...
func (e *desc) OnLostPointerCapture(handler string) *desc {
...
func (e *desc) OnTouchStart(handler string) *desc {
...
func (e *desc) OnTouchEnd(handler string) *desc {
...
func (e *desc) OnTouchMove(handler string) *desc {
...
func (e *desc) OnTouchCancel(handler string) *desc {
...
func (e *desc) OnSelectStart(handler string) *desc {
...
func (e *desc) OnSelectionChange(handler string) *desc {
...
func (e *desc) SetAttribute(key string, value string) {
...
func (e *desc) SetAttributeRaw(key string, value string) {
	if e.attr == nil {
		e.attr = &[]node.Attribute{}
	}
	for i, attr := range *e.attr {
...
func (e *desc) Memoise(version any) *desc {
	e.memoise = version
	return e
}
...
func (e *desc) BufferHint(hint int) *desc {
	if hint > 0 {
...
func (e *desc) Render(w io.Writer) {
	_, _ = e.WriteTo(w)
}
...
func (e *desc) WriteTo(w io.Writer) (int64, error) {
...
func (e *desc) AttributeBuilder(buf *bytes.Buffer) {
...
func (e *desc) RenderBuilder(buf *bytes.Buffer) {
	buf.Write(TagDesc)
...
// isSVGShape seals desc as a Shape.
func (*desc) isSVGShape() {}

// isSVGShapeContent seals desc as a ShapeContent.
func (*desc) isSVGShapeContent() {}

// isSVGPrimitiveContent seals desc as a PrimitiveContent.
func (*desc) isSVGPrimitiveContent() {}

// isSVGDescriptive seals desc as a Descriptive.
func (*desc) isSVGDescriptive() {}
