...
// fePointLight represents the <fePointLight> SVG element.
...
func (e *fePointLight) svg() *svgAttrs {
	if e.sa == nil {
		e.sa = &svgAttrs{}
	}
	return e.sa
...
func (e *fePointLight) event() *html5.EventAttributes {
	if e.ea == nil {
...
// FePointLight defines a light source at (x, y, z) for FeDiffuseLighting or
// FeSpecularLighting. Light travels from that point towards the surface, so
// its direction varies across the input image.
func FePointLight(children ...PrimitiveContent) *fePointLight {
...
func (e *fePointLight) X(value string) *fePointLight {
...
func (e *fePointLight) Y(value string) *fePointLight {
...
//
// How far the light is above the surface. Larger values spread the light more evenly.
func (e *fePointLight) Z(value string) *fePointLight {
	e.z = node.EscapeAttribute(value)
	return e
}

// ID sets the id attribute.
func (e *fePointLight) ID(id string) *fePointLight {
	e.svg().ID = node.EscapeAttribute(id)
	return e
}

// Class appends to the space-separated class attribute.
func (e *fePointLight) Class(class string) *fePointLight {
...
func (e *fePointLight) Style(css string) *fePointLight {
	e.svg().Style = node.EscapeAttribute(css)
	return e
}

// Transform sets the transform attribute.
func (e *fePointLight) Transform(transform string) *fePointLight {
...
func (e *fePointLight) TransformOrigin(origin string) *fePointLight {
	e.svg().TransformOrigin = node.EscapeAttribute(origin)
	return e
}

// TabIndex sets the tabindex attribute.
func (e *fePointLight) TabIndex(index string) *fePointLight {
	e.svg().TabIndex = node.EscapeAttribute(index)
	return e
}

// Role sets the role attribute.
func (e *fePointLight) Role(role string) *fePointLight {
...
func (e *fePointLight) Lang(lang string) *fePointLight {
...
func (e *fePointLight) AutoFocus(conds ...bool) *fePointLight {
	if len(conds) > 0 {
...
func (e *fePointLight) SetAria(key string, value string) *fePointLight {
...
func (e *fePointLight) StrokeDashOffset(offset string) *fePointLight {
...
func (e *fePointLight) StrokeMiterLimit(limit string) *fePointLight {
...
func (e *fePointLight) FillRule(rule fillrule.FillRule) *fePointLight {
	e.svg().FillRule = rule
	return e
}
...
// a clipPath.
func (e *fePointLight) ClipRule(rule cliprule.ClipRule) *fePointLight {
	e.svg().ClipRule = rule
	return e
}
...
func (e *fePointLight) ClipPath(clip string) *fePointLight {
...
// per pixel.
func (e *fePointLight) Mask(mask string) *fePointLight {
...
func (e *fePointLight) Filter(filter string) *fePointLight {
...
func (e *fePointLight) Color(color string) *fePointLight {
...
func (e *fePointLight) Cursor(cursor string) *fePointLight {
...
func (e *fePointLight) Display(display string) *fePointLight {
...
// drawn again.
func (e *fePointLight) Visibility(value visibility.Visibility) *fePointLight {
...
func (e *fePointLight) PointerEvents(events pointerevents.PointerEvents) *fePointLight {
...
func (e *fePointLight) VectorEffect(effect vectoreffect.VectorEffect) *fePointLight {
...
func (e *fePointLight) ShapeRendering(rendering shaperendering.ShapeRendering) *fePointLight {
...
func (e *fePointLight) FontFamily(family string) *fePointLight {
...
// is in user units.
func (e *fePointLight) FontSize(size string) *fePointLight {
...
// from 100 to 900.
func (e *fePointLight) FontWeight(weight string) *fePointLight {
...
func (e *fePointLight) FontStyle(style string) *fePointLight {
...
func (e *fePointLight) OnClick(handler string) *fePointLight {
...
func (e *fePointLight) OnChange(handler string) *fePointLight {
...
func (e *fePointLight) OnInput(handler string) *fePointLight {
...
func (e *fePointLight) OnFocus(handler string) *fePointLight {
...
func (e *fePointLight) OnBlur(handler string) *fePointLight {
...
func (e *fePointLight) OnSubmit(handler string) *fePointLight {
...
func (e *fePointLight) OnLoad(handler string) *fePointLight {
...
func (e *fePointLight) OnError(handler string) *fePointLight {
...
// developer-controlled key. Never build the key from user input - a key containing a space, quote,
// "=", "/" or ">" changes the markup structure. The value is escaped. The key is not escaped.
func (e *fePointLight) SetEvent(key string, value string) *fePointLight {
...
func (e *fePointLight) OnAbort(handler string) *fePointLight {
...
func (e *fePointLight) OnAutoComplete(handler string) *fePointLight {
...
//
// Deprecated: Removed from the WHATWG living standard. Was in an older HTML5 draft.
func (e *fePointLight) OnAutoCompleteError(handler string) *fePointLight {
...
func (e *fePointLight) OnCancel(handler string) *fePointLight {
...
func (e *fePointLight) OnCanPlay(handler string) *fePointLight {
...
func (e *fePointLight) OnCanPlayThrough(handler string) *fePointLight {
...
// results.
func (e *fePointLight) OnClose(handler string) *fePointLight {
...
func (e *fePointLight) OnContextMenu(handler string) *fePointLight {
...
// timestamps.
func (e *fePointLight) OnCueChange(handler string) *fePointLight {
...
func (e *fePointLight) OnDblClick(handler string) *fePointLight {
...
func (e *fePointLight) OnDrag(handler string) *fePointLight {
...
func (e *fePointLight) OnDragEnd(handler string) *fePointLight {
...
func (e *fePointLight) OnDragEnter(handler string) *fePointLight {
...
func (e *fePointLight) OnDragLeave(handler string) *fePointLight {
...
func (e *fePointLight) OnDragOver(handler string) *fePointLight {
...
func (e *fePointLight) OnDragStart(handler string) *fePointLight {
...
// enable dropping.
func (e *fePointLight) OnDrop(handler string) *fePointLight {
...
func (e *fePointLight) OnDurationChange(handler string) *fePointLight {
...
// media content.
func (e *fePointLight) OnEmptied(handler string) *fePointLight {
...
func (e *fePointLight) OnEnded(handler string) *fePointLight {
...
func (e *fePointLight) OnInvalid(handler string) *fePointLight {
...
func (e *fePointLight) OnKeyDown(handler string) *fePointLight {
...
func (e *fePointLight) OnKeyPress(handler string) *fePointLight {
...
func (e *fePointLight) OnKeyUp(handler string) *fePointLight {
...
func (e *fePointLight) OnLoadedData(handler string) *fePointLight {
...
func (e *fePointLight) OnLoadedMetadata(handler string) *fePointLight {
...
func (e *fePointLight) OnLoadStart(handler string) *fePointLight {
...
func (e *fePointLight) OnMouseDown(handler string) *fePointLight {
...
func (e *fePointLight) OnMouseEnter(handler string) *fePointLight {
...
func (e *fePointLight) OnMouseLeave(handler string) *fePointLight {
...
func (e *fePointLight) OnMouseMove(handler string) *fePointLight {
...
func (e *fePointLight) OnMouseOut(handler string) *fePointLight {
...
func (e *fePointLight) OnMouseOver(handler string) *fePointLight {
...
func (e *fePointLight) OnMouseUp(handler string) *fePointLight {
...
func (e *fePointLight) OnMouseWheel(handler string) *fePointLight {
...
func (e *fePointLight) OnPause(handler string) *fePointLight {
...
func (e *fePointLight) OnPlay(handler string) *fePointLight {
...
func (e *fePointLight) OnPlaying(handler string) *fePointLight {
...
func (e *fePointLight) OnProgress(handler string) *fePointLight {
...
func (e *fePointLight) OnRateChange(handler string) *fePointLight {
...
func (e *fePointLight) OnReset(handler string) *fePointLight {
...
// ResizeObserver.
func (e *fePointLight) OnResize(handler string) *fePointLight {
...
func (e *fePointLight) OnScroll(handler string) *fePointLight {
...
func (e *fePointLight) OnSeeked(handler string) *fePointLight {
...
func (e *fePointLight) OnSeeking(handler string) *fePointLight {
...
func (e *fePointLight) OnSelect(handler string) *fePointLight {
...
func (e *fePointLight) OnShow(handler string) *fePointLight {
...
func (e *fePointLight) OnSort(handler string) *fePointLight {
...
func (e *fePointLight) OnStalled(handler string) *fePointLight {
...
func (e *fePointLight) OnSuspend(handler string) *fePointLight {
...
func (e *fePointLight) OnTimeUpdate(handler string) *fePointLight {
...
func (e *fePointLight) OnToggle(handler string) *fePointLight {
...
func (e *fePointLight) OnVolumeChange(handler string) *fePointLight {
...
func (e *fePointLight) OnWaiting(handler string) *fePointLight {
...
func (e *fePointLight) OnAuxClick(handler string) *fePointLight {
...
func (e *fePointLight) OnWheel(handler string) *fePointLight {
...
func (e *fePointLight) OnCopy(handler string) *fePointLight {
...
// content itself.
func (e *fePointLight) OnCut(handler string) *fePointLight {
...
func (e *fePointLight) OnPaste(handler string) *fePointLight {
...
func (e *fePointLight) OnScrollEnd(handler string) *fePointLight {
...
func (e *fePointLight) OnFormData(handler string) *fePointLight {
...
func (e *fePointLight) OnAnimationCancel(handler string) *fePointLight {
...
func (e *fePointLight) OnAnimationEnd(handler string) *fePointLight {
...
func (e *fePointLight) OnAnimationIteration(handler string) *fePointLight {
...
func (e *fePointLight) OnAnimationStart(handler string) *fePointLight {
...
func (e *fePointLight) OnTransitionCancel(handler string) *fePointLight {
...
func (e *fePointLight) OnTransitionEnd(handler string) *fePointLight {
...
func (e *fePointLight) OnTransitionRun(handler string) *fePointLight {
...
func (e *fePointLight) OnTransitionStart(handler string) *fePointLight {
...
func (e *fePointLight) OnBeforeToggle(handler string) *fePointLight {
...
func (e *fePointLight) OnBeforeInput(handler string) *fePointLight {
...
func (e *fePointLight) OnBeforeMatch(handler string) *fePointLight {
...
func (e *fePointLight) OnCommand(handler string) *fePointLight {
...
func (e *fePointLight) OnContextLost(handler string) *fePointLight {
...
func (e *fePointLight) OnContextRestored(handler string) *fePointLight {
...
func (e *fePointLight) OnSecurityPolicyViolation(handler string) *fePointLight {
...
func (e *fePointLight) OnSlotChange(handler string) *fePointLight {
...
func (e *fePointLight) OnPointerDown(handler string) *fePointLight {
...
func (e *fePointLight) OnPointerUp(handler string) *fePointLight {
...
func (e *fePointLight) OnPointerMove(handler string) *fePointLight {
...
func (e *fePointLight) OnPointerEnter(handler string) *fePointLight {
...
func (e *fePointLight) OnPointerLeave(handler string) *fePointLight {
...
func (e *fePointLight) OnPointerOver(handler string) *fePointLight {
...
// element for any of its descendants.
func (e *fePointLight) OnPointerOut(handler string) *fePointLight {
...
func (e *fePointLight) OnPointerCancel(handler string) *fePointLight {
...
func (e *fePointLight) OnGotPointerCapture(handler string) *fePointLight {
...
func (e *fePointLight) OnLostPointerCapture(handler string) *fePointLight {
...
func (e *fePointLight) OnTouchStart(handler string) *fePointLight {
...
func (e *fePointLight) OnTouchEnd(handler string) *fePointLight {
...
func (e *fePointLight) OnTouchMove(handler string) *fePointLight {
...
func (e *fePointLight) OnTouchCancel(handler string) *fePointLight {
...
func (e *fePointLight) OnSelectStart(handler string) *fePointLight {
...
func (e *fePointLight) OnSelectionChange(handler string) *fePointLight {
...
func (e *fePointLight) SetAttribute(key string, value string) {
...
func (e *fePointLight) SetAttributeRaw(key string, value string) {
	if e.attr == nil {
		e.attr = &[]node.Attribute{}
	}
	for i, attr := range *e.attr {
...
func (e *fePointLight) Add(children ...PrimitiveContent) *fePointLight {
...
func (e *fePointLight) Replace(children ...PrimitiveContent) *fePointLight {
...
func (e *fePointLight) Dynamic(key string) *fePointLight {
	e.dynamic = key
	return e
}

// IsDynamic reports whether this element has been marked for reactive tracking.
func (e *fePointLight) IsDynamic() bool {
	return e.dynamic != ""
}
...
func (e *fePointLight) DynamicKey() string {
	return e.dynamic
}
...
func (e *fePointLight) Memoise(version any) *fePointLight {
	e.memoise = version
	return e
}
...
// by fluent-jit.
func (e *fePointLight) MemoiseKey() any {
	return e.memoise
}
...
func (e *fePointLight) BufferHint(hint int) *fePointLight {
	if hint > 0 {
...
func (e *fePointLight) RenderedSize() int {
...
func (e *fePointLight) Render(w io.Writer) {
	_, _ = e.WriteTo(w)
}
...
func (e *fePointLight) WriteTo(w io.Writer) (int64, error) {
...
func (e *fePointLight) RenderBytes() []byte {
...
func (e *fePointLight) AttributeBuilder(buf *bytes.Buffer) {
	if e.x != "" {
		buf.Write(AttrX)
		buf.WriteString(e.x)
...
func (e *fePointLight) RenderBuilder(buf *bytes.Buffer) {
	buf.Write(TagFePointLight)
	...
	buf.Write(TagFePointLightClose)
}

// RenderOpen writes the opening tag and attributes to the buffer.
func (e *fePointLight) RenderOpen(buf *bytes.Buffer) {
	buf.Write(TagFePointLight)
	e.AttributeBuilder(buf)
	buf.Write(MarkupCloseTag)
}
...
// isSVGLightSource seals fePointLight as a LightSource.
func (*fePointLight) isSVGLightSource() {}
