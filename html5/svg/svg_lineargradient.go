...
func (e *linearGradient) event() *html5.EventAttributes {
	if e.ea == nil {
...
//
// A transform list applied to the gradient's coordinate system, for example "rotate(45)" to angle a
// gradient without changing its endpoints.
func (e *linearGradient) GradientTransform(value string) *linearGradient {
...
//
// How the gradient fills the area beyond its end points: pad with the end colours, reflect, or repeat.
func (e *linearGradient) SpreadMethod(value spreadmethod.SpreadMethod) *linearGradient {
...
// sets its own. Define the stops once and reuse them at different angles.
func (e *linearGradient) Href(value string) *linearGradient {
...
func (e *linearGradient) Lang(lang string) *linearGradient {
...
func (e *linearGradient) StrokeDashOffset(offset string) *linearGradient {
...
func (e *linearGradient) StrokeMiterLimit(limit string) *linearGradient {
...
// a clipPath.
func (e *linearGradient) ClipRule(rule cliprule.ClipRule) *linearGradient {
	e.svg().ClipRule = rule
	return e
}
...
func (e *linearGradient) ClipPath(clip string) *linearGradient {
...
// per pixel.
func (e *linearGradient) Mask(mask string) *linearGradient {
...
func (e *linearGradient) Filter(filter string) *linearGradient {
...
func (e *linearGradient) Color(color string) *linearGradient {
...
func (e *linearGradient) Cursor(cursor string) *linearGradient {
...
func (e *linearGradient) Display(display string) *linearGradient {
...
// drawn again.
func (e *linearGradient) Visibility(value visibility.Visibility) *linearGradient {
...
func (e *linearGradient) PointerEvents(events pointerevents.PointerEvents) *linearGradient {
...
func (e *linearGradient) FontFamily(family string) *linearGradient {
...
// is in user units.
func (e *linearGradient) FontSize(size string) *linearGradient {
...
// from 100 to 900.
func (e *linearGradient) FontWeight(weight string) *linearGradient {
...
func (e *linearGradient) FontStyle(style string) *linearGradient {
...
func (e *linearGradient) OnAbort(handler string) *linearGradient {
...
//
// Deprecated: Removed from the WHATWG living standard. Was in an older HTML5 draft.
func (e *linearGradient) OnAutoCompleteError(handler string) *linearGradient {
...
func (e *linearGradient) OnCancel(handler string) *linearGradient {
...
// results.
func (e *linearGradient) OnClose(handler string) *linearGradient {
...
func (e *linearGradient) OnContextMenu(handler string) *linearGradient {
...
// enable dropping.
func (e *linearGradient) OnDrop(handler string) *linearGradient {
...
func (e *linearGradient) OnDurationChange(handler string) *linearGradient {
...
// media content.
func (e *linearGradient) OnEmptied(handler string) *linearGradient {
...
func (e *linearGradient) OnEnded(handler string) *linearGradient {
...
func (e *linearGradient) OnInvalid(handler string) *linearGradient {
...
func (e *linearGradient) OnLoadedData(handler string) *linearGradient {
...
func (e *linearGradient) OnPause(handler string) *linearGradient {
...
func (e *linearGradient) OnPlay(handler string) *linearGradient {
...
func (e *linearGradient) OnProgress(handler string) *linearGradient {
...
func (e *linearGradient) OnReset(handler string) *linearGradient {
...
func (e *linearGradient) OnScroll(handler string) *linearGradient {
...
func (e *linearGradient) OnSeeked(handler string) *linearGradient {
...
func (e *linearGradient) OnSeeking(handler string) *linearGradient {
...
func (e *linearGradient) OnSelect(handler string) *linearGradient {
...
func (e *linearGradient) OnShow(handler string) *linearGradient {
...
func (e *linearGradient) OnSort(handler string) *linearGradient {
...
func (e *linearGradient) OnWaiting(handler string) *linearGradient {
...
func (e *linearGradient) OnAuxClick(handler string) *linearGradient {
...
func (e *linearGradient) OnWheel(handler string) *linearGradient {
...
func (e *linearGradient) OnScrollEnd(handler string) *linearGradient {
...
func (e *linearGradient) OnAnimationCancel(handler string) *linearGradient {
...
func (e *linearGradient) OnAnimationEnd(handler string) *linearGradient {
...
func (e *linearGradient) OnAnimationIteration(handler string) *linearGradient {
...
func (e *linearGradient) OnAnimationStart(handler string) *linearGradient {
...
func (e *linearGradient) OnTransitionCancel(handler string) *linearGradient {
...
func (e *linearGradient) OnTransitionEnd(handler string) *linearGradient {
...
func (e *linearGradient) OnTransitionRun(handler string) *linearGradient {
...
func (e *linearGradient) OnTransitionStart(handler string) *linearGradient {
...
func (e *linearGradient) OnCommand(handler string) *linearGradient {
...
func (e *linearGradient) OnSecurityPolicyViolation(handler string) *linearGradient {
...
func (e *linearGradient) OnPointerDown(handler string) *linearGradient {
...
func (e *linearGradient) OnPointerUp(handler string) *linearGradient {
...
func (e *linearGradient) OnPointerMove(handler string) *linearGradient {
...
func (e *linearGradient) OnPointerEnter(handler string) *linearGradient {
...
func (e *linearGradient) OnPointerLeave(handler string) *linearGradient {
...
func (e *linearGradient) OnPointerOver(handler string) *linearGradient {
...
// element for any of its descendants.
func (e *linearGradient) OnPointerOut(handler string) *linearGradient {
...
func (e *linearGradient) OnPointerCancel(handler string) *linearGradient {
...
func (e *linearGradient) OnTouchStart(handler string) *linearGradient {
...
func (e *linearGradient) OnTouchEnd(handler string) *linearGradient {
...
func (e *linearGradient) OnTouchMove(handler string) *linearGradient {
...
func (e *linearGradient) OnTouchCancel(handler string) *linearGradient {
...
func (e *linearGradient) OnSelectStart(handler string) *linearGradient {
...
func (e *linearGradient) OnSelectionChange(handler string) *linearGradient {
