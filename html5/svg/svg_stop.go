...
func (e *stop) event() *html5.EventAttributes {
	if e.ea == nil {
...
func Stop(children ...PrimitiveContent) *stop {
...
func (e *stop) TransformOrigin(origin string) *stop {
...
func (e *stop) Lang(lang string) *stop {
...
func (e *stop) AutoFocus(conds ...bool) *stop {
	if len(conds) > 0 {
...
// developer-controlled key. Never build the key from user input - a key containing a space, quote,
// "=", "/" or ">" changes the markup structure. The value is escaped. The key is not escaped.
func (e *stop) SetData(key string, value string) *stop {
...
func (e *stop) StrokeDashOffset(offset string) *stop {
...
func (e *stop) StrokeMiterLimit(limit string) *stop {
...
func (e *stop) FillRule(rule fillrule.FillRule) *stop {
	e.svg().FillRule = rule
	return e
}
...
// a clipPath.
func (e *stop) ClipRule(rule cliprule.ClipRule) *stop {
	e.svg().ClipRule = rule
	return e
}
...
func (e *stop) ClipPath(clip string) *stop {
...
// per pixel.
func (e *stop) Mask(mask string) *stop {
...
func (e *stop) Filter(filter string) *stop {
...
func (e *stop) Color(color string) *stop {
...
func (e *stop) Cursor(cursor string) *stop {
...
func (e *stop) Display(display string) *stop {
...
// drawn again.
func (e *stop) Visibility(value visibility.Visibility) *stop {
...
func (e *stop) PointerEvents(events pointerevents.PointerEvents) *stop {
...
func (e *stop) VectorEffect(effect vectoreffect.VectorEffect) *stop {
...
func (e *stop) ShapeRendering(rendering shaperendering.ShapeRendering) *stop {
...
func (e *stop) FontFamily(family string) *stop {
...
// is in user units.
func (e *stop) FontSize(size string) *stop {
...
// from 100 to 900.
func (e *stop) FontWeight(weight string) *stop {
...
func (e *stop) FontStyle(style string) *stop {
...
func (e *stop) OnChange(handler string) *stop {
...
func (e *stop) OnInput(handler string) *stop {
...
func (e *stop) OnSubmit(handler string) *stop {
...
func (e *stop) OnLoad(handler string) *stop {
...
func (e *stop) OnError(handler string) *stop {
...
// developer-controlled key. Never build the key from user input - a key containing a space, quote,
// "=", "/" or ">" changes the markup structure. The value is escaped. The key is not escaped.
func (e *stop) SetEvent(key string, value string) *stop {
...
func (e *stop) OnAbort(handler string) *stop {
...
func (e *stop) OnAutoComplete(handler string) *stop {
...
//
// Deprecated: Removed from the WHATWG living standard. Was in an older HTML5 draft.
func (e *stop) OnAutoCompleteError(handler string) *stop {
...
func (e *stop) OnCancel(handler string) *stop {
...
func (e *stop) OnCanPlay(handler string) *stop {
...
func (e *stop) OnCanPlayThrough(handler string) *stop {
...
// results.
func (e *stop) OnClose(handler string) *stop {
...
func (e *stop) OnContextMenu(handler string) *stop {
...
// timestamps.
func (e *stop) OnCueChange(handler string) *stop {
...
func (e *stop) OnDblClick(handler string) *stop {
...
func (e *stop) OnDrag(handler string) *stop {
...
func (e *stop) OnDragEnd(handler string) *stop {
...
func (e *stop) OnDragEnter(handler string) *stop {
...
func (e *stop) OnDragLeave(handler string) *stop {
...
func (e *stop) OnDragOver(handler string) *stop {
...
func (e *stop) OnDragStart(handler string) *stop {
...
// enable dropping.
func (e *stop) OnDrop(handler string) *stop {
...
func (e *stop) OnDurationChange(handler string) *stop {
...
// media content.
func (e *stop) OnEmptied(handler string) *stop {
...
func (e *stop) OnEnded(handler string) *stop {
...
func (e *stop) OnInvalid(handler string) *stop {
...
func (e *stop) OnKeyDown(handler string) *stop {
...
func (e *stop) OnKeyPress(handler string) *stop {
...
func (e *stop) OnKeyUp(handler string) *stop {
...
func (e *stop) OnLoadedData(handler string) *stop {
...
func (e *stop) OnLoadedMetadata(handler string) *stop {
...
func (e *stop) OnLoadStart(handler string) *stop {
...
func (e *stop) OnMouseEnter(handler string) *stop {
...
func (e *stop) OnMouseLeave(handler string) *stop {
...
func (e *stop) OnMouseWheel(handler string) *stop {
...
func (e *stop) OnPause(handler string) *stop {
...
func (e *stop) OnPlay(handler string) *stop {
...
func (e *stop) OnPlaying(handler string) *stop {
...
func (e *stop) OnProgress(handler string) *stop {
...
func (e *stop) OnRateChange(handler string) *stop {
...
func (e *stop) OnReset(handler string) *stop {
...
// ResizeObserver.
func (e *stop) OnResize(handler string) *stop {
...
func (e *stop) OnScroll(handler string) *stop {
...
func (e *stop) OnSeeked(handler string) *stop {
...
func (e *stop) OnSeeking(handler string) *stop {
...
func (e *stop) OnSelect(handler string) *stop {
...
func (e *stop) OnShow(handler string) *stop {
...
func (e *stop) OnSort(handler string) *stop {
...
func (e *stop) OnStalled(handler string) *stop {
...
func (e *stop) OnSuspend(handler string) *stop {
...
func (e *stop) OnTimeUpdate(handler string) *stop {
...
func (e *stop) OnToggle(handler string) *stop {
...
func (e *stop) OnVolumeChange(handler string) *stop {
...
func (e *stop) OnWaiting(handler string) *stop {
...
func (e *stop) OnAuxClick(handler string) *stop {
...
func (e *stop) OnWheel(handler string) *stop {
...
func (e *stop) OnCopy(handler string) *stop {
...
// content itself.
func (e *stop) OnCut(handler string) *stop {
...
func (e *stop) OnPaste(handler string) *stop {
...
func (e *stop) OnScrollEnd(handler string) *stop {
...
func (e *stop) OnFormData(handler string) *stop {
...
func (e *stop) OnAnimationCancel(handler string) *stop {
...
func (e *stop) OnAnimationEnd(handler string) *stop {
...
func (e *stop) OnAnimationIteration(handler string) *stop {
...
func (e *stop) OnAnimationStart(handler string) *stop {
...
func (e *stop) OnTransitionCancel(handler string) *stop {
...
func (e *stop) OnTransitionEnd(handler string) *stop {
...
func (e *stop) OnTransitionRun(handler string) *stop {
...
func (e *stop) OnTransitionStart(handler string) *stop {
...
func (e *stop) OnBeforeToggle(handler string) *stop {
...
func (e *stop) OnBeforeInput(handler string) *stop {
...
func (e *stop) OnBeforeMatch(handler string) *stop {
...
func (e *stop) OnCommand(handler string) *stop {
...
func (e *stop) OnContextLost(handler string) *stop {
...
func (e *stop) OnContextRestored(handler string) *stop {
...
func (e *stop) OnSecurityPolicyViolation(handler string) *stop {
...
func (e *stop) OnSlotChange(handler string) *stop {
...
func (e *stop) OnPointerDown(handler string) *stop {
...
func (e *stop) OnPointerUp(handler string) *stop {
...
func (e *stop) OnPointerMove(handler string) *stop {
...
func (e *stop) OnPointerEnter(handler string) *stop {
...
func (e *stop) OnPointerLeave(handler string) *stop {
...
func (e *stop) OnPointerOver(handler string) *stop {
...
// element for any of its descendants.
func (e *stop) OnPointerOut(handler string) *stop {
...
func (e *stop) OnPointerCancel(handler string) *stop {
...
func (e *stop) OnGotPointerCapture(handler string) *stop {
...
func (e *stop) OnLostPointerCapture(handler string) *stop {
...
func (e *stop) OnTouchStart(handler string) *stop {
...
func (e *stop) OnTouchEnd(handler string) *stop {
...
func (e *stop) OnTouchMove(handler string) *stop {
...
func (e *stop) OnTouchCancel(handler string) *stop {
...
func (e *stop) OnSelectStart(handler string) *stop {
...
func (e *stop) OnSelectionChange(handler string) *stop {
...
func (e *stop) Add(children ...PrimitiveContent) *stop {
...
func (e *stop) Replace(children ...PrimitiveContent) *stop {
...
// isSVGShape seals stop as a Shape.
