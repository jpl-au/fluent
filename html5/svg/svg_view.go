...
// view represents the <view> SVG element.
type view struct {
...
func (e *view) event() *html5.EventAttributes {
	if e.ea == nil {
...
// View defines a named view of the drawing. Linking to it by fragment, as
// "drawing.svg#name", opens the document framed by this view's viewBox rather
// than the root's, so one file can offer several framings of the same artwork.
func View(children ...Descriptive) *view {
...
//
// The region of the drawing this view frames, as "min-x min-y width height".
func (e *view) ViewBox(value string) *view {
...
//
// How the viewBox is fitted to the viewport when their aspect ratios differ.
func (e *view) PreserveAspectRatio(value string) *view {
	e.preserveAspectRatio = node.EscapeAttribute(value)
	return e
}

// ID sets the id attribute.
func (e *view) ID(id string) *view {
	e.svg().ID = node.EscapeAttribute(id)
	return e
}

// Class appends to the space-separated class attribute.
func (e *view) Class(class string) *view {
...
func (e *view) Style(css string) *view {
	e.svg().Style = node.EscapeAttribute(css)
	return e
}

// Transform sets the transform attribute.
func (e *view) Transform(transform string) *view {
...
func (e *view) Lang(lang string) *view {
...
func (e *view) AutoFocus(conds ...bool) *view {
	if len(conds) > 0 {
...
func (e *view) SetAria(key string, value string) *view {
...
func (e *view) StrokeDashOffset(offset string) *view {
...
func (e *view) StrokeMiterLimit(limit string) *view {
...
func (e *view) FillRule(rule fillrule.FillRule) *view {
	e.svg().FillRule = rule
	return e
}
...
// a clipPath.
func (e *view) ClipRule(rule cliprule.ClipRule) *view {
	e.svg().ClipRule = rule
	return e
}
...
func (e *view) ClipPath(clip string) *view {
...
// per pixel.
func (e *view) Mask(mask string) *view {
...
func (e *view) Filter(filter string) *view {
...
func (e *view) Color(color string) *view {
...
func (e *view) Cursor(cursor string) *view {
...
func (e *view) Display(display string) *view {
...
// drawn again.
func (e *view) Visibility(value visibility.Visibility) *view {
...
func (e *view) PointerEvents(events pointerevents.PointerEvents) *view {
...
func (e *view) VectorEffect(effect vectoreffect.VectorEffect) *view {
...
func (e *view) ShapeRendering(rendering shaperendering.ShapeRendering) *view {
...
func (e *view) FontFamily(family string) *view {
...
// is in user units.
func (e *view) FontSize(size string) *view {
...
// from 100 to 900.
func (e *view) FontWeight(weight string) *view {
...
func (e *view) FontStyle(style string) *view {
...
func (e *view) OnClick(handler string) *view {
...
func (e *view) OnChange(handler string) *view {
...
func (e *view) OnInput(handler string) *view {
...
func (e *view) OnFocus(handler string) *view {
...
func (e *view) OnBlur(handler string) *view {
...
func (e *view) OnSubmit(handler string) *view {
...
func (e *view) OnLoad(handler string) *view {
...
func (e *view) OnError(handler string) *view {
...
// developer-controlled key. Never build the key from user input - a key containing a space, quote,
// "=", "/" or ">" changes the markup structure. The value is escaped. The key is not escaped.
func (e *view) SetEvent(key string, value string) *view {
...
func (e *view) OnAbort(handler string) *view {
...
func (e *view) OnAutoComplete(handler string) *view {
...
//
// Deprecated: Removed from the WHATWG living standard. Was in an older HTML5 draft.
func (e *view) OnAutoCompleteError(handler string) *view {
...
func (e *view) OnCancel(handler string) *view {
...
func (e *view) OnCanPlay(handler string) *view {
...
func (e *view) OnCanPlayThrough(handler string) *view {
...
// results.
func (e *view) OnClose(handler string) *view {
...
func (e *view) OnContextMenu(handler string) *view {
...
// timestamps.
func (e *view) OnCueChange(handler string) *view {
...
func (e *view) OnDblClick(handler string) *view {
...
func (e *view) OnDrag(handler string) *view {
...
func (e *view) OnDragEnd(handler string) *view {
...
func (e *view) OnDragEnter(handler string) *view {
...
func (e *view) OnDragLeave(handler string) *view {
...
func (e *view) OnDragOver(handler string) *view {
...
func (e *view) OnDragStart(handler string) *view {
...
// enable dropping.
func (e *view) OnDrop(handler string) *view {
...
func (e *view) OnDurationChange(handler string) *view {
...
// media content.
func (e *view) OnEmptied(handler string) *view {
...
func (e *view) OnEnded(handler string) *view {
...
func (e *view) OnInvalid(handler string) *view {
...
func (e *view) OnKeyDown(handler string) *view {
...
func (e *view) OnKeyPress(handler string) *view {
...
func (e *view) OnKeyUp(handler string) *view {
...
func (e *view) OnLoadedData(handler string) *view {
...
func (e *view) OnLoadedMetadata(handler string) *view {
...
func (e *view) OnLoadStart(handler string) *view {
...
func (e *view) OnMouseDown(handler string) *view {
...
func (e *view) OnMouseEnter(handler string) *view {
...
func (e *view) OnMouseLeave(handler string) *view {
...
func (e *view) OnMouseMove(handler string) *view {
...
func (e *view) OnMouseOut(handler string) *view {
...
func (e *view) OnMouseOver(handler string) *view {
...
func (e *view) OnMouseUp(handler string) *view {
...
func (e *view) OnMouseWheel(handler string) *view {
...
func (e *view) OnPause(handler string) *view {
...
func (e *view) OnPlay(handler string) *view {
...
func (e *view) OnPlaying(handler string) *view {
...
func (e *view) OnProgress(handler string) *view {
...
func (e *view) OnRateChange(handler string) *view {
...
func (e *view) OnReset(handler string) *view {
...
// ResizeObserver.
func (e *view) OnResize(handler string) *view {
...
func (e *view) OnScroll(handler string) *view {
...
func (e *view) OnSeeked(handler string) *view {
...
func (e *view) OnSeeking(handler string) *view {
...
func (e *view) OnSelect(handler string) *view {
...
func (e *view) OnShow(handler string) *view {
...
func (e *view) OnSort(handler string) *view {
...
func (e *view) OnStalled(handler string) *view {
...
func (e *view) OnSuspend(handler string) *view {
...
func (e *view) OnTimeUpdate(handler string) *view {
...
func (e *view) OnToggle(handler string) *view {
...
func (e *view) OnVolumeChange(handler string) *view {
...
func (e *view) OnWaiting(handler string) *view {
...
func (e *view) OnAuxClick(handler string) *view {
...
func (e *view) OnWheel(handler string) *view {
...
func (e *view) OnCopy(handler string) *view {
...
// content itself.
func (e *view) OnCut(handler string) *view {
...
func (e *view) OnPaste(handler string) *view {
...
func (e *view) OnScrollEnd(handler string) *view {
...
func (e *view) OnFormData(handler string) *view {
...
func (e *view) OnAnimationCancel(handler string) *view {
...
func (e *view) OnAnimationEnd(handler string) *view {
...
func (e *view) OnAnimationIteration(handler string) *view {
...
func (e *view) OnAnimationStart(handler string) *view {
...
func (e *view) OnTransitionCancel(handler string) *view {
...
func (e *view) OnTransitionEnd(handler string) *view {
...
func (e *view) OnTransitionRun(handler string) *view {
...
func (e *view) OnTransitionStart(handler string) *view {
...
func (e *view) OnBeforeToggle(handler string) *view {
...
func (e *view) OnBeforeInput(handler string) *view {
...
func (e *view) OnBeforeMatch(handler string) *view {
...
func (e *view) OnCommand(handler string) *view {
...
func (e *view) OnContextLost(handler string) *view {
...
func (e *view) OnContextRestored(handler string) *view {
...
func (e *view) OnSecurityPolicyViolation(handler string) *view {
...
func (e *view) OnSlotChange(handler string) *view {
...
func (e *view) OnPointerDown(handler string) *view {
...
func (e *view) OnPointerUp(handler string) *view {
...
func (e *view) OnPointerMove(handler string) *view {
...
func (e *view) OnPointerEnter(handler string) *view {
...
func (e *view) OnPointerLeave(handler string) *view {
...
func (e *view) OnPointerOver(handler string) *view {
...
// element for any of its descendants.
func (e *view) OnPointerOut(handler string) *view {
...
func (e *view) OnPointerCancel(handler string) *view {
...
func (e *view) OnGotPointerCapture(handler string) *view {
...
func (e *view) OnLostPointerCapture(handler string) *view {
...
func (e *view) OnTouchStart(handler string) *view {
...
func (e *view) OnTouchEnd(handler string) *view {
...
func (e *view) OnTouchMove(handler string) *view {
...
func (e *view) OnTouchCancel(handler string) *view {
...
func (e *view) OnSelectStart(handler string) *view {
...
func (e *view) OnSelectionChange(handler string) *view {
...
func (e *view) SetAttribute(key string, value string) {
...
func (e *view) SetAttributeRaw(key string, value string) {
	if e.attr == nil {
		e.attr = &[]node.Attribute{}
	}
	for i, attr := range *e.attr {
...
func (e *view) Add(children ...Descriptive) *view {
...
func (e *view) Replace(children ...Descriptive) *view {
...
func (e *view) Memoise(version any) *view {
	e.memoise = version
	return e
}
...
func (e *view) BufferHint(hint int) *view {
	if hint > 0 {
...
func (e *view) Render(w io.Writer) {
	_, _ = e.WriteTo(w)
}
...
func (e *view) WriteTo(w io.Writer) (int64, error) {
...
func (e *view) AttributeBuilder(buf *bytes.Buffer) {
	if e.viewBox != "" {
...
func (e *view) RenderBuilder(buf *bytes.Buffer) {
	buf.Write(TagView)
...
// isSVGShape seals view as a Shape.
func (*view) isSVGShape() {}
