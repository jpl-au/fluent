...
// Width Specifies the displayed width of the SVG viewport. Can be in pixels, percentages, or other CSS units.
...
// Height Specifies the displayed height of the SVG viewport. Can be in pixels, percentages, or other CSS units.
...
// ViewBox Defines the internal coordinate system using four space-separated numbers: 'min-x min-y width height'.
...
// PreserveAspectRatio Controls how the SVG content scales when the viewBox aspect ratio differs from the viewport.
...
// Xmlns Specifies the XML namespace for SVG elements, typically 'http://www.w3.org/2000/svg'. Required for
