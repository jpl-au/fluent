...
// pattern represents the <pattern> SVG element.
type pattern struct {
	bufferhint          atomic.Int64
	nodes               []node.Node
	patternContentUnits units.Units
	patternUnits        units.Units
	dynamic             string
	height              string
	href                string
	memoise             any
...
func (e *pattern) event() *html5.EventAttributes {
	if e.ea == nil {
...
// Pattern defines a tile that is repeated to fill a shape. Reference it from
// Fill or Stroke as "url(#id)". It is a paint server, like a gradient, and is
// not drawn where it is defined.
func Pattern(children ...Shape) *pattern {
...
func (e *pattern) X(value string) *pattern {
	e.x = node.EscapeAttribute(value)
	return e
}

// Y sets the y attribute.
func (e *pattern) Y(value string) *pattern {
	e.y = node.EscapeAttribute(value)
	return e
}

// Width sets the width attribute.
func (e *pattern) Width(value string) *pattern {
	e.width = node.EscapeAttribute(value)
	return e
}

// Height sets the height attribute.
func (e *pattern) Height(value string) *pattern {
...
//
// The coordinate system of x, y, width and height, which is the size and position of one tile: the user
// space in place where the pattern is referenced, or fractions of the bounding box of the filled element,
// which is the default.
func (e *pattern) PatternUnits(value units.Units) *pattern {
	e.patternUnits = value
	return e
}

// PatternContentUnits sets the patternContentUnits attribute.
//
// The coordinate system of the pattern's own children, which is separate from the system the tile is
// measured in. It defaults to the user space in place where the pattern is referenced.
func (e *pattern) PatternContentUnits(value units.Units) *pattern {
	e.patternContentUnits = value
	return e
}

// PatternTransform sets the patternTransform attribute.
//
// A transform list applied to the whole pattern, for example "rotate(45)" to angle the tiling without
// changing the tile itself.
func (e *pattern) PatternTransform(value string) *pattern {
	e.patternTransform = node.EscapeAttribute(value)
	return e
}

// ViewBox sets the viewBox attribute.
//
// The user coordinate system of the tile's contents, as "min-x min-y width height", so the tile scales
// to the size given by width and height.
func (e *pattern) ViewBox(value string) *pattern {
...
//
// How the viewBox is fitted to the tile when their aspect ratios differ.
func (e *pattern) PreserveAspectRatio(value string) *pattern {
...
//
// A reference to another pattern, as "#id", whose attributes and children this pattern inherits unless
// it sets its own.
func (e *pattern) Href(value string) *pattern {
	e.href = node.EscapeAttribute(value)
	return e
}

// ID sets the id attribute.
func (e *pattern) ID(id string) *pattern {
	e.svg().ID = node.EscapeAttribute(id)
	return e
}

// Class appends to the space-separated class attribute.
func (e *pattern) Class(class string) *pattern {
...
func (e *pattern) Style(css string) *pattern {
	e.svg().Style = node.EscapeAttribute(css)
	return e
}

// Transform sets the transform attribute.
func (e *pattern) Transform(transform string) *pattern {
...
func (e *pattern) TransformOrigin(origin string) *pattern {
	e.svg().TransformOrigin = node.EscapeAttribute(origin)
	return e
}

// TabIndex sets the tabindex attribute.
func (e *pattern) TabIndex(index string) *pattern {
	e.svg().TabIndex = node.EscapeAttribute(index)
	return e
}

// Role sets the role attribute.
func (e *pattern) Role(role string) *pattern {
...
func (e *pattern) Lang(lang string) *pattern {
...
func (e *pattern) AutoFocus(conds ...bool) *pattern {
	if len(conds) > 0 {
...
func (e *pattern) SetAria(key string, value string) *pattern {
...
func (e *pattern) StrokeDashOffset(offset string) *pattern {
...
func (e *pattern) StrokeMiterLimit(limit string) *pattern {
...
func (e *pattern) FillRule(rule fillrule.FillRule) *pattern {
	e.svg().FillRule = rule
	return e
}
...
// a clipPath.
func (e *pattern) ClipRule(rule cliprule.ClipRule) *pattern {
	e.svg().ClipRule = rule
	return e
}
...
func (e *pattern) ClipPath(clip string) *pattern {
...
// per pixel.
func (e *pattern) Mask(mask string) *pattern {
...
func (e *pattern) Filter(filter string) *pattern {
...
func (e *pattern) Color(color string) *pattern {
...
func (e *pattern) Cursor(cursor string) *pattern {
...
func (e *pattern) Display(display string) *pattern {
...
// drawn again.
func (e *pattern) Visibility(value visibility.Visibility) *pattern {
...
func (e *pattern) PointerEvents(events pointerevents.PointerEvents) *pattern {
...
func (e *pattern) VectorEffect(effect vectoreffect.VectorEffect) *pattern {
...
func (e *pattern) ShapeRendering(rendering shaperendering.ShapeRendering) *pattern {
...
func (e *pattern) FontFamily(family string) *pattern {
...
// is in user units.
func (e *pattern) FontSize(size string) *pattern {
...
// from 100 to 900.
func (e *pattern) FontWeight(weight string) *pattern {
...
func (e *pattern) FontStyle(style string) *pattern {
...
func (e *pattern) OnClick(handler string) *pattern {
...
func (e *pattern) OnChange(handler string) *pattern {
...
func (e *pattern) OnInput(handler string) *pattern {
...
func (e *pattern) OnFocus(handler string) *pattern {
...
func (e *pattern) OnBlur(handler string) *pattern {
...
func (e *pattern) OnSubmit(handler string) *pattern {
...
func (e *pattern) OnLoad(handler string) *pattern {
...
func (e *pattern) OnError(handler string) *pattern {
...
// developer-controlled key. Never build the key from user input - a key containing a space, quote,
// "=", "/" or ">" changes the markup structure. The value is escaped. The key is not escaped.
func (e *pattern) SetEvent(key string, value string) *pattern {
...
func (e *pattern) OnAbort(handler string) *pattern {
...
func (e *pattern) OnAutoComplete(handler string) *pattern {
...
//
// Deprecated: Removed from the WHATWG living standard. Was in an older HTML5 draft.
func (e *pattern) OnAutoCompleteError(handler string) *pattern {
...
func (e *pattern) OnCancel(handler string) *pattern {
...
func (e *pattern) OnCanPlay(handler string) *pattern {
...
func (e *pattern) OnCanPlayThrough(handler string) *pattern {
...
// results.
func (e *pattern) OnClose(handler string) *pattern {
...
func (e *pattern) OnContextMenu(handler string) *pattern {
...
// timestamps.
func (e *pattern) OnCueChange(handler string) *pattern {
...
func (e *pattern) OnDblClick(handler string) *pattern {
...
func (e *pattern) OnDrag(handler string) *pattern {
...
func (e *pattern) OnDragEnd(handler string) *pattern {
...
func (e *pattern) OnDragEnter(handler string) *pattern {
...
func (e *pattern) OnDragLeave(handler string) *pattern {
...
func (e *pattern) OnDragOver(handler string) *pattern {
...
func (e *pattern) OnDragStart(handler string) *pattern {
...
// enable dropping.
func (e *pattern) OnDrop(handler string) *pattern {
...
func (e *pattern) OnDurationChange(handler string) *pattern {
...
// media content.
func (e *pattern) OnEmptied(handler string) *pattern {
...
func (e *pattern) OnEnded(handler string) *pattern {
...
func (e *pattern) OnInvalid(handler string) *pattern {
...
func (e *pattern) OnKeyDown(handler string) *pattern {
...
func (e *pattern) OnKeyPress(handler string) *pattern {
...
func (e *pattern) OnKeyUp(handler string) *pattern {
...
func (e *pattern) OnLoadedData(handler string) *pattern {
...
func (e *pattern) OnLoadedMetadata(handler string) *pattern {
...
func (e *pattern) OnLoadStart(handler string) *pattern {
...
func (e *pattern) OnMouseDown(handler string) *pattern {
...
func (e *pattern) OnMouseEnter(handler string) *pattern {
...
func (e *pattern) OnMouseLeave(handler string) *pattern {
...
func (e *pattern) OnMouseMove(handler string) *pattern {
...
func (e *pattern) OnMouseOut(handler string) *pattern {
...
func (e *pattern) OnMouseOver(handler string) *pattern {
...
func (e *pattern) OnMouseUp(handler string) *pattern {
...
func (e *pattern) OnMouseWheel(handler string) *pattern {
...
func (e *pattern) OnPause(handler string) *pattern {
...
func (e *pattern) OnPlay(handler string) *pattern {
...
func (e *pattern) OnPlaying(handler string) *pattern {
...
func (e *pattern) OnProgress(handler string) *pattern {
...
func (e *pattern) OnRateChange(handler string) *pattern {
...
func (e *pattern) OnReset(handler string) *pattern {
...
// ResizeObserver.
func (e *pattern) OnResize(handler string) *pattern {
...
func (e *pattern) OnScroll(handler string) *pattern {
...
func (e *pattern) OnSeeked(handler string) *pattern {
...
func (e *pattern) OnSeeking(handler string) *pattern {
...
func (e *pattern) OnSelect(handler string) *pattern {
...
func (e *pattern) OnShow(handler string) *pattern {
...
func (e *pattern) OnSort(handler string) *pattern {
...
func (e *pattern) OnStalled(handler string) *pattern {
...
func (e *pattern) OnSuspend(handler string) *pattern {
...
func (e *pattern) OnTimeUpdate(handler string) *pattern {
...
func (e *pattern) OnToggle(handler string) *pattern {
...
func (e *pattern) OnVolumeChange(handler string) *pattern {
...
func (e *pattern) OnWaiting(handler string) *pattern {
...
func (e *pattern) OnAuxClick(handler string) *pattern {
...
func (e *pattern) OnWheel(handler string) *pattern {
...
func (e *pattern) OnCopy(handler string) *pattern {
...
// content itself.
func (e *pattern) OnCut(handler string) *pattern {
...
func (e *pattern) OnPaste(handler string) *pattern {
...
func (e *pattern) OnScrollEnd(handler string) *pattern {
...
func (e *pattern) OnFormData(handler string) *pattern {
...
func (e *pattern) OnAnimationCancel(handler string) *pattern {
...
func (e *pattern) OnAnimationEnd(handler string) *pattern {
...
func (e *pattern) OnAnimationIteration(handler string) *pattern {
...
func (e *pattern) OnAnimationStart(handler string) *pattern {
...
func (e *pattern) OnTransitionCancel(handler string) *pattern {
...
func (e *pattern) OnTransitionEnd(handler string) *pattern {
...
func (e *pattern) OnTransitionRun(handler string) *pattern {
...
func (e *pattern) OnTransitionStart(handler string) *pattern {
...
func (e *pattern) OnBeforeToggle(handler string) *pattern {
...
func (e *pattern) OnBeforeInput(handler string) *pattern {
...
func (e *pattern) OnBeforeMatch(handler string) *pattern {
...
func (e *pattern) OnCommand(handler string) *pattern {
...
func (e *pattern) OnContextLost(handler string) *pattern {
...
func (e *pattern) OnContextRestored(handler string) *pattern {
...
func (e *pattern) OnSecurityPolicyViolation(handler string) *pattern {
...
func (e *pattern) OnSlotChange(handler string) *pattern {
...
func (e *pattern) OnPointerDown(handler string) *pattern {
...
func (e *pattern) OnPointerUp(handler string) *pattern {
...
func (e *pattern) OnPointerMove(handler string) *pattern {
...
func (e *pattern) OnPointerEnter(handler string) *pattern {
...
func (e *pattern) OnPointerLeave(handler string) *pattern {
...
func (e *pattern) OnPointerOver(handler string) *pattern {
...
// element for any of its descendants.
func (e *pattern) OnPointerOut(handler string) *pattern {
...
func (e *pattern) OnPointerCancel(handler string) *pattern {
...
func (e *pattern) OnGotPointerCapture(handler string) *pattern {
...
func (e *pattern) OnLostPointerCapture(handler string) *pattern {
...
func (e *pattern) OnTouchStart(handler string) *pattern {
...
func (e *pattern) OnTouchEnd(handler string) *pattern {
...
func (e *pattern) OnTouchMove(handler string) *pattern {
...
func (e *pattern) OnTouchCancel(handler string) *pattern {
...
func (e *pattern) OnSelectStart(handler string) *pattern {
...
func (e *pattern) OnSelectionChange(handler string) *pattern {
...
func (e *pattern) SetAttribute(key string, value string) {
...
func (e *pattern) SetAttributeRaw(key string, value string) {
	if e.attr == nil {
		e.attr = &[]node.Attribute{}
	}
	for i, attr := range *e.attr {
...
func (e *pattern) Add(children ...Shape) *pattern {
...
func (e *pattern) Replace(children ...Shape) *pattern {
...
func (e *pattern) DynamicKey() string {
	return e.dynamic
}
...
func (e *pattern) Memoise(version any) *pattern {
	e.memoise = version
	return e
}
...
func (e *pattern) BufferHint(hint int) *pattern {
	if hint > 0 {
...
func (e *pattern) RenderedSize() int {
...
func (e *pattern) Render(w io.Writer) {
	_, _ = e.WriteTo(w)
}
...
func (e *pattern) WriteTo(w io.Writer) (int64, error) {
...
func (e *pattern) RenderBytes() []byte {
...
func (e *pattern) AttributeBuilder(buf *bytes.Buffer) {
	if e.x != "" {
		buf.Write(AttrX)
		buf.WriteString(e.x)
	...
	if len(e.patternUnits) > 0 {
		buf.Write(AttrPatternUnits)
		buf.Write(e.patternUnits)
		buf.Write(MarkupQuote)
	}
	if len(e.patternContentUnits) > 0 {
		buf.Write(AttrPatternContentUnits)
		buf.Write(e.patternContentUnits)
		buf.Write(MarkupQuote)
	}
	if e.patternTransform != "" {
		buf.Write(AttrPatternTransform)
		buf.WriteString(e.patternTransform)
		buf.Write(MarkupQuote)
	}
	if e.viewBox != "" {
...
func (e *pattern) RenderBuilder(buf *bytes.Buffer) {
	buf.Write(TagPattern)
	...
	buf.Write(TagPatternClose)
}

// RenderOpen writes the opening tag and attributes to the buffer.
func (e *pattern) RenderOpen(buf *bytes.Buffer) {
	buf.Write(TagPattern)
	e.AttributeBuilder(buf)
	buf.Write(MarkupCloseTag)
}
...
// isSVGShape seals pattern as a Shape.
func (*pattern) isSVGShape() {}

// isSVGShapeContent seals pattern as a ShapeContent.
func (*pattern) isSVGShapeContent() {}
