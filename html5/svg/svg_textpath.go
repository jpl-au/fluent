...
// textPath represents the <textPath> SVG element.
...
func (e *textPath) event() *html5.EventAttributes {
	if e.ea == nil {
...
// TextPath lays text along a path referenced by href. Place it inside a Text
// element. The startOffset attribute controls where the text begins along the path.
// Keep the referenced path in Defs to position the text without drawing the path.
// The string content is HTML-escaped.
func TextPath(s string) *textPath {
	return &textPath{
...
//
// A reference to the path the text follows, as "#id". The path itself is only drawn if it is also placed
// in the drawing. One in defs positions the text without being seen.
func (e *textPath) Href(value string) *textPath {
...
//
// How far along the path the text begins, as a length or a percentage of the path's length.
func (e *textPath) StartOffset(value string) *textPath {
	e.startOffset = node.EscapeAttribute(value)
	return e
}

// Method sets the method attribute.
//
// Whether glyphs are rotated onto the path, "align", the default, or stretched to follow it, "stretch".
func (e *textPath) Method(value string) *textPath {
	e.method = node.EscapeAttribute(value)
	return e
}

// Spacing sets the spacing attribute.
//
// Whether the renderer adjusts spacing to keep the text even on curves, "auto", or uses the exact
// advances, "exact".
func (e *textPath) Spacing(value string) *textPath {
	e.spacing = node.EscapeAttribute(value)
	return e
}

// Side sets the side attribute.
//
// Which side of the path the text is placed on, "left", the default, or "right", which flips text to the
// inside of a curve.
func (e *textPath) Side(value string) *textPath {
	e.side = node.EscapeAttribute(value)
	return e
}

// TextLength sets the textLength attribute.
//
// The length the rendered text must occupy along the path.
func (e *textPath) TextLength(value string) *textPath {
...
//
// Whether textLength is reached by changing only the spacing between glyphs or by stretching the glyphs.
func (e *textPath) LengthAdjust(value lengthadjust.LengthAdjust) *textPath {
	e.lengthAdjust = value
	return e
}

// ID sets the id attribute.
func (e *textPath) ID(id string) *textPath {
	e.svg().ID = node.EscapeAttribute(id)
	return e
}

// Class appends to the space-separated class attribute.
func (e *textPath) Class(class string) *textPath {
...
func (e *textPath) Style(css string) *textPath {
	e.svg().Style = node.EscapeAttribute(css)
	return e
}

// Transform sets the transform attribute.
func (e *textPath) Transform(transform string) *textPath {
...
func (e *textPath) TransformOrigin(origin string) *textPath {
	e.svg().TransformOrigin = node.EscapeAttribute(origin)
	return e
}

// TabIndex sets the tabindex attribute.
func (e *textPath) TabIndex(index string) *textPath {
	e.svg().TabIndex = node.EscapeAttribute(index)
	return e
}

// Role sets the role attribute.
func (e *textPath) Role(role string) *textPath {
...
func (e *textPath) Lang(lang string) *textPath {
...
func (e *textPath) AutoFocus(conds ...bool) *textPath {
	if len(conds) > 0 {
...
func (e *textPath) SetAria(key string, value string) *textPath {
...
func (e *textPath) StrokeDashOffset(offset string) *textPath {
...
func (e *textPath) StrokeMiterLimit(limit string) *textPath {
...
func (e *textPath) FillRule(rule fillrule.FillRule) *textPath {
	e.svg().FillRule = rule
	return e
}
...
// a clipPath.
func (e *textPath) ClipRule(rule cliprule.ClipRule) *textPath {
	e.svg().ClipRule = rule
	return e
}
...
func (e *textPath) ClipPath(clip string) *textPath {
...
// per pixel.
func (e *textPath) Mask(mask string) *textPath {
...
func (e *textPath) Filter(filter string) *textPath {
...
func (e *textPath) Color(color string) *textPath {
...
func (e *textPath) Cursor(cursor string) *textPath {
...
func (e *textPath) Display(display string) *textPath {
...
// drawn again.
func (e *textPath) Visibility(value visibility.Visibility) *textPath {
...
func (e *textPath) PointerEvents(events pointerevents.PointerEvents) *textPath {
...
func (e *textPath) VectorEffect(effect vectoreffect.VectorEffect) *textPath {
...
func (e *textPath) ShapeRendering(rendering shaperendering.ShapeRendering) *textPath {
...
func (e *textPath) FontFamily(family string) *textPath {
...
// is in user units.
func (e *textPath) FontSize(size string) *textPath {
...
// from 100 to 900.
func (e *textPath) FontWeight(weight string) *textPath {
...
func (e *textPath) FontStyle(style string) *textPath {
...
func (e *textPath) OnClick(handler string) *textPath {
...
func (e *textPath) OnChange(handler string) *textPath {
...
func (e *textPath) OnInput(handler string) *textPath {
...
func (e *textPath) OnFocus(handler string) *textPath {
...
func (e *textPath) OnBlur(handler string) *textPath {
...
func (e *textPath) OnSubmit(handler string) *textPath {
...
func (e *textPath) OnLoad(handler string) *textPath {
...
func (e *textPath) OnError(handler string) *textPath {
...
// developer-controlled key. Never build the key from user input - a key containing a space, quote,
// "=", "/" or ">" changes the markup structure. The value is escaped. The key is not escaped.
func (e *textPath) SetEvent(key string, value string) *textPath {
...
func (e *textPath) OnAbort(handler string) *textPath {
...
func (e *textPath) OnAutoComplete(handler string) *textPath {
...
//
// Deprecated: Removed from the WHATWG living standard. Was in an older HTML5 draft.
func (e *textPath) OnAutoCompleteError(handler string) *textPath {
...
func (e *textPath) OnCancel(handler string) *textPath {
...
func (e *textPath) OnCanPlay(handler string) *textPath {
...
func (e *textPath) OnCanPlayThrough(handler string) *textPath {
...
// results.
func (e *textPath) OnClose(handler string) *textPath {
...
func (e *textPath) OnContextMenu(handler string) *textPath {
...
// timestamps.
func (e *textPath) OnCueChange(handler string) *textPath {
...
func (e *textPath) OnDblClick(handler string) *textPath {
...
func (e *textPath) OnDrag(handler string) *textPath {
...
func (e *textPath) OnDragEnd(handler string) *textPath {
...
func (e *textPath) OnDragEnter(handler string) *textPath {
...
func (e *textPath) OnDragLeave(handler string) *textPath {
...
func (e *textPath) OnDragOver(handler string) *textPath {
...
func (e *textPath) OnDragStart(handler string) *textPath {
...
// enable dropping.
func (e *textPath) OnDrop(handler string) *textPath {
...
func (e *textPath) OnDurationChange(handler string) *textPath {
...
// media content.
func (e *textPath) OnEmptied(handler string) *textPath {
...
func (e *textPath) OnEnded(handler string) *textPath {
...
func (e *textPath) OnInvalid(handler string) *textPath {
...
func (e *textPath) OnKeyDown(handler string) *textPath {
...
func (e *textPath) OnKeyPress(handler string) *textPath {
...
func (e *textPath) OnKeyUp(handler string) *textPath {
...
func (e *textPath) OnLoadedData(handler string) *textPath {
...
func (e *textPath) OnLoadedMetadata(handler string) *textPath {
...
func (e *textPath) OnLoadStart(handler string) *textPath {
...
func (e *textPath) OnMouseDown(handler string) *textPath {
...
func (e *textPath) OnMouseEnter(handler string) *textPath {
...
func (e *textPath) OnMouseLeave(handler string) *textPath {
...
func (e *textPath) OnMouseMove(handler string) *textPath {
...
func (e *textPath) OnMouseOut(handler string) *textPath {
...
func (e *textPath) OnMouseOver(handler string) *textPath {
...
func (e *textPath) OnMouseUp(handler string) *textPath {
...
func (e *textPath) OnMouseWheel(handler string) *textPath {
...
func (e *textPath) OnPause(handler string) *textPath {
...
func (e *textPath) OnPlay(handler string) *textPath {
...
func (e *textPath) OnPlaying(handler string) *textPath {
...
func (e *textPath) OnProgress(handler string) *textPath {
...
func (e *textPath) OnRateChange(handler string) *textPath {
...
func (e *textPath) OnReset(handler string) *textPath {
...
// ResizeObserver.
func (e *textPath) OnResize(handler string) *textPath {
...
func (e *textPath) OnScroll(handler string) *textPath {
...
func (e *textPath) OnSeeked(handler string) *textPath {
...
func (e *textPath) OnSeeking(handler string) *textPath {
...
func (e *textPath) OnSelect(handler string) *textPath {
...
func (e *textPath) OnShow(handler string) *textPath {
...
func (e *textPath) OnSort(handler string) *textPath {
...
func (e *textPath) OnStalled(handler string) *textPath {
...
func (e *textPath) OnSuspend(handler string) *textPath {
...
func (e *textPath) OnTimeUpdate(handler string) *textPath {
...
func (e *textPath) OnToggle(handler string) *textPath {
...
func (e *textPath) OnVolumeChange(handler string) *textPath {
...
func (e *textPath) OnWaiting(handler string) *textPath {
...
func (e *textPath) OnAuxClick(handler string) *textPath {
...
func (e *textPath) OnWheel(handler string) *textPath {
...
func (e *textPath) OnCopy(handler string) *textPath {
...
// content itself.
func (e *textPath) OnCut(handler string) *textPath {
...
func (e *textPath) OnPaste(handler string) *textPath {
...
func (e *textPath) OnScrollEnd(handler string) *textPath {
...
func (e *textPath) OnFormData(handler string) *textPath {
...
func (e *textPath) OnAnimationCancel(handler string) *textPath {
...
func (e *textPath) OnAnimationEnd(handler string) *textPath {
...
func (e *textPath) OnAnimationIteration(handler string) *textPath {
...
func (e *textPath) OnAnimationStart(handler string) *textPath {
...
func (e *textPath) OnTransitionCancel(handler string) *textPath {
...
func (e *textPath) OnTransitionEnd(handler string) *textPath {
...
func (e *textPath) OnTransitionRun(handler string) *textPath {
...
func (e *textPath) OnTransitionStart(handler string) *textPath {
...
func (e *textPath) OnBeforeToggle(handler string) *textPath {
...
func (e *textPath) OnBeforeInput(handler string) *textPath {
...
func (e *textPath) OnBeforeMatch(handler string) *textPath {
...
func (e *textPath) OnCommand(handler string) *textPath {
...
func (e *textPath) OnContextLost(handler string) *textPath {
...
func (e *textPath) OnContextRestored(handler string) *textPath {
...
func (e *textPath) OnSecurityPolicyViolation(handler string) *textPath {
...
func (e *textPath) OnSlotChange(handler string) *textPath {
...
func (e *textPath) OnPointerDown(handler string) *textPath {
...
func (e *textPath) OnPointerUp(handler string) *textPath {
...
func (e *textPath) OnPointerMove(handler string) *textPath {
...
func (e *textPath) OnPointerEnter(handler string) *textPath {
...
func (e *textPath) OnPointerLeave(handler string) *textPath {
...
func (e *textPath) OnPointerOver(handler string) *textPath {
...
// element for any of its descendants.
func (e *textPath) OnPointerOut(handler string) *textPath {
...
func (e *textPath) OnPointerCancel(handler string) *textPath {
...
func (e *textPath) OnGotPointerCapture(handler string) *textPath {
...
func (e *textPath) OnLostPointerCapture(handler string) *textPath {
...
func (e *textPath) OnTouchStart(handler string) *textPath {
...
func (e *textPath) OnTouchEnd(handler string) *textPath {
...
func (e *textPath) OnTouchMove(handler string) *textPath {
...
func (e *textPath) OnTouchCancel(handler string) *textPath {
...
func (e *textPath) OnSelectStart(handler string) *textPath {
...
func (e *textPath) OnSelectionChange(handler string) *textPath {
...
func (e *textPath) SetAttribute(key string, value string) {
...
func (e *textPath) SetAttributeRaw(key string, value string) {
	if e.attr == nil {
		e.attr = &[]node.Attribute{}
	}
	for i, attr := range *e.attr {
...
func (e *textPath) DynamicKey() string {
	return e.dynamic
}
...
func (e *textPath) Memoise(version any) *textPath {
	e.memoise = version
	return e
}
...
// by fluent-jit.
func (e *textPath) MemoiseKey() any {
	return e.memoise
}
...
func (e *textPath) BufferHint(hint int) *textPath {
	if hint > 0 {
...
func (e *textPath) RenderedSize() int {
...
func (e *textPath) Render(w io.Writer) {
	_, _ = e.WriteTo(w)
}
...
func (e *textPath) WriteTo(w io.Writer) (int64, error) {
...
func (e *textPath) RenderBytes() []byte {
...
func (e *textPath) AttributeBuilder(buf *bytes.Buffer) {
	if e.href != "" {
		buf.Write(AttrHref)
	...
	if e.startOffset != "" {
		buf.Write(AttrStartOffset)
		buf.WriteString(e.startOffset)
		buf.Write(MarkupQuote)
	}
	if e.method != "" {
		buf.Write(AttrMethod)
		buf.WriteString(e.method)
		buf.Write(MarkupQuote)
	}
	if e.spacing != "" {
		buf.Write(AttrSpacing)
		buf.WriteString(e.spacing)
		buf.Write(MarkupQuote)
	}
	if e.side != "" {
		buf.Write(AttrSide)
		buf.WriteString(e.side)
		buf.Write(MarkupQuote)
	}
	if e.textLength != "" {
...
func (e *textPath) RenderBuilder(buf *bytes.Buffer) {
	buf.Write(TagTextPath)
	...
	buf.Write(TagTextPathClose)
}

// RenderOpen writes the opening tag and attributes to the buffer.
func (e *textPath) RenderOpen(buf *bytes.Buffer) {
	buf.Write(TagTextPath)
	e.AttributeBuilder(buf)
	buf.Write(MarkupCloseTag)
}
...
// isSVGShape seals textPath as a Shape.
func (*textPath) isSVGShape() {}
