...
// foreignObject represents the <foreignObject> SVG element.
...
func (e *foreignObject) svg() *svgAttrs {
	if e.sa == nil {
		e.sa = &svgAttrs{}
	}
	return e.sa
...
func (e *foreignObject) event() *html5.EventAttributes {
	if e.ea == nil {
...
// ForeignObject embeds content from another namespace within an SVG region
// positioned by x and y and sized by width and height. HTML children can use
// normal text layout, form controls and CSS inside that region.
func ForeignObject(children ...node.Node) *foreignObject {
...
func (e *foreignObject) X(value string) *foreignObject {
	e.x = node.EscapeAttribute(value)
	return e
}

// Y sets the y attribute.
func (e *foreignObject) Y(value string) *foreignObject {
	e.y = node.EscapeAttribute(value)
	return e
}

// Width sets the width attribute.
func (e *foreignObject) Width(value string) *foreignObject {
	e.width = node.EscapeAttribute(value)
	return e
}

// Height sets the height attribute.
func (e *foreignObject) Height(value string) *foreignObject {
	e.height = node.EscapeAttribute(value)
	return e
}

// ID sets the id attribute.
func (e *foreignObject) ID(id string) *foreignObject {
	e.svg().ID = node.EscapeAttribute(id)
	return e
}

// Class appends to the space-separated class attribute.
func (e *foreignObject) Class(class string) *foreignObject {
...
func (e *foreignObject) Style(css string) *foreignObject {
	e.svg().Style = node.EscapeAttribute(css)
	return e
}

// Transform sets the transform attribute.
func (e *foreignObject) Transform(transform string) *foreignObject {
...
func (e *foreignObject) TransformOrigin(origin string) *foreignObject {
	e.svg().TransformOrigin = node.EscapeAttribute(origin)
	return e
}

// TabIndex sets the tabindex attribute.
func (e *foreignObject) TabIndex(index string) *foreignObject {
	e.svg().TabIndex = node.EscapeAttribute(index)
	return e
}

// Role sets the role attribute.
func (e *foreignObject) Role(role string) *foreignObject {
...
func (e *foreignObject) Lang(lang string) *foreignObject {
...
func (e *foreignObject) AutoFocus(conds ...bool) *foreignObject {
	if len(conds) > 0 {
...
func (e *foreignObject) SetAria(key string, value string) *foreignObject {
...
func (e *foreignObject) StrokeDashOffset(offset string) *foreignObject {
...
func (e *foreignObject) StrokeMiterLimit(limit string) *foreignObject {
...
func (e *foreignObject) FillRule(rule fillrule.FillRule) *foreignObject {
	e.svg().FillRule = rule
	return e
}
...
// a clipPath.
func (e *foreignObject) ClipRule(rule cliprule.ClipRule) *foreignObject {
	e.svg().ClipRule = rule
	return e
}
...
func (e *foreignObject) ClipPath(clip string) *foreignObject {
...
// per pixel.
func (e *foreignObject) Mask(mask string) *foreignObject {
...
func (e *foreignObject) Filter(filter string) *foreignObject {
...
func (e *foreignObject) Color(color string) *foreignObject {
...
func (e *foreignObject) Cursor(cursor string) *foreignObject {
...
func (e *foreignObject) Display(display string) *foreignObject {
...
// drawn again.
func (e *foreignObject) Visibility(value visibility.Visibility) *foreignObject {
...
func (e *foreignObject) PointerEvents(events pointerevents.PointerEvents) *foreignObject {
...
func (e *foreignObject) VectorEffect(effect vectoreffect.VectorEffect) *foreignObject {
...
func (e *foreignObject) ShapeRendering(rendering shaperendering.ShapeRendering) *foreignObject {
...
func (e *foreignObject) FontFamily(family string) *foreignObject {
...
// is in user units.
func (e *foreignObject) FontSize(size string) *foreignObject {
...
// from 100 to 900.
func (e *foreignObject) FontWeight(weight string) *foreignObject {
...
func (e *foreignObject) FontStyle(style string) *foreignObject {
...
func (e *foreignObject) OnClick(handler string) *foreignObject {
...
func (e *foreignObject) OnChange(handler string) *foreignObject {
...
func (e *foreignObject) OnInput(handler string) *foreignObject {
...
func (e *foreignObject) OnFocus(handler string) *foreignObject {
...
func (e *foreignObject) OnBlur(handler string) *foreignObject {
...
func (e *foreignObject) OnSubmit(handler string) *foreignObject {
...
func (e *foreignObject) OnLoad(handler string) *foreignObject {
...
func (e *foreignObject) OnError(handler string) *foreignObject {
...
// developer-controlled key. Never build the key from user input - a key containing a space, quote,
// "=", "/" or ">" changes the markup structure. The value is escaped. The key is not escaped.
func (e *foreignObject) SetEvent(key string, value string) *foreignObject {
...
func (e *foreignObject) OnAbort(handler string) *foreignObject {
...
func (e *foreignObject) OnAutoComplete(handler string) *foreignObject {
...
//
// Deprecated: Removed from the WHATWG living standard. Was in an older HTML5 draft.
func (e *foreignObject) OnAutoCompleteError(handler string) *foreignObject {
...
func (e *foreignObject) OnCancel(handler string) *foreignObject {
...
func (e *foreignObject) OnCanPlay(handler string) *foreignObject {
...
func (e *foreignObject) OnCanPlayThrough(handler string) *foreignObject {
...
// results.
func (e *foreignObject) OnClose(handler string) *foreignObject {
...
func (e *foreignObject) OnContextMenu(handler string) *foreignObject {
...
// timestamps.
func (e *foreignObject) OnCueChange(handler string) *foreignObject {
...
func (e *foreignObject) OnDblClick(handler string) *foreignObject {
...
func (e *foreignObject) OnDrag(handler string) *foreignObject {
...
func (e *foreignObject) OnDragEnd(handler string) *foreignObject {
...
func (e *foreignObject) OnDragEnter(handler string) *foreignObject {
...
func (e *foreignObject) OnDragLeave(handler string) *foreignObject {
...
func (e *foreignObject) OnDragOver(handler string) *foreignObject {
...
func (e *foreignObject) OnDragStart(handler string) *foreignObject {
...
// enable dropping.
func (e *foreignObject) OnDrop(handler string) *foreignObject {
...
func (e *foreignObject) OnDurationChange(handler string) *foreignObject {
...
// media content.
func (e *foreignObject) OnEmptied(handler string) *foreignObject {
...
func (e *foreignObject) OnEnded(handler string) *foreignObject {
...
func (e *foreignObject) OnInvalid(handler string) *foreignObject {
...
func (e *foreignObject) OnKeyDown(handler string) *foreignObject {
...
func (e *foreignObject) OnKeyPress(handler string) *foreignObject {
...
func (e *foreignObject) OnKeyUp(handler string) *foreignObject {
...
func (e *foreignObject) OnLoadedData(handler string) *foreignObject {
...
func (e *foreignObject) OnLoadedMetadata(handler string) *foreignObject {
...
func (e *foreignObject) OnLoadStart(handler string) *foreignObject {
...
func (e *foreignObject) OnMouseDown(handler string) *foreignObject {
...
func (e *foreignObject) OnMouseEnter(handler string) *foreignObject {
...
func (e *foreignObject) OnMouseLeave(handler string) *foreignObject {
...
func (e *foreignObject) OnMouseMove(handler string) *foreignObject {
...
func (e *foreignObject) OnMouseOut(handler string) *foreignObject {
...
func (e *foreignObject) OnMouseOver(handler string) *foreignObject {
...
func (e *foreignObject) OnMouseUp(handler string) *foreignObject {
...
func (e *foreignObject) OnMouseWheel(handler string) *foreignObject {
...
func (e *foreignObject) OnPause(handler string) *foreignObject {
...
func (e *foreignObject) OnPlay(handler string) *foreignObject {
...
func (e *foreignObject) OnPlaying(handler string) *foreignObject {
...
func (e *foreignObject) OnProgress(handler string) *foreignObject {
...
func (e *foreignObject) OnRateChange(handler string) *foreignObject {
...
func (e *foreignObject) OnReset(handler string) *foreignObject {
...
// ResizeObserver.
func (e *foreignObject) OnResize(handler string) *foreignObject {
...
func (e *foreignObject) OnScroll(handler string) *foreignObject {
...
func (e *foreignObject) OnSeeked(handler string) *foreignObject {
...
func (e *foreignObject) OnSeeking(handler string) *foreignObject {
...
func (e *foreignObject) OnSelect(handler string) *foreignObject {
...
func (e *foreignObject) OnShow(handler string) *foreignObject {
...
func (e *foreignObject) OnSort(handler string) *foreignObject {
...
func (e *foreignObject) OnStalled(handler string) *foreignObject {
...
func (e *foreignObject) OnSuspend(handler string) *foreignObject {
...
func (e *foreignObject) OnTimeUpdate(handler string) *foreignObject {
...
func (e *foreignObject) OnToggle(handler string) *foreignObject {
...
func (e *foreignObject) OnVolumeChange(handler string) *foreignObject {
...
func (e *foreignObject) OnWaiting(handler string) *foreignObject {
...
func (e *foreignObject) OnAuxClick(handler string) *foreignObject {
...
func (e *foreignObject) OnWheel(handler string) *foreignObject {
...
func (e *foreignObject) OnCopy(handler string) *foreignObject {
...
// content itself.
func (e *foreignObject) OnCut(handler string) *foreignObject {
...
func (e *foreignObject) OnPaste(handler string) *foreignObject {
...
func (e *foreignObject) OnScrollEnd(handler string) *foreignObject {
...
func (e *foreignObject) OnFormData(handler string) *foreignObject {
...
func (e *foreignObject) OnAnimationCancel(handler string) *foreignObject {
...
func (e *foreignObject) OnAnimationEnd(handler string) *foreignObject {
...
func (e *foreignObject) OnAnimationIteration(handler string) *foreignObject {
...
func (e *foreignObject) OnAnimationStart(handler string) *foreignObject {
...
func (e *foreignObject) OnTransitionCancel(handler string) *foreignObject {
...
func (e *foreignObject) OnTransitionEnd(handler string) *foreignObject {
...
func (e *foreignObject) OnTransitionRun(handler string) *foreignObject {
...
func (e *foreignObject) OnTransitionStart(handler string) *foreignObject {
...
func (e *foreignObject) OnBeforeToggle(handler string) *foreignObject {
...
func (e *foreignObject) OnBeforeInput(handler string) *foreignObject {
...
func (e *foreignObject) OnBeforeMatch(handler string) *foreignObject {
...
func (e *foreignObject) OnCommand(handler string) *foreignObject {
...
func (e *foreignObject) OnContextLost(handler string) *foreignObject {
...
func (e *foreignObject) OnContextRestored(handler string) *foreignObject {
...
func (e *foreignObject) OnSecurityPolicyViolation(handler string) *foreignObject {
...
func (e *foreignObject) OnSlotChange(handler string) *foreignObject {
...
func (e *foreignObject) OnPointerDown(handler string) *foreignObject {
...
func (e *foreignObject) OnPointerUp(handler string) *foreignObject {
...
func (e *foreignObject) OnPointerMove(handler string) *foreignObject {
...
func (e *foreignObject) OnPointerEnter(handler string) *foreignObject {
...
func (e *foreignObject) OnPointerLeave(handler string) *foreignObject {
...
func (e *foreignObject) OnPointerOver(handler string) *foreignObject {
...
// element for any of its descendants.
func (e *foreignObject) OnPointerOut(handler string) *foreignObject {
...
func (e *foreignObject) OnPointerCancel(handler string) *foreignObject {
...
func (e *foreignObject) OnGotPointerCapture(handler string) *foreignObject {
...
func (e *foreignObject) OnLostPointerCapture(handler string) *foreignObject {
...
func (e *foreignObject) OnTouchStart(handler string) *foreignObject {
...
func (e *foreignObject) OnTouchEnd(handler string) *foreignObject {
...
func (e *foreignObject) OnTouchMove(handler string) *foreignObject {
...
func (e *foreignObject) OnTouchCancel(handler string) *foreignObject {
...
func (e *foreignObject) OnSelectStart(handler string) *foreignObject {
...
func (e *foreignObject) OnSelectionChange(handler string) *foreignObject {
...
func (e *foreignObject) SetAttribute(key string, value string) {
...
func (e *foreignObject) SetAttributeRaw(key string, value string) {
	if e.attr == nil {
		e.attr = &[]node.Attribute{}
	}
	for i, attr := range *e.attr {
...
func (e *foreignObject) Add(children ...node.Node) *foreignObject {
...
func (e *foreignObject) Replace(children ...node.Node) *foreignObject {
...
func (e *foreignObject) Dynamic(key string) *foreignObject {
	e.dynamic = key
	return e
}

// IsDynamic reports whether this element has been marked for reactive tracking.
func (e *foreignObject) IsDynamic() bool {
	return e.dynamic != ""
}
...
func (e *foreignObject) DynamicKey() string {
	return e.dynamic
}
...
func (e *foreignObject) Memoise(version any) *foreignObject {
	e.memoise = version
	return e
}
...
// by fluent-jit.
func (e *foreignObject) MemoiseKey() any {
	return e.memoise
}
...
func (e *foreignObject) BufferHint(hint int) *foreignObject {
	if hint > 0 {
...
func (e *foreignObject) RenderedSize() int {
...
func (e *foreignObject) Render(w io.Writer) {
	_, _ = e.WriteTo(w)
}
...
func (e *foreignObject) WriteTo(w io.Writer) (int64, error) {
...
func (e *foreignObject) RenderBytes() []byte {
...
func (e *foreignObject) AttributeBuilder(buf *bytes.Buffer) {
	if e.x != "" {
		buf.Write(AttrX)
		buf.WriteString(e.x)
...
func (e *foreignObject) RenderBuilder(buf *bytes.Buffer) {
	buf.Write(TagForeignObject)
	...
	buf.Write(TagForeignObjectClose)
}

// RenderOpen writes the opening tag and attributes to the buffer.
func (e *foreignObject) RenderOpen(buf *bytes.Buffer) {
	buf.Write(TagForeignObject)
	e.AttributeBuilder(buf)
	buf.Write(MarkupCloseTag)
}
...
// isSVGShape seals foreignObject as a Shape.
func (*foreignObject) isSVGShape() {}
