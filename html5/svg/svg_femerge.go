...
// feMerge represents the <feMerge> SVG element.
type feMerge struct {
...
func (e *feMerge) event() *html5.EventAttributes {
	if e.ea == nil {
...
// FeMerge composites several filter inputs in child order, from back to front.
// Each FeMergeNode identifies one input. For example, place a shadow input
// before SourceGraphic to render the original artwork over its shadow.
func FeMerge(children ...*feMergeNode) *feMerge {
...
func (e *feMerge) Style(css string) *feMerge {
	e.svg().Style = node.EscapeAttribute(css)
	return e
}

// Transform sets the transform attribute.
func (e *feMerge) Transform(transform string) *feMerge {
...
func (e *feMerge) TransformOrigin(origin string) *feMerge {
	e.svg().TransformOrigin = node.EscapeAttribute(origin)
	return e
}

// TabIndex sets the tabindex attribute.
func (e *feMerge) TabIndex(index string) *feMerge {
	e.svg().TabIndex = node.EscapeAttribute(index)
	return e
}

// Role sets the role attribute.
func (e *feMerge) Role(role string) *feMerge {
...
func (e *feMerge) Lang(lang string) *feMerge {
...
func (e *feMerge) AutoFocus(conds ...bool) *feMerge {
	if len(conds) > 0 {
...
func (e *feMerge) SetAria(key string, value string) *feMerge {
...
func (e *feMerge) StrokeDashOffset(offset string) *feMerge {
...
func (e *feMerge) StrokeMiterLimit(limit string) *feMerge {
...
func (e *feMerge) FillRule(rule fillrule.FillRule) *feMerge {
	e.svg().FillRule = rule
	return e
}
...
// a clipPath.
func (e *feMerge) ClipRule(rule cliprule.ClipRule) *feMerge {
	e.svg().ClipRule = rule
	return e
}
...
func (e *feMerge) ClipPath(clip string) *feMerge {
...
// per pixel.
func (e *feMerge) Mask(mask string) *feMerge {
...
func (e *feMerge) Filter(filter string) *feMerge {
...
func (e *feMerge) Color(color string) *feMerge {
...
func (e *feMerge) Cursor(cursor string) *feMerge {
...
func (e *feMerge) Display(display string) *feMerge {
...
// drawn again.
func (e *feMerge) Visibility(value visibility.Visibility) *feMerge {
...
func (e *feMerge) PointerEvents(events pointerevents.PointerEvents) *feMerge {
...
func (e *feMerge) VectorEffect(effect vectoreffect.VectorEffect) *feMerge {
...
func (e *feMerge) ShapeRendering(rendering shaperendering.ShapeRendering) *feMerge {
...
func (e *feMerge) FontFamily(family string) *feMerge {
...
// is in user units.
func (e *feMerge) FontSize(size string) *feMerge {
...
// from 100 to 900.
func (e *feMerge) FontWeight(weight string) *feMerge {
...
func (e *feMerge) FontStyle(style string) *feMerge {
...
func (e *feMerge) OnClick(handler string) *feMerge {
...
func (e *feMerge) OnChange(handler string) *feMerge {
...
func (e *feMerge) OnInput(handler string) *feMerge {
...
func (e *feMerge) OnFocus(handler string) *feMerge {
...
func (e *feMerge) OnBlur(handler string) *feMerge {
...
func (e *feMerge) OnSubmit(handler string) *feMerge {
...
func (e *feMerge) OnLoad(handler string) *feMerge {
...
func (e *feMerge) OnError(handler string) *feMerge {
...
// developer-controlled key. Never build the key from user input - a key containing a space, quote,
// "=", "/" or ">" changes the markup structure. The value is escaped. The key is not escaped.
func (e *feMerge) SetEvent(key string, value string) *feMerge {
...
func (e *feMerge) OnAbort(handler string) *feMerge {
...
func (e *feMerge) OnAutoComplete(handler string) *feMerge {
...
//
// Deprecated: Removed from the WHATWG living standard. Was in an older HTML5 draft.
func (e *feMerge) OnAutoCompleteError(handler string) *feMerge {
...
func (e *feMerge) OnCancel(handler string) *feMerge {
...
func (e *feMerge) OnCanPlay(handler string) *feMerge {
...
func (e *feMerge) OnCanPlayThrough(handler string) *feMerge {
...
// results.
func (e *feMerge) OnClose(handler string) *feMerge {
...
func (e *feMerge) OnContextMenu(handler string) *feMerge {
...
// timestamps.
func (e *feMerge) OnCueChange(handler string) *feMerge {
...
func (e *feMerge) OnDblClick(handler string) *feMerge {
...
func (e *feMerge) OnDrag(handler string) *feMerge {
...
func (e *feMerge) OnDragEnd(handler string) *feMerge {
...
func (e *feMerge) OnDragEnter(handler string) *feMerge {
...
func (e *feMerge) OnDragLeave(handler string) *feMerge {
...
func (e *feMerge) OnDragOver(handler string) *feMerge {
...
func (e *feMerge) OnDragStart(handler string) *feMerge {
...
// enable dropping.
func (e *feMerge) OnDrop(handler string) *feMerge {
...
func (e *feMerge) OnDurationChange(handler string) *feMerge {
...
// media content.
func (e *feMerge) OnEmptied(handler string) *feMerge {
...
func (e *feMerge) OnEnded(handler string) *feMerge {
...
func (e *feMerge) OnInvalid(handler string) *feMerge {
...
func (e *feMerge) OnKeyDown(handler string) *feMerge {
...
func (e *feMerge) OnKeyPress(handler string) *feMerge {
...
func (e *feMerge) OnKeyUp(handler string) *feMerge {
...
func (e *feMerge) OnLoadedData(handler string) *feMerge {
...
func (e *feMerge) OnLoadedMetadata(handler string) *feMerge {
...
func (e *feMerge) OnLoadStart(handler string) *feMerge {
...
func (e *feMerge) OnMouseDown(handler string) *feMerge {
...
func (e *feMerge) OnMouseEnter(handler string) *feMerge {
...
func (e *feMerge) OnMouseLeave(handler string) *feMerge {
...
func (e *feMerge) OnMouseMove(handler string) *feMerge {
...
func (e *feMerge) OnMouseOut(handler string) *feMerge {
...
func (e *feMerge) OnMouseOver(handler string) *feMerge {
...
func (e *feMerge) OnMouseUp(handler string) *feMerge {
...
func (e *feMerge) OnMouseWheel(handler string) *feMerge {
...
func (e *feMerge) OnPause(handler string) *feMerge {
...
func (e *feMerge) OnPlay(handler string) *feMerge {
...
func (e *feMerge) OnPlaying(handler string) *feMerge {
...
func (e *feMerge) OnProgress(handler string) *feMerge {
...
func (e *feMerge) OnRateChange(handler string) *feMerge {
...
func (e *feMerge) OnReset(handler string) *feMerge {
...
// ResizeObserver.
func (e *feMerge) OnResize(handler string) *feMerge {
...
func (e *feMerge) OnScroll(handler string) *feMerge {
...
func (e *feMerge) OnSeeked(handler string) *feMerge {
...
func (e *feMerge) OnSeeking(handler string) *feMerge {
...
func (e *feMerge) OnSelect(handler string) *feMerge {
...
func (e *feMerge) OnShow(handler string) *feMerge {
...
func (e *feMerge) OnSort(handler string) *feMerge {
...
func (e *feMerge) OnStalled(handler string) *feMerge {
...
func (e *feMerge) OnSuspend(handler string) *feMerge {
...
func (e *feMerge) OnTimeUpdate(handler string) *feMerge {
...
func (e *feMerge) OnToggle(handler string) *feMerge {
...
func (e *feMerge) OnVolumeChange(handler string) *feMerge {
...
func (e *feMerge) OnWaiting(handler string) *feMerge {
...
func (e *feMerge) OnAuxClick(handler string) *feMerge {
...
func (e *feMerge) OnWheel(handler string) *feMerge {
...
func (e *feMerge) OnCopy(handler string) *feMerge {
...
// content itself.
func (e *feMerge) OnCut(handler string) *feMerge {
...
func (e *feMerge) OnPaste(handler string) *feMerge {
...
func (e *feMerge) OnScrollEnd(handler string) *feMerge {
...
func (e *feMerge) OnFormData(handler string) *feMerge {
...
func (e *feMerge) OnAnimationCancel(handler string) *feMerge {
...
func (e *feMerge) OnAnimationEnd(handler string) *feMerge {
...
func (e *feMerge) OnAnimationIteration(handler string) *feMerge {
...
func (e *feMerge) OnAnimationStart(handler string) *feMerge {
...
func (e *feMerge) OnTransitionCancel(handler string) *feMerge {
...
func (e *feMerge) OnTransitionEnd(handler string) *feMerge {
...
func (e *feMerge) OnTransitionRun(handler string) *feMerge {
...
func (e *feMerge) OnTransitionStart(handler string) *feMerge {
...
func (e *feMerge) OnBeforeToggle(handler string) *feMerge {
...
func (e *feMerge) OnBeforeInput(handler string) *feMerge {
...
func (e *feMerge) OnBeforeMatch(handler string) *feMerge {
...
func (e *feMerge) OnCommand(handler string) *feMerge {
...
func (e *feMerge) OnContextLost(handler string) *feMerge {
...
func (e *feMerge) OnContextRestored(handler string) *feMerge {
...
func (e *feMerge) OnSecurityPolicyViolation(handler string) *feMerge {
...
func (e *feMerge) OnSlotChange(handler string) *feMerge {
...
func (e *feMerge) OnPointerDown(handler string) *feMerge {
...
func (e *feMerge) OnPointerUp(handler string) *feMerge {
...
func (e *feMerge) OnPointerMove(handler string) *feMerge {
...
func (e *feMerge) OnPointerEnter(handler string) *feMerge {
...
func (e *feMerge) OnPointerLeave(handler string) *feMerge {
...
func (e *feMerge) OnPointerOver(handler string) *feMerge {
...
// element for any of its descendants.
func (e *feMerge) OnPointerOut(handler string) *feMerge {
...
func (e *feMerge) OnPointerCancel(handler string) *feMerge {
...
func (e *feMerge) OnGotPointerCapture(handler string) *feMerge {
...
func (e *feMerge) OnLostPointerCapture(handler string) *feMerge {
...
func (e *feMerge) OnTouchStart(handler string) *feMerge {
...
func (e *feMerge) OnTouchEnd(handler string) *feMerge {
...
func (e *feMerge) OnTouchMove(handler string) *feMerge {
...
func (e *feMerge) OnTouchCancel(handler string) *feMerge {
...
func (e *feMerge) OnSelectStart(handler string) *feMerge {
...
func (e *feMerge) OnSelectionChange(handler string) *feMerge {
...
func (e *feMerge) SetAttribute(key string, value string) {
...
func (e *feMerge) SetAttributeRaw(key string, value string) {
	if e.attr == nil {
		e.attr = &[]node.Attribute{}
	}
	for i, attr := range *e.attr {
...
func (e *feMerge) Add(children ...*feMergeNode) *feMerge {
...
func (e *feMerge) Replace(children ...*feMergeNode) *feMerge {
...
func (e *feMerge) DynamicKey() string {
	return e.dynamic
}
...
func (e *feMerge) Memoise(version any) *feMerge {
	e.memoise = version
	return e
}
...
func (e *feMerge) BufferHint(hint int) *feMerge {
	if hint > 0 {
...
func (e *feMerge) RenderedSize() int {
...
func (e *feMerge) Render(w io.Writer) {
	_, _ = e.WriteTo(w)
}
...
func (e *feMerge) WriteTo(w io.Writer) (int64, error) {
...
func (e *feMerge) RenderBytes() []byte {
...
func (e *feMerge) AttributeBuilder(buf *bytes.Buffer) {
	if e.x != "" {
		buf.Write(AttrX)
		buf.WriteString(e.x)
...
func (e *feMerge) RenderBuilder(buf *bytes.Buffer) {
	buf.Write(TagFeMerge)
	...
	buf.Write(TagFeMergeClose)
}

// RenderOpen writes the opening tag and attributes to the buffer.
func (e *feMerge) RenderOpen(buf *bytes.Buffer) {
	buf.Write(TagFeMerge)
	e.AttributeBuilder(buf)
	buf.Write(MarkupCloseTag)
}
...
// isSVGFilterPrimitive seals feMerge as a FilterPrimitive.
func (*feMerge) isSVGFilterPrimitive() {}
