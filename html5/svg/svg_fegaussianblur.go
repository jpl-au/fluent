...
// feGaussianBlur represents the <feGaussianBlur> SVG element.
...
func (e *feGaussianBlur) svg() *svgAttrs {
	if e.sa == nil {
		e.sa = &svgAttrs{}
	}
	return e.sa
...
func (e *feGaussianBlur) event() *html5.EventAttributes {
	if e.ea == nil {
...
// FeGaussianBlur blurs a filter input using a Gaussian kernel. The
// stdDeviation attribute sets the blur amount on each axis, and edgeMode
// controls how pixels outside the input image are sampled.
func FeGaussianBlur(children ...PrimitiveContent) *feGaussianBlur {
...
//
// The input image, as a previous result name or a standard input such as
// SourceGraphic or SourceAlpha. If omitted, it uses the previous primitive's
// result, or SourceGraphic when this is the first primitive.
func (e *feGaussianBlur) In(value string) *feGaussianBlur {
	e.in = node.EscapeAttribute(value)
	return e
}

// StdDeviation sets the stdDeviation attribute.
//
// The standard deviation of the Gaussian kernel. One number sets both axes.
// Two numbers set x and y separately. For example, "4 0" blurs horizontally
// without blurring vertically.
func (e *feGaussianBlur) StdDeviation(value string) *feGaussianBlur {
	e.stdDeviation = node.EscapeAttribute(value)
	return e
}
...
func (e *feGaussianBlur) EdgeMode(value edgemode.EdgeMode) *feGaussianBlur {
	e.edgeMode = value
	return e
}

// X sets the x attribute.
func (e *feGaussianBlur) X(value string) *feGaussianBlur {
	e.x = node.EscapeAttribute(value)
	return e
}

// Y sets the y attribute.
func (e *feGaussianBlur) Y(value string) *feGaussianBlur {
	e.y = node.EscapeAttribute(value)
	return e
}

// Width sets the width attribute.
func (e *feGaussianBlur) Width(value string) *feGaussianBlur {
	e.width = node.EscapeAttribute(value)
	return e
}

// Height sets the height attribute.
func (e *feGaussianBlur) Height(value string) *feGaussianBlur {
...
//
// A name for this primitive's output, so a later primitive can take it as its in.
func (e *feGaussianBlur) Result(value string) *feGaussianBlur {
	e.result = node.EscapeAttribute(value)
	return e
}

// ID sets the id attribute.
func (e *feGaussianBlur) ID(id string) *feGaussianBlur {
	e.svg().ID = node.EscapeAttribute(id)
	return e
}

// Class appends to the space-separated class attribute.
func (e *feGaussianBlur) Class(class string) *feGaussianBlur {
...
func (e *feGaussianBlur) Style(css string) *feGaussianBlur {
	e.svg().Style = node.EscapeAttribute(css)
	return e
}

// Transform sets the transform attribute.
func (e *feGaussianBlur) Transform(transform string) *feGaussianBlur {
...
func (e *feGaussianBlur) TransformOrigin(origin string) *feGaussianBlur {
	e.svg().TransformOrigin = node.EscapeAttribute(origin)
	return e
}

// TabIndex sets the tabindex attribute.
func (e *feGaussianBlur) TabIndex(index string) *feGaussianBlur {
	e.svg().TabIndex = node.EscapeAttribute(index)
	return e
}

// Role sets the role attribute.
func (e *feGaussianBlur) Role(role string) *feGaussianBlur {
...
func (e *feGaussianBlur) Lang(lang string) *feGaussianBlur {
...
func (e *feGaussianBlur) AutoFocus(conds ...bool) *feGaussianBlur {
	if len(conds) > 0 {
...
func (e *feGaussianBlur) SetAria(key string, value string) *feGaussianBlur {
...
func (e *feGaussianBlur) StrokeDashOffset(offset string) *feGaussianBlur {
...
func (e *feGaussianBlur) StrokeMiterLimit(limit string) *feGaussianBlur {
...
func (e *feGaussianBlur) FillRule(rule fillrule.FillRule) *feGaussianBlur {
	e.svg().FillRule = rule
	return e
}
...
// a clipPath.
func (e *feGaussianBlur) ClipRule(rule cliprule.ClipRule) *feGaussianBlur {
	e.svg().ClipRule = rule
	return e
}
...
func (e *feGaussianBlur) ClipPath(clip string) *feGaussianBlur {
...
// per pixel.
func (e *feGaussianBlur) Mask(mask string) *feGaussianBlur {
...
func (e *feGaussianBlur) Filter(filter string) *feGaussianBlur {
...
func (e *feGaussianBlur) Color(color string) *feGaussianBlur {
...
func (e *feGaussianBlur) Cursor(cursor string) *feGaussianBlur {
...
func (e *feGaussianBlur) Display(display string) *feGaussianBlur {
...
// drawn again.
func (e *feGaussianBlur) Visibility(value visibility.Visibility) *feGaussianBlur {
...
func (e *feGaussianBlur) PointerEvents(events pointerevents.PointerEvents) *feGaussianBlur {
...
func (e *feGaussianBlur) VectorEffect(effect vectoreffect.VectorEffect) *feGaussianBlur {
...
func (e *feGaussianBlur) ShapeRendering(rendering shaperendering.ShapeRendering) *feGaussianBlur {
...
func (e *feGaussianBlur) FontFamily(family string) *feGaussianBlur {
...
// is in user units.
func (e *feGaussianBlur) FontSize(size string) *feGaussianBlur {
...
// from 100 to 900.
func (e *feGaussianBlur) FontWeight(weight string) *feGaussianBlur {
...
func (e *feGaussianBlur) FontStyle(style string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnClick(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnChange(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnInput(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnFocus(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnBlur(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnSubmit(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnLoad(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnError(handler string) *feGaussianBlur {
...
// developer-controlled key. Never build the key from user input - a key containing a space, quote,
// "=", "/" or ">" changes the markup structure. The value is escaped. The key is not escaped.
func (e *feGaussianBlur) SetEvent(key string, value string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnAbort(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnAutoComplete(handler string) *feGaussianBlur {
...
//
// Deprecated: Removed from the WHATWG living standard. Was in an older HTML5 draft.
func (e *feGaussianBlur) OnAutoCompleteError(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnCancel(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnCanPlay(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnCanPlayThrough(handler string) *feGaussianBlur {
...
// results.
func (e *feGaussianBlur) OnClose(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnContextMenu(handler string) *feGaussianBlur {
...
// timestamps.
func (e *feGaussianBlur) OnCueChange(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnDblClick(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnDrag(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnDragEnd(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnDragEnter(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnDragLeave(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnDragOver(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnDragStart(handler string) *feGaussianBlur {
...
// enable dropping.
func (e *feGaussianBlur) OnDrop(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnDurationChange(handler string) *feGaussianBlur {
...
// media content.
func (e *feGaussianBlur) OnEmptied(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnEnded(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnInvalid(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnKeyDown(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnKeyPress(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnKeyUp(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnLoadedData(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnLoadedMetadata(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnLoadStart(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnMouseDown(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnMouseEnter(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnMouseLeave(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnMouseMove(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnMouseOut(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnMouseOver(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnMouseUp(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnMouseWheel(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnPause(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnPlay(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnPlaying(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnProgress(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnRateChange(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnReset(handler string) *feGaussianBlur {
...
// ResizeObserver.
func (e *feGaussianBlur) OnResize(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnScroll(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnSeeked(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnSeeking(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnSelect(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnShow(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnSort(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnStalled(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnSuspend(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnTimeUpdate(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnToggle(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnVolumeChange(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnWaiting(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnAuxClick(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnWheel(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnCopy(handler string) *feGaussianBlur {
...
// content itself.
func (e *feGaussianBlur) OnCut(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnPaste(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnScrollEnd(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnFormData(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnAnimationCancel(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnAnimationEnd(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnAnimationIteration(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnAnimationStart(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnTransitionCancel(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnTransitionEnd(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnTransitionRun(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnTransitionStart(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnBeforeToggle(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnBeforeInput(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnBeforeMatch(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnCommand(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnContextLost(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnContextRestored(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnSecurityPolicyViolation(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnSlotChange(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnPointerDown(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnPointerUp(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnPointerMove(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnPointerEnter(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnPointerLeave(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnPointerOver(handler string) *feGaussianBlur {
...
// element for any of its descendants.
func (e *feGaussianBlur) OnPointerOut(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnPointerCancel(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnGotPointerCapture(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnLostPointerCapture(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnTouchStart(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnTouchEnd(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnTouchMove(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnTouchCancel(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnSelectStart(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) OnSelectionChange(handler string) *feGaussianBlur {
...
func (e *feGaussianBlur) SetAttribute(key string, value string) {
...
func (e *feGaussianBlur) SetAttributeRaw(key string, value string) {
	if e.attr == nil {
		e.attr = &[]node.Attribute{}
	}
	for i, attr := range *e.attr {
...
func (e *feGaussianBlur) Add(children ...PrimitiveContent) *feGaussianBlur {
...
func (e *feGaussianBlur) Replace(children ...PrimitiveContent) *feGaussianBlur {
...
func (e *feGaussianBlur) Dynamic(key string) *feGaussianBlur {
	e.dynamic = key
	return e
}

// IsDynamic reports whether this element has been marked for reactive tracking.
func (e *feGaussianBlur) IsDynamic() bool {
	return e.dynamic != ""
}
...
func (e *feGaussianBlur) DynamicKey() string {
	return e.dynamic
}
...
func (e *feGaussianBlur) Memoise(version any) *feGaussianBlur {
	e.memoise = version
	return e
}
...
// by fluent-jit.
func (e *feGaussianBlur) MemoiseKey() any {
	return e.memoise
}
...
func (e *feGaussianBlur) BufferHint(hint int) *feGaussianBlur {
	if hint > 0 {
...
func (e *feGaussianBlur) RenderedSize() int {
...
func (e *feGaussianBlur) Render(w io.Writer) {
	_, _ = e.WriteTo(w)
}
...
func (e *feGaussianBlur) WriteTo(w io.Writer) (int64, error) {
...
func (e *feGaussianBlur) RenderBytes() []byte {
...
func (e *feGaussianBlur) AttributeBuilder(buf *bytes.Buffer) {
	if e.in != "" {
		buf.Write(AttrIn)
	...
	if e.stdDeviation != "" {
		buf.Write(AttrStdDeviation)
		buf.WriteString(e.stdDeviation)
		buf.Write(MarkupQuote)
	}
	if len(e.edgeMode) > 0 {
...
func (e *feGaussianBlur) RenderBuilder(buf *bytes.Buffer) {
	buf.Write(TagFeGaussianBlur)
	...
	buf.Write(TagFeGaussianBlurClose)
}

// RenderOpen writes the opening tag and attributes to the buffer.
func (e *feGaussianBlur) RenderOpen(buf *bytes.Buffer) {
	buf.Write(TagFeGaussianBlur)
	e.AttributeBuilder(buf)
	buf.Write(MarkupCloseTag)
}
...
func (e *feGaussianBlur) RenderClose(buf *bytes.Buffer) {
	buf.Write(TagFeGaussianBlurClose)
}

// Nodes returns a slice of child nodes.
func (e *feGaussianBlur) Nodes() []node.Node {
	return e.nodes
}

// Attributes returns a pointer to the underlying attributes slice for direct attribute manipulation.
func (e *feGaussianBlur) Attributes() *[]node.Attribute {
	if e.attr == nil {
...
// isSVGFilterPrimitive seals feGaussianBlur as a FilterPrimitive.
func (*feGaussianBlur) isSVGFilterPrimitive() {}
