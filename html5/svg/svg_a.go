...
// a represents the <a> SVG element.
type a struct {
...
func (e *a) event() *html5.EventAttributes {
	if e.ea == nil {
...
// A makes its child graphics or text a hyperlink to the URL in href. Target
// selects the browsing context and download requests saving the resource.
// Without href, the element does not provide a hyperlink.
func A(children ...Shape) *a {
...
//
// Where to open the link: the same browsing context, a new one, the parent, or the top-level context.
func (e *a) Target(value target.Target) *a {
	e.target = value
	return e
}
...
//
// Requests downloading the linked resource. A non-empty value suggests a file
// name. An empty value leaves the name to the browser, which may use response
// headers or the URL. The browser can restrict or ignore download requests.
...
//
// The relationship from the current document to the target, as a space-separated list such as
// "noopener noreferrer".
func (e *a) Rel(value string) *a {
	e.rel = node.EscapeAttribute(value)
	return e
}

// HrefLang sets the hreflang attribute.
//
// The language of the target, as a BCP 47 tag. It is a hint only, and does not change how the link works.
func (e *a) HrefLang(value string) *a {
	e.hrefLang = node.EscapeAttribute(value)
	return e
}

// Type sets the type attribute.
//
// The MIME type of the target, as a hint to the browser. It does not change how the link works.
...
func (e *a) AutoFocus(conds ...bool) *a {
	if len(conds) > 0 {
...
func (e *a) SetAria(key string, value string) *a {
...
func (e *a) StrokeDashOffset(offset string) *a {
...
func (e *a) StrokeMiterLimit(limit string) *a {
...
func (e *a) FillRule(rule fillrule.FillRule) *a {
	e.svg().FillRule = rule
	return e
}
...
// a clipPath.
func (e *a) ClipRule(rule cliprule.ClipRule) *a {
	e.svg().ClipRule = rule
	return e
}
...
func (e *a) ClipPath(clip string) *a {
...
func (e *a) Filter(filter string) *a {
...
func (e *a) Cursor(cursor string) *a {
...
func (e *a) Display(display string) *a {
...
// drawn again.
func (e *a) Visibility(value visibility.Visibility) *a {
...
func (e *a) PointerEvents(events pointerevents.PointerEvents) *a {
...
func (e *a) VectorEffect(effect vectoreffect.VectorEffect) *a {
...
func (e *a) ShapeRendering(rendering shaperendering.ShapeRendering) *a {
...
func (e *a) FontFamily(family string) *a {
...
// is in user units.
func (e *a) FontSize(size string) *a {
...
// from 100 to 900.
func (e *a) FontWeight(weight string) *a {
...
func (e *a) FontStyle(style string) *a {
...
func (e *a) OnClick(handler string) *a {
...
func (e *a) OnChange(handler string) *a {
...
func (e *a) OnInput(handler string) *a {
...
func (e *a) OnFocus(handler string) *a {
...
func (e *a) OnBlur(handler string) *a {
...
func (e *a) OnSubmit(handler string) *a {
...
func (e *a) OnLoad(handler string) *a {
...
func (e *a) OnError(handler string) *a {
...
// developer-controlled key. Never build the key from user input - a key containing a space, quote,
// "=", "/" or ">" changes the markup structure. The value is escaped. The key is not escaped.
func (e *a) SetEvent(key string, value string) *a {
...
func (e *a) OnAbort(handler string) *a {
...
func (e *a) OnAutoComplete(handler string) *a {
...
//
// Deprecated: Removed from the WHATWG living standard. Was in an older HTML5 draft.
func (e *a) OnAutoCompleteError(handler string) *a {
...
func (e *a) OnCancel(handler string) *a {
...
func (e *a) OnCanPlay(handler string) *a {
...
func (e *a) OnCanPlayThrough(handler string) *a {
...
// results.
func (e *a) OnClose(handler string) *a {
...
func (e *a) OnContextMenu(handler string) *a {
...
// timestamps.
func (e *a) OnCueChange(handler string) *a {
...
func (e *a) OnDblClick(handler string) *a {
...
func (e *a) OnDrag(handler string) *a {
...
func (e *a) OnDragEnd(handler string) *a {
...
func (e *a) OnDragEnter(handler string) *a {
...
func (e *a) OnDragLeave(handler string) *a {
...
func (e *a) OnDragOver(handler string) *a {
...
func (e *a) OnDragStart(handler string) *a {
...
// enable dropping.
func (e *a) OnDrop(handler string) *a {
...
func (e *a) OnDurationChange(handler string) *a {
...
// media content.
func (e *a) OnEmptied(handler string) *a {
...
func (e *a) OnEnded(handler string) *a {
...
func (e *a) OnInvalid(handler string) *a {
...
func (e *a) OnKeyDown(handler string) *a {
...
func (e *a) OnKeyPress(handler string) *a {
...
func (e *a) OnKeyUp(handler string) *a {
...
func (e *a) OnLoadedData(handler string) *a {
...
func (e *a) OnLoadedMetadata(handler string) *a {
...
func (e *a) OnLoadStart(handler string) *a {
...
func (e *a) OnMouseDown(handler string) *a {
...
func (e *a) OnMouseEnter(handler string) *a {
...
func (e *a) OnMouseLeave(handler string) *a {
...
func (e *a) OnMouseMove(handler string) *a {
...
func (e *a) OnMouseOut(handler string) *a {
...
func (e *a) OnMouseOver(handler string) *a {
...
func (e *a) OnMouseUp(handler string) *a {
...
func (e *a) OnMouseWheel(handler string) *a {
...
func (e *a) OnPause(handler string) *a {
...
func (e *a) OnPlay(handler string) *a {
...
func (e *a) OnPlaying(handler string) *a {
...
func (e *a) OnProgress(handler string) *a {
...
func (e *a) OnRateChange(handler string) *a {
...
func (e *a) OnReset(handler string) *a {
...
// ResizeObserver.
func (e *a) OnResize(handler string) *a {
...
func (e *a) OnScroll(handler string) *a {
...
func (e *a) OnSeeked(handler string) *a {
...
func (e *a) OnSeeking(handler string) *a {
...
func (e *a) OnSelect(handler string) *a {
...
func (e *a) OnShow(handler string) *a {
...
func (e *a) OnSort(handler string) *a {
...
func (e *a) OnStalled(handler string) *a {
...
func (e *a) OnSuspend(handler string) *a {
...
func (e *a) OnTimeUpdate(handler string) *a {
...
func (e *a) OnToggle(handler string) *a {
...
func (e *a) OnVolumeChange(handler string) *a {
...
func (e *a) OnWaiting(handler string) *a {
...
func (e *a) OnAuxClick(handler string) *a {
...
func (e *a) OnWheel(handler string) *a {
...
func (e *a) OnCopy(handler string) *a {
...
// content itself.
func (e *a) OnCut(handler string) *a {
...
func (e *a) OnPaste(handler string) *a {
...
func (e *a) OnScrollEnd(handler string) *a {
...
func (e *a) OnFormData(handler string) *a {
...
func (e *a) OnAnimationCancel(handler string) *a {
...
func (e *a) OnAnimationEnd(handler string) *a {
...
func (e *a) OnAnimationIteration(handler string) *a {
...
func (e *a) OnAnimationStart(handler string) *a {
...
func (e *a) OnTransitionCancel(handler string) *a {
...
func (e *a) OnTransitionEnd(handler string) *a {
...
func (e *a) OnTransitionRun(handler string) *a {
...
func (e *a) OnTransitionStart(handler string) *a {
...
func (e *a) OnBeforeToggle(handler string) *a {
...
func (e *a) OnBeforeInput(handler string) *a {
...
func (e *a) OnBeforeMatch(handler string) *a {
...
func (e *a) OnCommand(handler string) *a {
...
func (e *a) OnContextLost(handler string) *a {
...
func (e *a) OnContextRestored(handler string) *a {
...
func (e *a) OnSecurityPolicyViolation(handler string) *a {
...
func (e *a) OnSlotChange(handler string) *a {
...
func (e *a) OnPointerDown(handler string) *a {
...
func (e *a) OnPointerUp(handler string) *a {
...
func (e *a) OnPointerMove(handler string) *a {
...
func (e *a) OnPointerEnter(handler string) *a {
...
func (e *a) OnPointerLeave(handler string) *a {
...
func (e *a) OnPointerOver(handler string) *a {
...
// element for any of its descendants.
func (e *a) OnPointerOut(handler string) *a {
...
func (e *a) OnPointerCancel(handler string) *a {
...
func (e *a) OnGotPointerCapture(handler string) *a {
...
func (e *a) OnLostPointerCapture(handler string) *a {
...
func (e *a) OnTouchStart(handler string) *a {
...
func (e *a) OnTouchEnd(handler string) *a {
...
func (e *a) OnTouchMove(handler string) *a {
...
func (e *a) OnTouchCancel(handler string) *a {
...
func (e *a) OnSelectStart(handler string) *a {
...
func (e *a) OnSelectionChange(handler string) *a {
...
func (e *a) SetAttribute(key string, value string) {
...
func (e *a) SetAttributeRaw(key string, value string) {
	if e.attr == nil {
		e.attr = &[]node.Attribute{}
	}
	for i, attr := range *e.attr {
...
func (e *a) Replace(children ...Shape) *a {
...
func (e *a) Memoise(version any) *a {
	e.memoise = version
	return e
}
...
func (e *a) BufferHint(hint int) *a {
	if hint > 0 {
...
func (e *a) WriteTo(w io.Writer) (int64, error) {
...
func (e *a) AttributeBuilder(buf *bytes.Buffer) {
	if e.href != "" {
		buf.Write(AttrHref)
	...
	if len(e.target) > 0 {
		buf.Write(AttrTarget)
		buf.Write(e.target)
		buf.Write(MarkupQuote)
	}
	if e.download != nil {
		buf.Write(AttrDownload)
		buf.WriteString(*e.download)
		buf.Write(MarkupQuote)
	}
	if e.rel != "" {
		buf.Write(AttrRel)
	...
	if e.hrefLang != "" {
		buf.Write(AttrHrefLang)
		buf.WriteString(e.hrefLang)
		buf.Write(MarkupQuote)
	}
	if e.typeAttr != "" {
		buf.Write(AttrType)
...
func (e *a) RenderBuilder(buf *bytes.Buffer) {
	buf.Write(TagA)
...
func (e *a) RenderOpen(buf *bytes.Buffer) {
	buf.Write(TagA)
	e.AttributeBuilder(buf)
	buf.Write(MarkupCloseTag)
}
