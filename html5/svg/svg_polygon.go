...
func (e *polygon) event() *html5.EventAttributes {
	if e.ea == nil {
...
// Polygon draws a closed shape from the coordinate pairs in points. It joins
// each point to the next and closes the last point back to the first. Fill
// paints the interior, and stroke paints the outline.
func Polygon(children ...ShapeContent) *polygon {
...
func (e *polygon) TransformOrigin(origin string) *polygon {
...
func (e *polygon) Lang(lang string) *polygon {
...
func (e *polygon) AutoFocus(conds ...bool) *polygon {
	if len(conds) > 0 {
...
// developer-controlled key. Never build the key from user input - a key containing a space, quote,
// "=", "/" or ">" changes the markup structure. The value is escaped. The key is not escaped.
func (e *polygon) SetData(key string, value string) *polygon {
...
func (e *polygon) StrokeDashOffset(offset string) *polygon {
...
func (e *polygon) StrokeMiterLimit(limit string) *polygon {
...
func (e *polygon) FillRule(rule fillrule.FillRule) *polygon {
	e.svg().FillRule = rule
	return e
}
...
// a clipPath.
func (e *polygon) ClipRule(rule cliprule.ClipRule) *polygon {
	e.svg().ClipRule = rule
	return e
}
...
func (e *polygon) ClipPath(clip string) *polygon {
...
// per pixel.
func (e *polygon) Mask(mask string) *polygon {
...
func (e *polygon) Filter(filter string) *polygon {
...
func (e *polygon) Color(color string) *polygon {
...
func (e *polygon) Cursor(cursor string) *polygon {
...
func (e *polygon) Display(display string) *polygon {
...
// drawn again.
func (e *polygon) Visibility(value visibility.Visibility) *polygon {
...
func (e *polygon) PointerEvents(events pointerevents.PointerEvents) *polygon {
...
func (e *polygon) VectorEffect(effect vectoreffect.VectorEffect) *polygon {
...
func (e *polygon) ShapeRendering(rendering shaperendering.ShapeRendering) *polygon {
...
func (e *polygon) FontFamily(family string) *polygon {
...
// is in user units.
func (e *polygon) FontSize(size string) *polygon {
...
// from 100 to 900.
func (e *polygon) FontWeight(weight string) *polygon {
...
func (e *polygon) FontStyle(style string) *polygon {
...
func (e *polygon) OnChange(handler string) *polygon {
...
func (e *polygon) OnInput(handler string) *polygon {
...
func (e *polygon) OnSubmit(handler string) *polygon {
...
func (e *polygon) OnLoad(handler string) *polygon {
...
func (e *polygon) OnError(handler string) *polygon {
...
// developer-controlled key. Never build the key from user input - a key containing a space, quote,
// "=", "/" or ">" changes the markup structure. The value is escaped. The key is not escaped.
func (e *polygon) SetEvent(key string, value string) *polygon {
...
func (e *polygon) OnAbort(handler string) *polygon {
...
func (e *polygon) OnAutoComplete(handler string) *polygon {
...
//
// Deprecated: Removed from the WHATWG living standard. Was in an older HTML5 draft.
func (e *polygon) OnAutoCompleteError(handler string) *polygon {
...
func (e *polygon) OnCancel(handler string) *polygon {
...
func (e *polygon) OnCanPlay(handler string) *polygon {
...
func (e *polygon) OnCanPlayThrough(handler string) *polygon {
...
// results.
func (e *polygon) OnClose(handler string) *polygon {
...
func (e *polygon) OnContextMenu(handler string) *polygon {
...
// timestamps.
func (e *polygon) OnCueChange(handler string) *polygon {
...
func (e *polygon) OnDblClick(handler string) *polygon {
...
func (e *polygon) OnDrag(handler string) *polygon {
...
func (e *polygon) OnDragEnd(handler string) *polygon {
...
func (e *polygon) OnDragEnter(handler string) *polygon {
...
func (e *polygon) OnDragLeave(handler string) *polygon {
...
func (e *polygon) OnDragOver(handler string) *polygon {
...
func (e *polygon) OnDragStart(handler string) *polygon {
...
// enable dropping.
func (e *polygon) OnDrop(handler string) *polygon {
...
func (e *polygon) OnDurationChange(handler string) *polygon {
...
// media content.
func (e *polygon) OnEmptied(handler string) *polygon {
...
func (e *polygon) OnEnded(handler string) *polygon {
...
func (e *polygon) OnInvalid(handler string) *polygon {
...
func (e *polygon) OnKeyDown(handler string) *polygon {
...
func (e *polygon) OnKeyPress(handler string) *polygon {
...
func (e *polygon) OnKeyUp(handler string) *polygon {
...
func (e *polygon) OnLoadedData(handler string) *polygon {
...
func (e *polygon) OnLoadedMetadata(handler string) *polygon {
...
func (e *polygon) OnLoadStart(handler string) *polygon {
...
func (e *polygon) OnMouseEnter(handler string) *polygon {
...
func (e *polygon) OnMouseLeave(handler string) *polygon {
...
func (e *polygon) OnMouseWheel(handler string) *polygon {
...
func (e *polygon) OnPause(handler string) *polygon {
...
func (e *polygon) OnPlay(handler string) *polygon {
...
func (e *polygon) OnPlaying(handler string) *polygon {
...
func (e *polygon) OnProgress(handler string) *polygon {
...
func (e *polygon) OnRateChange(handler string) *polygon {
...
func (e *polygon) OnReset(handler string) *polygon {
...
// ResizeObserver.
func (e *polygon) OnResize(handler string) *polygon {
...
func (e *polygon) OnScroll(handler string) *polygon {
...
func (e *polygon) OnSeeked(handler string) *polygon {
...
func (e *polygon) OnSeeking(handler string) *polygon {
...
func (e *polygon) OnSelect(handler string) *polygon {
...
func (e *polygon) OnShow(handler string) *polygon {
...
func (e *polygon) OnSort(handler string) *polygon {
...
func (e *polygon) OnStalled(handler string) *polygon {
...
func (e *polygon) OnSuspend(handler string) *polygon {
...
func (e *polygon) OnTimeUpdate(handler string) *polygon {
...
func (e *polygon) OnToggle(handler string) *polygon {
...
func (e *polygon) OnVolumeChange(handler string) *polygon {
...
func (e *polygon) OnWaiting(handler string) *polygon {
...
func (e *polygon) OnAuxClick(handler string) *polygon {
...
func (e *polygon) OnWheel(handler string) *polygon {
...
func (e *polygon) OnCopy(handler string) *polygon {
...
// content itself.
func (e *polygon) OnCut(handler string) *polygon {
...
func (e *polygon) OnPaste(handler string) *polygon {
...
func (e *polygon) OnScrollEnd(handler string) *polygon {
...
func (e *polygon) OnFormData(handler string) *polygon {
...
func (e *polygon) OnAnimationCancel(handler string) *polygon {
...
func (e *polygon) OnAnimationEnd(handler string) *polygon {
...
func (e *polygon) OnAnimationIteration(handler string) *polygon {
...
func (e *polygon) OnAnimationStart(handler string) *polygon {
...
func (e *polygon) OnTransitionCancel(handler string) *polygon {
...
func (e *polygon) OnTransitionEnd(handler string) *polygon {
...
func (e *polygon) OnTransitionRun(handler string) *polygon {
...
func (e *polygon) OnTransitionStart(handler string) *polygon {
...
func (e *polygon) OnBeforeToggle(handler string) *polygon {
...
func (e *polygon) OnBeforeInput(handler string) *polygon {
...
func (e *polygon) OnBeforeMatch(handler string) *polygon {
...
func (e *polygon) OnCommand(handler string) *polygon {
...
func (e *polygon) OnContextLost(handler string) *polygon {
...
func (e *polygon) OnContextRestored(handler string) *polygon {
...
func (e *polygon) OnSecurityPolicyViolation(handler string) *polygon {
...
func (e *polygon) OnSlotChange(handler string) *polygon {
...
func (e *polygon) OnPointerDown(handler string) *polygon {
...
func (e *polygon) OnPointerUp(handler string) *polygon {
...
func (e *polygon) OnPointerMove(handler string) *polygon {
...
func (e *polygon) OnPointerEnter(handler string) *polygon {
...
func (e *polygon) OnPointerLeave(handler string) *polygon {
...
func (e *polygon) OnPointerOver(handler string) *polygon {
...
// element for any of its descendants.
func (e *polygon) OnPointerOut(handler string) *polygon {
...
func (e *polygon) OnPointerCancel(handler string) *polygon {
...
func (e *polygon) OnGotPointerCapture(handler string) *polygon {
...
func (e *polygon) OnLostPointerCapture(handler string) *polygon {
...
func (e *polygon) OnTouchStart(handler string) *polygon {
...
func (e *polygon) OnTouchEnd(handler string) *polygon {
...
func (e *polygon) OnTouchMove(handler string) *polygon {
...
func (e *polygon) OnTouchCancel(handler string) *polygon {
...
func (e *polygon) OnSelectStart(handler string) *polygon {
...
func (e *polygon) OnSelectionChange(handler string) *polygon {
...
func (e *polygon) Add(children ...ShapeContent) *polygon {
...
func (e *polygon) Replace(children ...ShapeContent) *polygon {
...
// isSVGShape seals polygon as a Shape.
