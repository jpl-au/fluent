...
// feComposite represents the <feComposite> SVG element.
type feComposite struct {
	bufferhint atomic.Int64
	nodes      []node.Node
	operator   compositeoperator.CompositeOperator
	dynamic    string
	height     string
	in         string
	in2        string
...
func (e *feComposite) svg() *svgAttrs {
	if e.sa == nil {
		e.sa = &svgAttrs{}
	}
	return e.sa
...
func (e *feComposite) event() *html5.EventAttributes {
	if e.ea == nil {
...
// FeComposite combines two filter inputs using a Porter-Duff compositing
// operation or component-wise arithmetic. The in and in2 attributes select
// the inputs. Arithmetic uses the k1, k2, k3 and k4 coefficients.
func FeComposite(children ...PrimitiveContent) *feComposite {
...
//
// The source input to the compositing operation. The in2 attribute supplies
// the destination input. The distinction matters for operations such as over,
// in and out.
func (e *feComposite) In(value string) *feComposite {
...
//
// The second input.
func (e *feComposite) In2(value string) *feComposite {
	e.in2 = node.EscapeAttribute(value)
	return e
}

// Operator sets the operator attribute.
//
// Which operation combines the inputs.
func (e *feComposite) Operator(value compositeoperator.CompositeOperator) *feComposite {
	e.operator = value
	return e
}

// K1 sets the k1 attribute.
//
// The coefficient of i1·i2 in the arithmetic operator. It is ignored by every other operator.
func (e *feComposite) K1(value string) *feComposite {
	e.k1 = node.EscapeAttribute(value)
	return e
}

// K2 sets the k2 attribute.
//
// The coefficient of i1 in the arithmetic operator.
func (e *feComposite) K2(value string) *feComposite {
	e.k2 = node.EscapeAttribute(value)
	return e
}

// K3 sets the k3 attribute.
//
// The coefficient of i2 in the arithmetic operator.
func (e *feComposite) K3(value string) *feComposite {
	e.k3 = node.EscapeAttribute(value)
	return e
}

// K4 sets the k4 attribute.
//
// The constant added by the arithmetic operator.
func (e *feComposite) K4(value string) *feComposite {
	e.k4 = node.EscapeAttribute(value)
	return e
}

// X sets the x attribute.
func (e *feComposite) X(value string) *feComposite {
	e.x = node.EscapeAttribute(value)
	return e
}

// Y sets the y attribute.
func (e *feComposite) Y(value string) *feComposite {
	e.y = node.EscapeAttribute(value)
	return e
}

// Width sets the width attribute.
func (e *feComposite) Width(value string) *feComposite {
	e.width = node.EscapeAttribute(value)
	return e
}

// Height sets the height attribute.
func (e *feComposite) Height(value string) *feComposite {
	e.height = node.EscapeAttribute(value)
	return e
}

// Result sets the result attribute.
func (e *feComposite) Result(value string) *feComposite {
	e.result = node.EscapeAttribute(value)
	return e
}

// ID sets the id attribute.
func (e *feComposite) ID(id string) *feComposite {
	e.svg().ID = node.EscapeAttribute(id)
	return e
}

// Class appends to the space-separated class attribute.
func (e *feComposite) Class(class string) *feComposite {
...
func (e *feComposite) Style(css string) *feComposite {
	e.svg().Style = node.EscapeAttribute(css)
	return e
}

// Transform sets the transform attribute.
func (e *feComposite) Transform(transform string) *feComposite {
...
func (e *feComposite) TransformOrigin(origin string) *feComposite {
	e.svg().TransformOrigin = node.EscapeAttribute(origin)
	return e
}

// TabIndex sets the tabindex attribute.
func (e *feComposite) TabIndex(index string) *feComposite {
	e.svg().TabIndex = node.EscapeAttribute(index)
	return e
}

// Role sets the role attribute.
func (e *feComposite) Role(role string) *feComposite {
...
func (e *feComposite) Lang(lang string) *feComposite {
...
func (e *feComposite) AutoFocus(conds ...bool) *feComposite {
	if len(conds) > 0 {
...
func (e *feComposite) SetAria(key string, value string) *feComposite {
...
func (e *feComposite) StrokeDashOffset(offset string) *feComposite {
...
func (e *feComposite) StrokeMiterLimit(limit string) *feComposite {
...
func (e *feComposite) FillRule(rule fillrule.FillRule) *feComposite {
	e.svg().FillRule = rule
	return e
}
...
// a clipPath.
func (e *feComposite) ClipRule(rule cliprule.ClipRule) *feComposite {
	e.svg().ClipRule = rule
	return e
}
...
func (e *feComposite) ClipPath(clip string) *feComposite {
...
// per pixel.
func (e *feComposite) Mask(mask string) *feComposite {
...
func (e *feComposite) Filter(filter string) *feComposite {
...
func (e *feComposite) Color(color string) *feComposite {
...
func (e *feComposite) Cursor(cursor string) *feComposite {
...
func (e *feComposite) Display(display string) *feComposite {
...
// drawn again.
func (e *feComposite) Visibility(value visibility.Visibility) *feComposite {
...
func (e *feComposite) PointerEvents(events pointerevents.PointerEvents) *feComposite {
...
func (e *feComposite) VectorEffect(effect vectoreffect.VectorEffect) *feComposite {
...
func (e *feComposite) ShapeRendering(rendering shaperendering.ShapeRendering) *feComposite {
...
func (e *feComposite) FontFamily(family string) *feComposite {
...
// is in user units.
func (e *feComposite) FontSize(size string) *feComposite {
...
// from 100 to 900.
func (e *feComposite) FontWeight(weight string) *feComposite {
...
func (e *feComposite) FontStyle(style string) *feComposite {
...
func (e *feComposite) OnClick(handler string) *feComposite {
...
func (e *feComposite) OnChange(handler string) *feComposite {
...
func (e *feComposite) OnInput(handler string) *feComposite {
...
func (e *feComposite) OnFocus(handler string) *feComposite {
...
func (e *feComposite) OnBlur(handler string) *feComposite {
...
func (e *feComposite) OnSubmit(handler string) *feComposite {
...
func (e *feComposite) OnLoad(handler string) *feComposite {
...
func (e *feComposite) OnError(handler string) *feComposite {
...
// developer-controlled key. Never build the key from user input - a key containing a space, quote,
// "=", "/" or ">" changes the markup structure. The value is escaped. The key is not escaped.
func (e *feComposite) SetEvent(key string, value string) *feComposite {
...
func (e *feComposite) OnAbort(handler string) *feComposite {
...
func (e *feComposite) OnAutoComplete(handler string) *feComposite {
...
//
// Deprecated: Removed from the WHATWG living standard. Was in an older HTML5 draft.
func (e *feComposite) OnAutoCompleteError(handler string) *feComposite {
...
func (e *feComposite) OnCancel(handler string) *feComposite {
...
func (e *feComposite) OnCanPlay(handler string) *feComposite {
...
func (e *feComposite) OnCanPlayThrough(handler string) *feComposite {
...
// results.
func (e *feComposite) OnClose(handler string) *feComposite {
...
func (e *feComposite) OnContextMenu(handler string) *feComposite {
...
// timestamps.
func (e *feComposite) OnCueChange(handler string) *feComposite {
...
func (e *feComposite) OnDblClick(handler string) *feComposite {
...
func (e *feComposite) OnDrag(handler string) *feComposite {
...
func (e *feComposite) OnDragEnd(handler string) *feComposite {
...
func (e *feComposite) OnDragEnter(handler string) *feComposite {
...
func (e *feComposite) OnDragLeave(handler string) *feComposite {
...
func (e *feComposite) OnDragOver(handler string) *feComposite {
...
func (e *feComposite) OnDragStart(handler string) *feComposite {
...
// enable dropping.
func (e *feComposite) OnDrop(handler string) *feComposite {
...
func (e *feComposite) OnDurationChange(handler string) *feComposite {
...
// media content.
func (e *feComposite) OnEmptied(handler string) *feComposite {
...
func (e *feComposite) OnEnded(handler string) *feComposite {
...
func (e *feComposite) OnInvalid(handler string) *feComposite {
...
func (e *feComposite) OnKeyDown(handler string) *feComposite {
...
func (e *feComposite) OnKeyPress(handler string) *feComposite {
...
func (e *feComposite) OnKeyUp(handler string) *feComposite {
...
func (e *feComposite) OnLoadedData(handler string) *feComposite {
...
func (e *feComposite) OnLoadedMetadata(handler string) *feComposite {
...
func (e *feComposite) OnLoadStart(handler string) *feComposite {
...
func (e *feComposite) OnMouseDown(handler string) *feComposite {
...
func (e *feComposite) OnMouseEnter(handler string) *feComposite {
...
func (e *feComposite) OnMouseLeave(handler string) *feComposite {
...
func (e *feComposite) OnMouseMove(handler string) *feComposite {
...
func (e *feComposite) OnMouseOut(handler string) *feComposite {
...
func (e *feComposite) OnMouseOver(handler string) *feComposite {
...
func (e *feComposite) OnMouseUp(handler string) *feComposite {
...
func (e *feComposite) OnMouseWheel(handler string) *feComposite {
...
func (e *feComposite) OnPause(handler string) *feComposite {
...
func (e *feComposite) OnPlay(handler string) *feComposite {
...
func (e *feComposite) OnPlaying(handler string) *feComposite {
...
func (e *feComposite) OnProgress(handler string) *feComposite {
...
func (e *feComposite) OnRateChange(handler string) *feComposite {
...
func (e *feComposite) OnReset(handler string) *feComposite {
...
// ResizeObserver.
func (e *feComposite) OnResize(handler string) *feComposite {
...
func (e *feComposite) OnScroll(handler string) *feComposite {
...
func (e *feComposite) OnSeeked(handler string) *feComposite {
...
func (e *feComposite) OnSeeking(handler string) *feComposite {
...
func (e *feComposite) OnSelect(handler string) *feComposite {
...
func (e *feComposite) OnShow(handler string) *feComposite {
...
func (e *feComposite) OnSort(handler string) *feComposite {
...
func (e *feComposite) OnStalled(handler string) *feComposite {
...
func (e *feComposite) OnSuspend(handler string) *feComposite {
...
func (e *feComposite) OnTimeUpdate(handler string) *feComposite {
...
func (e *feComposite) OnToggle(handler string) *feComposite {
...
func (e *feComposite) OnVolumeChange(handler string) *feComposite {
...
func (e *feComposite) OnWaiting(handler string) *feComposite {
...
func (e *feComposite) OnAuxClick(handler string) *feComposite {
...
func (e *feComposite) OnWheel(handler string) *feComposite {
...
func (e *feComposite) OnCopy(handler string) *feComposite {
...
// content itself.
func (e *feComposite) OnCut(handler string) *feComposite {
...
func (e *feComposite) OnPaste(handler string) *feComposite {
...
func (e *feComposite) OnScrollEnd(handler string) *feComposite {
...
func (e *feComposite) OnFormData(handler string) *feComposite {
...
func (e *feComposite) OnAnimationCancel(handler string) *feComposite {
...
func (e *feComposite) OnAnimationEnd(handler string) *feComposite {
...
func (e *feComposite) OnAnimationIteration(handler string) *feComposite {
...
func (e *feComposite) OnAnimationStart(handler string) *feComposite {
...
func (e *feComposite) OnTransitionCancel(handler string) *feComposite {
...
func (e *feComposite) OnTransitionEnd(handler string) *feComposite {
...
func (e *feComposite) OnTransitionRun(handler string) *feComposite {
...
func (e *feComposite) OnTransitionStart(handler string) *feComposite {
...
func (e *feComposite) OnBeforeToggle(handler string) *feComposite {
...
func (e *feComposite) OnBeforeInput(handler string) *feComposite {
...
func (e *feComposite) OnBeforeMatch(handler string) *feComposite {
...
func (e *feComposite) OnCommand(handler string) *feComposite {
...
func (e *feComposite) OnContextLost(handler string) *feComposite {
...
func (e *feComposite) OnContextRestored(handler string) *feComposite {
...
func (e *feComposite) OnSecurityPolicyViolation(handler string) *feComposite {
...
func (e *feComposite) OnSlotChange(handler string) *feComposite {
...
func (e *feComposite) OnPointerDown(handler string) *feComposite {
...
func (e *feComposite) OnPointerUp(handler string) *feComposite {
...
func (e *feComposite) OnPointerMove(handler string) *feComposite {
...
func (e *feComposite) OnPointerEnter(handler string) *feComposite {
...
func (e *feComposite) OnPointerLeave(handler string) *feComposite {
...
func (e *feComposite) OnPointerOver(handler string) *feComposite {
...
// element for any of its descendants.
func (e *feComposite) OnPointerOut(handler string) *feComposite {
...
func (e *feComposite) OnPointerCancel(handler string) *feComposite {
...
func (e *feComposite) OnGotPointerCapture(handler string) *feComposite {
...
func (e *feComposite) OnLostPointerCapture(handler string) *feComposite {
...
func (e *feComposite) OnTouchStart(handler string) *feComposite {
...
func (e *feComposite) OnTouchEnd(handler string) *feComposite {
...
func (e *feComposite) OnTouchMove(handler string) *feComposite {
...
func (e *feComposite) OnTouchCancel(handler string) *feComposite {
...
func (e *feComposite) OnSelectStart(handler string) *feComposite {
...
func (e *feComposite) OnSelectionChange(handler string) *feComposite {
...
func (e *feComposite) SetAttribute(key string, value string) {
...
func (e *feComposite) SetAttributeRaw(key string, value string) {
	if e.attr == nil {
		e.attr = &[]node.Attribute{}
	}
	for i, attr := range *e.attr {
...
func (e *feComposite) Add(children ...PrimitiveContent) *feComposite {
...
func (e *feComposite) Replace(children ...PrimitiveContent) *feComposite {
...
func (e *feComposite) Dynamic(key string) *feComposite {
	e.dynamic = key
	return e
}

// IsDynamic reports whether this element has been marked for reactive tracking.
func (e *feComposite) IsDynamic() bool {
	return e.dynamic != ""
}
...
func (e *feComposite) DynamicKey() string {
	return e.dynamic
}
...
func (e *feComposite) Memoise(version any) *feComposite {
	e.memoise = version
	return e
}
...
// by fluent-jit.
func (e *feComposite) MemoiseKey() any {
	return e.memoise
}
...
func (e *feComposite) BufferHint(hint int) *feComposite {
	if hint > 0 {
...
func (e *feComposite) RenderedSize() int {
...
func (e *feComposite) Render(w io.Writer) {
	_, _ = e.WriteTo(w)
}
...
func (e *feComposite) WriteTo(w io.Writer) (int64, error) {
...
func (e *feComposite) RenderBytes() []byte {
...
func (e *feComposite) AttributeBuilder(buf *bytes.Buffer) {
	if e.in != "" {
		buf.Write(AttrIn)
	...
	if len(e.operator) > 0 {
		buf.Write(AttrOperator)
		buf.Write(e.operator)
		buf.Write(MarkupQuote)
	}
	if e.k1 != "" {
		buf.Write(AttrK1)
		buf.WriteString(e.k1)
		buf.Write(MarkupQuote)
	}
	if e.k2 != "" {
		buf.Write(AttrK2)
		buf.WriteString(e.k2)
		buf.Write(MarkupQuote)
	}
	if e.k3 != "" {
		buf.Write(AttrK3)
		buf.WriteString(e.k3)
		buf.Write(MarkupQuote)
	}
	if e.k4 != "" {
		buf.Write(AttrK4)
		buf.WriteString(e.k4)
		buf.Write(MarkupQuote)
	}
	if e.x != "" {
		buf.Write(AttrX)
...
func (e *feComposite) RenderBuilder(buf *bytes.Buffer) {
	buf.Write(TagFeComposite)
	...
	buf.Write(TagFeCompositeClose)
}

// RenderOpen writes the opening tag and attributes to the buffer.
func (e *feComposite) RenderOpen(buf *bytes.Buffer) {
	buf.Write(TagFeComposite)
	e.AttributeBuilder(buf)
	buf.Write(MarkupCloseTag)
}
...
// isSVGFilterPrimitive seals feComposite as a FilterPrimitive.
func (*feComposite) isSVGFilterPrimitive() {}
