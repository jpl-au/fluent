...
// feDistantLight represents the <feDistantLight> SVG element.
...
func (e *feDistantLight) svg() *svgAttrs {
	if e.sa == nil {
		e.sa = &svgAttrs{}
	}
	return e.sa
...
func (e *feDistantLight) event() *html5.EventAttributes {
	if e.ea == nil {
...
// FeDistantLight defines a directional light source for FeDiffuseLighting or
// FeSpecularLighting. Its rays are parallel. Azimuth and elevation specify
// the direction without a position.
func FeDistantLight(children ...PrimitiveContent) *feDistantLight {
...
// Azimuth sets the azimuth attribute.
//
// The direction of the light in the xy plane, in degrees clockwise from the positive x axis.
func (e *feDistantLight) Azimuth(value string) *feDistantLight {
	e.azimuth = node.EscapeAttribute(value)
	return e
}

// Elevation sets the elevation attribute.
//
// The angle of the light above the xy plane, in degrees. Ninety is directly overhead.
func (e *feDistantLight) Elevation(value string) *feDistantLight {
	e.elevation = node.EscapeAttribute(value)
	return e
}

// ID sets the id attribute.
func (e *feDistantLight) ID(id string) *feDistantLight {
	e.svg().ID = node.EscapeAttribute(id)
	return e
}

// Class appends to the space-separated class attribute.
func (e *feDistantLight) Class(class string) *feDistantLight {
...
func (e *feDistantLight) Style(css string) *feDistantLight {
	e.svg().Style = node.EscapeAttribute(css)
	return e
}

// Transform sets the transform attribute.
func (e *feDistantLight) Transform(transform string) *feDistantLight {
...
func (e *feDistantLight) TransformOrigin(origin string) *feDistantLight {
	e.svg().TransformOrigin = node.EscapeAttribute(origin)
	return e
}

// TabIndex sets the tabindex attribute.
func (e *feDistantLight) TabIndex(index string) *feDistantLight {
	e.svg().TabIndex = node.EscapeAttribute(index)
	return e
}

// Role sets the role attribute.
func (e *feDistantLight) Role(role string) *feDistantLight {
...
func (e *feDistantLight) Lang(lang string) *feDistantLight {
...
func (e *feDistantLight) AutoFocus(conds ...bool) *feDistantLight {
	if len(conds) > 0 {
...
func (e *feDistantLight) SetAria(key string, value string) *feDistantLight {
...
func (e *feDistantLight) StrokeDashOffset(offset string) *feDistantLight {
...
func (e *feDistantLight) StrokeMiterLimit(limit string) *feDistantLight {
...
func (e *feDistantLight) FillRule(rule fillrule.FillRule) *feDistantLight {
	e.svg().FillRule = rule
	return e
}
...
// a clipPath.
func (e *feDistantLight) ClipRule(rule cliprule.ClipRule) *feDistantLight {
	e.svg().ClipRule = rule
	return e
}
...
func (e *feDistantLight) ClipPath(clip string) *feDistantLight {
...
// per pixel.
func (e *feDistantLight) Mask(mask string) *feDistantLight {
...
func (e *feDistantLight) Filter(filter string) *feDistantLight {
...
func (e *feDistantLight) Color(color string) *feDistantLight {
...
func (e *feDistantLight) Cursor(cursor string) *feDistantLight {
...
func (e *feDistantLight) Display(display string) *feDistantLight {
...
// drawn again.
func (e *feDistantLight) Visibility(value visibility.Visibility) *feDistantLight {
...
func (e *feDistantLight) PointerEvents(events pointerevents.PointerEvents) *feDistantLight {
...
func (e *feDistantLight) VectorEffect(effect vectoreffect.VectorEffect) *feDistantLight {
...
func (e *feDistantLight) ShapeRendering(rendering shaperendering.ShapeRendering) *feDistantLight {
...
func (e *feDistantLight) FontFamily(family string) *feDistantLight {
...
// is in user units.
func (e *feDistantLight) FontSize(size string) *feDistantLight {
...
// from 100 to 900.
func (e *feDistantLight) FontWeight(weight string) *feDistantLight {
...
func (e *feDistantLight) FontStyle(style string) *feDistantLight {
...
func (e *feDistantLight) OnClick(handler string) *feDistantLight {
...
func (e *feDistantLight) OnChange(handler string) *feDistantLight {
...
func (e *feDistantLight) OnInput(handler string) *feDistantLight {
...
func (e *feDistantLight) OnFocus(handler string) *feDistantLight {
...
func (e *feDistantLight) OnBlur(handler string) *feDistantLight {
...
func (e *feDistantLight) OnSubmit(handler string) *feDistantLight {
...
func (e *feDistantLight) OnLoad(handler string) *feDistantLight {
...
func (e *feDistantLight) OnError(handler string) *feDistantLight {
...
// developer-controlled key. Never build the key from user input - a key containing a space, quote,
// "=", "/" or ">" changes the markup structure. The value is escaped. The key is not escaped.
func (e *feDistantLight) SetEvent(key string, value string) *feDistantLight {
...
func (e *feDistantLight) OnAbort(handler string) *feDistantLight {
...
func (e *feDistantLight) OnAutoComplete(handler string) *feDistantLight {
...
//
// Deprecated: Removed from the WHATWG living standard. Was in an older HTML5 draft.
func (e *feDistantLight) OnAutoCompleteError(handler string) *feDistantLight {
...
func (e *feDistantLight) OnCancel(handler string) *feDistantLight {
...
func (e *feDistantLight) OnCanPlay(handler string) *feDistantLight {
...
func (e *feDistantLight) OnCanPlayThrough(handler string) *feDistantLight {
...
// results.
func (e *feDistantLight) OnClose(handler string) *feDistantLight {
...
func (e *feDistantLight) OnContextMenu(handler string) *feDistantLight {
...
// timestamps.
func (e *feDistantLight) OnCueChange(handler string) *feDistantLight {
...
func (e *feDistantLight) OnDblClick(handler string) *feDistantLight {
...
func (e *feDistantLight) OnDrag(handler string) *feDistantLight {
...
func (e *feDistantLight) OnDragEnd(handler string) *feDistantLight {
...
func (e *feDistantLight) OnDragEnter(handler string) *feDistantLight {
...
func (e *feDistantLight) OnDragLeave(handler string) *feDistantLight {
...
func (e *feDistantLight) OnDragOver(handler string) *feDistantLight {
...
func (e *feDistantLight) OnDragStart(handler string) *feDistantLight {
...
// enable dropping.
func (e *feDistantLight) OnDrop(handler string) *feDistantLight {
...
func (e *feDistantLight) OnDurationChange(handler string) *feDistantLight {
...
// media content.
func (e *feDistantLight) OnEmptied(handler string) *feDistantLight {
...
func (e *feDistantLight) OnEnded(handler string) *feDistantLight {
...
func (e *feDistantLight) OnInvalid(handler string) *feDistantLight {
...
func (e *feDistantLight) OnKeyDown(handler string) *feDistantLight {
...
func (e *feDistantLight) OnKeyPress(handler string) *feDistantLight {
...
func (e *feDistantLight) OnKeyUp(handler string) *feDistantLight {
...
func (e *feDistantLight) OnLoadedData(handler string) *feDistantLight {
...
func (e *feDistantLight) OnLoadedMetadata(handler string) *feDistantLight {
...
func (e *feDistantLight) OnLoadStart(handler string) *feDistantLight {
...
func (e *feDistantLight) OnMouseDown(handler string) *feDistantLight {
...
func (e *feDistantLight) OnMouseEnter(handler string) *feDistantLight {
...
func (e *feDistantLight) OnMouseLeave(handler string) *feDistantLight {
...
func (e *feDistantLight) OnMouseMove(handler string) *feDistantLight {
...
func (e *feDistantLight) OnMouseOut(handler string) *feDistantLight {
...
func (e *feDistantLight) OnMouseOver(handler string) *feDistantLight {
...
func (e *feDistantLight) OnMouseUp(handler string) *feDistantLight {
...
func (e *feDistantLight) OnMouseWheel(handler string) *feDistantLight {
...
func (e *feDistantLight) OnPause(handler string) *feDistantLight {
...
func (e *feDistantLight) OnPlay(handler string) *feDistantLight {
...
func (e *feDistantLight) OnPlaying(handler string) *feDistantLight {
...
func (e *feDistantLight) OnProgress(handler string) *feDistantLight {
...
func (e *feDistantLight) OnRateChange(handler string) *feDistantLight {
...
func (e *feDistantLight) OnReset(handler string) *feDistantLight {
...
// ResizeObserver.
func (e *feDistantLight) OnResize(handler string) *feDistantLight {
...
func (e *feDistantLight) OnScroll(handler string) *feDistantLight {
...
func (e *feDistantLight) OnSeeked(handler string) *feDistantLight {
...
func (e *feDistantLight) OnSeeking(handler string) *feDistantLight {
...
func (e *feDistantLight) OnSelect(handler string) *feDistantLight {
...
func (e *feDistantLight) OnShow(handler string) *feDistantLight {
...
func (e *feDistantLight) OnSort(handler string) *feDistantLight {
...
func (e *feDistantLight) OnStalled(handler string) *feDistantLight {
...
func (e *feDistantLight) OnSuspend(handler string) *feDistantLight {
...
func (e *feDistantLight) OnTimeUpdate(handler string) *feDistantLight {
...
func (e *feDistantLight) OnToggle(handler string) *feDistantLight {
...
func (e *feDistantLight) OnVolumeChange(handler string) *feDistantLight {
...
func (e *feDistantLight) OnWaiting(handler string) *feDistantLight {
...
func (e *feDistantLight) OnAuxClick(handler string) *feDistantLight {
...
func (e *feDistantLight) OnWheel(handler string) *feDistantLight {
...
func (e *feDistantLight) OnCopy(handler string) *feDistantLight {
...
// content itself.
func (e *feDistantLight) OnCut(handler string) *feDistantLight {
...
func (e *feDistantLight) OnPaste(handler string) *feDistantLight {
...
func (e *feDistantLight) OnScrollEnd(handler string) *feDistantLight {
...
func (e *feDistantLight) OnFormData(handler string) *feDistantLight {
...
func (e *feDistantLight) OnAnimationCancel(handler string) *feDistantLight {
...
func (e *feDistantLight) OnAnimationEnd(handler string) *feDistantLight {
...
func (e *feDistantLight) OnAnimationIteration(handler string) *feDistantLight {
...
func (e *feDistantLight) OnAnimationStart(handler string) *feDistantLight {
...
func (e *feDistantLight) OnTransitionCancel(handler string) *feDistantLight {
...
func (e *feDistantLight) OnTransitionEnd(handler string) *feDistantLight {
...
func (e *feDistantLight) OnTransitionRun(handler string) *feDistantLight {
...
func (e *feDistantLight) OnTransitionStart(handler string) *feDistantLight {
...
func (e *feDistantLight) OnBeforeToggle(handler string) *feDistantLight {
...
func (e *feDistantLight) OnBeforeInput(handler string) *feDistantLight {
...
func (e *feDistantLight) OnBeforeMatch(handler string) *feDistantLight {
...
func (e *feDistantLight) OnCommand(handler string) *feDistantLight {
...
func (e *feDistantLight) OnContextLost(handler string) *feDistantLight {
...
func (e *feDistantLight) OnContextRestored(handler string) *feDistantLight {
...
func (e *feDistantLight) OnSecurityPolicyViolation(handler string) *feDistantLight {
...
func (e *feDistantLight) OnSlotChange(handler string) *feDistantLight {
...
func (e *feDistantLight) OnPointerDown(handler string) *feDistantLight {
...
func (e *feDistantLight) OnPointerUp(handler string) *feDistantLight {
...
func (e *feDistantLight) OnPointerMove(handler string) *feDistantLight {
...
func (e *feDistantLight) OnPointerEnter(handler string) *feDistantLight {
...
func (e *feDistantLight) OnPointerLeave(handler string) *feDistantLight {
...
func (e *feDistantLight) OnPointerOver(handler string) *feDistantLight {
...
// element for any of its descendants.
func (e *feDistantLight) OnPointerOut(handler string) *feDistantLight {
...
func (e *feDistantLight) OnPointerCancel(handler string) *feDistantLight {
...
func (e *feDistantLight) OnGotPointerCapture(handler string) *feDistantLight {
...
func (e *feDistantLight) OnLostPointerCapture(handler string) *feDistantLight {
...
func (e *feDistantLight) OnTouchStart(handler string) *feDistantLight {
...
func (e *feDistantLight) OnTouchEnd(handler string) *feDistantLight {
...
func (e *feDistantLight) OnTouchMove(handler string) *feDistantLight {
...
func (e *feDistantLight) OnTouchCancel(handler string) *feDistantLight {
...
func (e *feDistantLight) OnSelectStart(handler string) *feDistantLight {
...
func (e *feDistantLight) OnSelectionChange(handler string) *feDistantLight {
...
func (e *feDistantLight) SetAttribute(key string, value string) {
...
func (e *feDistantLight) SetAttributeRaw(key string, value string) {
	if e.attr == nil {
		e.attr = &[]node.Attribute{}
	}
	for i, attr := range *e.attr {
...
func (e *feDistantLight) Add(children ...PrimitiveContent) *feDistantLight {
...
func (e *feDistantLight) Replace(children ...PrimitiveContent) *feDistantLight {
...
func (e *feDistantLight) Dynamic(key string) *feDistantLight {
	e.dynamic = key
	return e
}

// IsDynamic reports whether this element has been marked for reactive tracking.
func (e *feDistantLight) IsDynamic() bool {
	return e.dynamic != ""
}
...
func (e *feDistantLight) DynamicKey() string {
	return e.dynamic
}
...
func (e *feDistantLight) Memoise(version any) *feDistantLight {
	e.memoise = version
	return e
}
...
// by fluent-jit.
func (e *feDistantLight) MemoiseKey() any {
	return e.memoise
}
...
func (e *feDistantLight) BufferHint(hint int) *feDistantLight {
	if hint > 0 {
...
func (e *feDistantLight) RenderedSize() int {
...
func (e *feDistantLight) Render(w io.Writer) {
	_, _ = e.WriteTo(w)
}
...
func (e *feDistantLight) WriteTo(w io.Writer) (int64, error) {
...
func (e *feDistantLight) RenderBytes() []byte {
...
func (e *feDistantLight) AttributeBuilder(buf *bytes.Buffer) {
	if e.azimuth != "" {
		buf.Write(AttrAzimuth)
		buf.WriteString(e.azimuth)
		buf.Write(MarkupQuote)
	}
	if e.elevation != "" {
		buf.Write(AttrElevation)
		buf.WriteString(e.elevation)
		buf.Write(MarkupQuote)
	}
...
func (e *feDistantLight) RenderBuilder(buf *bytes.Buffer) {
	buf.Write(TagFeDistantLight)
	...
	buf.Write(TagFeDistantLightClose)
}

// RenderOpen writes the opening tag and attributes to the buffer.
func (e *feDistantLight) RenderOpen(buf *bytes.Buffer) {
	buf.Write(TagFeDistantLight)
	e.AttributeBuilder(buf)
	buf.Write(MarkupCloseTag)
}
...
func (e *feDistantLight) RenderClose(buf *bytes.Buffer) {
	buf.Write(TagFeDistantLightClose)
}

// Nodes returns a slice of child nodes.
func (e *feDistantLight) Nodes() []node.Node {
	return e.nodes
}

// Attributes returns a pointer to the underlying attributes slice for direct attribute manipulation.
func (e *feDistantLight) Attributes() *[]node.Attribute {
	if e.attr == nil {
...
// isSVGLightSource seals feDistantLight as a LightSource.
func (*feDistantLight) isSVGLightSource() {}
