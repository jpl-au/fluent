...
// feTurbulence represents the <feTurbulence> SVG element.
type feTurbulence struct {
	bufferhint    atomic.Int64
	nodes         []node.Node
	stitchTiles   stitchtiles.StitchTiles
	typeAttr      turbulencetype.TurbulenceType
...
func (e *feTurbulence) svg() *svgAttrs {
	if e.sa == nil {
		e.sa = &svgAttrs{}
	}
	return e.sa
...
func (e *feTurbulence) event() *html5.EventAttributes {
	if e.ea == nil {
...
// FeTurbulence generates Perlin noise, with no input. It is the source of
// procedural textures such as clouds, marble and paper grain, and of the
// displacement maps that warp other artwork.
func FeTurbulence(children ...PrimitiveContent) *feTurbulence {
...
// BaseFrequency sets the baseFrequency attribute.
//
// The scale of the noise. Small values give large, soft features and large values give fine grain. One
// number applies to both axes. Two apply to x and y separately.
func (e *feTurbulence) BaseFrequency(value string) *feTurbulence {
	e.baseFrequency = node.EscapeAttribute(value)
	return e
}

// NumOctaves sets the numOctaves attribute.
//
// How many layers of detail are summed. Each octave doubles the frequency, so more octaves add finer
// detail at more cost.
func (e *feTurbulence) NumOctaves(value string) *feTurbulence {
	e.numOctaves = node.EscapeAttribute(value)
	return e
}

// Seed sets the seed attribute.
//
// The starting number for the noise, so a different seed gives a different pattern at the same settings.
func (e *feTurbulence) Seed(value string) *feTurbulence {
	e.seed = node.EscapeAttribute(value)
	return e
}

// StitchTiles sets the stitchTiles attribute.
//
// Whether the noise is adjusted so adjacent tiles meet without a seam.
func (e *feTurbulence) StitchTiles(value stitchtiles.StitchTiles) *feTurbulence {
	e.stitchTiles = value
	return e
}
...
//
// Which kind of noise to generate.
func (e *feTurbulence) Type(value turbulencetype.TurbulenceType) *feTurbulence {
	e.typeAttr = value
	return e
}

// X sets the x attribute.
func (e *feTurbulence) X(value string) *feTurbulence {
	e.x = node.EscapeAttribute(value)
	return e
}

// Y sets the y attribute.
func (e *feTurbulence) Y(value string) *feTurbulence {
	e.y = node.EscapeAttribute(value)
	return e
}

// Width sets the width attribute.
func (e *feTurbulence) Width(value string) *feTurbulence {
	e.width = node.EscapeAttribute(value)
	return e
}

// Height sets the height attribute.
func (e *feTurbulence) Height(value string) *feTurbulence {
	e.height = node.EscapeAttribute(value)
	return e
}

// Result sets the result attribute.
func (e *feTurbulence) Result(value string) *feTurbulence {
	e.result = node.EscapeAttribute(value)
	return e
}

// ID sets the id attribute.
func (e *feTurbulence) ID(id string) *feTurbulence {
	e.svg().ID = node.EscapeAttribute(id)
	return e
}

// Class appends to the space-separated class attribute.
func (e *feTurbulence) Class(class string) *feTurbulence {
...
func (e *feTurbulence) Style(css string) *feTurbulence {
	e.svg().Style = node.EscapeAttribute(css)
	return e
}

// Transform sets the transform attribute.
func (e *feTurbulence) Transform(transform string) *feTurbulence {
...
func (e *feTurbulence) TransformOrigin(origin string) *feTurbulence {
	e.svg().TransformOrigin = node.EscapeAttribute(origin)
	return e
}

// TabIndex sets the tabindex attribute.
func (e *feTurbulence) TabIndex(index string) *feTurbulence {
	e.svg().TabIndex = node.EscapeAttribute(index)
	return e
}

// Role sets the role attribute.
func (e *feTurbulence) Role(role string) *feTurbulence {
...
func (e *feTurbulence) Lang(lang string) *feTurbulence {
...
func (e *feTurbulence) AutoFocus(conds ...bool) *feTurbulence {
	if len(conds) > 0 {
...
func (e *feTurbulence) SetAria(key string, value string) *feTurbulence {
...
func (e *feTurbulence) StrokeDashOffset(offset string) *feTurbulence {
...
func (e *feTurbulence) StrokeMiterLimit(limit string) *feTurbulence {
...
func (e *feTurbulence) FillRule(rule fillrule.FillRule) *feTurbulence {
	e.svg().FillRule = rule
	return e
}
...
// a clipPath.
func (e *feTurbulence) ClipRule(rule cliprule.ClipRule) *feTurbulence {
	e.svg().ClipRule = rule
	return e
}
...
func (e *feTurbulence) ClipPath(clip string) *feTurbulence {
...
// per pixel.
func (e *feTurbulence) Mask(mask string) *feTurbulence {
...
func (e *feTurbulence) Filter(filter string) *feTurbulence {
...
func (e *feTurbulence) Color(color string) *feTurbulence {
...
func (e *feTurbulence) Cursor(cursor string) *feTurbulence {
...
func (e *feTurbulence) Display(display string) *feTurbulence {
...
// drawn again.
func (e *feTurbulence) Visibility(value visibility.Visibility) *feTurbulence {
...
func (e *feTurbulence) PointerEvents(events pointerevents.PointerEvents) *feTurbulence {
...
func (e *feTurbulence) VectorEffect(effect vectoreffect.VectorEffect) *feTurbulence {
...
func (e *feTurbulence) ShapeRendering(rendering shaperendering.ShapeRendering) *feTurbulence {
...
func (e *feTurbulence) FontFamily(family string) *feTurbulence {
...
// is in user units.
func (e *feTurbulence) FontSize(size string) *feTurbulence {
...
// from 100 to 900.
func (e *feTurbulence) FontWeight(weight string) *feTurbulence {
...
func (e *feTurbulence) FontStyle(style string) *feTurbulence {
...
func (e *feTurbulence) OnClick(handler string) *feTurbulence {
...
func (e *feTurbulence) OnChange(handler string) *feTurbulence {
...
func (e *feTurbulence) OnInput(handler string) *feTurbulence {
...
func (e *feTurbulence) OnFocus(handler string) *feTurbulence {
...
func (e *feTurbulence) OnBlur(handler string) *feTurbulence {
...
func (e *feTurbulence) OnSubmit(handler string) *feTurbulence {
...
func (e *feTurbulence) OnLoad(handler string) *feTurbulence {
...
func (e *feTurbulence) OnError(handler string) *feTurbulence {
...
// developer-controlled key. Never build the key from user input - a key containing a space, quote,
// "=", "/" or ">" changes the markup structure. The value is escaped. The key is not escaped.
func (e *feTurbulence) SetEvent(key string, value string) *feTurbulence {
...
func (e *feTurbulence) OnAbort(handler string) *feTurbulence {
...
func (e *feTurbulence) OnAutoComplete(handler string) *feTurbulence {
...
//
// Deprecated: Removed from the WHATWG living standard. Was in an older HTML5 draft.
func (e *feTurbulence) OnAutoCompleteError(handler string) *feTurbulence {
...
func (e *feTurbulence) OnCancel(handler string) *feTurbulence {
...
func (e *feTurbulence) OnCanPlay(handler string) *feTurbulence {
...
func (e *feTurbulence) OnCanPlayThrough(handler string) *feTurbulence {
...
// results.
func (e *feTurbulence) OnClose(handler string) *feTurbulence {
...
func (e *feTurbulence) OnContextMenu(handler string) *feTurbulence {
...
// timestamps.
func (e *feTurbulence) OnCueChange(handler string) *feTurbulence {
...
func (e *feTurbulence) OnDblClick(handler string) *feTurbulence {
...
func (e *feTurbulence) OnDrag(handler string) *feTurbulence {
...
func (e *feTurbulence) OnDragEnd(handler string) *feTurbulence {
...
func (e *feTurbulence) OnDragEnter(handler string) *feTurbulence {
...
func (e *feTurbulence) OnDragLeave(handler string) *feTurbulence {
...
func (e *feTurbulence) OnDragOver(handler string) *feTurbulence {
...
func (e *feTurbulence) OnDragStart(handler string) *feTurbulence {
...
// enable dropping.
func (e *feTurbulence) OnDrop(handler string) *feTurbulence {
...
func (e *feTurbulence) OnDurationChange(handler string) *feTurbulence {
...
// media content.
func (e *feTurbulence) OnEmptied(handler string) *feTurbulence {
...
func (e *feTurbulence) OnEnded(handler string) *feTurbulence {
...
func (e *feTurbulence) OnInvalid(handler string) *feTurbulence {
...
func (e *feTurbulence) OnKeyDown(handler string) *feTurbulence {
...
func (e *feTurbulence) OnKeyPress(handler string) *feTurbulence {
...
func (e *feTurbulence) OnKeyUp(handler string) *feTurbulence {
...
func (e *feTurbulence) OnLoadedData(handler string) *feTurbulence {
...
func (e *feTurbulence) OnLoadedMetadata(handler string) *feTurbulence {
...
func (e *feTurbulence) OnLoadStart(handler string) *feTurbulence {
...
func (e *feTurbulence) OnMouseDown(handler string) *feTurbulence {
...
func (e *feTurbulence) OnMouseEnter(handler string) *feTurbulence {
...
func (e *feTurbulence) OnMouseLeave(handler string) *feTurbulence {
...
func (e *feTurbulence) OnMouseMove(handler string) *feTurbulence {
...
func (e *feTurbulence) OnMouseOut(handler string) *feTurbulence {
...
func (e *feTurbulence) OnMouseOver(handler string) *feTurbulence {
...
func (e *feTurbulence) OnMouseUp(handler string) *feTurbulence {
...
func (e *feTurbulence) OnMouseWheel(handler string) *feTurbulence {
...
func (e *feTurbulence) OnPause(handler string) *feTurbulence {
...
func (e *feTurbulence) OnPlay(handler string) *feTurbulence {
...
func (e *feTurbulence) OnPlaying(handler string) *feTurbulence {
...
func (e *feTurbulence) OnProgress(handler string) *feTurbulence {
...
func (e *feTurbulence) OnRateChange(handler string) *feTurbulence {
...
func (e *feTurbulence) OnReset(handler string) *feTurbulence {
...
// ResizeObserver.
func (e *feTurbulence) OnResize(handler string) *feTurbulence {
...
func (e *feTurbulence) OnScroll(handler string) *feTurbulence {
...
func (e *feTurbulence) OnSeeked(handler string) *feTurbulence {
...
func (e *feTurbulence) OnSeeking(handler string) *feTurbulence {
...
func (e *feTurbulence) OnSelect(handler string) *feTurbulence {
...
func (e *feTurbulence) OnShow(handler string) *feTurbulence {
...
func (e *feTurbulence) OnSort(handler string) *feTurbulence {
...
func (e *feTurbulence) OnStalled(handler string) *feTurbulence {
...
func (e *feTurbulence) OnSuspend(handler string) *feTurbulence {
...
func (e *feTurbulence) OnTimeUpdate(handler string) *feTurbulence {
...
func (e *feTurbulence) OnToggle(handler string) *feTurbulence {
...
func (e *feTurbulence) OnVolumeChange(handler string) *feTurbulence {
...
func (e *feTurbulence) OnWaiting(handler string) *feTurbulence {
...
func (e *feTurbulence) OnAuxClick(handler string) *feTurbulence {
...
func (e *feTurbulence) OnWheel(handler string) *feTurbulence {
...
func (e *feTurbulence) OnCopy(handler string) *feTurbulence {
...
// content itself.
func (e *feTurbulence) OnCut(handler string) *feTurbulence {
...
func (e *feTurbulence) OnPaste(handler string) *feTurbulence {
...
func (e *feTurbulence) OnScrollEnd(handler string) *feTurbulence {
...
func (e *feTurbulence) OnFormData(handler string) *feTurbulence {
...
func (e *feTurbulence) OnAnimationCancel(handler string) *feTurbulence {
...
func (e *feTurbulence) OnAnimationEnd(handler string) *feTurbulence {
...
func (e *feTurbulence) OnAnimationIteration(handler string) *feTurbulence {
...
func (e *feTurbulence) OnAnimationStart(handler string) *feTurbulence {
...
func (e *feTurbulence) OnTransitionCancel(handler string) *feTurbulence {
...
func (e *feTurbulence) OnTransitionEnd(handler string) *feTurbulence {
...
func (e *feTurbulence) OnTransitionRun(handler string) *feTurbulence {
...
func (e *feTurbulence) OnTransitionStart(handler string) *feTurbulence {
...
func (e *feTurbulence) OnBeforeToggle(handler string) *feTurbulence {
...
func (e *feTurbulence) OnBeforeInput(handler string) *feTurbulence {
...
func (e *feTurbulence) OnBeforeMatch(handler string) *feTurbulence {
...
func (e *feTurbulence) OnCommand(handler string) *feTurbulence {
...
func (e *feTurbulence) OnContextLost(handler string) *feTurbulence {
...
func (e *feTurbulence) OnContextRestored(handler string) *feTurbulence {
...
func (e *feTurbulence) OnSecurityPolicyViolation(handler string) *feTurbulence {
...
func (e *feTurbulence) OnSlotChange(handler string) *feTurbulence {
...
func (e *feTurbulence) OnPointerDown(handler string) *feTurbulence {
...
func (e *feTurbulence) OnPointerUp(handler string) *feTurbulence {
...
func (e *feTurbulence) OnPointerMove(handler string) *feTurbulence {
...
func (e *feTurbulence) OnPointerEnter(handler string) *feTurbulence {
...
func (e *feTurbulence) OnPointerLeave(handler string) *feTurbulence {
...
func (e *feTurbulence) OnPointerOver(handler string) *feTurbulence {
...
// element for any of its descendants.
func (e *feTurbulence) OnPointerOut(handler string) *feTurbulence {
...
func (e *feTurbulence) OnPointerCancel(handler string) *feTurbulence {
...
func (e *feTurbulence) OnGotPointerCapture(handler string) *feTurbulence {
...
func (e *feTurbulence) OnLostPointerCapture(handler string) *feTurbulence {
...
func (e *feTurbulence) OnTouchStart(handler string) *feTurbulence {
...
func (e *feTurbulence) OnTouchEnd(handler string) *feTurbulence {
...
func (e *feTurbulence) OnTouchMove(handler string) *feTurbulence {
...
func (e *feTurbulence) OnTouchCancel(handler string) *feTurbulence {
...
func (e *feTurbulence) OnSelectStart(handler string) *feTurbulence {
...
func (e *feTurbulence) OnSelectionChange(handler string) *feTurbulence {
...
func (e *feTurbulence) SetAttribute(key string, value string) {
...
func (e *feTurbulence) SetAttributeRaw(key string, value string) {
	if e.attr == nil {
		e.attr = &[]node.Attribute{}
	}
	for i, attr := range *e.attr {
...
func (e *feTurbulence) Add(children ...PrimitiveContent) *feTurbulence {
...
func (e *feTurbulence) Replace(children ...PrimitiveContent) *feTurbulence {
...
func (e *feTurbulence) Dynamic(key string) *feTurbulence {
	e.dynamic = key
	return e
}

// IsDynamic reports whether this element has been marked for reactive tracking.
func (e *feTurbulence) IsDynamic() bool {
	return e.dynamic != ""
}
...
func (e *feTurbulence) DynamicKey() string {
	return e.dynamic
}
...
func (e *feTurbulence) Memoise(version any) *feTurbulence {
	e.memoise = version
	return e
}
...
// by fluent-jit.
func (e *feTurbulence) MemoiseKey() any {
	return e.memoise
}
...
func (e *feTurbulence) BufferHint(hint int) *feTurbulence {
	if hint > 0 {
...
func (e *feTurbulence) RenderedSize() int {
...
func (e *feTurbulence) Render(w io.Writer) {
	_, _ = e.WriteTo(w)
}
...
func (e *feTurbulence) WriteTo(w io.Writer) (int64, error) {
...
func (e *feTurbulence) RenderBytes() []byte {
...
func (e *feTurbulence) AttributeBuilder(buf *bytes.Buffer) {
	if e.baseFrequency != "" {
		buf.Write(AttrBaseFrequency)
		buf.WriteString(e.baseFrequency)
		buf.Write(MarkupQuote)
	}
	if e.numOctaves != "" {
		buf.Write(AttrNumOctaves)
		buf.WriteString(e.numOctaves)
		buf.Write(MarkupQuote)
	}
	if e.seed != "" {
		buf.Write(AttrSeed)
		buf.WriteString(e.seed)
		buf.Write(MarkupQuote)
	}
	if len(e.stitchTiles) > 0 {
		buf.Write(AttrStitchTiles)
		buf.Write(e.stitchTiles)
		buf.Write(MarkupQuote)
	}
	if len(e.typeAttr) > 0 {
		buf.Write(AttrType)
...
func (e *feTurbulence) RenderBuilder(buf *bytes.Buffer) {
	buf.Write(TagFeTurbulence)
	...
	buf.Write(TagFeTurbulenceClose)
}

// RenderOpen writes the opening tag and attributes to the buffer.
func (e *feTurbulence) RenderOpen(buf *bytes.Buffer) {
	buf.Write(TagFeTurbulence)
	e.AttributeBuilder(buf)
	buf.Write(MarkupCloseTag)
}
...
// isSVGFilterPrimitive seals feTurbulence as a FilterPrimitive.
func (*feTurbulence) isSVGFilterPrimitive() {}
