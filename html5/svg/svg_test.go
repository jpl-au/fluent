...
func TestRenderCircle(t *testing.T) {
	got := string(svg.Circle().Cx("cx").Cy("cy").R("r").Class("class").Fill("fill").StrokeWidth("stroke-width").StrokeLineCap(strokelinecap.Custom("stroke-linecap")).StrokeLineJoin(strokelinejoin.Custom("stroke-linejoin")).Render())
...
func TestRenderDefs(t *testing.T) {
	got := string(svg.Defs().Class("class").Fill("fill").StrokeWidth("stroke-width").StrokeLineCap(strokelinecap.Custom("stroke-linecap")).StrokeLineJoin(strokelinejoin.Custom("stroke-linejoin")).Render())
...
func TestRenderEllipse(t *testing.T) {
	got := string(svg.Ellipse().Cx("cx").Cy("cy").Rx("rx").Ry("ry").Class("class").Fill("fill").StrokeWidth("stroke-width").StrokeLineCap(strokelinecap.Custom("stroke-linecap")).StrokeLineJoin(strokelinejoin.Custom("stroke-linejoin")).Render())
...
func TestRenderG(t *testing.T) {
	got := string(svg.G().Class("class").Fill("fill").StrokeWidth("stroke-width").StrokeLineCap(strokelinecap.Custom("stroke-linecap")).StrokeLineJoin(strokelinejoin.Custom("stroke-linejoin")).Render())
...
func TestRenderLine(t *testing.T) {
	got := string(svg.Line().X1("x1").Y1("y1").X2("x2").Y2("y2").Class("class").Fill("fill").StrokeWidth("stroke-width").StrokeLineCap(strokelinecap.Custom("stroke-linecap")).StrokeLineJoin(strokelinejoin.Custom("stroke-linejoin")).Render())
...
func TestRenderLinearGradient(t *testing.T) {
	got := string(svg.LinearGradient().X1("x1").Y1("y1").X2("x2").Y2("y2").GradientUnits(gradientunits.Custom("gradientUnits")).Class("class").Fill("fill").StrokeWidth("stroke-width").StrokeLineCap(strokelinecap.Custom("stroke-linecap")).StrokeLineJoin(strokelinejoin.Custom("stroke-linejoin")).Render())
...
func TestRenderPath(t *testing.T) {
	got := string(svg.Path().D("d").Class("class").Fill("fill").StrokeWidth("stroke-width").StrokeLineCap(strokelinecap.Custom("stroke-linecap")).StrokeLineJoin(strokelinejoin.Custom("stroke-linejoin")).Render())
...
func TestRenderPolygon(t *testing.T) {
	got := string(svg.Polygon().Points("points").Class("class").Fill("fill").StrokeWidth("stroke-width").StrokeLineCap(strokelinecap.Custom("stroke-linecap")).StrokeLineJoin(strokelinejoin.Custom("stroke-linejoin")).Render())
...
func TestRenderPolyline(t *testing.T) {
	got := string(svg.Polyline().Points("points").Class("class").Fill("fill").StrokeWidth("stroke-width").StrokeLineCap(strokelinecap.Custom("stroke-linecap")).StrokeLineJoin(strokelinejoin.Custom("stroke-linejoin")).Render())
...
func TestRenderRadialGradient(t *testing.T) {
	got := string(svg.RadialGradient().Cx("cx").Cy("cy").R("r").Fx("fx").Fy("fy").GradientUnits(gradientunits.Custom("gradientUnits")).Class("class").Fill("fill").StrokeWidth("stroke-width").StrokeLineCap(strokelinecap.Custom("stroke-linecap")).StrokeLineJoin(strokelinejoin.Custom("stroke-linejoin")).Render())
...
func TestRenderRect(t *testing.T) {
	got := string(svg.Rect().X("x").Y("y").Width("width").Height("height").Rx("rx").Ry("ry").Class("class").Fill("fill").StrokeWidth("stroke-width").StrokeLineCap(strokelinecap.Custom("stroke-linecap")).StrokeLineJoin(strokelinejoin.Custom("stroke-linejoin")).Render())
...
func TestRenderStop(t *testing.T) {
	got := string(svg.Stop().Offset("offset").StopColor("stop-color").StopOpacity("stop-opacity").Class("class").Fill("fill").StrokeWidth("stroke-width").StrokeLineCap(strokelinecap.Custom("stroke-linecap")).StrokeLineJoin(strokelinejoin.Custom("stroke-linejoin")).Render())
...
func TestRenderElement(t *testing.T) {
	got := string(svg.New().Width("width").Height("height").ViewBox("viewBox").PreserveAspectRatio("preserveAspectRatio").Xmlns("xmlns").Class("class").Fill("fill").StrokeWidth("stroke-width").StrokeLineCap(strokelinecap.Custom("stroke-linecap")).StrokeLineJoin(strokelinejoin.Custom("stroke-linejoin")).Render())
...
func TestRenderText(t *testing.T) {
	got := string(svg.Text("hello").X("x").Y("y").Dx("dx").Dy("dy").TextAnchor(textanchor.Custom("text-anchor")).Class("class").Fill("fill").StrokeWidth("stroke-width").StrokeLineCap(strokelinecap.Custom("stroke-linecap")).StrokeLineJoin(strokelinejoin.Custom("stroke-linejoin")).Render())
...
func TestRenderTspan(t *testing.T) {
	got := string(svg.TSpan("hello").X("x").Y("y").Dx("dx").Dy("dy").Class("class").Fill("fill").StrokeWidth("stroke-width").StrokeLineCap(strokelinecap.Custom("stroke-linecap")).StrokeLineJoin(strokelinejoin.Custom("stroke-linejoin")).Render())
...
func TestRawEscapeHatch(t *testing.T) {
	got := string(svg.G(svg.Raw("<path/>")).Render())
	if got != "<g><path/></g>" {
		t.Errorf("got %q, want %q", got, "<g><path/></g>")
	}
}
func TestNestedTree(t *testing.T) {
	got := string(svg.New(svg.Rect().X("0").Fill("var(--blue)"), svg.Defs(svg.LinearGradient(svg.Stop().Offset("0").StopColor("#fff")).ID("grad"))).ViewBox("0 0 10 10").Render())
...
func TestDynamicKey(t *testing.T) {
	got := string(svg.Rect().Dynamic("k").Render())
