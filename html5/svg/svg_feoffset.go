...
// feOffset represents the <feOffset> SVG element.
...
func (e *feOffset) event() *html5.EventAttributes {
	if e.ea == nil {
...
// FeOffset translates its filter input by dx and dy without otherwise changing
// its pixels. It is commonly used to position a blurred shadow before merging
// that result with the original graphic.
func FeOffset(children ...PrimitiveContent) *feOffset {
...
func (e *feOffset) In(value string) *feOffset {
...
//
// How far to shift along x. A positive value moves right.
func (e *feOffset) Dx(value string) *feOffset {
...
//
// How far to shift along y. A positive value moves down.
func (e *feOffset) Dy(value string) *feOffset {
	e.dy = node.EscapeAttribute(value)
	return e
}

// X sets the x attribute.
func (e *feOffset) X(value string) *feOffset {
	e.x = node.EscapeAttribute(value)
	return e
}

// Y sets the y attribute.
func (e *feOffset) Y(value string) *feOffset {
	e.y = node.EscapeAttribute(value)
	return e
}

// Width sets the width attribute.
func (e *feOffset) Width(value string) *feOffset {
	e.width = node.EscapeAttribute(value)
	return e
}

// Height sets the height attribute.
func (e *feOffset) Height(value string) *feOffset {
	e.height = node.EscapeAttribute(value)
	return e
}

// Result sets the result attribute.
func (e *feOffset) Result(value string) *feOffset {
	e.result = node.EscapeAttribute(value)
	return e
}

// ID sets the id attribute.
func (e *feOffset) ID(id string) *feOffset {
	e.svg().ID = node.EscapeAttribute(id)
	return e
}

// Class appends to the space-separated class attribute.
func (e *feOffset) Class(class string) *feOffset {
...
func (e *feOffset) Style(css string) *feOffset {
	e.svg().Style = node.EscapeAttribute(css)
	return e
}

// Transform sets the transform attribute.
func (e *feOffset) Transform(transform string) *feOffset {
...
func (e *feOffset) TransformOrigin(origin string) *feOffset {
	e.svg().TransformOrigin = node.EscapeAttribute(origin)
	return e
}

// TabIndex sets the tabindex attribute.
func (e *feOffset) TabIndex(index string) *feOffset {
	e.svg().TabIndex = node.EscapeAttribute(index)
	return e
}

// Role sets the role attribute.
func (e *feOffset) Role(role string) *feOffset {
...
func (e *feOffset) Lang(lang string) *feOffset {
...
func (e *feOffset) AutoFocus(conds ...bool) *feOffset {
	if len(conds) > 0 {
...
func (e *feOffset) SetAria(key string, value string) *feOffset {
...
func (e *feOffset) StrokeDashOffset(offset string) *feOffset {
...
func (e *feOffset) StrokeMiterLimit(limit string) *feOffset {
...
func (e *feOffset) FillRule(rule fillrule.FillRule) *feOffset {
	e.svg().FillRule = rule
	return e
}
...
// a clipPath.
func (e *feOffset) ClipRule(rule cliprule.ClipRule) *feOffset {
	e.svg().ClipRule = rule
	return e
}
...
func (e *feOffset) ClipPath(clip string) *feOffset {
...
// per pixel.
func (e *feOffset) Mask(mask string) *feOffset {
...
func (e *feOffset) Filter(filter string) *feOffset {
...
func (e *feOffset) Color(color string) *feOffset {
...
func (e *feOffset) Cursor(cursor string) *feOffset {
...
func (e *feOffset) Display(display string) *feOffset {
...
// drawn again.
func (e *feOffset) Visibility(value visibility.Visibility) *feOffset {
...
func (e *feOffset) PointerEvents(events pointerevents.PointerEvents) *feOffset {
...
func (e *feOffset) VectorEffect(effect vectoreffect.VectorEffect) *feOffset {
...
func (e *feOffset) ShapeRendering(rendering shaperendering.ShapeRendering) *feOffset {
...
func (e *feOffset) FontFamily(family string) *feOffset {
...
// is in user units.
func (e *feOffset) FontSize(size string) *feOffset {
...
// from 100 to 900.
func (e *feOffset) FontWeight(weight string) *feOffset {
...
func (e *feOffset) FontStyle(style string) *feOffset {
...
func (e *feOffset) OnClick(handler string) *feOffset {
...
func (e *feOffset) OnChange(handler string) *feOffset {
...
func (e *feOffset) OnInput(handler string) *feOffset {
...
func (e *feOffset) OnFocus(handler string) *feOffset {
...
func (e *feOffset) OnBlur(handler string) *feOffset {
...
func (e *feOffset) OnSubmit(handler string) *feOffset {
...
func (e *feOffset) OnLoad(handler string) *feOffset {
...
func (e *feOffset) OnError(handler string) *feOffset {
...
// developer-controlled key. Never build the key from user input - a key containing a space, quote,
// "=", "/" or ">" changes the markup structure. The value is escaped. The key is not escaped.
func (e *feOffset) SetEvent(key string, value string) *feOffset {
...
func (e *feOffset) OnAbort(handler string) *feOffset {
...
func (e *feOffset) OnAutoComplete(handler string) *feOffset {
...
//
// Deprecated: Removed from the WHATWG living standard. Was in an older HTML5 draft.
func (e *feOffset) OnAutoCompleteError(handler string) *feOffset {
...
func (e *feOffset) OnCancel(handler string) *feOffset {
...
func (e *feOffset) OnCanPlay(handler string) *feOffset {
...
func (e *feOffset) OnCanPlayThrough(handler string) *feOffset {
...
// results.
func (e *feOffset) OnClose(handler string) *feOffset {
...
func (e *feOffset) OnContextMenu(handler string) *feOffset {
...
// timestamps.
func (e *feOffset) OnCueChange(handler string) *feOffset {
...
func (e *feOffset) OnDblClick(handler string) *feOffset {
...
func (e *feOffset) OnDrag(handler string) *feOffset {
...
func (e *feOffset) OnDragEnd(handler string) *feOffset {
...
func (e *feOffset) OnDragEnter(handler string) *feOffset {
...
func (e *feOffset) OnDragLeave(handler string) *feOffset {
...
func (e *feOffset) OnDragOver(handler string) *feOffset {
...
func (e *feOffset) OnDragStart(handler string) *feOffset {
...
// enable dropping.
func (e *feOffset) OnDrop(handler string) *feOffset {
...
func (e *feOffset) OnDurationChange(handler string) *feOffset {
...
// media content.
func (e *feOffset) OnEmptied(handler string) *feOffset {
...
func (e *feOffset) OnEnded(handler string) *feOffset {
...
func (e *feOffset) OnInvalid(handler string) *feOffset {
...
func (e *feOffset) OnKeyDown(handler string) *feOffset {
...
func (e *feOffset) OnKeyPress(handler string) *feOffset {
...
func (e *feOffset) OnKeyUp(handler string) *feOffset {
...
func (e *feOffset) OnLoadedData(handler string) *feOffset {
...
func (e *feOffset) OnLoadedMetadata(handler string) *feOffset {
...
func (e *feOffset) OnLoadStart(handler string) *feOffset {
...
func (e *feOffset) OnMouseDown(handler string) *feOffset {
...
func (e *feOffset) OnMouseEnter(handler string) *feOffset {
...
func (e *feOffset) OnMouseLeave(handler string) *feOffset {
...
func (e *feOffset) OnMouseMove(handler string) *feOffset {
...
func (e *feOffset) OnMouseOut(handler string) *feOffset {
...
func (e *feOffset) OnMouseOver(handler string) *feOffset {
...
func (e *feOffset) OnMouseUp(handler string) *feOffset {
...
func (e *feOffset) OnMouseWheel(handler string) *feOffset {
...
func (e *feOffset) OnPause(handler string) *feOffset {
...
func (e *feOffset) OnPlay(handler string) *feOffset {
...
func (e *feOffset) OnPlaying(handler string) *feOffset {
...
func (e *feOffset) OnProgress(handler string) *feOffset {
...
func (e *feOffset) OnRateChange(handler string) *feOffset {
...
func (e *feOffset) OnReset(handler string) *feOffset {
...
// ResizeObserver.
func (e *feOffset) OnResize(handler string) *feOffset {
...
func (e *feOffset) OnScroll(handler string) *feOffset {
...
func (e *feOffset) OnSeeked(handler string) *feOffset {
...
func (e *feOffset) OnSeeking(handler string) *feOffset {
...
func (e *feOffset) OnSelect(handler string) *feOffset {
...
func (e *feOffset) OnShow(handler string) *feOffset {
...
func (e *feOffset) OnSort(handler string) *feOffset {
...
func (e *feOffset) OnStalled(handler string) *feOffset {
...
func (e *feOffset) OnSuspend(handler string) *feOffset {
...
func (e *feOffset) OnTimeUpdate(handler string) *feOffset {
...
func (e *feOffset) OnToggle(handler string) *feOffset {
...
func (e *feOffset) OnVolumeChange(handler string) *feOffset {
...
func (e *feOffset) OnWaiting(handler string) *feOffset {
...
func (e *feOffset) OnAuxClick(handler string) *feOffset {
...
func (e *feOffset) OnWheel(handler string) *feOffset {
...
func (e *feOffset) OnCopy(handler string) *feOffset {
...
// content itself.
func (e *feOffset) OnCut(handler string) *feOffset {
...
func (e *feOffset) OnPaste(handler string) *feOffset {
...
func (e *feOffset) OnScrollEnd(handler string) *feOffset {
...
func (e *feOffset) OnFormData(handler string) *feOffset {
...
func (e *feOffset) OnAnimationCancel(handler string) *feOffset {
...
func (e *feOffset) OnAnimationEnd(handler string) *feOffset {
...
func (e *feOffset) OnAnimationIteration(handler string) *feOffset {
...
func (e *feOffset) OnAnimationStart(handler string) *feOffset {
...
func (e *feOffset) OnTransitionCancel(handler string) *feOffset {
...
func (e *feOffset) OnTransitionEnd(handler string) *feOffset {
...
func (e *feOffset) OnTransitionRun(handler string) *feOffset {
...
func (e *feOffset) OnTransitionStart(handler string) *feOffset {
...
func (e *feOffset) OnBeforeToggle(handler string) *feOffset {
...
func (e *feOffset) OnBeforeInput(handler string) *feOffset {
...
func (e *feOffset) OnBeforeMatch(handler string) *feOffset {
...
func (e *feOffset) OnCommand(handler string) *feOffset {
...
func (e *feOffset) OnContextLost(handler string) *feOffset {
...
func (e *feOffset) OnContextRestored(handler string) *feOffset {
...
func (e *feOffset) OnSecurityPolicyViolation(handler string) *feOffset {
...
func (e *feOffset) OnSlotChange(handler string) *feOffset {
...
func (e *feOffset) OnPointerDown(handler string) *feOffset {
...
func (e *feOffset) OnPointerUp(handler string) *feOffset {
...
func (e *feOffset) OnPointerMove(handler string) *feOffset {
...
func (e *feOffset) OnPointerEnter(handler string) *feOffset {
...
func (e *feOffset) OnPointerLeave(handler string) *feOffset {
...
func (e *feOffset) OnPointerOver(handler string) *feOffset {
...
// element for any of its descendants.
func (e *feOffset) OnPointerOut(handler string) *feOffset {
...
func (e *feOffset) OnPointerCancel(handler string) *feOffset {
...
func (e *feOffset) OnGotPointerCapture(handler string) *feOffset {
...
func (e *feOffset) OnLostPointerCapture(handler string) *feOffset {
...
func (e *feOffset) OnTouchStart(handler string) *feOffset {
...
func (e *feOffset) OnTouchEnd(handler string) *feOffset {
...
func (e *feOffset) OnTouchMove(handler string) *feOffset {
...
func (e *feOffset) OnTouchCancel(handler string) *feOffset {
...
func (e *feOffset) OnSelectStart(handler string) *feOffset {
...
func (e *feOffset) OnSelectionChange(handler string) *feOffset {
...
func (e *feOffset) SetAttribute(key string, value string) {
...
func (e *feOffset) SetAttributeRaw(key string, value string) {
	if e.attr == nil {
		e.attr = &[]node.Attribute{}
	}
	for i, attr := range *e.attr {
...
func (e *feOffset) Add(children ...PrimitiveContent) *feOffset {
...
func (e *feOffset) Replace(children ...PrimitiveContent) *feOffset {
...
func (e *feOffset) DynamicKey() string {
	return e.dynamic
}
...
func (e *feOffset) Memoise(version any) *feOffset {
	e.memoise = version
	return e
}
...
// by fluent-jit.
func (e *feOffset) MemoiseKey() any {
	return e.memoise
}
...
func (e *feOffset) BufferHint(hint int) *feOffset {
	if hint > 0 {
...
func (e *feOffset) RenderedSize() int {
...
func (e *feOffset) Render(w io.Writer) {
	_, _ = e.WriteTo(w)
}
...
func (e *feOffset) WriteTo(w io.Writer) (int64, error) {
...
func (e *feOffset) RenderBytes() []byte {
...
func (e *feOffset) AttributeBuilder(buf *bytes.Buffer) {
	if e.in != "" {
		buf.Write(AttrIn)
...
func (e *feOffset) RenderBuilder(buf *bytes.Buffer) {
	buf.Write(TagFeOffset)
	...
	buf.Write(TagFeOffsetClose)
}

// RenderOpen writes the opening tag and attributes to the buffer.
func (e *feOffset) RenderOpen(buf *bytes.Buffer) {
	buf.Write(TagFeOffset)
	e.AttributeBuilder(buf)
	buf.Write(MarkupCloseTag)
}
...
// isSVGFilterPrimitive seals feOffset as a FilterPrimitive.
func (*feOffset) isSVGFilterPrimitive() {}
