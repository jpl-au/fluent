...
// feMorphology represents the <feMorphology> SVG element.
...
func (e *feMorphology) svg() *svgAttrs {
	if e.sa == nil {
		e.sa = &svgAttrs{}
	}
	return e.sa
...
func (e *feMorphology) event() *html5.EventAttributes {
	if e.ea == nil {
...
// FeMorphology erodes or dilates its input within the neighbourhood specified
// by radius. The operation takes minimum or maximum channel values.
// On alpha, this shrinks or expands opaque regions.
func FeMorphology(children ...PrimitiveContent) *feMorphology {
...
func (e *feMorphology) In(value string) *feMorphology {
...
//
// Whether the input is thinned or thickened.
func (e *feMorphology) Operator(value morphologyoperator.MorphologyOperator) *feMorphology {
	e.operator = value
	return e
}
...
//
// How far to thin or thicken by. One number applies to both axes. Two apply to x and y separately.
func (e *feMorphology) Radius(value string) *feMorphology {
	e.radius = node.EscapeAttribute(value)
	return e
}

// X sets the x attribute.
func (e *feMorphology) X(value string) *feMorphology {
	e.x = node.EscapeAttribute(value)
	return e
}

// Y sets the y attribute.
func (e *feMorphology) Y(value string) *feMorphology {
	e.y = node.EscapeAttribute(value)
	return e
}

// Width sets the width attribute.
func (e *feMorphology) Width(value string) *feMorphology {
	e.width = node.EscapeAttribute(value)
	return e
}

// Height sets the height attribute.
func (e *feMorphology) Height(value string) *feMorphology {
	e.height = node.EscapeAttribute(value)
	return e
}

// Result sets the result attribute.
func (e *feMorphology) Result(value string) *feMorphology {
	e.result = node.EscapeAttribute(value)
	return e
}

// ID sets the id attribute.
func (e *feMorphology) ID(id string) *feMorphology {
	e.svg().ID = node.EscapeAttribute(id)
	return e
}

// Class appends to the space-separated class attribute.
func (e *feMorphology) Class(class string) *feMorphology {
...
func (e *feMorphology) Style(css string) *feMorphology {
	e.svg().Style = node.EscapeAttribute(css)
	return e
}

// Transform sets the transform attribute.
func (e *feMorphology) Transform(transform string) *feMorphology {
...
func (e *feMorphology) TransformOrigin(origin string) *feMorphology {
	e.svg().TransformOrigin = node.EscapeAttribute(origin)
	return e
}

// TabIndex sets the tabindex attribute.
func (e *feMorphology) TabIndex(index string) *feMorphology {
	e.svg().TabIndex = node.EscapeAttribute(index)
	return e
}

// Role sets the role attribute.
func (e *feMorphology) Role(role string) *feMorphology {
...
func (e *feMorphology) Lang(lang string) *feMorphology {
...
func (e *feMorphology) AutoFocus(conds ...bool) *feMorphology {
	if len(conds) > 0 {
...
func (e *feMorphology) SetAria(key string, value string) *feMorphology {
...
func (e *feMorphology) StrokeDashOffset(offset string) *feMorphology {
...
func (e *feMorphology) StrokeMiterLimit(limit string) *feMorphology {
...
func (e *feMorphology) FillRule(rule fillrule.FillRule) *feMorphology {
	e.svg().FillRule = rule
	return e
}
...
// a clipPath.
func (e *feMorphology) ClipRule(rule cliprule.ClipRule) *feMorphology {
	e.svg().ClipRule = rule
	return e
}
...
func (e *feMorphology) ClipPath(clip string) *feMorphology {
...
// per pixel.
func (e *feMorphology) Mask(mask string) *feMorphology {
...
func (e *feMorphology) Filter(filter string) *feMorphology {
...
func (e *feMorphology) Color(color string) *feMorphology {
...
func (e *feMorphology) Cursor(cursor string) *feMorphology {
...
func (e *feMorphology) Display(display string) *feMorphology {
...
// drawn again.
func (e *feMorphology) Visibility(value visibility.Visibility) *feMorphology {
...
func (e *feMorphology) PointerEvents(events pointerevents.PointerEvents) *feMorphology {
...
func (e *feMorphology) VectorEffect(effect vectoreffect.VectorEffect) *feMorphology {
...
func (e *feMorphology) ShapeRendering(rendering shaperendering.ShapeRendering) *feMorphology {
...
func (e *feMorphology) FontFamily(family string) *feMorphology {
...
// is in user units.
func (e *feMorphology) FontSize(size string) *feMorphology {
...
// from 100 to 900.
func (e *feMorphology) FontWeight(weight string) *feMorphology {
...
func (e *feMorphology) FontStyle(style string) *feMorphology {
...
func (e *feMorphology) OnClick(handler string) *feMorphology {
...
func (e *feMorphology) OnChange(handler string) *feMorphology {
...
func (e *feMorphology) OnInput(handler string) *feMorphology {
...
func (e *feMorphology) OnFocus(handler string) *feMorphology {
...
func (e *feMorphology) OnBlur(handler string) *feMorphology {
...
func (e *feMorphology) OnSubmit(handler string) *feMorphology {
...
func (e *feMorphology) OnLoad(handler string) *feMorphology {
...
func (e *feMorphology) OnError(handler string) *feMorphology {
...
// developer-controlled key. Never build the key from user input - a key containing a space, quote,
// "=", "/" or ">" changes the markup structure. The value is escaped. The key is not escaped.
func (e *feMorphology) SetEvent(key string, value string) *feMorphology {
...
func (e *feMorphology) OnAbort(handler string) *feMorphology {
...
func (e *feMorphology) OnAutoComplete(handler string) *feMorphology {
...
//
// Deprecated: Removed from the WHATWG living standard. Was in an older HTML5 draft.
func (e *feMorphology) OnAutoCompleteError(handler string) *feMorphology {
...
func (e *feMorphology) OnCancel(handler string) *feMorphology {
...
func (e *feMorphology) OnCanPlay(handler string) *feMorphology {
...
func (e *feMorphology) OnCanPlayThrough(handler string) *feMorphology {
...
// results.
func (e *feMorphology) OnClose(handler string) *feMorphology {
...
func (e *feMorphology) OnContextMenu(handler string) *feMorphology {
...
// timestamps.
func (e *feMorphology) OnCueChange(handler string) *feMorphology {
...
func (e *feMorphology) OnDblClick(handler string) *feMorphology {
...
func (e *feMorphology) OnDrag(handler string) *feMorphology {
...
func (e *feMorphology) OnDragEnd(handler string) *feMorphology {
...
func (e *feMorphology) OnDragEnter(handler string) *feMorphology {
...
func (e *feMorphology) OnDragLeave(handler string) *feMorphology {
...
func (e *feMorphology) OnDragOver(handler string) *feMorphology {
...
func (e *feMorphology) OnDragStart(handler string) *feMorphology {
...
// enable dropping.
func (e *feMorphology) OnDrop(handler string) *feMorphology {
...
func (e *feMorphology) OnDurationChange(handler string) *feMorphology {
...
// media content.
func (e *feMorphology) OnEmptied(handler string) *feMorphology {
...
func (e *feMorphology) OnEnded(handler string) *feMorphology {
...
func (e *feMorphology) OnInvalid(handler string) *feMorphology {
...
func (e *feMorphology) OnKeyDown(handler string) *feMorphology {
...
func (e *feMorphology) OnKeyPress(handler string) *feMorphology {
...
func (e *feMorphology) OnKeyUp(handler string) *feMorphology {
...
func (e *feMorphology) OnLoadedData(handler string) *feMorphology {
...
func (e *feMorphology) OnLoadedMetadata(handler string) *feMorphology {
...
func (e *feMorphology) OnLoadStart(handler string) *feMorphology {
...
func (e *feMorphology) OnMouseDown(handler string) *feMorphology {
...
func (e *feMorphology) OnMouseEnter(handler string) *feMorphology {
...
func (e *feMorphology) OnMouseLeave(handler string) *feMorphology {
...
func (e *feMorphology) OnMouseMove(handler string) *feMorphology {
...
func (e *feMorphology) OnMouseOut(handler string) *feMorphology {
...
func (e *feMorphology) OnMouseOver(handler string) *feMorphology {
...
func (e *feMorphology) OnMouseUp(handler string) *feMorphology {
...
func (e *feMorphology) OnMouseWheel(handler string) *feMorphology {
...
func (e *feMorphology) OnPause(handler string) *feMorphology {
...
func (e *feMorphology) OnPlay(handler string) *feMorphology {
...
func (e *feMorphology) OnPlaying(handler string) *feMorphology {
...
func (e *feMorphology) OnProgress(handler string) *feMorphology {
...
func (e *feMorphology) OnRateChange(handler string) *feMorphology {
...
func (e *feMorphology) OnReset(handler string) *feMorphology {
...
// ResizeObserver.
func (e *feMorphology) OnResize(handler string) *feMorphology {
...
func (e *feMorphology) OnScroll(handler string) *feMorphology {
...
func (e *feMorphology) OnSeeked(handler string) *feMorphology {
...
func (e *feMorphology) OnSeeking(handler string) *feMorphology {
...
func (e *feMorphology) OnSelect(handler string) *feMorphology {
...
func (e *feMorphology) OnShow(handler string) *feMorphology {
...
func (e *feMorphology) OnSort(handler string) *feMorphology {
...
func (e *feMorphology) OnStalled(handler string) *feMorphology {
...
func (e *feMorphology) OnSuspend(handler string) *feMorphology {
...
func (e *feMorphology) OnTimeUpdate(handler string) *feMorphology {
...
func (e *feMorphology) OnToggle(handler string) *feMorphology {
...
func (e *feMorphology) OnVolumeChange(handler string) *feMorphology {
...
func (e *feMorphology) OnWaiting(handler string) *feMorphology {
...
func (e *feMorphology) OnAuxClick(handler string) *feMorphology {
...
func (e *feMorphology) OnWheel(handler string) *feMorphology {
...
func (e *feMorphology) OnCopy(handler string) *feMorphology {
...
// content itself.
func (e *feMorphology) OnCut(handler string) *feMorphology {
...
func (e *feMorphology) OnPaste(handler string) *feMorphology {
...
func (e *feMorphology) OnScrollEnd(handler string) *feMorphology {
...
func (e *feMorphology) OnFormData(handler string) *feMorphology {
...
func (e *feMorphology) OnAnimationCancel(handler string) *feMorphology {
...
func (e *feMorphology) OnAnimationEnd(handler string) *feMorphology {
...
func (e *feMorphology) OnAnimationIteration(handler string) *feMorphology {
...
func (e *feMorphology) OnAnimationStart(handler string) *feMorphology {
...
func (e *feMorphology) OnTransitionCancel(handler string) *feMorphology {
...
func (e *feMorphology) OnTransitionEnd(handler string) *feMorphology {
...
func (e *feMorphology) OnTransitionRun(handler string) *feMorphology {
...
func (e *feMorphology) OnTransitionStart(handler string) *feMorphology {
...
func (e *feMorphology) OnBeforeToggle(handler string) *feMorphology {
...
func (e *feMorphology) OnBeforeInput(handler string) *feMorphology {
...
func (e *feMorphology) OnBeforeMatch(handler string) *feMorphology {
...
func (e *feMorphology) OnCommand(handler string) *feMorphology {
...
func (e *feMorphology) OnContextLost(handler string) *feMorphology {
...
func (e *feMorphology) OnContextRestored(handler string) *feMorphology {
...
func (e *feMorphology) OnSecurityPolicyViolation(handler string) *feMorphology {
...
func (e *feMorphology) OnSlotChange(handler string) *feMorphology {
...
func (e *feMorphology) OnPointerDown(handler string) *feMorphology {
...
func (e *feMorphology) OnPointerUp(handler string) *feMorphology {
...
func (e *feMorphology) OnPointerMove(handler string) *feMorphology {
...
func (e *feMorphology) OnPointerEnter(handler string) *feMorphology {
...
func (e *feMorphology) OnPointerLeave(handler string) *feMorphology {
...
func (e *feMorphology) OnPointerOver(handler string) *feMorphology {
...
// element for any of its descendants.
func (e *feMorphology) OnPointerOut(handler string) *feMorphology {
...
func (e *feMorphology) OnPointerCancel(handler string) *feMorphology {
...
func (e *feMorphology) OnGotPointerCapture(handler string) *feMorphology {
...
func (e *feMorphology) OnLostPointerCapture(handler string) *feMorphology {
...
func (e *feMorphology) OnTouchStart(handler string) *feMorphology {
...
func (e *feMorphology) OnTouchEnd(handler string) *feMorphology {
...
func (e *feMorphology) OnTouchMove(handler string) *feMorphology {
...
func (e *feMorphology) OnTouchCancel(handler string) *feMorphology {
...
func (e *feMorphology) OnSelectStart(handler string) *feMorphology {
...
func (e *feMorphology) OnSelectionChange(handler string) *feMorphology {
...
func (e *feMorphology) SetAttribute(key string, value string) {
...
func (e *feMorphology) SetAttributeRaw(key string, value string) {
	if e.attr == nil {
		e.attr = &[]node.Attribute{}
	}
	for i, attr := range *e.attr {
...
func (e *feMorphology) Add(children ...PrimitiveContent) *feMorphology {
...
func (e *feMorphology) Replace(children ...PrimitiveContent) *feMorphology {
...
func (e *feMorphology) Dynamic(key string) *feMorphology {
	e.dynamic = key
	return e
}

// IsDynamic reports whether this element has been marked for reactive tracking.
func (e *feMorphology) IsDynamic() bool {
	return e.dynamic != ""
}
...
func (e *feMorphology) DynamicKey() string {
	return e.dynamic
}
...
func (e *feMorphology) Memoise(version any) *feMorphology {
	e.memoise = version
	return e
}
...
// by fluent-jit.
func (e *feMorphology) MemoiseKey() any {
	return e.memoise
}
...
func (e *feMorphology) BufferHint(hint int) *feMorphology {
	if hint > 0 {
...
func (e *feMorphology) RenderedSize() int {
...
func (e *feMorphology) Render(w io.Writer) {
	_, _ = e.WriteTo(w)
}
...
func (e *feMorphology) WriteTo(w io.Writer) (int64, error) {
...
func (e *feMorphology) RenderBytes() []byte {
...
func (e *feMorphology) AttributeBuilder(buf *bytes.Buffer) {
	if e.in != "" {
		buf.Write(AttrIn)
	...
	if e.radius != "" {
		buf.Write(AttrRadius)
		buf.WriteString(e.radius)
		buf.Write(MarkupQuote)
	}
	if e.x != "" {
		buf.Write(AttrX)
...
func (e *feMorphology) RenderBuilder(buf *bytes.Buffer) {
	buf.Write(TagFeMorphology)
	...
	buf.Write(TagFeMorphologyClose)
}

// RenderOpen writes the opening tag and attributes to the buffer.
func (e *feMorphology) RenderOpen(buf *bytes.Buffer) {
	buf.Write(TagFeMorphology)
	e.AttributeBuilder(buf)
	buf.Write(MarkupCloseTag)
}
...
// isSVGFilterPrimitive seals feMorphology as a FilterPrimitive.
func (*feMorphology) isSVGFilterPrimitive() {}
