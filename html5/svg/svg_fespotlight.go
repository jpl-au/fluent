...
// feSpotLight represents the <feSpotLight> SVG element.
...
func (e *feSpotLight) svg() *svgAttrs {
	if e.sa == nil {
		e.sa = &svgAttrs{}
	}
	return e.sa
...
func (e *feSpotLight) event() *html5.EventAttributes {
	if e.ea == nil {
...
// FeSpotLight defines a positioned light aimed at another point on the surface.
// The pointsAtX, pointsAtY and pointsAtZ attributes set its target.
// The specularExponent attribute controls concentration. The limitingConeAngle
// attribute bounds the beam.
func FeSpotLight(children ...PrimitiveContent) *feSpotLight {
...
func (e *feSpotLight) X(value string) *feSpotLight {
...
func (e *feSpotLight) Y(value string) *feSpotLight {
	e.y = node.EscapeAttribute(value)
	return e
}

// Z sets the z attribute.
//
// How far the light is above the surface.
func (e *feSpotLight) Z(value string) *feSpotLight {
	e.z = node.EscapeAttribute(value)
	return e
}

// PointsAtX sets the pointsAtX attribute.
//
// The x the light is aimed at.
func (e *feSpotLight) PointsAtX(value string) *feSpotLight {
	e.pointsAtX = node.EscapeAttribute(value)
	return e
}

// PointsAtY sets the pointsAtY attribute.
//
// The y the light is aimed at.
func (e *feSpotLight) PointsAtY(value string) *feSpotLight {
	e.pointsAtY = node.EscapeAttribute(value)
	return e
}

// PointsAtZ sets the pointsAtZ attribute.
//
// The z the light is aimed at.
func (e *feSpotLight) PointsAtZ(value string) *feSpotLight {
	e.pointsAtZ = node.EscapeAttribute(value)
	return e
}

// SpecularExponent sets the specularExponent attribute.
//
// How focused the beam is. Larger values concentrate the light at the centre of the cone.
func (e *feSpotLight) SpecularExponent(value string) *feSpotLight {
	e.specularExponent = node.EscapeAttribute(value)
	return e
}

// LimitingConeAngle sets the limitingConeAngle attribute.
//
// Half the width of the cone in degrees. Beyond it nothing is lit, which gives the spotlight its edge.
func (e *feSpotLight) LimitingConeAngle(value string) *feSpotLight {
	e.limitingConeAngle = node.EscapeAttribute(value)
	return e
}

// ID sets the id attribute.
func (e *feSpotLight) ID(id string) *feSpotLight {
	e.svg().ID = node.EscapeAttribute(id)
	return e
}

// Class appends to the space-separated class attribute.
func (e *feSpotLight) Class(class string) *feSpotLight {
...
func (e *feSpotLight) Style(css string) *feSpotLight {
	e.svg().Style = node.EscapeAttribute(css)
	return e
}

// Transform sets the transform attribute.
func (e *feSpotLight) Transform(transform string) *feSpotLight {
...
func (e *feSpotLight) TransformOrigin(origin string) *feSpotLight {
	e.svg().TransformOrigin = node.EscapeAttribute(origin)
	return e
}

// TabIndex sets the tabindex attribute.
func (e *feSpotLight) TabIndex(index string) *feSpotLight {
	e.svg().TabIndex = node.EscapeAttribute(index)
	return e
}

// Role sets the role attribute.
func (e *feSpotLight) Role(role string) *feSpotLight {
...
func (e *feSpotLight) Lang(lang string) *feSpotLight {
...
func (e *feSpotLight) AutoFocus(conds ...bool) *feSpotLight {
	if len(conds) > 0 {
...
func (e *feSpotLight) SetAria(key string, value string) *feSpotLight {
...
func (e *feSpotLight) StrokeDashOffset(offset string) *feSpotLight {
...
func (e *feSpotLight) StrokeMiterLimit(limit string) *feSpotLight {
...
func (e *feSpotLight) FillRule(rule fillrule.FillRule) *feSpotLight {
	e.svg().FillRule = rule
	return e
}
...
// a clipPath.
func (e *feSpotLight) ClipRule(rule cliprule.ClipRule) *feSpotLight {
	e.svg().ClipRule = rule
	return e
}
...
func (e *feSpotLight) ClipPath(clip string) *feSpotLight {
...
// per pixel.
func (e *feSpotLight) Mask(mask string) *feSpotLight {
...
func (e *feSpotLight) Filter(filter string) *feSpotLight {
...
func (e *feSpotLight) Color(color string) *feSpotLight {
...
func (e *feSpotLight) Cursor(cursor string) *feSpotLight {
...
func (e *feSpotLight) Display(display string) *feSpotLight {
...
// drawn again.
func (e *feSpotLight) Visibility(value visibility.Visibility) *feSpotLight {
...
func (e *feSpotLight) PointerEvents(events pointerevents.PointerEvents) *feSpotLight {
...
func (e *feSpotLight) VectorEffect(effect vectoreffect.VectorEffect) *feSpotLight {
...
func (e *feSpotLight) ShapeRendering(rendering shaperendering.ShapeRendering) *feSpotLight {
...
func (e *feSpotLight) FontFamily(family string) *feSpotLight {
...
// is in user units.
func (e *feSpotLight) FontSize(size string) *feSpotLight {
...
// from 100 to 900.
func (e *feSpotLight) FontWeight(weight string) *feSpotLight {
...
func (e *feSpotLight) FontStyle(style string) *feSpotLight {
...
func (e *feSpotLight) OnClick(handler string) *feSpotLight {
...
func (e *feSpotLight) OnChange(handler string) *feSpotLight {
...
func (e *feSpotLight) OnInput(handler string) *feSpotLight {
...
func (e *feSpotLight) OnFocus(handler string) *feSpotLight {
...
func (e *feSpotLight) OnBlur(handler string) *feSpotLight {
...
func (e *feSpotLight) OnSubmit(handler string) *feSpotLight {
...
func (e *feSpotLight) OnLoad(handler string) *feSpotLight {
...
func (e *feSpotLight) OnError(handler string) *feSpotLight {
...
// developer-controlled key. Never build the key from user input - a key containing a space, quote,
// "=", "/" or ">" changes the markup structure. The value is escaped. The key is not escaped.
func (e *feSpotLight) SetEvent(key string, value string) *feSpotLight {
...
func (e *feSpotLight) OnAbort(handler string) *feSpotLight {
...
func (e *feSpotLight) OnAutoComplete(handler string) *feSpotLight {
...
//
// Deprecated: Removed from the WHATWG living standard. Was in an older HTML5 draft.
func (e *feSpotLight) OnAutoCompleteError(handler string) *feSpotLight {
...
func (e *feSpotLight) OnCancel(handler string) *feSpotLight {
...
func (e *feSpotLight) OnCanPlay(handler string) *feSpotLight {
...
func (e *feSpotLight) OnCanPlayThrough(handler string) *feSpotLight {
...
// results.
func (e *feSpotLight) OnClose(handler string) *feSpotLight {
...
func (e *feSpotLight) OnContextMenu(handler string) *feSpotLight {
...
// timestamps.
func (e *feSpotLight) OnCueChange(handler string) *feSpotLight {
...
func (e *feSpotLight) OnDblClick(handler string) *feSpotLight {
...
func (e *feSpotLight) OnDrag(handler string) *feSpotLight {
...
func (e *feSpotLight) OnDragEnd(handler string) *feSpotLight {
...
func (e *feSpotLight) OnDragEnter(handler string) *feSpotLight {
...
func (e *feSpotLight) OnDragLeave(handler string) *feSpotLight {
...
func (e *feSpotLight) OnDragOver(handler string) *feSpotLight {
...
func (e *feSpotLight) OnDragStart(handler string) *feSpotLight {
...
// enable dropping.
func (e *feSpotLight) OnDrop(handler string) *feSpotLight {
...
func (e *feSpotLight) OnDurationChange(handler string) *feSpotLight {
...
// media content.
func (e *feSpotLight) OnEmptied(handler string) *feSpotLight {
...
func (e *feSpotLight) OnEnded(handler string) *feSpotLight {
...
func (e *feSpotLight) OnInvalid(handler string) *feSpotLight {
...
func (e *feSpotLight) OnKeyDown(handler string) *feSpotLight {
...
func (e *feSpotLight) OnKeyPress(handler string) *feSpotLight {
...
func (e *feSpotLight) OnKeyUp(handler string) *feSpotLight {
...
func (e *feSpotLight) OnLoadedData(handler string) *feSpotLight {
...
func (e *feSpotLight) OnLoadedMetadata(handler string) *feSpotLight {
...
func (e *feSpotLight) OnLoadStart(handler string) *feSpotLight {
...
func (e *feSpotLight) OnMouseDown(handler string) *feSpotLight {
...
func (e *feSpotLight) OnMouseEnter(handler string) *feSpotLight {
...
func (e *feSpotLight) OnMouseLeave(handler string) *feSpotLight {
...
func (e *feSpotLight) OnMouseMove(handler string) *feSpotLight {
...
func (e *feSpotLight) OnMouseOut(handler string) *feSpotLight {
...
func (e *feSpotLight) OnMouseOver(handler string) *feSpotLight {
...
func (e *feSpotLight) OnMouseUp(handler string) *feSpotLight {
...
func (e *feSpotLight) OnMouseWheel(handler string) *feSpotLight {
...
func (e *feSpotLight) OnPause(handler string) *feSpotLight {
...
func (e *feSpotLight) OnPlay(handler string) *feSpotLight {
...
func (e *feSpotLight) OnPlaying(handler string) *feSpotLight {
...
func (e *feSpotLight) OnProgress(handler string) *feSpotLight {
...
func (e *feSpotLight) OnRateChange(handler string) *feSpotLight {
...
func (e *feSpotLight) OnReset(handler string) *feSpotLight {
...
// ResizeObserver.
func (e *feSpotLight) OnResize(handler string) *feSpotLight {
...
func (e *feSpotLight) OnScroll(handler string) *feSpotLight {
...
func (e *feSpotLight) OnSeeked(handler string) *feSpotLight {
...
func (e *feSpotLight) OnSeeking(handler string) *feSpotLight {
...
func (e *feSpotLight) OnSelect(handler string) *feSpotLight {
...
func (e *feSpotLight) OnShow(handler string) *feSpotLight {
...
func (e *feSpotLight) OnSort(handler string) *feSpotLight {
...
func (e *feSpotLight) OnStalled(handler string) *feSpotLight {
...
func (e *feSpotLight) OnSuspend(handler string) *feSpotLight {
...
func (e *feSpotLight) OnTimeUpdate(handler string) *feSpotLight {
...
func (e *feSpotLight) OnToggle(handler string) *feSpotLight {
...
func (e *feSpotLight) OnVolumeChange(handler string) *feSpotLight {
...
func (e *feSpotLight) OnWaiting(handler string) *feSpotLight {
...
func (e *feSpotLight) OnAuxClick(handler string) *feSpotLight {
...
func (e *feSpotLight) OnWheel(handler string) *feSpotLight {
...
func (e *feSpotLight) OnCopy(handler string) *feSpotLight {
...
// content itself.
func (e *feSpotLight) OnCut(handler string) *feSpotLight {
...
func (e *feSpotLight) OnPaste(handler string) *feSpotLight {
...
func (e *feSpotLight) OnScrollEnd(handler string) *feSpotLight {
...
func (e *feSpotLight) OnFormData(handler string) *feSpotLight {
...
func (e *feSpotLight) OnAnimationCancel(handler string) *feSpotLight {
...
func (e *feSpotLight) OnAnimationEnd(handler string) *feSpotLight {
...
func (e *feSpotLight) OnAnimationIteration(handler string) *feSpotLight {
...
func (e *feSpotLight) OnAnimationStart(handler string) *feSpotLight {
...
func (e *feSpotLight) OnTransitionCancel(handler string) *feSpotLight {
...
func (e *feSpotLight) OnTransitionEnd(handler string) *feSpotLight {
...
func (e *feSpotLight) OnTransitionRun(handler string) *feSpotLight {
...
func (e *feSpotLight) OnTransitionStart(handler string) *feSpotLight {
...
func (e *feSpotLight) OnBeforeToggle(handler string) *feSpotLight {
...
func (e *feSpotLight) OnBeforeInput(handler string) *feSpotLight {
...
func (e *feSpotLight) OnBeforeMatch(handler string) *feSpotLight {
...
func (e *feSpotLight) OnCommand(handler string) *feSpotLight {
...
func (e *feSpotLight) OnContextLost(handler string) *feSpotLight {
...
func (e *feSpotLight) OnContextRestored(handler string) *feSpotLight {
...
func (e *feSpotLight) OnSecurityPolicyViolation(handler string) *feSpotLight {
...
func (e *feSpotLight) OnSlotChange(handler string) *feSpotLight {
...
func (e *feSpotLight) OnPointerDown(handler string) *feSpotLight {
...
func (e *feSpotLight) OnPointerUp(handler string) *feSpotLight {
...
func (e *feSpotLight) OnPointerMove(handler string) *feSpotLight {
...
func (e *feSpotLight) OnPointerEnter(handler string) *feSpotLight {
...
func (e *feSpotLight) OnPointerLeave(handler string) *feSpotLight {
...
func (e *feSpotLight) OnPointerOver(handler string) *feSpotLight {
...
// element for any of its descendants.
func (e *feSpotLight) OnPointerOut(handler string) *feSpotLight {
...
func (e *feSpotLight) OnPointerCancel(handler string) *feSpotLight {
...
func (e *feSpotLight) OnGotPointerCapture(handler string) *feSpotLight {
...
func (e *feSpotLight) OnLostPointerCapture(handler string) *feSpotLight {
...
func (e *feSpotLight) OnTouchStart(handler string) *feSpotLight {
...
func (e *feSpotLight) OnTouchEnd(handler string) *feSpotLight {
...
func (e *feSpotLight) OnTouchMove(handler string) *feSpotLight {
...
func (e *feSpotLight) OnTouchCancel(handler string) *feSpotLight {
...
func (e *feSpotLight) OnSelectStart(handler string) *feSpotLight {
...
func (e *feSpotLight) OnSelectionChange(handler string) *feSpotLight {
...
func (e *feSpotLight) SetAttribute(key string, value string) {
...
func (e *feSpotLight) SetAttributeRaw(key string, value string) {
	if e.attr == nil {
		e.attr = &[]node.Attribute{}
	}
	for i, attr := range *e.attr {
...
func (e *feSpotLight) Add(children ...PrimitiveContent) *feSpotLight {
...
func (e *feSpotLight) Replace(children ...PrimitiveContent) *feSpotLight {
...
func (e *feSpotLight) Dynamic(key string) *feSpotLight {
	e.dynamic = key
	return e
}

// IsDynamic reports whether this element has been marked for reactive tracking.
func (e *feSpotLight) IsDynamic() bool {
	return e.dynamic != ""
}
...
func (e *feSpotLight) DynamicKey() string {
	return e.dynamic
}
...
func (e *feSpotLight) Memoise(version any) *feSpotLight {
	e.memoise = version
	return e
}
...
// by fluent-jit.
func (e *feSpotLight) MemoiseKey() any {
	return e.memoise
}
...
func (e *feSpotLight) BufferHint(hint int) *feSpotLight {
	if hint > 0 {
...
func (e *feSpotLight) RenderedSize() int {
...
func (e *feSpotLight) Render(w io.Writer) {
	_, _ = e.WriteTo(w)
}
...
func (e *feSpotLight) WriteTo(w io.Writer) (int64, error) {
...
func (e *feSpotLight) RenderBytes() []byte {
...
func (e *feSpotLight) AttributeBuilder(buf *bytes.Buffer) {
	if e.x != "" {
		buf.Write(AttrX)
		buf.WriteString(e.x)
	...
	if e.pointsAtX != "" {
		buf.Write(AttrPointsAtX)
		buf.WriteString(e.pointsAtX)
		buf.Write(MarkupQuote)
	}
	if e.pointsAtY != "" {
		buf.Write(AttrPointsAtY)
		buf.WriteString(e.pointsAtY)
		buf.Write(MarkupQuote)
	}
	if e.pointsAtZ != "" {
		buf.Write(AttrPointsAtZ)
		buf.WriteString(e.pointsAtZ)
		buf.Write(MarkupQuote)
	}
	...
	if e.limitingConeAngle != "" {
		buf.Write(AttrLimitingConeAngle)
		buf.WriteString(e.limitingConeAngle)
		buf.Write(MarkupQuote)
	}
...
func (e *feSpotLight) RenderBuilder(buf *bytes.Buffer) {
	buf.Write(TagFeSpotLight)
	...
	buf.Write(TagFeSpotLightClose)
}

// RenderOpen writes the opening tag and attributes to the buffer.
func (e *feSpotLight) RenderOpen(buf *bytes.Buffer) {
	buf.Write(TagFeSpotLight)
	e.AttributeBuilder(buf)
	buf.Write(MarkupCloseTag)
}
...
// isSVGLightSource seals feSpotLight as a LightSource.
func (*feSpotLight) isSVGLightSource() {}
