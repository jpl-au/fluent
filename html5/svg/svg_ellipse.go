...
func (e *ellipse) event() *html5.EventAttributes {
	if e.ea == nil {
...
// Ellipse draws an ellipse centred at (cx, cy). The rx and ry attributes set
// its horizontal and vertical radii independently. Equal radii produce a circle.
// Fill and stroke control the interior and outline.
func Ellipse(children ...ShapeContent) *ellipse {
...
func (e *ellipse) TransformOrigin(origin string) *ellipse {
...
func (e *ellipse) Lang(lang string) *ellipse {
...
func (e *ellipse) AutoFocus(conds ...bool) *ellipse {
	if len(conds) > 0 {
...
// developer-controlled key. Never build the key from user input - a key containing a space, quote,
// "=", "/" or ">" changes the markup structure. The value is escaped. The key is not escaped.
func (e *ellipse) SetData(key string, value string) *ellipse {
...
func (e *ellipse) StrokeDashOffset(offset string) *ellipse {
...
func (e *ellipse) StrokeMiterLimit(limit string) *ellipse {
...
func (e *ellipse) FillRule(rule fillrule.FillRule) *ellipse {
	e.svg().FillRule = rule
	return e
}
...
// a clipPath.
func (e *ellipse) ClipRule(rule cliprule.ClipRule) *ellipse {
	e.svg().ClipRule = rule
	return e
}
...
func (e *ellipse) ClipPath(clip string) *ellipse {
...
// per pixel.
func (e *ellipse) Mask(mask string) *ellipse {
...
func (e *ellipse) Filter(filter string) *ellipse {
...
func (e *ellipse) Cursor(cursor string) *ellipse {
...
func (e *ellipse) Display(display string) *ellipse {
...
// drawn again.
func (e *ellipse) Visibility(value visibility.Visibility) *ellipse {
...
func (e *ellipse) PointerEvents(events pointerevents.PointerEvents) *ellipse {
...
func (e *ellipse) VectorEffect(effect vectoreffect.VectorEffect) *ellipse {
...
func (e *ellipse) ShapeRendering(rendering shaperendering.ShapeRendering) *ellipse {
...
func (e *ellipse) FontFamily(family string) *ellipse {
...
// is in user units.
func (e *ellipse) FontSize(size string) *ellipse {
...
// from 100 to 900.
func (e *ellipse) FontWeight(weight string) *ellipse {
...
func (e *ellipse) FontStyle(style string) *ellipse {
...
func (e *ellipse) OnChange(handler string) *ellipse {
...
func (e *ellipse) OnInput(handler string) *ellipse {
...
func (e *ellipse) OnSubmit(handler string) *ellipse {
...
func (e *ellipse) OnLoad(handler string) *ellipse {
...
func (e *ellipse) OnError(handler string) *ellipse {
...
// developer-controlled key. Never build the key from user input - a key containing a space, quote,
// "=", "/" or ">" changes the markup structure. The value is escaped. The key is not escaped.
func (e *ellipse) SetEvent(key string, value string) *ellipse {
...
func (e *ellipse) OnAbort(handler string) *ellipse {
...
func (e *ellipse) OnAutoComplete(handler string) *ellipse {
...
//
// Deprecated: Removed from the WHATWG living standard. Was in an older HTML5 draft.
func (e *ellipse) OnAutoCompleteError(handler string) *ellipse {
...
func (e *ellipse) OnCancel(handler string) *ellipse {
...
func (e *ellipse) OnCanPlay(handler string) *ellipse {
...
func (e *ellipse) OnCanPlayThrough(handler string) *ellipse {
...
// results.
func (e *ellipse) OnClose(handler string) *ellipse {
...
func (e *ellipse) OnContextMenu(handler string) *ellipse {
...
// timestamps.
func (e *ellipse) OnCueChange(handler string) *ellipse {
...
func (e *ellipse) OnDblClick(handler string) *ellipse {
...
func (e *ellipse) OnDrag(handler string) *ellipse {
...
func (e *ellipse) OnDragEnd(handler string) *ellipse {
...
func (e *ellipse) OnDragEnter(handler string) *ellipse {
...
func (e *ellipse) OnDragLeave(handler string) *ellipse {
...
func (e *ellipse) OnDragOver(handler string) *ellipse {
...
func (e *ellipse) OnDragStart(handler string) *ellipse {
...
// enable dropping.
func (e *ellipse) OnDrop(handler string) *ellipse {
...
func (e *ellipse) OnDurationChange(handler string) *ellipse {
...
// media content.
func (e *ellipse) OnEmptied(handler string) *ellipse {
...
func (e *ellipse) OnEnded(handler string) *ellipse {
...
func (e *ellipse) OnInvalid(handler string) *ellipse {
...
func (e *ellipse) OnKeyDown(handler string) *ellipse {
...
func (e *ellipse) OnKeyPress(handler string) *ellipse {
...
func (e *ellipse) OnKeyUp(handler string) *ellipse {
...
func (e *ellipse) OnLoadedData(handler string) *ellipse {
...
func (e *ellipse) OnLoadedMetadata(handler string) *ellipse {
...
func (e *ellipse) OnLoadStart(handler string) *ellipse {
...
func (e *ellipse) OnMouseEnter(handler string) *ellipse {
...
func (e *ellipse) OnMouseLeave(handler string) *ellipse {
...
func (e *ellipse) OnMouseWheel(handler string) *ellipse {
...
func (e *ellipse) OnPause(handler string) *ellipse {
...
func (e *ellipse) OnPlay(handler string) *ellipse {
...
func (e *ellipse) OnPlaying(handler string) *ellipse {
...
func (e *ellipse) OnProgress(handler string) *ellipse {
...
func (e *ellipse) OnRateChange(handler string) *ellipse {
...
func (e *ellipse) OnReset(handler string) *ellipse {
...
// ResizeObserver.
func (e *ellipse) OnResize(handler string) *ellipse {
...
func (e *ellipse) OnScroll(handler string) *ellipse {
...
func (e *ellipse) OnSeeked(handler string) *ellipse {
...
func (e *ellipse) OnSeeking(handler string) *ellipse {
...
func (e *ellipse) OnSelect(handler string) *ellipse {
...
func (e *ellipse) OnShow(handler string) *ellipse {
...
func (e *ellipse) OnSort(handler string) *ellipse {
...
func (e *ellipse) OnStalled(handler string) *ellipse {
...
func (e *ellipse) OnSuspend(handler string) *ellipse {
...
func (e *ellipse) OnTimeUpdate(handler string) *ellipse {
...
func (e *ellipse) OnToggle(handler string) *ellipse {
...
func (e *ellipse) OnVolumeChange(handler string) *ellipse {
...
func (e *ellipse) OnWaiting(handler string) *ellipse {
...
func (e *ellipse) OnAuxClick(handler string) *ellipse {
...
func (e *ellipse) OnWheel(handler string) *ellipse {
...
func (e *ellipse) OnCopy(handler string) *ellipse {
...
// content itself.
func (e *ellipse) OnCut(handler string) *ellipse {
...
func (e *ellipse) OnPaste(handler string) *ellipse {
...
func (e *ellipse) OnScrollEnd(handler string) *ellipse {
...
func (e *ellipse) OnFormData(handler string) *ellipse {
...
func (e *ellipse) OnAnimationCancel(handler string) *ellipse {
...
func (e *ellipse) OnAnimationEnd(handler string) *ellipse {
...
func (e *ellipse) OnAnimationIteration(handler string) *ellipse {
...
func (e *ellipse) OnAnimationStart(handler string) *ellipse {
...
func (e *ellipse) OnTransitionCancel(handler string) *ellipse {
...
func (e *ellipse) OnTransitionEnd(handler string) *ellipse {
...
func (e *ellipse) OnTransitionRun(handler string) *ellipse {
...
func (e *ellipse) OnTransitionStart(handler string) *ellipse {
...
func (e *ellipse) OnBeforeToggle(handler string) *ellipse {
...
func (e *ellipse) OnBeforeInput(handler string) *ellipse {
...
func (e *ellipse) OnBeforeMatch(handler string) *ellipse {
...
func (e *ellipse) OnCommand(handler string) *ellipse {
...
func (e *ellipse) OnContextLost(handler string) *ellipse {
...
func (e *ellipse) OnContextRestored(handler string) *ellipse {
...
func (e *ellipse) OnSecurityPolicyViolation(handler string) *ellipse {
...
func (e *ellipse) OnSlotChange(handler string) *ellipse {
...
func (e *ellipse) OnPointerDown(handler string) *ellipse {
...
func (e *ellipse) OnPointerUp(handler string) *ellipse {
...
func (e *ellipse) OnPointerMove(handler string) *ellipse {
...
func (e *ellipse) OnPointerEnter(handler string) *ellipse {
...
func (e *ellipse) OnPointerLeave(handler string) *ellipse {
...
func (e *ellipse) OnPointerOver(handler string) *ellipse {
...
// element for any of its descendants.
func (e *ellipse) OnPointerOut(handler string) *ellipse {
...
func (e *ellipse) OnPointerCancel(handler string) *ellipse {
...
func (e *ellipse) OnGotPointerCapture(handler string) *ellipse {
...
func (e *ellipse) OnLostPointerCapture(handler string) *ellipse {
...
func (e *ellipse) OnTouchStart(handler string) *ellipse {
...
func (e *ellipse) OnTouchEnd(handler string) *ellipse {
...
func (e *ellipse) OnTouchMove(handler string) *ellipse {
...
func (e *ellipse) OnTouchCancel(handler string) *ellipse {
...
func (e *ellipse) OnSelectStart(handler string) *ellipse {
...
func (e *ellipse) OnSelectionChange(handler string) *ellipse {
...
func (e *ellipse) Add(children ...ShapeContent) *ellipse {
...
func (e *ellipse) Replace(children ...ShapeContent) *ellipse {
...
// isSVGShape seals ellipse as a Shape.
