...
// feFuncA represents the <feFuncA> SVG element.
type feFuncA struct {
	bufferhint  atomic.Int64
	nodes       []node.Node
	typeAttr    transfertype.TransferType
	amplitude   string
	dynamic     string
	exponent    string
	intercept   string
...
func (e *feFuncA) event() *html5.EventAttributes {
	if e.ea == nil {
...
// FeFuncA is the transfer function for the alpha channel of an
// FeComponentTransfer.
func FeFuncA(children ...PrimitiveContent) *feFuncA {
...
//
// The channel mapping: identity, table, discrete, linear or gamma. The mapping
// selects which parameters apply, such as tableValues for table and discrete,
// or slope and intercept for linear.
func (e *feFuncA) Type(value transfertype.TransferType) *feFuncA {
	e.typeAttr = value
	return e
}

// TableValues sets the tableValues attribute.
//
// The numbers the table and discrete functions map the channel through, as a space-separated list from 0
// to 1.
func (e *feFuncA) TableValues(value string) *feFuncA {
	e.tableValues = node.EscapeAttribute(value)
	return e
}

// Slope sets the slope attribute.
//
// The multiplier of the linear function.
func (e *feFuncA) Slope(value string) *feFuncA {
	e.slope = node.EscapeAttribute(value)
	return e
}

// Intercept sets the intercept attribute.
//
// The constant added by the linear function.
func (e *feFuncA) Intercept(value string) *feFuncA {
	e.intercept = node.EscapeAttribute(value)
	return e
}

// Amplitude sets the amplitude attribute.
//
// The multiplier of the gamma function.
func (e *feFuncA) Amplitude(value string) *feFuncA {
	e.amplitude = node.EscapeAttribute(value)
	return e
}

// Exponent sets the exponent attribute.
//
// The exponent of the gamma function.
func (e *feFuncA) Exponent(value string) *feFuncA {
	e.exponent = node.EscapeAttribute(value)
	return e
}

// Offset sets the offset attribute.
//
// The constant added by the gamma function.
func (e *feFuncA) Offset(value string) *feFuncA {
	e.offset = node.EscapeAttribute(value)
	return e
}

// ID sets the id attribute.
func (e *feFuncA) ID(id string) *feFuncA {
	e.svg().ID = node.EscapeAttribute(id)
	return e
}

// Class appends to the space-separated class attribute.
func (e *feFuncA) Class(class string) *feFuncA {
...
func (e *feFuncA) Style(css string) *feFuncA {
	e.svg().Style = node.EscapeAttribute(css)
	return e
}

// Transform sets the transform attribute.
func (e *feFuncA) Transform(transform string) *feFuncA {
...
func (e *feFuncA) TransformOrigin(origin string) *feFuncA {
	e.svg().TransformOrigin = node.EscapeAttribute(origin)
	return e
}

// TabIndex sets the tabindex attribute.
func (e *feFuncA) TabIndex(index string) *feFuncA {
	e.svg().TabIndex = node.EscapeAttribute(index)
	return e
}

// Role sets the role attribute.
func (e *feFuncA) Role(role string) *feFuncA {
...
func (e *feFuncA) Lang(lang string) *feFuncA {
...
func (e *feFuncA) AutoFocus(conds ...bool) *feFuncA {
	if len(conds) > 0 {
...
func (e *feFuncA) SetAria(key string, value string) *feFuncA {
...
func (e *feFuncA) StrokeDashOffset(offset string) *feFuncA {
...
func (e *feFuncA) StrokeMiterLimit(limit string) *feFuncA {
...
func (e *feFuncA) FillRule(rule fillrule.FillRule) *feFuncA {
	e.svg().FillRule = rule
	return e
}
...
// a clipPath.
func (e *feFuncA) ClipRule(rule cliprule.ClipRule) *feFuncA {
	e.svg().ClipRule = rule
	return e
}
...
func (e *feFuncA) ClipPath(clip string) *feFuncA {
...
// per pixel.
func (e *feFuncA) Mask(mask string) *feFuncA {
...
func (e *feFuncA) Filter(filter string) *feFuncA {
...
func (e *feFuncA) Color(color string) *feFuncA {
...
func (e *feFuncA) Cursor(cursor string) *feFuncA {
...
func (e *feFuncA) Display(display string) *feFuncA {
...
// drawn again.
func (e *feFuncA) Visibility(value visibility.Visibility) *feFuncA {
...
func (e *feFuncA) PointerEvents(events pointerevents.PointerEvents) *feFuncA {
...
func (e *feFuncA) VectorEffect(effect vectoreffect.VectorEffect) *feFuncA {
...
func (e *feFuncA) ShapeRendering(rendering shaperendering.ShapeRendering) *feFuncA {
...
func (e *feFuncA) FontFamily(family string) *feFuncA {
...
// is in user units.
func (e *feFuncA) FontSize(size string) *feFuncA {
...
// from 100 to 900.
func (e *feFuncA) FontWeight(weight string) *feFuncA {
...
func (e *feFuncA) FontStyle(style string) *feFuncA {
...
func (e *feFuncA) OnClick(handler string) *feFuncA {
...
func (e *feFuncA) OnChange(handler string) *feFuncA {
...
func (e *feFuncA) OnInput(handler string) *feFuncA {
...
func (e *feFuncA) OnFocus(handler string) *feFuncA {
...
func (e *feFuncA) OnBlur(handler string) *feFuncA {
...
func (e *feFuncA) OnSubmit(handler string) *feFuncA {
...
func (e *feFuncA) OnLoad(handler string) *feFuncA {
...
func (e *feFuncA) OnError(handler string) *feFuncA {
...
// developer-controlled key. Never build the key from user input - a key containing a space, quote,
// "=", "/" or ">" changes the markup structure. The value is escaped. The key is not escaped.
func (e *feFuncA) SetEvent(key string, value string) *feFuncA {
...
func (e *feFuncA) OnAbort(handler string) *feFuncA {
...
func (e *feFuncA) OnAutoComplete(handler string) *feFuncA {
...
//
// Deprecated: Removed from the WHATWG living standard. Was in an older HTML5 draft.
func (e *feFuncA) OnAutoCompleteError(handler string) *feFuncA {
...
func (e *feFuncA) OnCancel(handler string) *feFuncA {
...
func (e *feFuncA) OnCanPlay(handler string) *feFuncA {
...
func (e *feFuncA) OnCanPlayThrough(handler string) *feFuncA {
...
// results.
func (e *feFuncA) OnClose(handler string) *feFuncA {
...
func (e *feFuncA) OnContextMenu(handler string) *feFuncA {
...
// timestamps.
func (e *feFuncA) OnCueChange(handler string) *feFuncA {
...
func (e *feFuncA) OnDblClick(handler string) *feFuncA {
...
func (e *feFuncA) OnDrag(handler string) *feFuncA {
...
func (e *feFuncA) OnDragEnd(handler string) *feFuncA {
...
func (e *feFuncA) OnDragEnter(handler string) *feFuncA {
...
func (e *feFuncA) OnDragLeave(handler string) *feFuncA {
...
func (e *feFuncA) OnDragOver(handler string) *feFuncA {
...
func (e *feFuncA) OnDragStart(handler string) *feFuncA {
...
// enable dropping.
func (e *feFuncA) OnDrop(handler string) *feFuncA {
...
func (e *feFuncA) OnDurationChange(handler string) *feFuncA {
...
// media content.
func (e *feFuncA) OnEmptied(handler string) *feFuncA {
...
func (e *feFuncA) OnEnded(handler string) *feFuncA {
...
func (e *feFuncA) OnInvalid(handler string) *feFuncA {
...
func (e *feFuncA) OnKeyDown(handler string) *feFuncA {
...
func (e *feFuncA) OnKeyPress(handler string) *feFuncA {
...
func (e *feFuncA) OnKeyUp(handler string) *feFuncA {
...
func (e *feFuncA) OnLoadedData(handler string) *feFuncA {
...
func (e *feFuncA) OnLoadedMetadata(handler string) *feFuncA {
...
func (e *feFuncA) OnLoadStart(handler string) *feFuncA {
...
func (e *feFuncA) OnMouseDown(handler string) *feFuncA {
...
func (e *feFuncA) OnMouseEnter(handler string) *feFuncA {
...
func (e *feFuncA) OnMouseLeave(handler string) *feFuncA {
...
func (e *feFuncA) OnMouseMove(handler string) *feFuncA {
...
func (e *feFuncA) OnMouseOut(handler string) *feFuncA {
...
func (e *feFuncA) OnMouseOver(handler string) *feFuncA {
...
func (e *feFuncA) OnMouseUp(handler string) *feFuncA {
...
func (e *feFuncA) OnMouseWheel(handler string) *feFuncA {
...
func (e *feFuncA) OnPause(handler string) *feFuncA {
...
func (e *feFuncA) OnPlay(handler string) *feFuncA {
...
func (e *feFuncA) OnPlaying(handler string) *feFuncA {
...
func (e *feFuncA) OnProgress(handler string) *feFuncA {
...
func (e *feFuncA) OnRateChange(handler string) *feFuncA {
...
func (e *feFuncA) OnReset(handler string) *feFuncA {
...
// ResizeObserver.
func (e *feFuncA) OnResize(handler string) *feFuncA {
...
func (e *feFuncA) OnScroll(handler string) *feFuncA {
...
func (e *feFuncA) OnSeeked(handler string) *feFuncA {
...
func (e *feFuncA) OnSeeking(handler string) *feFuncA {
...
func (e *feFuncA) OnSelect(handler string) *feFuncA {
...
func (e *feFuncA) OnShow(handler string) *feFuncA {
...
func (e *feFuncA) OnSort(handler string) *feFuncA {
...
func (e *feFuncA) OnStalled(handler string) *feFuncA {
...
func (e *feFuncA) OnSuspend(handler string) *feFuncA {
...
func (e *feFuncA) OnTimeUpdate(handler string) *feFuncA {
...
func (e *feFuncA) OnToggle(handler string) *feFuncA {
...
func (e *feFuncA) OnVolumeChange(handler string) *feFuncA {
...
func (e *feFuncA) OnWaiting(handler string) *feFuncA {
...
func (e *feFuncA) OnAuxClick(handler string) *feFuncA {
...
func (e *feFuncA) OnWheel(handler string) *feFuncA {
...
func (e *feFuncA) OnCopy(handler string) *feFuncA {
...
// content itself.
func (e *feFuncA) OnCut(handler string) *feFuncA {
...
func (e *feFuncA) OnPaste(handler string) *feFuncA {
...
func (e *feFuncA) OnScrollEnd(handler string) *feFuncA {
...
func (e *feFuncA) OnFormData(handler string) *feFuncA {
...
func (e *feFuncA) OnAnimationCancel(handler string) *feFuncA {
...
func (e *feFuncA) OnAnimationEnd(handler string) *feFuncA {
...
func (e *feFuncA) OnAnimationIteration(handler string) *feFuncA {
...
func (e *feFuncA) OnAnimationStart(handler string) *feFuncA {
...
func (e *feFuncA) OnTransitionCancel(handler string) *feFuncA {
...
func (e *feFuncA) OnTransitionEnd(handler string) *feFuncA {
...
func (e *feFuncA) OnTransitionRun(handler string) *feFuncA {
...
func (e *feFuncA) OnTransitionStart(handler string) *feFuncA {
...
func (e *feFuncA) OnBeforeToggle(handler string) *feFuncA {
...
func (e *feFuncA) OnBeforeInput(handler string) *feFuncA {
...
func (e *feFuncA) OnBeforeMatch(handler string) *feFuncA {
...
func (e *feFuncA) OnCommand(handler string) *feFuncA {
...
func (e *feFuncA) OnContextLost(handler string) *feFuncA {
...
func (e *feFuncA) OnContextRestored(handler string) *feFuncA {
...
func (e *feFuncA) OnSecurityPolicyViolation(handler string) *feFuncA {
...
func (e *feFuncA) OnSlotChange(handler string) *feFuncA {
...
func (e *feFuncA) OnPointerDown(handler string) *feFuncA {
...
func (e *feFuncA) OnPointerUp(handler string) *feFuncA {
...
func (e *feFuncA) OnPointerMove(handler string) *feFuncA {
...
func (e *feFuncA) OnPointerEnter(handler string) *feFuncA {
...
func (e *feFuncA) OnPointerLeave(handler string) *feFuncA {
...
func (e *feFuncA) OnPointerOver(handler string) *feFuncA {
...
// element for any of its descendants.
func (e *feFuncA) OnPointerOut(handler string) *feFuncA {
...
func (e *feFuncA) OnPointerCancel(handler string) *feFuncA {
...
func (e *feFuncA) OnGotPointerCapture(handler string) *feFuncA {
...
func (e *feFuncA) OnLostPointerCapture(handler string) *feFuncA {
...
func (e *feFuncA) OnTouchStart(handler string) *feFuncA {
...
func (e *feFuncA) OnTouchEnd(handler string) *feFuncA {
...
func (e *feFuncA) OnTouchMove(handler string) *feFuncA {
...
func (e *feFuncA) OnTouchCancel(handler string) *feFuncA {
...
func (e *feFuncA) OnSelectStart(handler string) *feFuncA {
...
func (e *feFuncA) OnSelectionChange(handler string) *feFuncA {
...
func (e *feFuncA) SetAttribute(key string, value string) {
...
func (e *feFuncA) SetAttributeRaw(key string, value string) {
	if e.attr == nil {
		e.attr = &[]node.Attribute{}
	}
	for i, attr := range *e.attr {
...
func (e *feFuncA) Add(children ...PrimitiveContent) *feFuncA {
...
func (e *feFuncA) Replace(children ...PrimitiveContent) *feFuncA {
...
func (e *feFuncA) DynamicKey() string {
	return e.dynamic
}
...
func (e *feFuncA) Memoise(version any) *feFuncA {
	e.memoise = version
	return e
}
...
func (e *feFuncA) BufferHint(hint int) *feFuncA {
	if hint > 0 {
...
func (e *feFuncA) RenderedSize() int {
...
func (e *feFuncA) Render(w io.Writer) {
	_, _ = e.WriteTo(w)
}
...
func (e *feFuncA) WriteTo(w io.Writer) (int64, error) {
...
func (e *feFuncA) RenderBytes() []byte {
...
func (e *feFuncA) AttributeBuilder(buf *bytes.Buffer) {
	if len(e.typeAttr) > 0 {
		buf.Write(AttrType)
	...
	if e.tableValues != "" {
		buf.Write(AttrTableValues)
		buf.WriteString(e.tableValues)
		buf.Write(MarkupQuote)
	}
	if e.slope != "" {
		buf.Write(AttrSlope)
		buf.WriteString(e.slope)
		buf.Write(MarkupQuote)
	}
	if e.intercept != "" {
		buf.Write(AttrIntercept)
		buf.WriteString(e.intercept)
		buf.Write(MarkupQuote)
	}
	if e.amplitude != "" {
		buf.Write(AttrAmplitude)
		buf.WriteString(e.amplitude)
		buf.Write(MarkupQuote)
	}
	if e.exponent != "" {
		buf.Write(AttrExponent)
		buf.WriteString(e.exponent)
		buf.Write(MarkupQuote)
	}
	if e.offset != "" {
...
func (e *feFuncA) RenderBuilder(buf *bytes.Buffer) {
	buf.Write(TagFeFuncA)
	...
	buf.Write(TagFeFuncAClose)
}

// RenderOpen writes the opening tag and attributes to the buffer.
func (e *feFuncA) RenderOpen(buf *bytes.Buffer) {
	buf.Write(TagFeFuncA)
	e.AttributeBuilder(buf)
	buf.Write(MarkupCloseTag)
}
...
// isSVGTransferFunction seals feFuncA as a TransferFunction.
func (*feFuncA) isSVGTransferFunction() {}
