...
// symbol represents the <symbol> SVG element.
type symbol struct {
...
func (e *symbol) event() *html5.EventAttributes {
	if e.ea == nil {
...
// Symbol defines a reusable graphic that is not drawn where it is defined.
// Draw it with Use. Unlike a group in defs, a symbol carries its own viewBox,
// so each use can scale it to a different size.
func Symbol(children ...Shape) *symbol {
...
func (e *symbol) X(value string) *symbol {
	e.x = node.EscapeAttribute(value)
	return e
}

// Y sets the y attribute.
func (e *symbol) Y(value string) *symbol {
	e.y = node.EscapeAttribute(value)
	return e
}

// Width sets the width attribute.
func (e *symbol) Width(value string) *symbol {
	e.width = node.EscapeAttribute(value)
	return e
}

// Height sets the height attribute.
func (e *symbol) Height(value string) *symbol {
...
//
// The user coordinate system of the symbol's own contents, as "min-x min-y width height". It lets a use
// element scale the symbol to any size.
func (e *symbol) ViewBox(value string) *symbol {
...
//
// How the viewBox is fitted when its aspect ratio differs from the size a use element gives it, for
// example "xMidYMid meet" to centre it or "none" to stretch it.
func (e *symbol) PreserveAspectRatio(value string) *symbol {
...
//
// The x coordinate inside the symbol that is placed at the x of the use element, so a symbol can be
// positioned by its centre rather than its corner.
func (e *symbol) RefX(value string) *symbol {
...
//
// The y coordinate inside the symbol that is placed at the y of the use element.
func (e *symbol) RefY(value string) *symbol {
	e.refY = node.EscapeAttribute(value)
	return e
}

// ID sets the id attribute.
func (e *symbol) ID(id string) *symbol {
	e.svg().ID = node.EscapeAttribute(id)
	return e
}

// Class appends to the space-separated class attribute.
func (e *symbol) Class(class string) *symbol {
...
func (e *symbol) Style(css string) *symbol {
	e.svg().Style = node.EscapeAttribute(css)
	return e
}

// Transform sets the transform attribute.
func (e *symbol) Transform(transform string) *symbol {
...
func (e *symbol) TransformOrigin(origin string) *symbol {
	e.svg().TransformOrigin = node.EscapeAttribute(origin)
	return e
}

// TabIndex sets the tabindex attribute.
func (e *symbol) TabIndex(index string) *symbol {
	e.svg().TabIndex = node.EscapeAttribute(index)
	return e
}

// Role sets the role attribute.
func (e *symbol) Role(role string) *symbol {
...
func (e *symbol) Lang(lang string) *symbol {
...
func (e *symbol) AutoFocus(conds ...bool) *symbol {
	if len(conds) > 0 {
...
func (e *symbol) SetAria(key string, value string) *symbol {
...
func (e *symbol) StrokeDashOffset(offset string) *symbol {
...
func (e *symbol) StrokeMiterLimit(limit string) *symbol {
...
func (e *symbol) FillRule(rule fillrule.FillRule) *symbol {
	e.svg().FillRule = rule
	return e
}
...
// a clipPath.
func (e *symbol) ClipRule(rule cliprule.ClipRule) *symbol {
	e.svg().ClipRule = rule
	return e
}
...
func (e *symbol) ClipPath(clip string) *symbol {
...
// per pixel.
func (e *symbol) Mask(mask string) *symbol {
...
func (e *symbol) Filter(filter string) *symbol {
...
func (e *symbol) Color(color string) *symbol {
...
func (e *symbol) Cursor(cursor string) *symbol {
...
func (e *symbol) Display(display string) *symbol {
...
// drawn again.
func (e *symbol) Visibility(value visibility.Visibility) *symbol {
...
func (e *symbol) PointerEvents(events pointerevents.PointerEvents) *symbol {
...
func (e *symbol) VectorEffect(effect vectoreffect.VectorEffect) *symbol {
...
func (e *symbol) ShapeRendering(rendering shaperendering.ShapeRendering) *symbol {
...
func (e *symbol) FontFamily(family string) *symbol {
...
// is in user units.
func (e *symbol) FontSize(size string) *symbol {
...
// from 100 to 900.
func (e *symbol) FontWeight(weight string) *symbol {
...
func (e *symbol) FontStyle(style string) *symbol {
...
func (e *symbol) OnClick(handler string) *symbol {
...
func (e *symbol) OnChange(handler string) *symbol {
...
func (e *symbol) OnInput(handler string) *symbol {
...
func (e *symbol) OnFocus(handler string) *symbol {
...
func (e *symbol) OnBlur(handler string) *symbol {
...
func (e *symbol) OnSubmit(handler string) *symbol {
...
func (e *symbol) OnLoad(handler string) *symbol {
...
func (e *symbol) OnError(handler string) *symbol {
...
// developer-controlled key. Never build the key from user input - a key containing a space, quote,
// "=", "/" or ">" changes the markup structure. The value is escaped. The key is not escaped.
func (e *symbol) SetEvent(key string, value string) *symbol {
...
func (e *symbol) OnAbort(handler string) *symbol {
...
func (e *symbol) OnAutoComplete(handler string) *symbol {
...
//
// Deprecated: Removed from the WHATWG living standard. Was in an older HTML5 draft.
func (e *symbol) OnAutoCompleteError(handler string) *symbol {
...
func (e *symbol) OnCancel(handler string) *symbol {
...
func (e *symbol) OnCanPlay(handler string) *symbol {
...
func (e *symbol) OnCanPlayThrough(handler string) *symbol {
...
// results.
func (e *symbol) OnClose(handler string) *symbol {
...
func (e *symbol) OnContextMenu(handler string) *symbol {
...
// timestamps.
func (e *symbol) OnCueChange(handler string) *symbol {
...
func (e *symbol) OnDblClick(handler string) *symbol {
...
func (e *symbol) OnDrag(handler string) *symbol {
...
func (e *symbol) OnDragEnd(handler string) *symbol {
...
func (e *symbol) OnDragEnter(handler string) *symbol {
...
func (e *symbol) OnDragLeave(handler string) *symbol {
...
func (e *symbol) OnDragOver(handler string) *symbol {
...
func (e *symbol) OnDragStart(handler string) *symbol {
...
// enable dropping.
func (e *symbol) OnDrop(handler string) *symbol {
...
func (e *symbol) OnDurationChange(handler string) *symbol {
...
// media content.
func (e *symbol) OnEmptied(handler string) *symbol {
...
func (e *symbol) OnEnded(handler string) *symbol {
...
func (e *symbol) OnInvalid(handler string) *symbol {
...
func (e *symbol) OnKeyDown(handler string) *symbol {
...
func (e *symbol) OnKeyPress(handler string) *symbol {
...
func (e *symbol) OnKeyUp(handler string) *symbol {
...
func (e *symbol) OnLoadedData(handler string) *symbol {
...
func (e *symbol) OnLoadedMetadata(handler string) *symbol {
...
func (e *symbol) OnLoadStart(handler string) *symbol {
...
func (e *symbol) OnMouseDown(handler string) *symbol {
...
func (e *symbol) OnMouseEnter(handler string) *symbol {
...
func (e *symbol) OnMouseLeave(handler string) *symbol {
...
func (e *symbol) OnMouseMove(handler string) *symbol {
...
func (e *symbol) OnMouseOut(handler string) *symbol {
...
func (e *symbol) OnMouseOver(handler string) *symbol {
...
func (e *symbol) OnMouseUp(handler string) *symbol {
...
func (e *symbol) OnMouseWheel(handler string) *symbol {
...
func (e *symbol) OnPause(handler string) *symbol {
...
func (e *symbol) OnPlay(handler string) *symbol {
...
func (e *symbol) OnPlaying(handler string) *symbol {
...
func (e *symbol) OnProgress(handler string) *symbol {
...
func (e *symbol) OnRateChange(handler string) *symbol {
...
func (e *symbol) OnReset(handler string) *symbol {
...
// ResizeObserver.
func (e *symbol) OnResize(handler string) *symbol {
...
func (e *symbol) OnScroll(handler string) *symbol {
...
func (e *symbol) OnSeeked(handler string) *symbol {
...
func (e *symbol) OnSeeking(handler string) *symbol {
...
func (e *symbol) OnSelect(handler string) *symbol {
...
func (e *symbol) OnShow(handler string) *symbol {
...
func (e *symbol) OnSort(handler string) *symbol {
...
func (e *symbol) OnStalled(handler string) *symbol {
...
func (e *symbol) OnSuspend(handler string) *symbol {
...
func (e *symbol) OnTimeUpdate(handler string) *symbol {
...
func (e *symbol) OnToggle(handler string) *symbol {
...
func (e *symbol) OnVolumeChange(handler string) *symbol {
...
func (e *symbol) OnWaiting(handler string) *symbol {
...
func (e *symbol) OnAuxClick(handler string) *symbol {
...
func (e *symbol) OnWheel(handler string) *symbol {
...
func (e *symbol) OnCopy(handler string) *symbol {
...
// content itself.
func (e *symbol) OnCut(handler string) *symbol {
...
func (e *symbol) OnPaste(handler string) *symbol {
...
func (e *symbol) OnScrollEnd(handler string) *symbol {
...
func (e *symbol) OnFormData(handler string) *symbol {
...
func (e *symbol) OnAnimationCancel(handler string) *symbol {
...
func (e *symbol) OnAnimationEnd(handler string) *symbol {
...
func (e *symbol) OnAnimationIteration(handler string) *symbol {
...
func (e *symbol) OnAnimationStart(handler string) *symbol {
...
func (e *symbol) OnTransitionCancel(handler string) *symbol {
...
func (e *symbol) OnTransitionEnd(handler string) *symbol {
...
func (e *symbol) OnTransitionRun(handler string) *symbol {
...
func (e *symbol) OnTransitionStart(handler string) *symbol {
...
func (e *symbol) OnBeforeToggle(handler string) *symbol {
...
func (e *symbol) OnBeforeInput(handler string) *symbol {
...
func (e *symbol) OnBeforeMatch(handler string) *symbol {
...
func (e *symbol) OnCommand(handler string) *symbol {
...
func (e *symbol) OnContextLost(handler string) *symbol {
...
func (e *symbol) OnContextRestored(handler string) *symbol {
...
func (e *symbol) OnSecurityPolicyViolation(handler string) *symbol {
...
func (e *symbol) OnSlotChange(handler string) *symbol {
...
func (e *symbol) OnPointerDown(handler string) *symbol {
...
func (e *symbol) OnPointerUp(handler string) *symbol {
...
func (e *symbol) OnPointerMove(handler string) *symbol {
...
func (e *symbol) OnPointerEnter(handler string) *symbol {
...
func (e *symbol) OnPointerLeave(handler string) *symbol {
...
func (e *symbol) OnPointerOver(handler string) *symbol {
...
// element for any of its descendants.
func (e *symbol) OnPointerOut(handler string) *symbol {
...
func (e *symbol) OnPointerCancel(handler string) *symbol {
...
func (e *symbol) OnGotPointerCapture(handler string) *symbol {
...
func (e *symbol) OnLostPointerCapture(handler string) *symbol {
...
func (e *symbol) OnTouchStart(handler string) *symbol {
...
func (e *symbol) OnTouchEnd(handler string) *symbol {
...
func (e *symbol) OnTouchMove(handler string) *symbol {
...
func (e *symbol) OnTouchCancel(handler string) *symbol {
...
func (e *symbol) OnSelectStart(handler string) *symbol {
...
func (e *symbol) OnSelectionChange(handler string) *symbol {
...
func (e *symbol) SetAttribute(key string, value string) {
...
func (e *symbol) SetAttributeRaw(key string, value string) {
	if e.attr == nil {
		e.attr = &[]node.Attribute{}
	}
	for i, attr := range *e.attr {
...
func (e *symbol) Add(children ...Shape) *symbol {
...
func (e *symbol) Replace(children ...Shape) *symbol {
...
func (e *symbol) DynamicKey() string {
	return e.dynamic
}
...
func (e *symbol) Memoise(version any) *symbol {
	e.memoise = version
	return e
}
...
func (e *symbol) BufferHint(hint int) *symbol {
	if hint > 0 {
...
func (e *symbol) RenderedSize() int {
...
func (e *symbol) Render(w io.Writer) {
	_, _ = e.WriteTo(w)
}
...
func (e *symbol) WriteTo(w io.Writer) (int64, error) {
...
func (e *symbol) RenderBytes() []byte {
...
func (e *symbol) AttributeBuilder(buf *bytes.Buffer) {
	if e.x != "" {
		buf.Write(AttrX)
		buf.WriteString(e.x)
...
func (e *symbol) RenderBuilder(buf *bytes.Buffer) {
	buf.Write(TagSymbol)
	...
	buf.Write(TagSymbolClose)
}

// RenderOpen writes the opening tag and attributes to the buffer.
func (e *symbol) RenderOpen(buf *bytes.Buffer) {
	buf.Write(TagSymbol)
	e.AttributeBuilder(buf)
	buf.Write(MarkupCloseTag)
}
...
// isSVGShape seals symbol as a Shape.
func (*symbol) isSVGShape() {}
