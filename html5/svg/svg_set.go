...
// set represents the <set> SVG element.
type set struct {
...
func (e *set) event() *html5.EventAttributes {
	if e.ea == nil {
...
// Set applies a fixed attribute value for a specified active duration, without
// interpolation. The attributeName and to attributes identify the change.
// The begin, dur and end attributes control when it applies. It can be used for discrete
// changes such as showing an element on hover.
func Set(children ...Descriptive) *set {
...
//
// Which attribute of the parent to set, such as "visibility".
func (e *set) AttributeName(value string) *set {
...
//
// The value to set it to while the animation is active.
func (e *set) To(value string) *set {
...
//
// When to apply the value, as a time, an event such as "mouseover", or a reference to another animation.
func (e *set) Begin(value string) *set {
...
//
// How long the value stays applied, or "indefinite".
func (e *set) Dur(value string) *set {
...
//
// When to stop applying it, in the same forms as begin.
func (e *set) End(value string) *set {
...
//
// The shortest the animation may last.
func (e *set) Min(value string) *set {
...
func (e *set) Max(value string) *set {
...
func (e *set) RepeatCount(value string) *set {
...
func (e *set) RepeatDur(value string) *set {
...
func (e *set) Restart(value restart.Restart) *set {
	e.restart = value
	return e
}
...
//
// Whether the value is kept once the animation ends, or the attribute returns to what it was.
func (e *set) Fill(value animationfill.AnimationFill) *set {
	e.fill = value
	return e
}
...
//
// The element to change, as "#id", when the animation is not placed inside it.
func (e *set) Href(value string) *set {
	e.href = node.EscapeAttribute(value)
	return e
}

// ID sets the id attribute.
func (e *set) ID(id string) *set {
	e.svg().ID = node.EscapeAttribute(id)
	return e
}

// Class appends to the space-separated class attribute.
func (e *set) Class(class string) *set {
...
func (e *set) Lang(lang string) *set {
...
func (e *set) AutoFocus(conds ...bool) *set {
	if len(conds) > 0 {
...
func (e *set) SetAria(key string, value string) *set {
...
func (e *set) StrokeDashOffset(offset string) *set {
...
func (e *set) StrokeMiterLimit(limit string) *set {
...
func (e *set) FillRule(rule fillrule.FillRule) *set {
	e.svg().FillRule = rule
	return e
}
...
// a clipPath.
func (e *set) ClipRule(rule cliprule.ClipRule) *set {
	e.svg().ClipRule = rule
	return e
}
...
func (e *set) ClipPath(clip string) *set {
...
// per pixel.
func (e *set) Mask(mask string) *set {
...
func (e *set) Filter(filter string) *set {
...
func (e *set) Color(color string) *set {
...
func (e *set) Cursor(cursor string) *set {
...
func (e *set) Display(display string) *set {
...
// drawn again.
func (e *set) Visibility(value visibility.Visibility) *set {
...
func (e *set) PointerEvents(events pointerevents.PointerEvents) *set {
...
func (e *set) VectorEffect(effect vectoreffect.VectorEffect) *set {
...
func (e *set) ShapeRendering(rendering shaperendering.ShapeRendering) *set {
...
func (e *set) FontFamily(family string) *set {
...
// is in user units.
func (e *set) FontSize(size string) *set {
...
// from 100 to 900.
func (e *set) FontWeight(weight string) *set {
...
func (e *set) FontStyle(style string) *set {
...
func (e *set) OnClick(handler string) *set {
...
func (e *set) OnChange(handler string) *set {
...
func (e *set) OnInput(handler string) *set {
...
func (e *set) OnFocus(handler string) *set {
...
func (e *set) OnBlur(handler string) *set {
...
func (e *set) OnSubmit(handler string) *set {
...
func (e *set) OnLoad(handler string) *set {
...
func (e *set) OnError(handler string) *set {
...
// developer-controlled key. Never build the key from user input - a key containing a space, quote,
// "=", "/" or ">" changes the markup structure. The value is escaped. The key is not escaped.
func (e *set) SetEvent(key string, value string) *set {
...
func (e *set) OnAbort(handler string) *set {
...
func (e *set) OnAutoComplete(handler string) *set {
...
//
// Deprecated: Removed from the WHATWG living standard. Was in an older HTML5 draft.
func (e *set) OnAutoCompleteError(handler string) *set {
...
func (e *set) OnCancel(handler string) *set {
...
func (e *set) OnCanPlay(handler string) *set {
...
func (e *set) OnCanPlayThrough(handler string) *set {
...
// results.
func (e *set) OnClose(handler string) *set {
...
func (e *set) OnContextMenu(handler string) *set {
...
// timestamps.
func (e *set) OnCueChange(handler string) *set {
...
func (e *set) OnDblClick(handler string) *set {
...
func (e *set) OnDrag(handler string) *set {
...
func (e *set) OnDragEnd(handler string) *set {
...
func (e *set) OnDragEnter(handler string) *set {
...
func (e *set) OnDragLeave(handler string) *set {
...
func (e *set) OnDragOver(handler string) *set {
...
func (e *set) OnDragStart(handler string) *set {
...
// enable dropping.
func (e *set) OnDrop(handler string) *set {
...
func (e *set) OnDurationChange(handler string) *set {
...
// media content.
func (e *set) OnEmptied(handler string) *set {
...
func (e *set) OnEnded(handler string) *set {
...
func (e *set) OnInvalid(handler string) *set {
...
func (e *set) OnKeyDown(handler string) *set {
...
func (e *set) OnKeyPress(handler string) *set {
...
func (e *set) OnKeyUp(handler string) *set {
...
func (e *set) OnLoadedData(handler string) *set {
...
func (e *set) OnLoadedMetadata(handler string) *set {
...
func (e *set) OnLoadStart(handler string) *set {
...
func (e *set) OnMouseDown(handler string) *set {
...
func (e *set) OnMouseEnter(handler string) *set {
...
func (e *set) OnMouseLeave(handler string) *set {
...
func (e *set) OnMouseMove(handler string) *set {
...
func (e *set) OnMouseOut(handler string) *set {
...
func (e *set) OnMouseOver(handler string) *set {
...
func (e *set) OnMouseUp(handler string) *set {
...
func (e *set) OnMouseWheel(handler string) *set {
...
func (e *set) OnPause(handler string) *set {
...
func (e *set) OnPlay(handler string) *set {
...
func (e *set) OnPlaying(handler string) *set {
...
func (e *set) OnProgress(handler string) *set {
...
func (e *set) OnRateChange(handler string) *set {
...
func (e *set) OnReset(handler string) *set {
...
// ResizeObserver.
func (e *set) OnResize(handler string) *set {
...
func (e *set) OnScroll(handler string) *set {
...
func (e *set) OnSeeked(handler string) *set {
...
func (e *set) OnSeeking(handler string) *set {
...
func (e *set) OnSelect(handler string) *set {
...
func (e *set) OnShow(handler string) *set {
...
func (e *set) OnSort(handler string) *set {
...
func (e *set) OnStalled(handler string) *set {
...
func (e *set) OnSuspend(handler string) *set {
...
func (e *set) OnTimeUpdate(handler string) *set {
...
func (e *set) OnToggle(handler string) *set {
...
func (e *set) OnVolumeChange(handler string) *set {
...
func (e *set) OnWaiting(handler string) *set {
...
func (e *set) OnAuxClick(handler string) *set {
...
func (e *set) OnWheel(handler string) *set {
...
func (e *set) OnCopy(handler string) *set {
...
// content itself.
func (e *set) OnCut(handler string) *set {
...
func (e *set) OnPaste(handler string) *set {
...
func (e *set) OnScrollEnd(handler string) *set {
...
func (e *set) OnFormData(handler string) *set {
...
func (e *set) OnAnimationCancel(handler string) *set {
...
func (e *set) OnAnimationEnd(handler string) *set {
...
func (e *set) OnAnimationIteration(handler string) *set {
...
func (e *set) OnAnimationStart(handler string) *set {
...
func (e *set) OnTransitionCancel(handler string) *set {
...
func (e *set) OnTransitionEnd(handler string) *set {
...
func (e *set) OnTransitionRun(handler string) *set {
...
func (e *set) OnTransitionStart(handler string) *set {
...
func (e *set) OnBeforeToggle(handler string) *set {
...
func (e *set) OnBeforeInput(handler string) *set {
...
func (e *set) OnBeforeMatch(handler string) *set {
...
func (e *set) OnCommand(handler string) *set {
...
func (e *set) OnContextLost(handler string) *set {
...
func (e *set) OnContextRestored(handler string) *set {
...
func (e *set) OnSecurityPolicyViolation(handler string) *set {
...
func (e *set) OnSlotChange(handler string) *set {
...
func (e *set) OnPointerDown(handler string) *set {
...
func (e *set) OnPointerUp(handler string) *set {
...
func (e *set) OnPointerMove(handler string) *set {
...
func (e *set) OnPointerEnter(handler string) *set {
...
func (e *set) OnPointerLeave(handler string) *set {
...
func (e *set) OnPointerOver(handler string) *set {
...
// element for any of its descendants.
func (e *set) OnPointerOut(handler string) *set {
...
func (e *set) OnPointerCancel(handler string) *set {
...
func (e *set) OnGotPointerCapture(handler string) *set {
...
func (e *set) OnLostPointerCapture(handler string) *set {
...
func (e *set) OnTouchStart(handler string) *set {
...
func (e *set) OnTouchEnd(handler string) *set {
...
func (e *set) OnTouchMove(handler string) *set {
...
func (e *set) OnTouchCancel(handler string) *set {
...
func (e *set) OnSelectStart(handler string) *set {
...
func (e *set) OnSelectionChange(handler string) *set {
...
func (e *set) SetAttribute(key string, value string) {
...
func (e *set) SetAttributeRaw(key string, value string) {
	if e.attr == nil {
		e.attr = &[]node.Attribute{}
	}
	for i, attr := range *e.attr {
...
func (e *set) Add(children ...Descriptive) *set {
...
func (e *set) Replace(children ...Descriptive) *set {
...
func (e *set) Memoise(version any) *set {
	e.memoise = version
	return e
}
...
func (e *set) BufferHint(hint int) *set {
	if hint > 0 {
...
func (e *set) WriteTo(w io.Writer) (int64, error) {
...
func (e *set) AttributeBuilder(buf *bytes.Buffer) {
	if e.attributeName != "" {
...
func (e *set) RenderBuilder(buf *bytes.Buffer) {
	buf.Write(TagSet)
...
// isSVGShape seals set as a Shape.
func (*set) isSVGShape() {}

// isSVGShapeContent seals set as a ShapeContent.
func (*set) isSVGShapeContent() {}

// isSVGPrimitiveContent seals set as a PrimitiveContent.
func (*set) isSVGPrimitiveContent() {}
