...
// feFuncB represents the <feFuncB> SVG element.
type feFuncB struct {
...
func (e *feFuncB) event() *html5.EventAttributes {
	if e.ea == nil {
...
// FeFuncB is the transfer function for the blue channel of an
// FeComponentTransfer.
func FeFuncB(children ...PrimitiveContent) *feFuncB {
...
func (e *feFuncB) Type(value transfertype.TransferType) *feFuncB {
	e.typeAttr = value
	return e
}
...
// to 1.
func (e *feFuncB) TableValues(value string) *feFuncB {
...
func (e *feFuncB) Slope(value string) *feFuncB {
...
func (e *feFuncB) Intercept(value string) *feFuncB {
...
func (e *feFuncB) Amplitude(value string) *feFuncB {
...
func (e *feFuncB) Exponent(value string) *feFuncB {
...
func (e *feFuncB) Style(css string) *feFuncB {
	e.svg().Style = node.EscapeAttribute(css)
	return e
}

// Transform sets the transform attribute.
func (e *feFuncB) Transform(transform string) *feFuncB {
...
func (e *feFuncB) TransformOrigin(origin string) *feFuncB {
	e.svg().TransformOrigin = node.EscapeAttribute(origin)
	return e
}

// TabIndex sets the tabindex attribute.
func (e *feFuncB) TabIndex(index string) *feFuncB {
	e.svg().TabIndex = node.EscapeAttribute(index)
	return e
}

// Role sets the role attribute.
func (e *feFuncB) Role(role string) *feFuncB {
...
func (e *feFuncB) Lang(lang string) *feFuncB {
...
func (e *feFuncB) AutoFocus(conds ...bool) *feFuncB {
	if len(conds) > 0 {
...
func (e *feFuncB) SetAria(key string, value string) *feFuncB {
...
func (e *feFuncB) StrokeDashOffset(offset string) *feFuncB {
...
func (e *feFuncB) StrokeMiterLimit(limit string) *feFuncB {
...
func (e *feFuncB) FillRule(rule fillrule.FillRule) *feFuncB {
	e.svg().FillRule = rule
	return e
}
...
// a clipPath.
func (e *feFuncB) ClipRule(rule cliprule.ClipRule) *feFuncB {
	e.svg().ClipRule = rule
	return e
}
...
func (e *feFuncB) ClipPath(clip string) *feFuncB {
...
// per pixel.
func (e *feFuncB) Mask(mask string) *feFuncB {
...
func (e *feFuncB) Filter(filter string) *feFuncB {
...
func (e *feFuncB) Color(color string) *feFuncB {
...
func (e *feFuncB) Cursor(cursor string) *feFuncB {
...
func (e *feFuncB) Display(display string) *feFuncB {
...
// drawn again.
func (e *feFuncB) Visibility(value visibility.Visibility) *feFuncB {
...
func (e *feFuncB) PointerEvents(events pointerevents.PointerEvents) *feFuncB {
...
func (e *feFuncB) VectorEffect(effect vectoreffect.VectorEffect) *feFuncB {
...
func (e *feFuncB) ShapeRendering(rendering shaperendering.ShapeRendering) *feFuncB {
...
func (e *feFuncB) FontFamily(family string) *feFuncB {
...
// is in user units.
func (e *feFuncB) FontSize(size string) *feFuncB {
...
// from 100 to 900.
func (e *feFuncB) FontWeight(weight string) *feFuncB {
...
func (e *feFuncB) FontStyle(style string) *feFuncB {
...
func (e *feFuncB) OnClick(handler string) *feFuncB {
...
func (e *feFuncB) OnChange(handler string) *feFuncB {
...
func (e *feFuncB) OnInput(handler string) *feFuncB {
...
func (e *feFuncB) OnFocus(handler string) *feFuncB {
...
func (e *feFuncB) OnBlur(handler string) *feFuncB {
...
func (e *feFuncB) OnSubmit(handler string) *feFuncB {
...
func (e *feFuncB) OnLoad(handler string) *feFuncB {
...
func (e *feFuncB) OnError(handler string) *feFuncB {
...
// developer-controlled key. Never build the key from user input - a key containing a space, quote,
// "=", "/" or ">" changes the markup structure. The value is escaped. The key is not escaped.
func (e *feFuncB) SetEvent(key string, value string) *feFuncB {
...
func (e *feFuncB) OnAbort(handler string) *feFuncB {
...
func (e *feFuncB) OnAutoComplete(handler string) *feFuncB {
...
//
// Deprecated: Removed from the WHATWG living standard. Was in an older HTML5 draft.
func (e *feFuncB) OnAutoCompleteError(handler string) *feFuncB {
...
func (e *feFuncB) OnCancel(handler string) *feFuncB {
...
func (e *feFuncB) OnCanPlay(handler string) *feFuncB {
...
func (e *feFuncB) OnCanPlayThrough(handler string) *feFuncB {
...
// results.
func (e *feFuncB) OnClose(handler string) *feFuncB {
...
func (e *feFuncB) OnContextMenu(handler string) *feFuncB {
...
// timestamps.
func (e *feFuncB) OnCueChange(handler string) *feFuncB {
...
func (e *feFuncB) OnDblClick(handler string) *feFuncB {
...
func (e *feFuncB) OnDrag(handler string) *feFuncB {
...
func (e *feFuncB) OnDragEnd(handler string) *feFuncB {
...
func (e *feFuncB) OnDragEnter(handler string) *feFuncB {
...
func (e *feFuncB) OnDragLeave(handler string) *feFuncB {
...
func (e *feFuncB) OnDragOver(handler string) *feFuncB {
...
func (e *feFuncB) OnDragStart(handler string) *feFuncB {
...
// enable dropping.
func (e *feFuncB) OnDrop(handler string) *feFuncB {
...
func (e *feFuncB) OnDurationChange(handler string) *feFuncB {
...
// media content.
func (e *feFuncB) OnEmptied(handler string) *feFuncB {
...
func (e *feFuncB) OnEnded(handler string) *feFuncB {
...
func (e *feFuncB) OnInvalid(handler string) *feFuncB {
...
func (e *feFuncB) OnKeyDown(handler string) *feFuncB {
...
func (e *feFuncB) OnKeyPress(handler string) *feFuncB {
...
func (e *feFuncB) OnKeyUp(handler string) *feFuncB {
...
func (e *feFuncB) OnLoadedData(handler string) *feFuncB {
...
func (e *feFuncB) OnLoadedMetadata(handler string) *feFuncB {
...
func (e *feFuncB) OnLoadStart(handler string) *feFuncB {
...
func (e *feFuncB) OnMouseDown(handler string) *feFuncB {
...
func (e *feFuncB) OnMouseEnter(handler string) *feFuncB {
...
func (e *feFuncB) OnMouseLeave(handler string) *feFuncB {
...
func (e *feFuncB) OnMouseMove(handler string) *feFuncB {
...
func (e *feFuncB) OnMouseOut(handler string) *feFuncB {
...
func (e *feFuncB) OnMouseOver(handler string) *feFuncB {
...
func (e *feFuncB) OnMouseUp(handler string) *feFuncB {
...
func (e *feFuncB) OnMouseWheel(handler string) *feFuncB {
...
func (e *feFuncB) OnPause(handler string) *feFuncB {
...
func (e *feFuncB) OnPlay(handler string) *feFuncB {
...
func (e *feFuncB) OnPlaying(handler string) *feFuncB {
...
func (e *feFuncB) OnProgress(handler string) *feFuncB {
...
func (e *feFuncB) OnRateChange(handler string) *feFuncB {
...
func (e *feFuncB) OnReset(handler string) *feFuncB {
...
// ResizeObserver.
func (e *feFuncB) OnResize(handler string) *feFuncB {
...
func (e *feFuncB) OnScroll(handler string) *feFuncB {
...
func (e *feFuncB) OnSeeked(handler string) *feFuncB {
...
func (e *feFuncB) OnSeeking(handler string) *feFuncB {
...
func (e *feFuncB) OnSelect(handler string) *feFuncB {
...
func (e *feFuncB) OnShow(handler string) *feFuncB {
...
func (e *feFuncB) OnSort(handler string) *feFuncB {
...
func (e *feFuncB) OnStalled(handler string) *feFuncB {
...
func (e *feFuncB) OnSuspend(handler string) *feFuncB {
...
func (e *feFuncB) OnTimeUpdate(handler string) *feFuncB {
...
func (e *feFuncB) OnToggle(handler string) *feFuncB {
...
func (e *feFuncB) OnVolumeChange(handler string) *feFuncB {
...
func (e *feFuncB) OnWaiting(handler string) *feFuncB {
...
func (e *feFuncB) OnAuxClick(handler string) *feFuncB {
...
func (e *feFuncB) OnWheel(handler string) *feFuncB {
...
func (e *feFuncB) OnCopy(handler string) *feFuncB {
...
// content itself.
func (e *feFuncB) OnCut(handler string) *feFuncB {
...
func (e *feFuncB) OnPaste(handler string) *feFuncB {
...
func (e *feFuncB) OnScrollEnd(handler string) *feFuncB {
...
func (e *feFuncB) OnFormData(handler string) *feFuncB {
...
func (e *feFuncB) OnAnimationCancel(handler string) *feFuncB {
...
func (e *feFuncB) OnAnimationEnd(handler string) *feFuncB {
...
func (e *feFuncB) OnAnimationIteration(handler string) *feFuncB {
...
func (e *feFuncB) OnAnimationStart(handler string) *feFuncB {
...
func (e *feFuncB) OnTransitionCancel(handler string) *feFuncB {
...
func (e *feFuncB) OnTransitionEnd(handler string) *feFuncB {
...
func (e *feFuncB) OnTransitionRun(handler string) *feFuncB {
...
func (e *feFuncB) OnTransitionStart(handler string) *feFuncB {
...
func (e *feFuncB) OnBeforeToggle(handler string) *feFuncB {
...
func (e *feFuncB) OnBeforeInput(handler string) *feFuncB {
...
func (e *feFuncB) OnBeforeMatch(handler string) *feFuncB {
...
func (e *feFuncB) OnCommand(handler string) *feFuncB {
...
func (e *feFuncB) OnContextLost(handler string) *feFuncB {
...
func (e *feFuncB) OnContextRestored(handler string) *feFuncB {
...
func (e *feFuncB) OnSecurityPolicyViolation(handler string) *feFuncB {
...
func (e *feFuncB) OnSlotChange(handler string) *feFuncB {
...
func (e *feFuncB) OnPointerDown(handler string) *feFuncB {
...
func (e *feFuncB) OnPointerUp(handler string) *feFuncB {
...
func (e *feFuncB) OnPointerMove(handler string) *feFuncB {
...
func (e *feFuncB) OnPointerEnter(handler string) *feFuncB {
...
func (e *feFuncB) OnPointerLeave(handler string) *feFuncB {
...
func (e *feFuncB) OnPointerOver(handler string) *feFuncB {
...
// element for any of its descendants.
func (e *feFuncB) OnPointerOut(handler string) *feFuncB {
...
func (e *feFuncB) OnPointerCancel(handler string) *feFuncB {
...
func (e *feFuncB) OnGotPointerCapture(handler string) *feFuncB {
...
func (e *feFuncB) OnLostPointerCapture(handler string) *feFuncB {
...
func (e *feFuncB) OnTouchStart(handler string) *feFuncB {
...
func (e *feFuncB) OnTouchEnd(handler string) *feFuncB {
...
func (e *feFuncB) OnTouchMove(handler string) *feFuncB {
...
func (e *feFuncB) OnTouchCancel(handler string) *feFuncB {
...
func (e *feFuncB) OnSelectStart(handler string) *feFuncB {
...
func (e *feFuncB) OnSelectionChange(handler string) *feFuncB {
...
func (e *feFuncB) SetAttribute(key string, value string) {
...
func (e *feFuncB) SetAttributeRaw(key string, value string) {
	if e.attr == nil {
		e.attr = &[]node.Attribute{}
	}
	for i, attr := range *e.attr {
...
func (e *feFuncB) Add(children ...PrimitiveContent) *feFuncB {
...
func (e *feFuncB) Replace(children ...PrimitiveContent) *feFuncB {
...
func (e *feFuncB) DynamicKey() string {
	return e.dynamic
}
...
func (e *feFuncB) Memoise(version any) *feFuncB {
	e.memoise = version
	return e
}
...
func (e *feFuncB) BufferHint(hint int) *feFuncB {
	if hint > 0 {
...
func (e *feFuncB) RenderedSize() int {
...
func (e *feFuncB) Render(w io.Writer) {
	_, _ = e.WriteTo(w)
}
...
func (e *feFuncB) WriteTo(w io.Writer) (int64, error) {
...
func (e *feFuncB) RenderBytes() []byte {
...
func (e *feFuncB) AttributeBuilder(buf *bytes.Buffer) {
	if len(e.typeAttr) > 0 {
		buf.Write(AttrType)
...
func (e *feFuncB) RenderBuilder(buf *bytes.Buffer) {
	buf.Write(TagFeFuncB)
	...
	buf.Write(TagFeFuncBClose)
}

// RenderOpen writes the opening tag and attributes to the buffer.
func (e *feFuncB) RenderOpen(buf *bytes.Buffer) {
	buf.Write(TagFeFuncB)
	e.AttributeBuilder(buf)
	buf.Write(MarkupCloseTag)
}
...
// isSVGTransferFunction seals feFuncB as a TransferFunction.
func (*feFuncB) isSVGTransferFunction() {}
