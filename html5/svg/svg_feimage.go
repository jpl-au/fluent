...
// feImage represents the <feImage> SVG element.
type feImage struct {
...
func (e *feImage) event() *html5.EventAttributes {
	if e.ea == nil {
...
// FeImage brings an external image, or another element of the same document,
// into a filter as an input.
func FeImage(children ...PrimitiveContent) *feImage {
...
//
// The URL of the image, or "#id" to use another element of this document as the input. A data URL embeds
// the image, so this value is not filtered against the URL scheme allowlist.
func (e *feImage) Href(value string) *feImage {
...
//
// How the image is fitted to the subregion when their aspect ratios differ.
func (e *feImage) PreserveAspectRatio(value string) *feImage {
...
//
// Whether the image is fetched with a CORS request, and whether credentials are sent.
func (e *feImage) Crossorigin(value crossorigin.CrossOrigin) *feImage {
	e.crossorigin = value
	return e
}

// X sets the x attribute.
func (e *feImage) X(value string) *feImage {
	e.x = node.EscapeAttribute(value)
	return e
}

// Y sets the y attribute.
func (e *feImage) Y(value string) *feImage {
	e.y = node.EscapeAttribute(value)
	return e
}

// Width sets the width attribute.
func (e *feImage) Width(value string) *feImage {
	e.width = node.EscapeAttribute(value)
	return e
}

// Height sets the height attribute.
func (e *feImage) Height(value string) *feImage {
	e.height = node.EscapeAttribute(value)
	return e
}

// Result sets the result attribute.
func (e *feImage) Result(value string) *feImage {
	e.result = node.EscapeAttribute(value)
	return e
}

// ID sets the id attribute.
func (e *feImage) ID(id string) *feImage {
	e.svg().ID = node.EscapeAttribute(id)
	return e
}

// Class appends to the space-separated class attribute.
func (e *feImage) Class(class string) *feImage {
...
func (e *feImage) Style(css string) *feImage {
	e.svg().Style = node.EscapeAttribute(css)
	return e
}

// Transform sets the transform attribute.
func (e *feImage) Transform(transform string) *feImage {
...
func (e *feImage) TransformOrigin(origin string) *feImage {
	e.svg().TransformOrigin = node.EscapeAttribute(origin)
	return e
}

// TabIndex sets the tabindex attribute.
func (e *feImage) TabIndex(index string) *feImage {
	e.svg().TabIndex = node.EscapeAttribute(index)
	return e
}

// Role sets the role attribute.
func (e *feImage) Role(role string) *feImage {
...
func (e *feImage) Lang(lang string) *feImage {
...
func (e *feImage) AutoFocus(conds ...bool) *feImage {
	if len(conds) > 0 {
...
func (e *feImage) SetAria(key string, value string) *feImage {
...
func (e *feImage) StrokeDashOffset(offset string) *feImage {
...
func (e *feImage) StrokeMiterLimit(limit string) *feImage {
...
func (e *feImage) FillRule(rule fillrule.FillRule) *feImage {
	e.svg().FillRule = rule
	return e
}
...
// a clipPath.
func (e *feImage) ClipRule(rule cliprule.ClipRule) *feImage {
	e.svg().ClipRule = rule
	return e
}
...
func (e *feImage) ClipPath(clip string) *feImage {
...
// per pixel.
func (e *feImage) Mask(mask string) *feImage {
...
func (e *feImage) Filter(filter string) *feImage {
...
func (e *feImage) Color(color string) *feImage {
...
func (e *feImage) Cursor(cursor string) *feImage {
...
func (e *feImage) Display(display string) *feImage {
...
// drawn again.
func (e *feImage) Visibility(value visibility.Visibility) *feImage {
...
func (e *feImage) PointerEvents(events pointerevents.PointerEvents) *feImage {
...
func (e *feImage) VectorEffect(effect vectoreffect.VectorEffect) *feImage {
...
func (e *feImage) ShapeRendering(rendering shaperendering.ShapeRendering) *feImage {
...
func (e *feImage) FontFamily(family string) *feImage {
...
// is in user units.
func (e *feImage) FontSize(size string) *feImage {
...
// from 100 to 900.
func (e *feImage) FontWeight(weight string) *feImage {
...
func (e *feImage) FontStyle(style string) *feImage {
...
func (e *feImage) OnClick(handler string) *feImage {
...
func (e *feImage) OnChange(handler string) *feImage {
...
func (e *feImage) OnInput(handler string) *feImage {
...
func (e *feImage) OnFocus(handler string) *feImage {
...
func (e *feImage) OnBlur(handler string) *feImage {
...
func (e *feImage) OnSubmit(handler string) *feImage {
...
func (e *feImage) OnLoad(handler string) *feImage {
...
func (e *feImage) OnError(handler string) *feImage {
...
// developer-controlled key. Never build the key from user input - a key containing a space, quote,
// "=", "/" or ">" changes the markup structure. The value is escaped. The key is not escaped.
func (e *feImage) SetEvent(key string, value string) *feImage {
...
func (e *feImage) OnAbort(handler string) *feImage {
...
func (e *feImage) OnAutoComplete(handler string) *feImage {
...
//
// Deprecated: Removed from the WHATWG living standard. Was in an older HTML5 draft.
func (e *feImage) OnAutoCompleteError(handler string) *feImage {
...
func (e *feImage) OnCancel(handler string) *feImage {
...
func (e *feImage) OnCanPlay(handler string) *feImage {
...
func (e *feImage) OnCanPlayThrough(handler string) *feImage {
...
// results.
func (e *feImage) OnClose(handler string) *feImage {
...
func (e *feImage) OnContextMenu(handler string) *feImage {
...
// timestamps.
func (e *feImage) OnCueChange(handler string) *feImage {
...
func (e *feImage) OnDblClick(handler string) *feImage {
...
func (e *feImage) OnDrag(handler string) *feImage {
...
func (e *feImage) OnDragEnd(handler string) *feImage {
...
func (e *feImage) OnDragEnter(handler string) *feImage {
...
func (e *feImage) OnDragLeave(handler string) *feImage {
...
func (e *feImage) OnDragOver(handler string) *feImage {
...
func (e *feImage) OnDragStart(handler string) *feImage {
...
// enable dropping.
func (e *feImage) OnDrop(handler string) *feImage {
...
func (e *feImage) OnDurationChange(handler string) *feImage {
...
// media content.
func (e *feImage) OnEmptied(handler string) *feImage {
...
func (e *feImage) OnEnded(handler string) *feImage {
...
func (e *feImage) OnInvalid(handler string) *feImage {
...
func (e *feImage) OnKeyDown(handler string) *feImage {
...
func (e *feImage) OnKeyPress(handler string) *feImage {
...
func (e *feImage) OnKeyUp(handler string) *feImage {
...
func (e *feImage) OnLoadedData(handler string) *feImage {
...
func (e *feImage) OnLoadedMetadata(handler string) *feImage {
...
func (e *feImage) OnLoadStart(handler string) *feImage {
...
func (e *feImage) OnMouseDown(handler string) *feImage {
...
func (e *feImage) OnMouseEnter(handler string) *feImage {
...
func (e *feImage) OnMouseLeave(handler string) *feImage {
...
func (e *feImage) OnMouseMove(handler string) *feImage {
...
func (e *feImage) OnMouseOut(handler string) *feImage {
...
func (e *feImage) OnMouseOver(handler string) *feImage {
...
func (e *feImage) OnMouseUp(handler string) *feImage {
...
func (e *feImage) OnMouseWheel(handler string) *feImage {
...
func (e *feImage) OnPause(handler string) *feImage {
...
func (e *feImage) OnPlay(handler string) *feImage {
...
func (e *feImage) OnPlaying(handler string) *feImage {
...
func (e *feImage) OnProgress(handler string) *feImage {
...
func (e *feImage) OnRateChange(handler string) *feImage {
...
func (e *feImage) OnReset(handler string) *feImage {
...
// ResizeObserver.
func (e *feImage) OnResize(handler string) *feImage {
...
func (e *feImage) OnScroll(handler string) *feImage {
...
func (e *feImage) OnSeeked(handler string) *feImage {
...
func (e *feImage) OnSeeking(handler string) *feImage {
...
func (e *feImage) OnSelect(handler string) *feImage {
...
func (e *feImage) OnShow(handler string) *feImage {
...
func (e *feImage) OnSort(handler string) *feImage {
...
func (e *feImage) OnStalled(handler string) *feImage {
...
func (e *feImage) OnSuspend(handler string) *feImage {
...
func (e *feImage) OnTimeUpdate(handler string) *feImage {
...
func (e *feImage) OnToggle(handler string) *feImage {
...
func (e *feImage) OnVolumeChange(handler string) *feImage {
...
func (e *feImage) OnWaiting(handler string) *feImage {
...
func (e *feImage) OnAuxClick(handler string) *feImage {
...
func (e *feImage) OnWheel(handler string) *feImage {
...
func (e *feImage) OnCopy(handler string) *feImage {
...
// content itself.
func (e *feImage) OnCut(handler string) *feImage {
...
func (e *feImage) OnPaste(handler string) *feImage {
...
func (e *feImage) OnScrollEnd(handler string) *feImage {
...
func (e *feImage) OnFormData(handler string) *feImage {
...
func (e *feImage) OnAnimationCancel(handler string) *feImage {
...
func (e *feImage) OnAnimationEnd(handler string) *feImage {
...
func (e *feImage) OnAnimationIteration(handler string) *feImage {
...
func (e *feImage) OnAnimationStart(handler string) *feImage {
...
func (e *feImage) OnTransitionCancel(handler string) *feImage {
...
func (e *feImage) OnTransitionEnd(handler string) *feImage {
...
func (e *feImage) OnTransitionRun(handler string) *feImage {
...
func (e *feImage) OnTransitionStart(handler string) *feImage {
...
func (e *feImage) OnBeforeToggle(handler string) *feImage {
...
func (e *feImage) OnBeforeInput(handler string) *feImage {
...
func (e *feImage) OnBeforeMatch(handler string) *feImage {
...
func (e *feImage) OnCommand(handler string) *feImage {
...
func (e *feImage) OnContextLost(handler string) *feImage {
...
func (e *feImage) OnContextRestored(handler string) *feImage {
...
func (e *feImage) OnSecurityPolicyViolation(handler string) *feImage {
...
func (e *feImage) OnSlotChange(handler string) *feImage {
...
func (e *feImage) OnPointerDown(handler string) *feImage {
...
func (e *feImage) OnPointerUp(handler string) *feImage {
...
func (e *feImage) OnPointerMove(handler string) *feImage {
...
func (e *feImage) OnPointerEnter(handler string) *feImage {
...
func (e *feImage) OnPointerLeave(handler string) *feImage {
...
func (e *feImage) OnPointerOver(handler string) *feImage {
...
// element for any of its descendants.
func (e *feImage) OnPointerOut(handler string) *feImage {
...
func (e *feImage) OnPointerCancel(handler string) *feImage {
...
func (e *feImage) OnGotPointerCapture(handler string) *feImage {
...
func (e *feImage) OnLostPointerCapture(handler string) *feImage {
...
func (e *feImage) OnTouchStart(handler string) *feImage {
...
func (e *feImage) OnTouchEnd(handler string) *feImage {
...
func (e *feImage) OnTouchMove(handler string) *feImage {
...
func (e *feImage) OnTouchCancel(handler string) *feImage {
...
func (e *feImage) OnSelectStart(handler string) *feImage {
...
func (e *feImage) OnSelectionChange(handler string) *feImage {
...
func (e *feImage) SetAttribute(key string, value string) {
...
func (e *feImage) SetAttributeRaw(key string, value string) {
	if e.attr == nil {
		e.attr = &[]node.Attribute{}
	}
	for i, attr := range *e.attr {
...
func (e *feImage) Add(children ...PrimitiveContent) *feImage {
...
func (e *feImage) Replace(children ...PrimitiveContent) *feImage {
...
func (e *feImage) DynamicKey() string {
	return e.dynamic
}
...
func (e *feImage) Memoise(version any) *feImage {
	e.memoise = version
	return e
}
...
func (e *feImage) BufferHint(hint int) *feImage {
	if hint > 0 {
...
func (e *feImage) RenderedSize() int {
...
func (e *feImage) Render(w io.Writer) {
	_, _ = e.WriteTo(w)
}
...
func (e *feImage) WriteTo(w io.Writer) (int64, error) {
...
func (e *feImage) RenderBytes() []byte {
...
func (e *feImage) AttributeBuilder(buf *bytes.Buffer) {
	if e.href != "" {
		buf.Write(AttrHref)
...
func (e *feImage) RenderBuilder(buf *bytes.Buffer) {
	buf.Write(TagFeImage)
	...
	buf.Write(TagFeImageClose)
}

// RenderOpen writes the opening tag and attributes to the buffer.
func (e *feImage) RenderOpen(buf *bytes.Buffer) {
	buf.Write(TagFeImage)
	e.AttributeBuilder(buf)
	buf.Write(MarkupCloseTag)
}
...
// isSVGFilterPrimitive seals feImage as a FilterPrimitive.
func (*feImage) isSVGFilterPrimitive() {}
