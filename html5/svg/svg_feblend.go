...
// feBlend represents the <feBlend> SVG element.
type feBlend struct {
...
func (e *feBlend) event() *html5.EventAttributes {
	if e.ea == nil {
...
// FeBlend combines two inputs with a blend mode, the same set of modes CSS
// offers through mix-blend-mode.
func FeBlend(children ...PrimitiveContent) *feBlend {
...
//
// The top input of the blend.
func (e *feBlend) In(value string) *feBlend {
...
//
// The bottom input of the blend.
func (e *feBlend) In2(value string) *feBlend {
...
func (e *feBlend) Style(css string) *feBlend {
	e.svg().Style = node.EscapeAttribute(css)
	return e
}

// Transform sets the transform attribute.
func (e *feBlend) Transform(transform string) *feBlend {
...
func (e *feBlend) TransformOrigin(origin string) *feBlend {
	e.svg().TransformOrigin = node.EscapeAttribute(origin)
	return e
}

// TabIndex sets the tabindex attribute.
func (e *feBlend) TabIndex(index string) *feBlend {
	e.svg().TabIndex = node.EscapeAttribute(index)
	return e
}

// Role sets the role attribute.
func (e *feBlend) Role(role string) *feBlend {
...
func (e *feBlend) Lang(lang string) *feBlend {
...
func (e *feBlend) AutoFocus(conds ...bool) *feBlend {
	if len(conds) > 0 {
...
func (e *feBlend) SetAria(key string, value string) *feBlend {
...
func (e *feBlend) StrokeDashOffset(offset string) *feBlend {
...
func (e *feBlend) StrokeMiterLimit(limit string) *feBlend {
...
func (e *feBlend) FillRule(rule fillrule.FillRule) *feBlend {
	e.svg().FillRule = rule
	return e
}
...
// a clipPath.
func (e *feBlend) ClipRule(rule cliprule.ClipRule) *feBlend {
	e.svg().ClipRule = rule
	return e
}
...
func (e *feBlend) ClipPath(clip string) *feBlend {
...
// per pixel.
func (e *feBlend) Mask(mask string) *feBlend {
...
func (e *feBlend) Filter(filter string) *feBlend {
...
func (e *feBlend) Color(color string) *feBlend {
...
func (e *feBlend) Cursor(cursor string) *feBlend {
...
func (e *feBlend) Display(display string) *feBlend {
...
// drawn again.
func (e *feBlend) Visibility(value visibility.Visibility) *feBlend {
...
func (e *feBlend) PointerEvents(events pointerevents.PointerEvents) *feBlend {
...
func (e *feBlend) VectorEffect(effect vectoreffect.VectorEffect) *feBlend {
...
func (e *feBlend) ShapeRendering(rendering shaperendering.ShapeRendering) *feBlend {
...
func (e *feBlend) FontFamily(family string) *feBlend {
...
// is in user units.
func (e *feBlend) FontSize(size string) *feBlend {
...
// from 100 to 900.
func (e *feBlend) FontWeight(weight string) *feBlend {
...
func (e *feBlend) FontStyle(style string) *feBlend {
...
func (e *feBlend) OnClick(handler string) *feBlend {
...
func (e *feBlend) OnChange(handler string) *feBlend {
...
func (e *feBlend) OnInput(handler string) *feBlend {
...
func (e *feBlend) OnFocus(handler string) *feBlend {
...
func (e *feBlend) OnBlur(handler string) *feBlend {
...
func (e *feBlend) OnSubmit(handler string) *feBlend {
...
func (e *feBlend) OnLoad(handler string) *feBlend {
...
func (e *feBlend) OnError(handler string) *feBlend {
...
// developer-controlled key. Never build the key from user input - a key containing a space, quote,
// "=", "/" or ">" changes the markup structure. The value is escaped. The key is not escaped.
func (e *feBlend) SetEvent(key string, value string) *feBlend {
...
func (e *feBlend) OnAbort(handler string) *feBlend {
...
func (e *feBlend) OnAutoComplete(handler string) *feBlend {
...
//
// Deprecated: Removed from the WHATWG living standard. Was in an older HTML5 draft.
func (e *feBlend) OnAutoCompleteError(handler string) *feBlend {
...
func (e *feBlend) OnCancel(handler string) *feBlend {
...
func (e *feBlend) OnCanPlay(handler string) *feBlend {
...
func (e *feBlend) OnCanPlayThrough(handler string) *feBlend {
...
// results.
func (e *feBlend) OnClose(handler string) *feBlend {
...
func (e *feBlend) OnContextMenu(handler string) *feBlend {
...
// timestamps.
func (e *feBlend) OnCueChange(handler string) *feBlend {
...
func (e *feBlend) OnDblClick(handler string) *feBlend {
...
func (e *feBlend) OnDrag(handler string) *feBlend {
...
func (e *feBlend) OnDragEnd(handler string) *feBlend {
...
func (e *feBlend) OnDragEnter(handler string) *feBlend {
...
func (e *feBlend) OnDragLeave(handler string) *feBlend {
...
func (e *feBlend) OnDragOver(handler string) *feBlend {
...
func (e *feBlend) OnDragStart(handler string) *feBlend {
...
// enable dropping.
func (e *feBlend) OnDrop(handler string) *feBlend {
...
func (e *feBlend) OnDurationChange(handler string) *feBlend {
...
// media content.
func (e *feBlend) OnEmptied(handler string) *feBlend {
...
func (e *feBlend) OnEnded(handler string) *feBlend {
...
func (e *feBlend) OnInvalid(handler string) *feBlend {
...
func (e *feBlend) OnKeyDown(handler string) *feBlend {
...
func (e *feBlend) OnKeyPress(handler string) *feBlend {
...
func (e *feBlend) OnKeyUp(handler string) *feBlend {
...
func (e *feBlend) OnLoadedData(handler string) *feBlend {
...
func (e *feBlend) OnLoadedMetadata(handler string) *feBlend {
...
func (e *feBlend) OnLoadStart(handler string) *feBlend {
...
func (e *feBlend) OnMouseDown(handler string) *feBlend {
...
func (e *feBlend) OnMouseEnter(handler string) *feBlend {
...
func (e *feBlend) OnMouseLeave(handler string) *feBlend {
...
func (e *feBlend) OnMouseMove(handler string) *feBlend {
...
func (e *feBlend) OnMouseOut(handler string) *feBlend {
...
func (e *feBlend) OnMouseOver(handler string) *feBlend {
...
func (e *feBlend) OnMouseUp(handler string) *feBlend {
...
func (e *feBlend) OnMouseWheel(handler string) *feBlend {
...
func (e *feBlend) OnPause(handler string) *feBlend {
...
func (e *feBlend) OnPlay(handler string) *feBlend {
...
func (e *feBlend) OnPlaying(handler string) *feBlend {
...
func (e *feBlend) OnProgress(handler string) *feBlend {
...
func (e *feBlend) OnRateChange(handler string) *feBlend {
...
func (e *feBlend) OnReset(handler string) *feBlend {
...
// ResizeObserver.
func (e *feBlend) OnResize(handler string) *feBlend {
...
func (e *feBlend) OnScroll(handler string) *feBlend {
...
func (e *feBlend) OnSeeked(handler string) *feBlend {
...
func (e *feBlend) OnSeeking(handler string) *feBlend {
...
func (e *feBlend) OnSelect(handler string) *feBlend {
...
func (e *feBlend) OnShow(handler string) *feBlend {
...
func (e *feBlend) OnSort(handler string) *feBlend {
...
func (e *feBlend) OnStalled(handler string) *feBlend {
...
func (e *feBlend) OnSuspend(handler string) *feBlend {
...
func (e *feBlend) OnTimeUpdate(handler string) *feBlend {
...
func (e *feBlend) OnToggle(handler string) *feBlend {
...
func (e *feBlend) OnVolumeChange(handler string) *feBlend {
...
func (e *feBlend) OnWaiting(handler string) *feBlend {
...
func (e *feBlend) OnAuxClick(handler string) *feBlend {
...
func (e *feBlend) OnWheel(handler string) *feBlend {
...
func (e *feBlend) OnCopy(handler string) *feBlend {
...
// content itself.
func (e *feBlend) OnCut(handler string) *feBlend {
...
func (e *feBlend) OnPaste(handler string) *feBlend {
...
func (e *feBlend) OnScrollEnd(handler string) *feBlend {
...
func (e *feBlend) OnFormData(handler string) *feBlend {
...
func (e *feBlend) OnAnimationCancel(handler string) *feBlend {
...
func (e *feBlend) OnAnimationEnd(handler string) *feBlend {
...
func (e *feBlend) OnAnimationIteration(handler string) *feBlend {
...
func (e *feBlend) OnAnimationStart(handler string) *feBlend {
...
func (e *feBlend) OnTransitionCancel(handler string) *feBlend {
...
func (e *feBlend) OnTransitionEnd(handler string) *feBlend {
...
func (e *feBlend) OnTransitionRun(handler string) *feBlend {
...
func (e *feBlend) OnTransitionStart(handler string) *feBlend {
...
func (e *feBlend) OnBeforeToggle(handler string) *feBlend {
...
func (e *feBlend) OnBeforeInput(handler string) *feBlend {
...
func (e *feBlend) OnBeforeMatch(handler string) *feBlend {
...
func (e *feBlend) OnCommand(handler string) *feBlend {
...
func (e *feBlend) OnContextLost(handler string) *feBlend {
...
func (e *feBlend) OnContextRestored(handler string) *feBlend {
...
func (e *feBlend) OnSecurityPolicyViolation(handler string) *feBlend {
...
func (e *feBlend) OnSlotChange(handler string) *feBlend {
...
func (e *feBlend) OnPointerDown(handler string) *feBlend {
...
func (e *feBlend) OnPointerUp(handler string) *feBlend {
...
func (e *feBlend) OnPointerMove(handler string) *feBlend {
...
func (e *feBlend) OnPointerEnter(handler string) *feBlend {
...
func (e *feBlend) OnPointerLeave(handler string) *feBlend {
...
func (e *feBlend) OnPointerOver(handler string) *feBlend {
...
// element for any of its descendants.
func (e *feBlend) OnPointerOut(handler string) *feBlend {
...
func (e *feBlend) OnPointerCancel(handler string) *feBlend {
...
func (e *feBlend) OnGotPointerCapture(handler string) *feBlend {
...
func (e *feBlend) OnLostPointerCapture(handler string) *feBlend {
...
func (e *feBlend) OnTouchStart(handler string) *feBlend {
...
func (e *feBlend) OnTouchEnd(handler string) *feBlend {
...
func (e *feBlend) OnTouchMove(handler string) *feBlend {
...
func (e *feBlend) OnTouchCancel(handler string) *feBlend {
...
func (e *feBlend) OnSelectStart(handler string) *feBlend {
...
func (e *feBlend) OnSelectionChange(handler string) *feBlend {
...
func (e *feBlend) SetAttribute(key string, value string) {
...
func (e *feBlend) SetAttributeRaw(key string, value string) {
	if e.attr == nil {
		e.attr = &[]node.Attribute{}
	}
	for i, attr := range *e.attr {
...
func (e *feBlend) Add(children ...PrimitiveContent) *feBlend {
...
func (e *feBlend) Replace(children ...PrimitiveContent) *feBlend {
...
func (e *feBlend) DynamicKey() string {
	return e.dynamic
}
...
func (e *feBlend) Memoise(version any) *feBlend {
	e.memoise = version
	return e
}
...
func (e *feBlend) BufferHint(hint int) *feBlend {
	if hint > 0 {
...
func (e *feBlend) RenderedSize() int {
...
func (e *feBlend) Render(w io.Writer) {
	_, _ = e.WriteTo(w)
}
...
func (e *feBlend) WriteTo(w io.Writer) (int64, error) {
...
func (e *feBlend) RenderBytes() []byte {
...
func (e *feBlend) AttributeBuilder(buf *bytes.Buffer) {
	if e.in != "" {
		buf.Write(AttrIn)
...
func (e *feBlend) RenderBuilder(buf *bytes.Buffer) {
	buf.Write(TagFeBlend)
	...
	buf.Write(TagFeBlendClose)
}

// RenderOpen writes the opening tag and attributes to the buffer.
func (e *feBlend) RenderOpen(buf *bytes.Buffer) {
	buf.Write(TagFeBlend)
	e.AttributeBuilder(buf)
	buf.Write(MarkupCloseTag)
}
...
// isSVGFilterPrimitive seals feBlend as a FilterPrimitive.
func (*feBlend) isSVGFilterPrimitive() {}
