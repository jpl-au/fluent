...
// Text Creates a new var element with text content.
...
// Static Creates a new var element with static text content.
// Example: variable.Static("Hello World")
// Renders: <var>Hello World</var>
...
// RawText Creates a new var element with raw text content as unescaped HTML.
// Example: variable.RawText("<em>x</em>")
// Renders: <var><em>x</em></var>
...
// Textf Creates a new var element with formatted text content using text.Textf.
// Example: variable.Textf("%s", "x")
// Renders: <var>x</var>
...
// RawTextf Creates a new var element with formatted raw text content as unescaped HTML using text.RawTextf.
// Example: variable.RawTextf("<em>%s</em>", "x")
// Renders: <var><em>x</em></var>
