...
// Method The HTTP method to use when submitting the form data.
...
// AutoCapitalize Controls whether and how the text input is automatically capitalized as it is entered/edited by the user.
...
// EncType If the method attribute is "post", this attribute specifies the MIME type of the form submission.
func (e *element) EncType(value enctype.EncType) *element {
	e.enctype = value
	return e
}

// Name A name for the form. This name must be unique among forms in the same document.
func (e *element) Name(value string) *element {
	e.name = value
	return e
}

// NoValidate A boolean attribute that, if present, indicates that the form should not be validated when submitted.
//
...
// Rel Specifies the relationship of the linked resource to the current document.
