...
//
// The <form> HTML element represents a document section containing interactive controls for submitting user
// data to a server. Defines how and where form data should be sent, including HTTP method, action URL,
// encoding type, and validation behaviour. Central to user input collection, authentication, search, data
// entry, and any interaction requiring server communication.
package form
...
//
// The HTTP method to use when submitting the form data.
...
//
// Controls whether and how the text input is automatically capitalized as it is entered/edited by the user.
...
//
// If the method attribute is "post", this attribute specifies the MIME type of the form submission.
...
//
// A boolean attribute that, if present, indicates that the form should not be validated when submitted.
//
