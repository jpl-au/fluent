...
//
// The MIME type to use to select the plug-in to instantiate. This helps the browser determine how to handle the embedded content.
func (e *Element) Type(mime string) *Element {
	e.embedType = node.EscapeAttribute(mime)
	return e
}
