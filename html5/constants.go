...
// Package html5 contains the type-safe HTML5 building blocks for Fluent.
//
// Element constructors and methods live in the html5/<element> subpackages,
// one per HTML element (e.g. div, input, span). This package itself defines
// the shared GlobalAttributes and EventAttributes types embedded by every
// element, along with the []byte constants for the markup, tags, and
