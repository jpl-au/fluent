...
var (
	...
	AttrDisablePictureInPicture = []byte(` disablepictureinpicture="disablepictureinpicture"`)
	AttrPlaysInline             = []byte(` playsinline="playsinline"`)
)
