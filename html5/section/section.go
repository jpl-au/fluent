...
// Text Creates a new section element with text content
// Example: section.Text("Section content")
// Renders: <section>Section content</section>
...
// Static Creates a new section element with static text content
// Example: section.Static("Content")
...
// RawText Creates a new section element with raw text content as unescaped HTML
// Example: section.RawText("<h2>Title</h2>")
...
// Textf Creates a new section element with formatted text content using text.Textf
...
// RawTextf Creates a new section element with formatted raw text content as unescaped HTML using text.RawTextf
// Example: section.RawTextf("<h2>%s</h2>", "Title")
// Renders: <section><h2>Title</h2></section>
