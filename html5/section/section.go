...
// specific semantic element to represent it. Give the section a heading that identifies its topic.
package section
...
// Element represents the <section> HTML element.
type Element struct {
...
func (e *Element) RenderBuilder(buf *bytes.Buffer) {
	...
	buf.Write(html5.TagSectionClose)
}
