...
//
// The <blockquote> HTML element indicates that the enclosed text is an extended quotation. Usually, this is
// rendered visually by indentation. A URL for the source of the quotation may be given using the cite
...
//
// A URL that designates the source document or resource for the quoted information. This attribute provides
// programmatic access to the citation source, which can be used by search engines, accessibility tools, and
// citation management systems. The URL should point to the original work being quoted. While the cite
// attribute provides the URL, you may also want to include a visible citation using the <cite> element
// within the blockquote content for user-visible attribution.
...
func (e *Element) RenderBuilder(buf *bytes.Buffer) {
	...
	buf.Write(html5.TagBlockquoteClose)
}
