...
// Text Creates a new blockquote element with text content (HTML-encoded).
// Example: blockquote.Text("<p>Quoted text.</p>")
...
// Textf Creates a new blockquote element with formatted text content using text.Textf.
// Example: blockquote.Textf("Hello %s", "World")
// Renders: <blockquote>Hello World</blockquote>
...
// Static Creates a new blockquote element with static text content.
...
// RawText Creates a new blockquote element with raw text content as unescaped HTML.
...
// RawTextf Creates a new blockquote element with formatted raw text content as unescaped HTML using text.RawTextf.
// Example: blockquote.RawTextf("Hello <em>%s</em>", "World")
// Renders: <blockquote>Hello <em>World</em></blockquote>
