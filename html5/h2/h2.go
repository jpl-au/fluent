...
//
// The <h2> HTML element represents the second highest level of section heading. It is typically used for
// subheadings within a main section.
package h2
...
// Element represents the <h2> HTML element.
type Element struct {
