...
// Text Creates a new h2 element with text content (HTML-encoded).
// Example: h2.Text("<i>Sub</i> Heading")
...
// Static Creates a new h2 element with static text content.
// Example: h2.Static("Hello World")
...
// RawText Creates a new h2 element with raw text content as unescaped HTML.
...
// Textf Creates a new h2 element with formatted text content using text.Textf.
// Example: h2.Textf("Hello %s", "World")
// Renders: <h2>Hello World</h2>
...
// RawTextf Creates a new h2 element with formatted raw text content as unescaped HTML using text.RawTextf.
// Example: h2.RawTextf("Hello <em>%s</em>", "World")
// Renders: <h2>Hello <em>World</em></h2>
