...
//
// Controls Cross-Origin Resource Sharing (CORS) behavior when fetching the script from a different origin
...
//
// Indicates that certain operations should be blocked until the script is fetched and executed.
