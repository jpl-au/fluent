...
// Async Downloads the script in parallel to parsing and executes as soon as it is available.
//
...
// Defer Defers script execution until after the HTML document has been completely parsed.
//
// Calling without an argument sets the attribute. Pass a bool to control presence conditionally.
...
// NoModule Prevents the script from executing in browsers that support ES6 modules. Use as a fallback
