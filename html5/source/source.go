...
// Type Specifies the MIME media type of the resource, helping browsers determine if they can play or display the
...
// Srcset Defines multiple image sources with different resolutions or formats that the browser can choose from,
...
// Sizes Specifies the intended display sizes of the image at different viewport widths, using CSS media queries.
...
// Media Defines the media query conditions under which this source should be selected, using CSS media query syntax.
...
// Width Specifies the intrinsic width of the image resource in pixels as an integer without units. This helps
...
// Height Specifies the intrinsic height of the image resource in pixels as an integer without units. Combined with
