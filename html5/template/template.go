...
//
// The <template> HTML element is a mechanism for holding HTML that is not to be rendered immediately when a
...
// element represents the <template> HTML element
type element struct {
...
//
// When set on a declarative shadow root template, the created shadow root is clonable. Cloning
// the host element will include a copy of the shadow root.
//
// Calling without an argument sets the attribute. Pass a bool to control presence conditionally.
func (e *element) ShadowRootClonable(conds ...bool) *element {
	if len(conds) > 0 {
		e.shadowrootclonable = conds[0]
	} else {
		e.shadowrootclonable = true
	}
	return e
}
...
//
// When set on a declarative shadow root template, the created shadow root delegates focus.
// When a non-focusable part of the shadow tree is clicked, the first focusable part is given focus.
//
// Calling without an argument sets the attribute. Pass a bool to control presence conditionally.
func (e *element) ShadowRootDelegatesFocus(conds ...bool) *element {
	if len(conds) > 0 {
		e.shadowrootdelegatesfocus = conds[0]
	} else {
		e.shadowrootdelegatesfocus = true
	}
	return e
}
...
//
// When set on a declarative shadow root template, the created shadow root is serializable.
// Allows the shadow root to be serialised using Element.getHTML() or ShadowRoot.getHTML().
//
// Calling without an argument sets the attribute. Pass a bool to control presence conditionally.
func (e *element) ShadowRootSerializable(conds ...bool) *element {
	if len(conds) > 0 {
		e.shadowrootserializable = conds[0]
	} else {
...
func (e *element) AttributeBuilder(buf *bytes.Buffer) {
	...
	if e.shadowrootdelegatesfocus {
		buf.Write(html5.AttrShadowRootDelegatesFocus)
	}
	if e.shadowrootserializable {
		buf.Write(html5.AttrShadowRootSerializable)
	}
	if e.class != "" {
...
func (e *element) RenderBuilder(buf *bytes.Buffer) {
	...
	buf.Write(html5.TagTemplateClose)
}
