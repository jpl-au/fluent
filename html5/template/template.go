...
// New Creates a new template element with optional child nodes.
...
// Text Creates a new template element with text content.
// Example: template.Text("Template content")
// Renders: <template>Template content</template>
...
// Static Creates a new template element with static text content.
// Example: template.Static("Hello World")
// Renders: <template>Hello World</template>
...
// RawText Creates a new template element with raw text content as unescaped HTML.
// Example: template.RawText("<div>Template</div> content")
// Renders: <template><div>Template</div> content</template>
...
// Textf Creates a new template element with formatted text content using text.Textf.
// Example: template.Textf("%s content", "Template")
// Renders: <template>Template content</template>
...
// RawTextf Creates a new template element with formatted raw text content as unescaped HTML using text.RawTextf.
// Example: template.RawTextf("<div>%s</div> content", "Template")
// Renders: <template><div>Template</div> content</template>
