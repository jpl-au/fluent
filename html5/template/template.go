...
// ShadowRootMode Creates a declarative shadow root on the parent element. The value specifies the encapsulation
...
// ShadowRootClonable When set on a declarative shadow root template, the created shadow root is clonable. Cloning
...
// ShadowRootDelegatesFocus When set on a declarative shadow root template, the created shadow root delegates focus.
...
// ShadowRootSerializable When set on a declarative shadow root template, the created shadow root is serializable.
