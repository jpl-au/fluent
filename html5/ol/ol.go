...
// Reversed Numbers the list items in reverse order (counting down instead of up).
//
...
// Start Specifies the starting number for the first list item
func (e *element) Start(number int) *element {
	e.start = number
	return e
}

// Type Defines the numbering style used for list item markers
