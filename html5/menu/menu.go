...
// New Creates a new menu element with optional child nodes.
// Example: menu.New()
// Renders: <menu></menu>
...
// Text Creates a new menu element with text content.
// Example: menu.Text("Menu items")
// Renders: <menu>Menu items</menu>
...
// Static Creates a new menu element with static text content.
// Example: menu.Static("Hello World")
// Renders: <menu>Hello World</menu>
...
// RawText Creates a new menu element with raw text content.
// Example: menu.RawText("Menu items")
// Renders: <menu>Menu items</menu>
...
// Textf Creates a new menu element with formatted text content (HTML-encoded).
// Example: menu.Textf("Menu %d", 1)
// Renders: <menu>Menu 1</menu>
...
// RawTextf Creates a new menu element with formatted raw text content as unescaped HTML.
// Example: menu.RawTextf("Menu <em>%d</em>", 1)
// Renders: <menu>Menu <em>1</em></menu>
