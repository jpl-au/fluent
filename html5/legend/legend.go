...
//
// The <legend> element captions a fieldset. Place it before the fieldset's other content.
// It names the group of controls rather than replacing each control's own label.
package legend
...
// Element represents the <legend> HTML element.
type Element struct {
...
func (e *Element) RenderBuilder(buf *bytes.Buffer) {
	...
	buf.Write(html5.TagLegendClose)
}
