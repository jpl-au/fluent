...
// Text Creates a new small element with text content (HTML-encoded).
// Example: small.Text("© 2024 <em>Company</em>")
// Renders: <small>© 2024 &lt;em&gt;Company&lt;/em&gt;</small>
...
// Static Creates a new small element with static text content.
// Example: small.Static("Hello World")
// Renders: <small>Hello World</small>
...
// RawText Creates a new small element with raw text content as unescaped HTML.
// Example: small.RawText("© 2024 <em>Company</em>")
// Renders: <small>© 2024 <em>Company</em></small>
...
// Textf Creates a new small element with formatted text content using text.Textf.
// Example: small.Textf("© %d %s", 2024, "Company")
// Renders: <small>© 2024 Company</small>
...
// RawTextf Creates a new small element with formatted raw text content as unescaped HTML using text.RawTextf.
// Example: small.RawTextf("© %d <em>%s</em>", 2024, "Company")
// Renders: <small>© 2024 <em>Company</em></small>
