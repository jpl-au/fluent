...
//
// Specifies the URL of the track file, typically a WebVTT (.vtt) file containing time-synchronised text data.
...
//
// Specifies the text track's purpose and how the media player presents it
// to users. This affects both the user interface (what controls are shown) and the default behaviour
...
//
// Names the text track in the browser's track-selection interface. Distinguish
// tracks with useful labels such as 'English subtitles' and 'English captions'.
// Use srclang separately to identify the track's language.
...
//
// Selects this track by default when the user's preferences do not identify
// another track. Within one media element, choose at most one default across
// subtitles and captions. Descriptions and chapters may each have a separate
// default. Metadata tracks have no such limit.
//
