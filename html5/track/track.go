...
// Kind Specifies how the text track should be used by the media player, determining its purpose and how it's
...
// Label Provides a human-readable title for the text track that appears in the browser's track selection menu. This
...
// Srclang Specifies the language of the track text data using a valid BCP 47 language tag (e.g., 'en', 'en-US',
...
// Default A boolean attribute that indicates this track should be enabled by default when the media loads, unless user
// preferences or browser settings suggest a more appropriate track. Only one track of each kind should have this
// attribute. This provides a fallback selection when multiple tracks are available, ensuring users see content
// even if they don't manually select a track.
