...
//
// The <data> HTML element links a given piece of content with a machine-readable translation. If the content is
...
// Element represents the <data> HTML element.
type Element struct {
