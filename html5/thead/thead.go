...
// New Creates a new thead element with optional child nodes.
// Example: thead.New()
// Renders: <thead></thead>
...
// Text Creates a new thead element with text content.
// Example: thead.Text("Table header")
// Renders: <thead>Table header</thead>
...
// Static Creates a new thead element with static text content.
// Example: thead.Static("Hello World")
// Renders: <thead>Hello World</thead>
...
// RawText Creates a new thead element with raw text content.
// Example: thead.RawText("Table header")
// Renders: <thead>Table header</thead>
...
// Textf Creates a new thead element with formatted text content (HTML-encoded).
// Example: thead.Textf("Header %s", "Text")
// Renders: <thead>Header Text</thead>
...
// RawTextf Creates a new thead element with formatted raw text content as unescaped HTML.
// Example: thead.RawTextf("Header <em>%s</em>", "Text")
// Renders: <thead>Header <em>Text</em></thead>
