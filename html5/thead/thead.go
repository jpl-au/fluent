...
// Element represents the <thead> HTML element.
type Element struct {
...
// RowsOf creates a new <thead> element from a slice of data and a mapper that returns one tr element per item, enforcing correct nesting at compile time.
...
// Example: thead.RowsOf([]int{1, 2}, func(int) *tr.Element { return tr.New() })
// Renders: <thead><tr></tr><tr></tr></thead>
...
// RowsFunc creates a new <thead> element from a function that returns tr elements, enforcing correct nesting at compile time.
...
// Example: thead.RowsFunc(func() []*tr.Element { return []*tr.Element{tr.New(), tr.New()} })
// Renders: <thead><tr></tr><tr></tr></thead>
