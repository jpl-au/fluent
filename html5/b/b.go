...
// Text Creates a new b element with text content (HTML-encoded).
// Example: b.Text("<em>This text</em> is important.")
...
// Static Creates a new b element with static text content.
// Example: b.Static("Hello World")
...
// RawText Creates a new b element with raw text content as unescaped HTML.
...
// Textf Creates a new b element with formatted text content using text.Textf.
...
// RawTextf Creates a new b element with formatted raw text content as unescaped HTML using text.RawTextf.
