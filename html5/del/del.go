...
//
// The <del> HTML element represents a range of text that has been deleted from a document. This can be used
// when rendering "track changes" or source code diff information, for example. The <ins> element can be used
// for the opposite purpose: to indicate text that has been added to the document.
package del
...
//
// A URI for a resource that explains or documents the reason for the deletion. This could link to meeting
// minutes, change logs, bug reports, or any documentation that provides context for why the content was
// removed. Useful for maintaining an audit trail of content changes and providing transparency in
// collaborative editing scenarios.
func (e *Element) Cite(url string) *Element {
	e.SetAttribute("cite", url)
	return e
}

// DateTime sets the datetime attribute.
//
// This attribute indicates the time and date when the deletion occurred. The value must be a valid date
