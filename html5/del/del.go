...
// Text Creates a new del element with text content.
...
// Static Creates a new del element with static text content.
// Example: del.Static("Hello World")
// Renders: <del>Hello World</del>
...
// RawText Creates a new del element with raw text content.
// Example: del.RawText("This text was deleted")
// Renders: <del>This text was deleted</del>
...
// Textf Creates a new del element with formatted text content using text.Textf.
// Example: del.Textf("Hello %s", "World")
// Renders: <del>Hello World</del>
...
// RawTextf Creates a new del element with formatted raw text content as unescaped HTML using text.RawTextf.
// Example: del.RawTextf("Hello <em>%s</em>", "World")
// Renders: <del>Hello <em>World</em></del>
...
// Cite A URI for a resource that explains or documents the reason for the deletion. This could link to meeting
...
// DateTime This attribute indicates the time and date when the deletion occurred. The value must be a valid date
