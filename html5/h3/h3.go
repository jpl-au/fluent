...
// Text Creates a new h3 element with text content (HTML-encoded).
// Example: h3.Text("<u>Minor</u> Heading")
...
// Static Creates a new h3 element with static text content.
// Example: h3.Static("Hello World")
...
// RawText Creates a new h3 element with raw text content as unescaped HTML.
...
// Textf Creates a new h3 element with formatted text content using text.Textf.
// Example: h3.Textf("Hello %s", "World")
// Renders: <h3>Hello World</h3>
...
// RawTextf Creates a new h3 element with formatted raw text content as unescaped HTML using text.RawTextf.
// Example: h3.RawTextf("Hello <em>%s</em>", "World")
// Renders: <h3>Hello <em>World</em></h3>
