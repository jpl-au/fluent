...
// Text Creates a new main element with text content
...
// Static Creates a new main element with static text content.
// Example: primary.Static("Hello World")
...
// RawText Creates a new main element with raw text content
...
// Textf Creates a new main element with formatted text content using text.Textf.
// Example: primary.Textf("Hello %s", "World")
// Renders: <main>Hello World</main>
...
// RawTextf Creates a new main element with formatted raw text content as unescaped HTML using text.RawTextf.
// Example: primary.RawTextf("Hello <em>%s</em>", "World")
// Renders: <main>Hello <em>World</em></main>
