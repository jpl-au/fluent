...
//
// The <main> HTML element represents the dominant content of the <body> of a document. The main content area
...
// Element represents the <main> HTML element.
type Element struct {
