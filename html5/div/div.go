...
// Text Creates a new div element with text content (HTML-encoded).
// Example: div.Text("<b>This is a div</b> with text content.")
// Renders: <div>&lt;b&gt;This is a div&lt;/b&gt; with text content.</div>
...
// Static Creates a new div element with static text content.
// Example: div.Static("Hello World")
...
// RawText Creates a new div element with raw text content as unescaped HTML.
// Example: div.RawText("<b>This is a div</b> with raw text content.")
// Renders: <div><b>This is a div</b> with raw text content.</div>
...
// Textf Creates a new div element with formatted text content using text.Textf.
// Example: div.Textf("Hello %s", "World")
// Renders: <div>Hello World</div>
...
// RawTextf Creates a new div element with formatted raw text content as unescaped HTML using text.RawTextf.
// Example: div.RawTextf("Hello <em>%s</em>", "World")
// Renders: <div>Hello <em>World</em></div>
