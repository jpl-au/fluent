...
//
// The <div> element groups flow content without adding a specific semantic
// meaning. It can carry shared attributes and act as a CSS layout container.
// Use a more specific element when the group is an article, navigation section
// or another recognised part of the document.
package div
