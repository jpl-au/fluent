...
// element represents the <map> HTML element
type element struct {
...
//
// The name attribute gives the map a name so that it can be referenced. The attribute must be present and
// must have a non-empty value with no space characters. The value of the name attribute must not be equal
// to the value of the name attribute of another <map> element in the same document.
