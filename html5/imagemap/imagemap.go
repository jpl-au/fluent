...
// New Creates a new map element with optional child nodes.
// Example: map.New()
// Renders: <map></map>
...
// Text Creates a new map element with text content.
// Example: map.Text("Navigation map")
// Renders: <map>Navigation map</map>
...
// Static Creates a new map element with static text content.
// Example: map.Static("Hello World")
// Renders: <map>Hello World</map>
...
// RawText Creates a new map element with raw text content.
// Example: map.RawText("Navigation map")
// Renders: <map>Navigation map</map>
...
// Textf Creates a new map element with formatted text content using text.Textf.
// Example: map.Textf("Hello %s", "World")
// Renders: <map>Hello World</map>
...
// RawTextf Creates a new map element with formatted raw text content as unescaped HTML using text.RawTextf.
// Example: map.RawTextf("Hello <em>%s</em>", "World")
// Renders: <map>Hello <em>World</em></map>
...
// Name The name attribute gives the map a name so that it can be referenced. The attribute must be present and
