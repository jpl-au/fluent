...
// Text Creates a new progress element with text content (HTML-encoded) for fallback.
...
// Static Creates a new progress element with static text content for fallback.
...
// RawText Creates a new progress element with raw text content as unescaped HTML for fallback.
...
// Textf Creates a new progress element with formatted text content (HTML-encoded) for fallback.
// Example: progress.Textf("%d%% complete", 50)
// Renders: <progress>50% complete</progress>
...
// RawTextf Creates a new progress element with formatted raw text content as unescaped HTML for fallback.
// Example: progress.RawTextf("<strong>%d%%</strong>", 50)
// Renders: <progress><strong>50%</strong></progress>
...
// Value Specifies the current completion amount of the task. Must be a valid floating-point number between 0 and
...
// Max Defines the maximum value that represents the complete state of the task. Must be a positive floating-point
