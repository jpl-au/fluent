...
// Option Creates a new option element with a value attribute and HTML-encoded text content
...
// Text Creates a new option element with text content
...
// Static Creates a new option element with static text content
...
// Textf Creates a new option element with formatted text content (HTML-encoded)
...
// Value Specifies the value that will be submitted to the server when this option is selected
func (e *element) Value(value string) *element {
	e.value = value
	return e
}

// Disabled A boolean attribute that indicates the option is not available for selection
func (e *element) Disabled() *element {
	e.disabled = true
	return e
}

// Label Provides alternative text for the option that can be displayed instead of the option's text content
func (e *element) Label(label string) *element {
	e.label = label
	return e
}

// Selected A boolean attribute that indicates this option should be pre-selected when the page loads
