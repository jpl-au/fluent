...
// Text Creates a new h4 element with text content (HTML-encoded).
// Example: h4.Text("<small>Detail</small> Heading")
...
// Static Creates a new h4 element with static text content.
// Example: h4.Static("Hello World")
// Renders: <h4>Hello World</h4>
...
// RawText Creates a new h4 element with raw text content as unescaped HTML.
...
// Textf Creates a new h4 element with formatted text content using text.Textf.
// Example: h4.Textf("Hello %s", "World")
// Renders: <h4>Hello World</h4>
...
// RawTextf Creates a new h4 element with formatted raw text content as unescaped HTML using text.RawTextf.
// Example: h4.RawTextf("Hello <em>%s</em>", "World")
// Renders: <h4>Hello <em>World</em></h4>
