...
// Text Creates a new sup element with text content (HTML-encoded).
// Example: sup.Text("<em>2</em>")
// Renders: <sup>&lt;em&gt;2&lt;/em&gt;</sup>
...
// Static Creates a new sup element with static text content.
// Example: sup.Static("Hello World")
// Renders: <sup>Hello World</sup>
...
// RawText Creates a new sup element with raw text content as unescaped HTML.
// Example: sup.RawText("<em>2</em>")
// Renders: <sup><em>2</em></sup>
...
// Textf Creates a new sup element with formatted text content using text.Textf.
// Example: sup.Textf("%d", 2)
// Renders: <sup>2</sup>
...
// RawTextf Creates a new sup element with formatted raw text content as unescaped HTML using text.RawTextf.
// Example: sup.RawTextf("<em>%d</em>", 2)
// Renders: <sup><em>2</em></sup>
