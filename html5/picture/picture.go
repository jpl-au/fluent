...
//
// The <picture> HTML element provides a container for multiple image sources, enabling art direction and
// responsive images. Contains zero or more <source> elements followed by one <img> element. Allows serving
// different images based on viewport size, resolution, or format support. Essential for responsive design,
// serving modern image formats with fallbacks, and optimising bandwidth across devices.
package picture
...
// Element represents the <picture> HTML element.
type Element struct {
...
func (e *Element) RenderBuilder(buf *bytes.Buffer) {
	...
	buf.Write(html5.TagPictureClose)
}
