...
// New Creates a new picture element with child nodes (typically <source> and <img> elements).
...
// Text Creates a new picture element with text content (HTML-encoded).
// Example: picture.Text("Fallback text")
// Renders: <picture>Fallback text</picture>
...
// Static Creates a new picture element with static text content.
// Example: picture.Static("Image not available")
// Renders: <picture>Image not available</picture>
...
// RawText Creates a new picture element with raw text content as unescaped HTML.
// Example: picture.RawText("<img src='fallback.jpg'>")
// Renders: <picture><img src='fallback.jpg'></picture>
...
// Textf Creates a new picture element with formatted text content (HTML-encoded).
// Example: picture.Textf("Image %d", 1)
// Renders: <picture>Image 1</picture>
...
// RawTextf Creates a new picture element with formatted raw text content as unescaped HTML.
// Example: picture.RawTextf("<span>%s</span>", "Content")
// Renders: <picture><span>Content</span></picture>
