...
//
// The <picture> element offers alternative images through source children,
// followed by an img fallback. Media can select different compositions, and
// type can select supported image formats. The img supplies alt text and the
// selected image's rendered element.
package picture
