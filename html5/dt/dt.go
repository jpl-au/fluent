...
// <dl> element. It is usually followed by a <dd> element; however, multiple <dt> elements in a row indicate
...
// Text creates a new dt element with text content. Uses text.Text which HTML-escapes the output.
