...
// Text Creates a new dt element with text content (HTML-encoded).
// Example: dt.Text("<b>Term</b>")
...
// Static Creates a new dt element with static text content.
// Example: dt.Static("Hello World")
// Renders: <dt>Hello World</dt>
...
// RawText Creates a new dt element with raw text content as unescaped HTML.
...
// Textf Creates a new dt element with formatted text content using text.Textf.
// Example: dt.Textf("Hello %s", "World")
// Renders: <dt>Hello World</dt>
...
// RawTextf Creates a new dt element with formatted raw text content as unescaped HTML using text.RawTextf.
// Example: dt.RawTextf("Hello <em>%s</em>", "World")
// Renders: <dt>Hello <em>World</em></dt>
