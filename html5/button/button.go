...
// Text Creates a new button element with text content (HTML-encoded).
// Example: button.Text("<b>Submit</b>")
...
// Static Creates a new button element with static text content.
// Example: button.Static("<b>Submit</b>")
// Renders: <button><b>Submit</b></button>
...
// RawText Creates a new button element with raw text content as unescaped HTML.
...
// Textf Creates a new button element with formatted text content using text.Textf.
// Example: button.Textf("Hello %s", "World")
// Renders: <button>Hello World</button>
...
// RawTextf Creates a new button element with formatted raw text content as unescaped HTML using text.RawTextf.
// Example: button.RawTextf("Hello <em>%s</em>", "World")
// Renders: <button>Hello <em>World</em></button>
...
// Command Specifies the action to be performed on an element being controlled by a control <button>, specified via
...
// Commandfor Turns a <button> element into a command button, controlling the given interactive element; takes the ID
...
// Form The <form> element to associate the button with (its form owner). The value of this attribute must be
...
// Formaction The URL that processes the information submitted by the button. Overrides the action attribute of the
...
// Formenctype If the button is a submit button, specifies how to encode the form data that is submitted.
...
// Formmethod If the button is a submit button, this attribute specifies the HTTP method used to submit the form.
...
// Formnovalidate If the button is a submit button, this Boolean attribute specifies that the form is not to be validated
...
// PopOverTarget Turns a <button> element into a popover control button; takes the ID of the popover element to control
// as its value.
...
// Popovertargetaction Specifies the action to be performed on a popover element being controlled by a control <button>.
...
// Value Defines the value associated with the button's name when it's submitted with the form data.
