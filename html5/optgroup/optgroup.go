...
// New Creates a new optgroup element with optional child nodes
...
// Text Creates a new optgroup element with text content
...
// Static Creates a new optgroup element with static text content
...
// RawText Creates a new optgroup element with raw text content
...
// Textf Creates a new optgroup element with formatted text content (HTML-encoded)
...
// RawTextf Creates a new optgroup element with formatted raw text content as unescaped HTML
...
// Label Specifies the name or title of the option group that browsers display as a heading above the grouped options
func (e *element) Label(text string) *element {
	e.label = text
	return e
}

// Disabled A boolean attribute that disables the entire option group, making all options within it unselectable
