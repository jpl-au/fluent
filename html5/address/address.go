...
//
// The <address>: The Contact Address element indicates that the enclosed HTML provides contact information
// for a person or people, or for an organization. The contact information can take whatever form is
// appropriate for the context, and may include any type of contact information that is needed, such as a
// physical address, URL, email address, phone number, social media handle, geographic coordinates, and so forth.
package address
...
// Text creates a new address element with text content. Uses text.Text which HTML-escapes the output.
...
func (e *element) RenderBuilder(buf *bytes.Buffer) {
	...
	buf.Write(html5.TagAddressClose)
}
