...
//
// The <address> element supplies contact information for its nearest article
// ancestor, or for the document when there is no article ancestor. It can contain
// names, postal addresses, email links and other contact details. It is not a
// general-purpose wrapper for any postal address.
package address
