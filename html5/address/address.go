...
// Text Creates a new address element with text contact information
...
// Static Creates a new address element with static text content.
// Example: address.Static("Hello World")
// Renders: <address>Hello World</address>
...
// RawText Creates a new address element with raw text content as unescaped HTML using text.RawText.
...
// Textf Creates a new address element with formatted text content using text.Textf.
// Example: address.Textf("Hello %s", "World")
// Renders: <address>Hello World</address>
...
// RawTextf Creates a new address element with formatted raw text content as unescaped HTML using text.RawTextf.
// Example: address.RawTextf("Hello <em>%s</em>", "World")
// Renders: <address>Hello <em>World</em></address>
