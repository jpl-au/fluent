...
// Text Creates a new span element with text content (HTML-encoded).
// Example: span.Text("<b>Hello</b> World")
// Renders: <span>&lt;b&gt;Hello&lt;/b&gt; World</span>
...
// Static Creates a new span element with static text content.
// Example: span.Static("Hello World")
...
// RawText Creates a new span element with raw text content as unescaped HTML.
...
// Textf Creates a new span element with formatted text content using text.Textf.
// Example: span.Textf("Hello %s", "World")
// Renders: <span>Hello World</span>
...
// RawTextf Creates a new span element with formatted raw text content as unescaped HTML using text.RawTextf.
// Example: span.RawTextf("Hello <b>%s</b>", "World")
// Renders: <span>Hello <b>World</b></span>
