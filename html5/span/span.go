...
//
// The <span>: The Content Span element is a generic inline container for phrasing content, which does not
// inherently represent anything. It can be used to group elements for styling purposes (using the class or id
// attributes), or because they share attribute values, such as lang. Use it when no other
...
// Element represents the <span> HTML element.
type Element struct {
