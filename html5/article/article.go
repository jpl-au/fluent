...
//
// The <article> element represents a self-contained item that could be reused
// or distributed independently, such as a news article, forum post or comment.
// Its headings describe the item rather than the surrounding page.
package article
...
// Text creates a new article element with text content. Uses text.Text which HTML-escapes the output.
...
func (e *Element) RenderBuilder(buf *bytes.Buffer) {
	...
	buf.Write(html5.TagArticleClose)
}
