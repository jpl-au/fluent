...
//
// The <title> HTML element defines the document's title, shown in the browser's
// title bar or page tab. Its contents are text. HTML tags within it are treated
// as plain text.
package title
...
// Element represents the <title> HTML element.
type Element struct {
