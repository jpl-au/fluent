...
// Text Creates a new title element with text content
// Example: title.Text("Page Title")
...
// Static Creates a new title element with static text content.
// Example: title.Static("Hello World")
// Renders: <title>Hello World</title>
...
// Textf Creates a new title element with formatted text content
// Example: title.Textf("%s %s", "Page", "Title")
// Renders: <title>Page Title</title>
...
// RawText Creates a new title element with raw text content
...
// RawTextf Creates a new title element with formatted raw text content
// Example: title.RawTextf("%s %s %s", "Page", "&amp;", "Title")
// Renders: <title>Page &amp; Title</title>
