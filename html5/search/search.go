...
// Text Creates a new search element with text content
// Example: search.Text("Search content")
// Renders: <search>Search content</search>
...
// Static Creates a new search element with static text content
// Example: search.Static("Find items")
// Renders: <search>Find items</search>
...
// RawText Creates a new search element with raw text content as unescaped HTML
// Example: search.RawText("<input type='search'>")
// Renders: <search><input type='search'></search>
...
// Textf Creates a new search element with formatted text content using text.Textf
// Example: search.Textf("Search %s", "items")
// Renders: <search>Search items</search>
...
// RawTextf Creates a new search element with formatted raw text content as unescaped HTML using text.RawTextf
// Example: search.RawTextf("<form>%s</form>", "content")
// Renders: <search><form>content</form></search>
