...
// controls or other content related to performing a search or filtering operation.
package search
...
// element represents the <search> HTML element
type element struct {
...
func (e *element) RenderBuilder(buf *bytes.Buffer) {
	...
	buf.Write(html5.TagSearchClose)
}
