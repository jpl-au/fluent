...
// Text Creates a new h5 element with text content (HTML-encoded).
// Example: h5.Text("<em>Minor</em> Sub-point")
...
// Static Creates a new h5 element with static text content.
// Example: h5.Static("Hello World")
// Renders: <h5>Hello World</h5>
...
// RawText Creates a new h5 element with raw text content as unescaped HTML.
...
// Textf Creates a new h5 element with formatted text content using text.Textf.
// Example: h5.Textf("Hello %s", "World")
// Renders: <h5>Hello World</h5>
...
// RawTextf Creates a new h5 element with formatted raw text content as unescaped HTML using text.RawTextf.
// Example: h5.RawTextf("Hello <em>%s</em>", "World")
// Renders: <h5>Hello <em>World</em></h5>
