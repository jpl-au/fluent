...
// Text Creates a new mark element with text content (HTML-encoded).
// Example: mark.Text("<strong>important</strong> result")
...
// Static Creates a new mark element with static text content.
// Example: mark.Static("Hello World")
// Renders: <mark>Hello World</mark>
...
// RawText Creates a new mark element with raw text content as unescaped HTML.
...
// Textf Creates a new mark element with formatted text content using text.Textf.
// Example: mark.Textf("Hello %s", "World")
// Renders: <mark>Hello World</mark>
...
// RawTextf Creates a new mark element with formatted raw text content as unescaped HTML using text.RawTextf.
// Example: mark.RawTextf("Hello <em>%s</em>", "World")
// Renders: <mark>Hello <em>World</em></mark>
