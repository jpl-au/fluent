...
//
// The <tfoot> HTML element defines a set of rows summarising the columns of the table.
package tfoot
...
// Element represents the <tfoot> HTML element.
type Element struct {
...
// RowsOf creates a new <tfoot> element from a slice of data and a mapper that returns one tr element per item, enforcing correct nesting at compile time.
...
// Example: tfoot.RowsOf([]int{1, 2}, func(int) *tr.Element { return tr.New() })
// Renders: <tfoot><tr></tr><tr></tr></tfoot>
...
// RowsFunc creates a new <tfoot> element from a function that returns tr elements, enforcing correct nesting at compile time.
...
// Example: tfoot.RowsFunc(func() []*tr.Element { return []*tr.Element{tr.New(), tr.New()} })
// Renders: <tfoot><tr></tr><tr></tr></tfoot>
