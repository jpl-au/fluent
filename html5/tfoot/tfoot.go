...
// New Creates a new tfoot element with optional child nodes.
// Example: tfoot.New()
// Renders: <tfoot></tfoot>
...
// Text Creates a new tfoot element with text content.
// Example: tfoot.Text("Table footer")
// Renders: <tfoot>Table footer</tfoot>
...
// Static Creates a new tfoot element with static text content.
// Example: tfoot.Static("Hello World")
// Renders: <tfoot>Hello World</tfoot>
...
// RawText Creates a new tfoot element with raw text content as unescaped HTML.
// Example: tfoot.RawText("<strong>Table</strong> footer")
// Renders: <tfoot><strong>Table</strong> footer</tfoot>
...
// Textf Creates a new tfoot element with formatted text content using text.Textf.
// Example: tfoot.Textf("%s footer", "Table")
// Renders: <tfoot>Table footer</tfoot>
...
// RawTextf Creates a new tfoot element with formatted raw text content as unescaped HTML using text.RawTextf.
// Example: tfoot.RawTextf("<strong>%s</strong> footer", "Table")
// Renders: <tfoot><strong>Table</strong> footer</tfoot>
