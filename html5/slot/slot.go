...
//
// The <slot> element marks an insertion point in a shadow tree. Named slots
// receive host children whose slot attribute matches the name. An unnamed slot
// receives default content. Its own children provide fallback content when
// nothing is assigned.
package slot
...
// Renders: <slot name="header"><p>Default header</p></slot>
...
//
// The slot's name. A named slot is a <slot> element with a name attribute. This identifier allows content
// to be assigned to specific slots within web components using the slot attribute on child elements.
