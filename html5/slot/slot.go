...
// Text Creates a new slot element with text content as fallback.
...
// Static Creates a new slot element with static text content.
// Example: slot.Static("Hello World")
// Renders: <slot>Hello World</slot>
...
// RawText Creates a new slot element with raw text content as unescaped HTML fallback.
...
// Textf Creates a new slot element with formatted text content using text.Textf.
// Example: slot.Textf("%s content", "Default")
// Renders: <slot>Default content</slot>
...
// RawTextf Creates a new slot element with formatted raw text content as unescaped HTML using text.RawTextf.
// Example: slot.RawTextf("<em>%s</em> content", "Default")
// Renders: <slot><em>Default</em> content</slot>
...
// Name The slot's name. A named slot is a <slot> element with a name attribute. This identifier allows content
