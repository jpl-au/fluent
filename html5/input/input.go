...
// Alpha Valid only for color input type. Allows the colour picker to include an alpha channel (transparency)
...
// ColorSpace Valid only for color input type. Specifies the colour space for the colour picker. Controls which colour
