...
//
// The <label> element names a form control. Associate it through for, using the
// control's id, or by nesting the control inside it. Activating the label focuses
// or activates its control, including toggling a checkbox or radio button.
package label
...
//
// The id of the form control that this label is associated with. When set, clicking the label focuses
