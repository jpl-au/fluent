...
// For Creates a new label element with for attribute and text content (HTML-encoded)
...
// Text Creates a new label element with text content (HTML-encoded)
...
// Static Creates a new label element with static text content
// Example: label.Static("Email Address")
// Renders: <label>Email Address</label>
...
// RawText Creates a new label element with raw text content as unescaped HTML
// Example: label.RawText("Email <em>Address</em>")
// Renders: <label>Email <em>Address</em></label>
...
// Textf Creates a new label element with formatted text content using text.Textf.
// Example: label.Textf("Hello %s", "World")
// Renders: <label>Hello World</label>
...
// RawTextf Creates a new label element with formatted raw text content as unescaped HTML using text.RawTextf.
// Example: label.RawTextf("Hello <em>%s</em>", "World")
// Renders: <label>Hello <em>World</em></label>
...
// For The id of the form control that this label is associated with. When set, clicking the label will focus
