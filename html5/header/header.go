...
// aids. It may contain some heading elements but also a logo, a search form, an author name, and other
// elements.
package header
...
// Element represents the <header> HTML element.
type Element struct {
...
func (e *Element) RenderBuilder(buf *bytes.Buffer) {
	...
	buf.Write(html5.TagHeaderClose)
}
