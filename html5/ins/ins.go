...
// Text Creates a new ins element with text content.
// Example: ins.Text("This text was inserted")
// Renders: <ins>This text was inserted</ins>
...
// Static Creates a new ins element with static text content.
// Example: ins.Static("Hello World")
// Renders: <ins>Hello World</ins>
...
// RawText Creates a new ins element with raw text content.
// Example: ins.RawText("This text was inserted")
// Renders: <ins>This text was inserted</ins>
...
// Textf Creates a new ins element with formatted text content using text.Textf.
// Example: ins.Textf("Hello %s", "World")
// Renders: <ins>Hello World</ins>
...
// RawTextf Creates a new ins element with formatted raw text content as unescaped HTML using text.RawTextf.
// Example: ins.RawTextf("Hello <em>%s</em>", "World")
// Renders: <ins>Hello <em>World</em></ins>
...
// Cite A URI for a resource that explains or documents the reason for the insertion. This could link to meeting
...
// DateTime This attribute indicates the time and date when the insertion occurred. The value must be a valid date
