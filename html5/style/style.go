...
// Text Creates a new style element with CSS text content.
...
// Static Creates a new style element with static text content.
// Example: style.Static("Hello World")
// Renders: <style>Hello World</style>
...
// RawText Creates a new style element with raw CSS content as unescaped HTML.
...
// Textf Creates a new style element with formatted text content using text.Textf.
// Example: style.Textf("%s { margin: %d; }", "body", 0)
// Renders: <style>body { margin: 0; }</style>
...
// RawTextf Creates a new style element with formatted raw text content as unescaped HTML using text.RawTextf.
// Example: style.RawTextf("%s { margin: %d; }", "body", 0)
// Renders: <style>body { margin: 0; }</style>
...
// for explicit content type declaration and may be required in certain contexts or for non-CSS styling
// languages.
...
// Media Specifies the media types and conditions for which the enclosed CSS should be applied, using CSS media
...
// Nonce A cryptographic nonce ('number used once') that allows this specific inline style block to execute despite
...
// Title Assigns a title to the style sheet, enabling it to be identified as an alternate style sheet that users can
...
// Blocking Indicates that certain operations should be blocked until the stylesheet is loaded and applied.
