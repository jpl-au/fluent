...
//
// The <wbr> element marks an optional line-break position within text. It lets
// the browser wrap a long word or URL at that point when needed, without forcing
// a break or adding a hyphen.
package wbr
...
// Element represents the <wbr> HTML element.
type Element struct {
