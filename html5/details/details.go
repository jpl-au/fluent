...
// Open This Boolean attribute indicates whether the details disclosure widget is currently expanded and its
// content visible. When true, the details are shown; when false or absent, the content is hidden. By
// default this attribute is absent, meaning the details are collapsed. Users can toggle this state by
// clicking on the summary element.
