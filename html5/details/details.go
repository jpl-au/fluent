...
// Open Marks the details widget as expanded, making the content visible. When absent, the content is hidden.
...
// Name This attribute creates a group name for multiple <details> elements, ensuring only one element in the
