...
//
// The <figcaption> element captions its parent figure, such as an image,
// diagram or code listing. It must be the figure's first or last child and
// provides a description associated with that figure.
package figcaption
