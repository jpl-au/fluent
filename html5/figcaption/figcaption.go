...
//
// The <figcaption> HTML element provides a caption or legend describing the content of its parent <figure>
// element. Should be the first or last child of the figure. Used to add descriptive text, credits, or
// explanatory information to images, diagrams, code listings, or other figure content. Improves accessibility
// and provides context for visual or illustrative content.
package figcaption
...
func (e *element) RenderBuilder(buf *bytes.Buffer) {
	...
	buf.Write(html5.TagFigcaptionClose)
}
