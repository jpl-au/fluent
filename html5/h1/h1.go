...
//
// The <h1> HTML element represents the highest level of section heading. It is typically used for the main
// title of a page or a major section.
package h1
...
// Element represents the <h1> HTML element.
type Element struct {
...
// Example: h1.RawText("<span class=\"logo\">Dashboard</span>")
// Renders: <h1><span class="logo">Dashboard</span></h1>
