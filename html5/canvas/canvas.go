...
//
// The <canvas> HTML element provides a drawable region for rendering graphics, animations, and visualizations
// using JavaScript. Used with the Canvas 2D API for 2D graphics or WebGL for 3D rendering. Content within the
// canvas element serves as fallback for browsers that don't support canvas. Essential for data visualisation,
// games, image manipulation, and real-time graphics.
package canvas
...
//
// The height of the coordinate space in CSS pixels. This defines the vertical resolution of the canvas
...
//
// The width of the coordinate space in CSS pixels. This defines the horizontal resolution of the canvas
