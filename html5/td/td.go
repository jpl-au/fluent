...
//
// The <td> element represents a data cell in a table row. Colspan and rowspan
// extend the cell across columns or rows. Headers can explicitly identify the
// th elements that describe the cell.
package td
...
//
// The number of columns occupied by this cell, from 1 to 1000. The default
// is 1. A spanning cell must fit the table's grid without overlapping others.
...
//
// The number of rows occupied by this cell. The default is 1. A value of 0
// extends it through the remaining rows of its row group. Positive values
// are limited to 65534.
...
//
// A space-separated list of ids of th elements in the same table that label
// this cell. Use explicit associations when the applicable headers cannot be
// expressed clearly through the table's row and column structure.
