...
// Text Creates a new table data cell element with text content.
// Example: td.Text("Cell content")
// Renders: <td>Cell content</td>
...
// Static Creates a new td element with static text content.
// Example: td.Static("Hello World")
// Renders: <td>Hello World</td>
...
// RawText Creates a new table data cell element with raw text content as unescaped HTML.
// Example: td.RawText("Data with <strong>formatting</strong>")
// Renders: <td>Data with <strong>formatting</strong></td>
...
// Textf Creates a new table data cell element with formatted text content using text.Textf.
// Example: td.Textf("%s data", "Cell")
// Renders: <td>Cell data</td>
...
// RawTextf Creates a new table data cell element with formatted raw text content as unescaped HTML using text.RawTextf.
// Example: td.RawTextf("%s with <strong>%s</strong>", "Data", "formatting")
// Renders: <td>Data with <strong>formatting</strong></td>
...
// ColSpan Specifies how many columns this cell should span horizontally, allowing the cell to extend across multiple
...
// RowSpan Specifies how many rows this cell should span vertically, allowing the cell to extend across multiple rows
...
// Headers Contains a space-separated list of ID values that correspond to the id attributes of <th> (table header)
...
// Scope Defines which cells this header cell applies to when used in <th> elements. While primarily intended for <th>
// elements, this attribute can also be used on <td> elements acting as headers. This semantic relationship
// improves table accessibility by helping screen readers understand the structure and relationships within complex
// tables.
// Possible values: row (applies to the rest of the row), col (applies to the rest of the column), rowgroup
// (applies to the entire row group), colgroup (applies to the entire column group)
