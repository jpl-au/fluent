...
// Text Creates a new rt element with text content
...
// Static Creates a new rt element with static text content
// Example: rt.Static("pronunciation")
// Renders: <rt>pronunciation</rt>
...
// RawText Creates a new rt element with raw text content
...
// Textf Creates a new rt element with formatted text content (HTML-encoded)
// Example: rt.Textf("pronunciation %d", 1)
// Renders: <rt>pronunciation 1</rt>
...
// RawTextf Creates a new rt element with formatted raw text content as unescaped HTML
// Example: rt.RawTextf("<span>%s</span>", "ruby")
// Renders: <rt><span>ruby</span></rt>
