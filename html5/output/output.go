...
// Text Creates a new output element with text content
...
// Static Creates a new output element with static text content
// Example: output.Static("Total")
// Renders: <output>Total</output>
...
// RawText Creates a new output element with raw text content
...
// Textf Creates a new output element with formatted text content (HTML-encoded)
// Example: output.Textf("Result: %d", 42)
// Renders: <output>Result: 42</output>
...
// RawTextf Creates a new output element with formatted raw text content as unescaped HTML
// Example: output.RawTextf("<strong>%d</strong>", 100)
// Renders: <output><strong>100</strong></output>
...
// For Specifies a space-separated list of element IDs that contributed input values to the calculation
func (e *element) For(forID string) *element {
	e.forID = forID
	return e
}

// Form Associates the output element with a form element in the document
func (e *element) Form(formID string) *element {
	e.form = formID
	return e
}

// Name Assigns a name to the output element for programmatic access
