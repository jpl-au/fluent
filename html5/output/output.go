...
// Element represents the <output> HTML element.
type Element struct {
...
//
// Specifies a space-separated list of element IDs that contributed input values to the calculation
...
//
// Associates the output element with a form element in the document
...
//
// Assigns a name to the output element for programmatic access
...
func (e *Element) RenderBuilder(buf *bytes.Buffer) {
	...
	buf.Write(html5.TagOutputClose)
}
