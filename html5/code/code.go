...
// fragment of computer code. By default, the content text is displayed using the user agent's default monospace
// font.
package code
...
// Element represents the <code> HTML element.
type Element struct {
