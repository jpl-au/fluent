...
// Type Specifies the MIME type of the resource specified by the data attribute
func (e *element) Type(mime string) *element {
	e.objectType = mime
	return e
}

// Form Associates the object element with a form element in the document
...
// Name Assigns a name to the embedded content for targeting and reference purposes
func (e *element) Name(name string) *element {
	e.name = name
	return e
}

// UseMap Associates the object with an image map defined by a <map> element
//
