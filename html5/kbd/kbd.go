...
// Text Creates a new kbd element with text content representing keyboard input.
// Example: kbd.Text("Ctrl+Alt+Del")
// Renders: <kbd>Ctrl+Alt+Del</kbd>
...
// Static Creates a new kbd element with static text content.
// Example: kbd.Static("Hello World")
// Renders: <kbd>Hello World</kbd>
...
// RawText Creates a new kbd element with raw text content.
// Example: kbd.RawText("Ctrl+Alt+Del")
// Renders: <kbd>Ctrl+Alt+Del</kbd>
...
// Textf Creates a new kbd element with formatted text content using text.Textf.
// Example: kbd.Textf("Hello %s", "World")
// Renders: <kbd>Hello World</kbd>
...
// RawTextf Creates a new kbd element with formatted raw text content as unescaped HTML using text.RawTextf.
// Example: kbd.RawTextf("Hello <em>%s</em>", "World")
// Renders: <kbd>Hello <em>World</em></kbd>
