...
// Text Creates a new u element with text content (HTML-encoded).
// Example: u.Text("<em>annotated</em> text")
...
// Static Creates a new u element with static text content.
// Example: u.Static("Hello World")
// Renders: <u>Hello World</u>
...
// RawText Creates a new u element with raw text content as unescaped HTML.
...
// Textf Creates a new u element with formatted text content using text.Textf.
// Example: u.Textf("annotated %s", "text")
// Renders: <u>annotated text</u>
...
// RawTextf Creates a new u element with formatted raw text content as unescaped HTML using text.RawTextf.
// Example: u.RawTextf("<em>%s</em> text", "annotated")
// Renders: <u><em>annotated</em> text</u>
