...
//
// The <u> HTML element marks text with a non-textual annotation, such as a
// spelling error. Browsers normally underline it. CSS can change that
// presentation.
package u
