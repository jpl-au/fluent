...
//
// The <cite> HTML element is used to mark up the title of a creative work. The reference may be in an
// abbreviated form according to context-appropriate conventions related to citation metadata.
package cite
...
// Element represents the <cite> HTML element.
type Element struct {
