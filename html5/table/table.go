...
//
// The <table> element represents data arranged in rows and columns. Use th for
// headers and td for data cells, with caption to identify the table. Row groups
// such as thead, tbody and tfoot organise the structure.
package table
...
// frame is displayed. For new documents, use CSS to style
// table borders with more control over appearance, colours, and styles.
//
...
//
// Specifies which sides of the table frame (border) are displayed. This legacy attribute provides basic
// control over table border appearance by selectively showing or hiding specific sides of the outer table
// border. Use CSS border properties for styling new documents.
...
//
// Specifies where dividing lines (rules) appear between table cells. This legacy attribute controls
