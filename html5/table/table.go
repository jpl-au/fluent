...
// Border Defines the width in pixels of the border frame surrounding the table. This is a legacy HTML attribute
...
// CellPadding Specifies the amount of space between the cell content and the cell border in pixels or as a percentage.
...
// CellSpacing Defines the amount of space between adjacent table cells, specified in pixels or as a percentage. This
...
// Frame Specifies which sides of the table frame (border) should be displayed. This legacy attribute provides basic
...
// Rules Specifies where dividing lines (rules) should appear between table cells. This legacy attribute controls
...
// Summary Provides a textual summary of the table's content and structure for accessibility purposes. This attribute
...
// Width Specifies the width of the table, either as a fixed pixel value (e.g., '500') or as a percentage of the
