...
//
// The <a> element creates a hyperlink when href is present. Its content supplies
// the link text or other interactive content, and target selects where the
// linked resource opens. Without href, it represents a placeholder for a link.
package a
...
//
// Requests that the linked resource be downloaded. A non-empty value suggests
// a file name. An empty value lets the browser derive one from the URL or
// response headers. Browser policy and the resource's origin can restrict
...
//
// The language of the linked resource, expressed as a BCP 47 tag such as
// "en" or "fr-CA". This describes the destination's language. It does not instruct the browser to
// translate it or change the language of the current link.
...
//
// Defines a space-separated list of destinations for ping notifications when the user follows the
...
//
// A space-separated set of link relationships, such as alternate, author,
// help, license, next or prev. Noopener and noreferrer control aspects of
// opening and navigating the link. Resource-loading relationships such as
// stylesheet and preload apply to link elements. They do not apply to anchors.
...
//
// The browsing context in which to open the destination: _self, _blank,
// _parent, _top or a named context. The default is _self. Named contexts can
// refer to an iframe through its name attribute.
...
//
// A media-type hint for the linked resource, such as application/pdf. It
// describes the destination without changing the link's navigation behaviour.
