...
// Align Specifies the horizontal alignment of content within all cells in this table row. This is a legacy HTML
...
// BgColor Sets the background color for all cells in this table row. The color can be specified as a named color, hex
...
// Char Specifies a character that cell content should be aligned on when the align attribute is set to 'char'. This
...
// CharOff Specifies the number of characters to offset from the alignment character specified by the char attribute.
...
// VAlign Specifies the vertical alignment of content within all cells in this table row. This is a legacy HTML
