...
//
// Specifies the horizontal alignment of content within all cells in this table row. This is a legacy HTML
// attribute that has been superseded by CSS text-align properties, which provide more control and better
// maintainability in modern web development.
// Possible values: left (align to left edge), center (center content), right (align to right edge), justify
// (distribute text evenly), char (align on a specific character)
//
// Deprecated: Use CSS text-align instead.
func (e *element) Align(alignment string) *element {
	e.SetAttribute("align", alignment)
	return e
}

// BgColor sets the bgcolor attribute.
//
// Sets the background color for all cells in this table row. The color can be specified as a named color, hex
// value, or RGB value. This is a legacy HTML attribute that has been superseded by CSS background-color
// properties, which offer more sophisticated color control, gradients, and better integration with modern
// styling systems.
//
// Deprecated: Use CSS background-color instead.
func (e *element) BgColor(color string) *element {
	e.SetAttribute("bgcolor", color)
	return e
}

// Char sets the char attribute.
//
// Specifies a character that cell content should be aligned on when the align attribute is set to 'char'. This
// enables alignment on decimal points, currency symbols, or other specific characters within table cells. This
// is a legacy HTML attribute that's rarely used in modern web development, with CSS offering more flexible
// alignment options.
//
// Deprecated: Use CSS text-align instead.
func (e *element) Char(character string) *element {
	e.SetAttribute("char", character)
	return e
}

// CharOff sets the charoff attribute.
//
// Specifies the number of characters to offset from the alignment character specified by the char attribute.
// This provides fine-tuned control over character-based alignment within table cells. This is a legacy HTML
// attribute that works in conjunction with the char attribute and is rarely used in modern web development.
//
// Deprecated: Use CSS text-align instead.
func (e *element) CharOff(offset string) *element {
	e.SetAttribute("charoff", offset)
	return e
}

// VAlign sets the valign attribute.
//
// Specifies the vertical alignment of content within all cells in this table row. This is a legacy HTML
// attribute that has been superseded by CSS vertical-align properties, which provide more control and better
// integration with modern layout systems.
// Possible values: baseline (align to text baseline), bottom (align to bottom), middle (center vertically),
// top (align to top)
//
// Deprecated: Use CSS vertical-align instead.
func (e *element) VAlign(alignment string) *element {
	e.SetAttribute("valign", alignment)
	return e
}
