...
// Possible values: left (align to left edge), center (centre content), right (align to right edge), justify
...
//
// Sets the background colour for all cells in this table row. The colour can be specified as a named colour, hex
// value, or RGB value. This is a legacy HTML attribute that has been superseded by CSS background-color
// properties, which offer more sophisticated colour control, gradients, and better integration with modern
// styling systems.
//
...
//
// Specifies the character used to align cell content when the align attribute is set to 'char'. This
...
// Possible values: baseline (align to text baseline), bottom (align to bottom), middle (centre vertically),
// top (align to top)
//
