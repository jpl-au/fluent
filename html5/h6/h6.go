...
//
// The <h6> element represents a sixth-level heading, the deepest heading rank.
// Use it for a section nested beneath h5. Choose the heading rank to reflect
// the document structure. Use CSS to make text smaller or less prominent.
package h6
...
// Text creates a new h6 element with text content. Uses text.Text which HTML-escapes the output.
