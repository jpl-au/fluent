...
//
// The <h6> HTML element represents the lowest level of section heading. It is typically used for the least
// important headings, such as those found in footnotes or sidebars.
package h6
