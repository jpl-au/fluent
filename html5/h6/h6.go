...
// Text Creates a new h6 element with text content (HTML-encoded).
// Example: h6.Text("<sup>Smallest</sup> Heading")
...
// Static Creates a new h6 element with static text content.
// Example: h6.Static("Hello World")
// Renders: <h6>Hello World</h6>
...
// RawText Creates a new h6 element with raw text content as unescaped HTML.
...
// Textf Creates a new h6 element with formatted text content using text.Textf.
// Example: h6.Textf("Hello %s", "World")
// Renders: <h6>Hello World</h6>
...
// RawTextf Creates a new h6 element with formatted raw text content as unescaped HTML using text.RawTextf.
// Example: h6.RawTextf("Hello <em>%s</em>", "World")
// Renders: <h6>Hello <em>World</em></h6>
