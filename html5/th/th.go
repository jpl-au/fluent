...
//
// The number of columns occupied by this header cell, from 1 to 1000. The
// default is 1. Use it to group columns under a shared heading.
...
//
// The number of rows occupied by this header cell. The default is 1. A value of 0
...
//
// Lists the space-separated IDs of other header cells in the same table that
// apply to this header. Use it to express multi-level header relationships
// when row and column scope alone do not describe the table.
