...
// Text Creates a new th element with text content.
...
// Static Creates a new th element with static text content.
// Example: th.Static("Hello World")
// Renders: <th>Hello World</th>
...
// RawText Creates a new th element with raw text content as unescaped HTML.
// Example: th.RawText("<strong>Name</strong>")
// Renders: <th><strong>Name</strong></th>
...
// Textf Creates a new th element with formatted text content using text.Textf.
// Example: th.Textf("%s Header", "Name")
// Renders: <th>Name Header</th>
...
// RawTextf Creates a new th element with formatted raw text content as unescaped HTML using text.RawTextf.
// Example: th.RawTextf("<strong>%s</strong>", "Name")
// Renders: <th><strong>Name</strong></th>
...
// RowSpan Specifies how many rows this header cell should span vertically, allowing the cell to extend across
...
// Headers Contains a space-separated list of ID values that correspond to the id attributes of other <th> elements
...
// Scope Defines which cells this header cell applies to, establishing the semantic relationship between the header
