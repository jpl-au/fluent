...
//
// The <em> HTML element marks text that has stress emphasis. The <em> element can be nested, with each level
// of nesting indicating a greater degree of emphasis.
package em
...
// Element represents the <em> HTML element.
type Element struct {
