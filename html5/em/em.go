...
// Text Creates a new em element with text content (HTML-encoded).
// Example: em.Text("<b>now</b>")
...
// Static Creates a new em element with static text content.
// Example: em.Static("Hello World")
// Renders: <em>Hello World</em>
...
// RawText Creates a new em element with raw text content as unescaped HTML.
...
// Textf Creates a new em element with formatted text content using text.Textf.
// Example: em.Textf("Hello %s", "World")
// Renders: <em>Hello World</em>
...
// RawTextf Creates a new em element with formatted raw text content as unescaped HTML using text.RawTextf.
// Example: em.RawTextf("Hello <strong>%s</strong>", "World")
// Renders: <em>Hello <strong>World</strong></em>
