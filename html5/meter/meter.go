...
//
// The <meter> element represents a measurement within a known range, such as
// disk usage. Min and max define the range. Low, high and optimum describe how
// to interpret the value. Use progress for task completion.
package meter
...
//
// The measurement to display within the range defined by min and max.
// Use it for a quantity such as storage usage. Use progress to represent
// task completion.
...
//
// Sets the lower bound of the measurement range. The default is 0. Keep min
// less than or equal to max, with value and any low, high, or optimum thresholds
// inside that range.
...
//
// Sets the upper bound of the measurement range. The default is 1. Keep max
// greater than or equal to min. Choose bounds that describe the quantity being
// measured rather than the current observed value.
...
//
// The upper boundary of the low portion of the range. It must be at least
// min and no greater than high or max. Together with high and optimum, it
// helps the browser distinguish desirable and undesirable values.
...
//
// The lower boundary of the high portion of the range. It must be at most
// max and no less than low or min. Its position relative to optimum determines
// whether high measurements are desirable.
...
//
// Indicates the optimal numeric value within the measurement range. This value defines what is considered the
// ideal or preferred measurement. Browsers use this to determine the semantic meaning of the current value -
// whether it's good, suboptimal, or poor relative to the optimal point. The position of optimum relative to
