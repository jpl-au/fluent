...
// Text Creates a new meter element with text content (fallback text)
...
// Static Creates a new meter element with static text content.
// Example: meter.Static("Hello World")
// Renders: <meter>Hello World</meter>
...
// RawText Creates a new meter element with raw text content
// Example: meter.RawText("6 out of 10")
// Renders: <meter>6 out of 10</meter>
...
// Textf Creates a new meter element with formatted text content (HTML-encoded).
// Example: meter.Textf("%d out of %d", 6, 10)
// Renders: <meter>6 out of 10</meter>
...
// RawTextf Creates a new meter element with formatted raw text content as unescaped HTML.
// Example: meter.RawTextf("<strong>%d</strong> out of %d", 6, 10)
...
// Value The current numeric value being measured. This must be between the minimum and maximum values (min and
...
// Min The lower numeric bound of the measured range. This establishes the minimum possible value for the
...
// Max The upper numeric bound of the measured range. This defines the maximum possible value for the measurement.
...
// Low The upper numeric bound of the low end of the measured range. This defines the threshold below which the
...
// High The lower numeric bound of the high end of the measured range. This defines the threshold above which the
...
// Optimum Indicates the optimal numeric value within the measurement range. This value defines what is considered the
