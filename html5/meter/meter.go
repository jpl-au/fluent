...
//
// The current numeric value being measured. This must be between the minimum and maximum values (min and
// max attributes) if they are specified. If omitted, the value is 0. The value represents the actual
...
//
// The lower numeric bound of the measured range. This establishes the minimum possible value for the
// measurement. If not specified, the minimum value is 0. This value must be less than the maximum value
...
//
// The upper numeric bound of the measured range. This defines the maximum possible value for the measurement.
// If not specified, the maximum value is 1. This value must be greater than the minimum value (min
...
//
// The upper numeric bound of the low end of the measured range. This defines the threshold below which the
// current value is considered to be in the "low" range. Used by browsers to apply appropriate styling
...
//
// The lower numeric bound of the high end of the measured range. This defines the threshold above which the
// current value is considered to be in the "high" range. Used by browsers to apply appropriate styling to
