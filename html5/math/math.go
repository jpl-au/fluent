...
// Text Creates a new math element with text content.
// Example: math.Text("x + y")
...
// Static Creates a new math element with static text content.
// Example: math.Static("Hello World")
// Renders: <math>Hello World</math>
...
// RawText Creates a new math element with raw text content.
// Example: math.RawText("x + y")
// Renders: <math>x + y</math>
...
// Textf Creates a new math element with formatted text content (HTML-encoded).
// Example: math.Textf("%s + %s", "x", "y")
// Renders: <math>x + y</math>
...
// RawTextf Creates a new math element with formatted raw text content as unescaped HTML.
// Example: math.RawTextf("<mi>%s</mi> + <mi>%s</mi>", "x", "y")
// Renders: <math><mi>x</mi> + <mi>y</mi></math>
...
// Display Specifies how the enclosed MathML markup should be rendered. Can be 'block' for displayed equations or
...
// MathVariant Specifies the logical class of the identifier, which varies in typography. Some of the values overlap with
...
// Xmlns Specifies the XML namespace for MathML. Typically set to "http://www.w3.org/1998/Math/MathML".
