...
// Text Creates a new q element with text content (HTML-encoded).
// Example: q.Text("Hello World")
// Renders: <q>Hello World</q>
...
// Static Creates a new q element with static text content.
// Example: q.Static("Quote text")
// Renders: <q>Quote text</q>
...
// RawText Creates a new q element with raw text content as unescaped HTML.
...
// Textf Creates a new q element with formatted text content (HTML-encoded).
// Example: q.Textf("Quote by %s", "Author")
// Renders: <q>Quote by Author</q>
...
// RawTextf Creates a new q element with formatted raw text content as unescaped HTML.
// Example: q.RawTextf("<strong>%s</strong>", "Quote")
// Renders: <q><strong>Quote</strong></q>
...
// Cite The value of this attribute is a URL that designates a source document or message for the information
