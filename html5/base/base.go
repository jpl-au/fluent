...
//
// The <base> HTML element specifies the base URL to use for all relative URLs in a document and the default
// target browsing context for links. Only one <base> element is permitted per document, and it should appear
// in the <head> before any elements with URLs. Useful for single-page applications, documentation sites, and
// pages served from different paths than their assets.
package base
