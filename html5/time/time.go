...
//
// The <time> element marks a date, time or duration. Datetime supplies its
// machine-readable representation when the visible text uses a different format,
// such as a localised date or a human-readable duration.
package time
...
//
// Provides a machine-readable value separate from the visible text. Use an
// HTML date/time format appropriate to the value, such as '2023-12-25' for a
// date, '14:30:00' for a time, '2023-12-25T14:30:00' for a local date and time,
// or 'PT2H30M' for a duration. Include an offset when representing a zoned time.
func (e *Element) DateTime(value string) *Element {
	e.datetime = node.EscapeAttribute(value)
	return e
}
