...
//
// Specifies the machine-readable date, time, or duration that the element represents. This attribute enables
// browsers, search engines, and other tools to understand temporal information precisely, regardless of how it's
// displayed to humans. The value must be a valid ISO 8601 format such as '2023-12-25' (date), '14:30:00' (time),
// '2023-12-25T14:30:00' (date and time), or 'PT2H30M' (duration). Essential for calendar integration, structured
// data, and accessibility features.
