...
// Text Creates a new time element with text content
// Example: time.Text("December 25, 2023")
// Renders: <time>December 25, 2023</time>
...
// Static Creates a new time element with static text content.
// Example: time.Static("Hello World")
// Renders: <time>Hello World</time>
...
// RawText Creates a new time element with raw text content
// Example: time.RawText("December 25, 2023")
// Renders: <time>December 25, 2023</time>
...
// Textf Creates a new time element with formatted text content (HTML-encoded).
// Example: time.Textf("Date: %s", "2023-12-25")
// Renders: <time>Date: 2023-12-25</time>
...
// RawTextf Creates a new time element with formatted raw text content as unescaped HTML.
// Example: time.RawTextf("Date: <em>%s</em>", "2023-12-25")
// Renders: <time>Date: <em>2023-12-25</em></time>
...
// DateTime Creates a new time element with datetime attribute and text content
...
// DateTime Specifies the machine-readable date, time, or duration that the element represents. This attribute enables
