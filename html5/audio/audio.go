...
//
// The <audio> HTML element embeds sound content in documents. It supports multiple audio sources through the src
// attribute or nested <source> elements, allowing the browser to select the most suitable format based on codec
// support. Common uses include background music, sound effects, podcasts, and audio players. The element provides
// built-in playback controls and supports streaming via MediaStream for real-time audio applications.
package audio
...
//
// A Boolean attribute that specifies the audio will automatically begin playback as soon as it can do so.
//
...
//
// Controls Cross-Origin Resource Sharing (CORS) behavior when fetching the audio file.
...
//
// Provides a hint to the browser about optimal preloading behaviour for the best user experience.
