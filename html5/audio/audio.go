...
// DisableRemotePlayback A Boolean attribute that disables remote playback capabilities on connected devices.
func (e *element) DisableRemotePlayback() *element {
	e.disableRemotePlayback = true
	return e
}

// Preload Provides a hint to the browser about optimal preloading behavior for the best user experience.
