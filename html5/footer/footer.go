...
// element. A footer typically contains information about the author of the section, copyright data, or links to
// related documents. It can also include navigation elements, contact information, and social media links.
package footer
...
// element represents the <footer> HTML element
type element struct {
...
func (e *element) RenderBuilder(buf *bytes.Buffer) {
	...
	buf.Write(html5.TagFooterClose)
}
