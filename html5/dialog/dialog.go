...
// Text Creates a new dialog element with text content.
// Example: dialog.Text("<strong>test</strong>")
// Renders: <dialog>&lt;strong&gt;test&lt;/strong&gt;</dialog>
...
// Static Creates a new dialog element with static text content.
// Example: dialog.Static("Hello World")
// Renders: <dialog>Hello World</dialog>
...
// RawText Creates a new dialog element with raw text content as unescaped HTML using text.RawText.
// Example: dialog.RawText("Greetings <em>one and all</em>!")
// Renders: <dialog>Greetings <em>one and all</em>!</dialog>
...
// Textf Creates a new dialog element with formatted text content using text.Textf.
// Example: dialog.Textf("Hello %s", "World")
// Renders: <dialog>Hello World</dialog>
...
// RawTextf Creates a new dialog element with formatted raw text content as unescaped HTML using text.RawTextf.
// Example: dialog.RawTextf("Hello <em>%s</em>", "World")
// Renders: <dialog>Hello <em>World</em></dialog>
...
// Open Indicates that the dialog box is active and is available for interaction. If the open attribute is not
// set, the dialog box will not be visible to the user.
func (e *element) Open() *element {
	e.open = true
	return e
}

// ClosedBy Specifies the types of user actions that can be used to close the <dialog> element. Possible values are
// "any", "closerequest", and "none".
func (e *element) ClosedBy(closedby string) *element {
	e.SetAttribute("closedby", closedby)
	return e
}
