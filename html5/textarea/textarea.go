...
// Disabled Disables the textarea, preventing user interaction. The element appears greyed out, cannot receive focus,
...
// ReadOnly Makes the textarea read-only, preventing user modification while still allowing the content to be
...
// Required Makes this textarea mandatory for form submission. Browsers prevent submission and display validation
