...
//
// The <hgroup> element groups one h1-h6 heading with related paragraphs, such
// as a subtitle or tagline. The paragraphs supplement the heading without
// introducing additional heading levels.
package hgroup
...
func (e *Element) RenderBuilder(buf *bytes.Buffer) {
	...
	buf.Write(html5.TagHgroupClose)
}
