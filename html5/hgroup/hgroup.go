...
// New Creates a new hgroup element with optional child nodes.
// Example: hgroup.New()
...
// Text Creates a new hgroup element with text content.
// Example: hgroup.Text("Main heading content")
// Renders: <hgroup>Main heading content</hgroup>
...
// Static Creates a new hgroup element with static text content.
// Example: hgroup.Static("Hello World")
// Renders: <hgroup>Hello World</hgroup>
...
// RawText Creates a new hgroup element with raw text content.
// Example: hgroup.RawText("Main heading content")
// Renders: <hgroup>Main heading content</hgroup>
...
// Textf Creates a new hgroup element with formatted text content using text.Textf.
// Example: hgroup.Textf("Hello %s", "World")
// Renders: <hgroup>Hello World</hgroup>
...
// RawTextf Creates a new hgroup element with formatted raw text content as unescaped HTML using text.RawTextf.
// Example: hgroup.RawTextf("Hello <em>%s</em>", "World")
// Renders: <hgroup>Hello <em>World</em></hgroup>
