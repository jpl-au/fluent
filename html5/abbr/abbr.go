...
//
// The <abbr>: The Abbreviation element represents an abbreviation or acronym. When including an abbreviation
// or acronym, provide a full expansion of the term in plain text on first use, along with the <abbr> to
// mark up the abbreviation. This informs the user what the abbreviation or acronym means.
package abbr
...
func Text(abbreviation string) *Element {
	return &Element{
		nodes: []node.Node{text.Text(abbreviation)},
	}
}
...
func Static(abbreviation string) *Element {
	return &Element{
		nodes: []node.Node{text.Static(abbreviation)},
	}
}
...
func RawText(abbreviation string) *Element {
	return &Element{
		nodes: []node.Node{text.RawText(abbreviation)},
	}
}
...
//
// Contains the full expansion or definition of the abbreviation or acronym. This attribute is essential
