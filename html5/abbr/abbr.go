...
// Text Creates a new abbreviation element with text content.
...
// Static Creates a new abbreviation element with static text content.
...
// RawText Creates a new abbreviation element with raw HTML content (unescaped).
...
// Textf Creates a new abbr element with formatted text content using text.Textf.
// Example: abbr.Textf("Hello %s", "World")
// Renders: <abbr>Hello World</abbr>
...
// RawTextf Creates a new abbr element with formatted raw text content as unescaped HTML using text.RawTextf.
// Example: abbr.RawTextf("Hello <em>%s</em>", "World")
// Renders: <abbr>Hello <em>World</em></abbr>
